---
title: "Практическое руководство. Просмотр отчетов о тестировании перед учетом | Документы Майкрософт"
description: "Узнайте, как получить тестовый отчет перед учетом."
...
1. В правом вернем углу щелкните значок **Поиск страницы или отчета** ![Поиск страницы или отчета](media/ui-search/search_small.png "значок "Поиск страницы или отчета""), введите **Счета покупок** и выберите связанную ссылку.
