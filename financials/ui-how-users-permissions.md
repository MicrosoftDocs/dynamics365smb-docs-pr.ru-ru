---
title: "Практическое руководство. Управление пользователями и разрешениями | Документы Майкрософт"
description: "Управление наборами разрешений для пользователей после создания пользователей в Office 365."
...
**Важно**! Если база данных имеет несколько организаций, то по крайней мере один пользователь должен быть членом группы суперпользователей во всех организациях.
...
1. В правом верхнем углу выберите значок "Поиск страницы или отчета", введите **Пользователи**, затем выберите связанную ссылку.
...
1. В правом верхнем углу выберите значок "Поиск страницы или отчета", введите **Группы пользователей**, затем выберите связанную ссылку.
...
4. В поле **Новый код группы пользователей** укажите имя новой группы пользователей, а затем нажмите кнопку **OK**.
