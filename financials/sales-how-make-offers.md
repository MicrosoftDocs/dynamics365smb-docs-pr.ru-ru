...
---
# <a name="make-offers"></a>Создание предложений
...
1. Выберите значок ![Поиск страницы или отчета](media/ui-search/search_small.png "Значок поиска страницы или отчета"), введите **Предложения по продаже**, затем выберите связанную ссылку.
