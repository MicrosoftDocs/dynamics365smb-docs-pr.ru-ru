...
Портал бухгалтера является выделенной версией [!INCLUDE[d365fin](includes/d365fin_md.md)]. Доступ к панели мониторинга можно получить, выполнив подписку из [Financials для бухгалтеров на Microsoft.com](https://www.microsoft.com/en-us/dynamics365/financial-insights-for-accountants).  
