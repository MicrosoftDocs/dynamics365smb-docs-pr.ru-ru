...
# <a name="how-to-create-a-sandbox-environment"></a>Практическое руководство. Создание среды "песочницы"
...
8.  Для переключения между производственной средой и средой песочницы можно использовать средства запуска приложений Dynamics 365.
