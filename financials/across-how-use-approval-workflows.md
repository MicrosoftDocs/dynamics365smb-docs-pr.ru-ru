---
title: "Практическое руководство. Использование рабочих процессов утверждения | Документы Майкрософт"
description: "Практическое руководство. Использование рабочего процесса утверждения"
documentationcenter: 
author: SorenGP
...
Рабочие процессы утверждения можно настроить в окне **Рабочий процесс**.
...
2. Чтобы увидеть все запросы утверждения, в правом вернем углу щелкните значок **Поиск страницы или отчета** ![Поиск страницы или отчета](media/ui-search/search_small.png "значок "Поиск страницы или отчета""), введите **Операции запросов утверждения** и выберите связанную ссылку.
...
2. Внесите необходимые изменения в запись, например, адрес поставщика.
...
1. В правом вернем углу щелкните значок **Поиск страницы или отчета** ![Поиск страницы или отчета](media/ui-search/search_small.png "значок "Поиск страницы или отчета""), введите **Запросы на утверждение** и выберите связанную ссылку.
...
1. В правом вернем углу щелкните значок **Поиск страницы или отчета** ![Поиск страницы или отчета](media/ui-search/search_small.png "значок "Поиск страницы или отчета""), введите **Просроченные запросы утверждения** и выберите связанную ссылку.
