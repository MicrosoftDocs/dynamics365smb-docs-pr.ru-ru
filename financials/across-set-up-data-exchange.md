...
description: "Настройка платформы обмена данными в Finance and Operations, Business edition."
author: SorenGP
...
|Установите одну из двух заранее настроенных служб для обновленных валютных курсов, чтобы выводить последние обменные курсы в окне **Валюты**.|[Обновление валютных курсов](finance-how-update-currencies.md)|  
