---
title: "Практическое руководство. Регистрация покупок | Документы Майкрософт"
...
**Внимание**! Не выполняйте учет счета покупки, пока не будут получены товары и не будет известна конечная себестоимость покупки, включая все дополнительные издержки. В противном случае значения стоимости запасов и прибыли могут быть неверными.
...
**Примечание**. Функция заказа на покупку требует, чтобы было задано значение **Пакет**. Дополнительные сведения см. в разделе [Настройка взаимодействия [!INCLUDE[d365fin](includes/d365fin_md.md)]](ui-experiences.md).
