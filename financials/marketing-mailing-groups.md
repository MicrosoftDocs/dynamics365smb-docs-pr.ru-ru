...
description: "Описываются группы рассылки для контактов в Financials."
...
## <a name="defining-mailing-group-codes"></a>Определение кодов групп рассылки
...
1. В правом вернем углу щелкните значок **Поиск страницы или отчета** ![Поиск страницы или отчета](media/ui-search/search_small.png "значок "Поиск страницы или отчета""), введите **Группы рассылки** и выберите связанную ссылку.
