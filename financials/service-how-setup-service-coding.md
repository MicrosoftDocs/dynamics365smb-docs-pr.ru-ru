...
3. <span data-ttu-id="8df9b-116">Заполните строки сервиса, связанные с данным сервисным кодом.</span><span class="sxs-lookup"><span data-stu-id="8df9b-116">Fill in the service lines linked to this service code.</span></span>  
