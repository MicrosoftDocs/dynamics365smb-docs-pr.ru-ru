---
title: "Настройка маркетинговых кампаний в Finance and Operations, Business edition | Microsoft Docs"
description: "Описывается, как можно настраивать и проводить маркетинговые кампании в Finance and Operations, Business edition, чтобы помочь выявить и привлечь потенциальных клиентов, а также сохранить существующих."
author: SorenGP
