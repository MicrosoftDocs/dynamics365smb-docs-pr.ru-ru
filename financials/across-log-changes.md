---
title: "Регистрация изменений в Dynamics 365 for Financials | Документы Майкрософт"
description: "Регистрация изменений, внесенных пользователями."
documentationcenter: 
author: edupont04
...
В окне **Настройка журнала изменений**, если выбрать действие **Таблицы**, можно указать, для каких таблиц требуется отлеживать изменения и какие изменения требуется отлеживаться. [!INCLUDE[d365fin](includes/d365fin_md.md)] также отслеживает несколько системных таблиц.
