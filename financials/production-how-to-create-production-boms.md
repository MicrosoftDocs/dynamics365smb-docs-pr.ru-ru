---
title: "Создание производственных спецификаций | Документы Майкрософт"
...
12.  Теперь можно присоединить новую производственную спецификацию к карточке рассматриваемого родительского товара. Дополнительные сведения см. в разделе [Практическое руководство. Регистрация новых продуктов](inventory-how-register-new-items.md).  
