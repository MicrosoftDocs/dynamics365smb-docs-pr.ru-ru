---
title: "Способы устранения или обхода неполадок при самостоятельной регистрации | Документы Майкрософт"
description: "Узнайте о типичных причинах проблем при регистрации в Dynamics 365 for Financials и способах их обхода."
...
## <a name="what-email-address-can-i-use-with-financials"></a>Какой адрес электронной почты можно использовать с Financials?
