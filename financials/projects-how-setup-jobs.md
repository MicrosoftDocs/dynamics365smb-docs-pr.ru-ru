---
title: "Практическое руководство. Настройка работ | Документы Майкрософт"
description: "Описывается, как подготовить систему для использования работ для управления проектами."
...
1. В правом вернем углу щелкните значок **Поиск страницы или отчета** ![Поиск страницы или отчета](media/ui-search/search_small.png "значок "Поиск страницы или отчета""), введите **Настройка работ** и выберите связанную ссылку.
...
**Примечание**. Необходимые счета в плане счетов должны быть настроены перед настройкой учетных групп. Дополнительные сведения см. в разделе [Настройка или изменение плана счетов](finance-setup-chart-accounts.md).  

1. В правом вернем углу щелкните значок **Поиск страницы или отчета** ![Поиск страницы или отчета](media/ui-search/search_small.png "значок "Поиск страницы или отчета""), введите **Учетные группы работ** и выберите связанную ссылку.  
