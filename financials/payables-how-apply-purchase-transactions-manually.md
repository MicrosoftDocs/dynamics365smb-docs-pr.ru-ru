---
title: "Практическое руководство. Выверка платежей поставщикам вручную | Документы Майкрософт"
description: "Практическое руководство. Выверка платежей поставщикам вручную"
...
1. В правом вернем углу щелкните значок **Поиск страницы или отчета** ![Поиск страницы или отчета](media/ui-search/search_small.png "значок "Поиск страницы или отчета""), введите **Журнал платежей** и выберите связанную ссылку.
...
1. В правом вернем углу щелкните значок **Поиск страницы или отчета** ![Поиск страницы или отчета](media/ui-search/search_small.png "значок "Поиск страницы или отчета""), введите **Кредит-нота покупки** и выберите связанную ссылку.
2. Откройте кредит-ноту, которую необходимо применить.
3. Введите соответствующую информацию в заголовок.
4. Чтобы применить одну операцию книги поставщиков, на экспресс-вкладке **Применение** в поле **Примен. к док. - номер** выберите операцию, к которой требуется применить кредит, а затем в поле **Сумма для применения** введите сумму для применения к операции.
