---
title: "Практическое руководство. Определение макетов платежных документов | Документы Майкрософт"
description: "Сведения о макетах платежных документов, доступных в Financials."
...
1. В правом вернем углу щелкните значок **Поиск страницы или отчета** ![Поиск страницы или отчета](media/ui-search/search_small.png "значок "Поиск страницы или отчета""), введите **Выбор отчета - банковский счет** и выберите связанную ссылку.
