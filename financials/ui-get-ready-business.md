...
description: "Описываются мастера настройки, видеоролики, разделы справки, а также страницы и окна, которые помогут подготовиться к ведению бизнеса в Dynamics 365 Business edition."
documentationcenter: 
