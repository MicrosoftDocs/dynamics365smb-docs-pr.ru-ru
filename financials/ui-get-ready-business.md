...
description: "Описываются мастера настройки, видеоролики, разделы справки, а также страницы и окна, которые помогут подготовиться к ведению бизнеса в Finance and Operations, Business edition."
documentationcenter: 
