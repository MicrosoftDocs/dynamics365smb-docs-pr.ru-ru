...
Товары могут быть и товарами в запасах, и услугами; это обозначается типами **Товар** и **Услуга** в карточке товара. Процедура обработки счетов продажи такая же для обоих типов товаров. Дополнительные сведения см. в разделе [Практическое руководство. Регистрация новых товаров](inventory-how-register-new-items.md).
...
[Массовое выставление счетов из Microsoft Bookings в Dynamics 365 Business edition](finance-bookings.md)  
