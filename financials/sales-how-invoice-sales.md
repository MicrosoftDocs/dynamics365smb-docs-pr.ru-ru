---
title: "Практическое руководство. Выставление счетов продажи | Документы Майкрософт"
description: "Описывается использование счетов продажи."
documentationcenter: 
author: SorenGP
...
**Примечание.** Существует несколько сценариев, когда необходимо использовать заказ на продажу вместо счета продажи:  
...
Товары могут быть и товарами в запасах, и услугами, обозначенными типами **Товар - Запасы** и **Товар - Сервис** в строках продажи. Процедура обработки счетов продажи такая же для обоих типов товаров. Дополнительные сведения см. в разделе [Практическое руководство. Регистрация новых товаров](inventory-how-register-new-items.md).
