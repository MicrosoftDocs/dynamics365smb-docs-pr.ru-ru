---
title: "Подготовка к настройке контактов | Документы Майкрософт"
description: "Описывается процедура подготовки к настройке в контактов в Financials."
...
---
# <a name="preparing-for-setting-up-contacts"></a>Подготовка к настройке контактов
