...
|Настройте SMTP-сервер для включения передачи сообщений электронной почты в и из него. [!INCLUDE[d365fin](includes/d365fin_md.md)]|[Настройка электронной почты](madeira-how-setup-email.md)|
...
|Добавление поддержки для бизнеса сценария, для которого требуются новые события рабочих процессов или отклики путем настройки кода приложения.|[Пошаговое руководство. Реализация новых и событий и отзывов рабочего процесса](/dynamics_nav/Walkthrough--Implementing-New-Workflow-Events-and-Responses).|  
