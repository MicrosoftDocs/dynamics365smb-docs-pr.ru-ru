...
|Настройте SMTP-сервер для включения передачи сообщений электронной почты в [!INCLUDE[d365fin](includes/d365fin_md.md)] и из него.|[Настройка электронной почты](madeira-how-setup-email.md)|
