...
* Настройка НДС товарных групп для определения ставок НДС для продуктов и услуг, которые вы покупаете или продаете.  
   ...
   > [!NOTE]  
>   Понятия НДС бизнес-групп и товарных групп похожи на понятия общих учетных групп. Дополнительные сведения см. в разделе [Настройка учетных групп](finance-posting-groups.md).
...
* Назначение НДС товарных групп счетам главной книги, используемым для продаж и покупок, товаров и ресурсов.  
   ...
   > [!NOTE]  
>   Чтобы настроить НДС для ресурсов, необходимо включить взаимодействие с пользователем **Пакет** для организации. Дополнительные сведения см. в разделе [Настройка взаимодействия Dynamics 365 for Financials](ui-experiences.md).
...
Наша служба также может сэкономить вам время при создании клиента или поставщика. Если вы знаете ИНН клиента, вы можете ввести его в поле **ИНН** в карточке "Клиент" или "Поставщик", после чего имя клиента будет заполнено автоматически. Некоторые страны также предлагают адреса организаций в структурированном формате. В этих странах также заполняется адрес.  
