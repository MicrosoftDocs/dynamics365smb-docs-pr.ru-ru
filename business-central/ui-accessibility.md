...
ms.author: jswymer
---
# <a name="accessibility-and-keyboard-shortcuts" />Специальные возможности и сочетания клавиш
...
## <a name="a-namenavigationa-navigation" /><a name="Navigation"></a> Навигация
...
## <a name="a-nameheadingsa-headings-in-content" /><a name="Headings"></a> Заголовки в содержимом
...
## <a name="a-nameimagesa-image-and-links" /><a name="Images"></a> Изображение и ссылки
...
## <a name="a-nameassistivetecha-assistive-technologies" /><a name="AssistiveTech"></a> Вспомогательные технологии
...
## <a name="a-namezooma-zoom" /><a name="zoom"></a> Масштаб
...
## <a name="tooltips" />Всплывающие подсказки
...
#### <a name="accessing-tooltips" />Доступ к всплывающим подсказкам
...
## <a name="for-more-accessibility-information" />Дополнительные сведения о специальных возможностях
