...
ms.author: jswymer
---
# <a name="accessibility-and-keyboard-shortcuts"></a><a name="accessibility-and-keyboard-shortcuts"></a>Специальные возможности и сочетания клавиш
...
## <a name="navigation"></a><a name="navigation"></a><a name="Navigation"></a> Навигация
...
## <a name="headings-in-content"></a><a name="headings-in-content"></a><a name="Headings"></a> Заголовки в содержимом
...
## <a name="image-and-links"></a><a name="image-and-links"></a><a name="Images"></a> Изображение и ссылки
...
## <a name="assistive-technologies"></a><a name="assistive-technologies"></a><a name="AssistiveTech"></a> Вспомогательные технологии
...
## <a name="zoom"></a><a name="zoom"></a><a name="zoom"></a> Масштаб
...
## <a name="tooltips"></a><a name="tooltips"></a>Всплывающие подсказки
...
#### <a name="accessing-tooltips"></a><a name="accessing-tooltips"></a>Доступ к всплывающим подсказкам
...
## <a name="for-more-accessibility-information"></a><a name="for-more-accessibility-information"></a>Дополнительные сведения о специальных возможностях
