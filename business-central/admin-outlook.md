...
В [!INCLUDE[d365fin](includes/d365fin_md.md)] один из шагов по сопровождаемой настройки "Приступая к работе" выполняется на странице **Управление бизнесом из Office 365**. На этой странице при нажатии кнопки **Настроить в Outlook** вы должны указать имя пользователя и пароль для Office 365. После этого надстройки [!INCLUDE[d365fin](includes/d365fin_md.md)] будут автоматически добавлены в Outlook.  
