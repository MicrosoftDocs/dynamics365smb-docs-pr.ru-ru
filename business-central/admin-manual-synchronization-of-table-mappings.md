...
# <a name="manually-synchronize-table-mappings"></a><a name="manually-synchronize-table-mappings"></a>Ручная синхронизация сопоставлений таблиц
...
## <a name="run-a-full-synchronization"></a><a name="run-a-full-synchronization"></a>Выполнение полной синхронизации
...
### <a name="to-run-a-full-synchronization"></a><a name="to-run-a-full-synchronization"></a>Для выполнения полной синхронизации
...
## <a name="synchronizing-all-modified-records"></a><a name="synchronizing-all-modified-records"></a>Синхронизация всех измененных записей
...
### <a name="to-synchronize-data-for-all-tables"></a><a name="to-synchronize-data-for-all-tables"></a>Для синхронизации данных для всех таблиц
...
## <a name="synchronize-individual-table-mappings"></a><a name="synchronize-individual-table-mappings"></a>Синхронизация отдельных сопоставлений таблиц
...
### <a name="to-synchronize-records-of-an-integration-table-mapping"></a><a name="to-synchronize-records-of-an-integration-table-mapping"></a>Для синхронизации записей сопоставления таблиц интеграции
