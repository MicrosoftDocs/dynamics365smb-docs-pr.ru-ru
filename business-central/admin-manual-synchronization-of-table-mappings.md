...
# <a name="manually-synchronize-table-mappings" />Ручная синхронизация сопоставлений таблиц
...
## <a name="run-a-full-synchronization" />Выполнение полной синхронизации
...
### <a name="to-run-a-full-synchronization" />Для выполнения полной синхронизации
...
## <a name="synchronizing-all-modified-records" />Синхронизация всех измененных записей
...
### <a name="to-synchronize-data-for-all-tables" />Для синхронизации данных для всех таблиц
...
## <a name="synchronize-individual-table-mappings" />Синхронизация отдельных сопоставлений таблиц
...
### <a name="to-synchronize-records-of-an-integration-table-mapping" />Для синхронизации записей сопоставления таблиц интеграции
