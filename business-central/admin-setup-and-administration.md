...
|**Задача**|**Ссылка**|  
|------------|-------------|  
|Добавьте пользователей, управляйте разрешениями и доступом к данным, назначьте роли.|[Знакомство с профилями (ролями) и ролевыми центрами](admin-users-profiles-roles.md)|  
