...
ms.author: edupont
---
# <a name="troubleshooting-your-company-hub" />Устранение неполадок в вашем разделе организации
...
## <a name="check-errors" />Проверка ошибок
...
## <a name="connection-failed" />Ошибка подключения
...
## <a name="data-does-not-refresh" />Данные не обновляются
