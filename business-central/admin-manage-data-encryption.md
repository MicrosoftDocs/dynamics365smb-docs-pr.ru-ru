...
> [!Note]
> Включить или отключать шифрование можно, только если вы используете локальные версии [!INCLUDE[d365fin](includes/d365fin_md.md)], Для онлайн-версий шифрование всегда включено, и его нельзя отключить.
