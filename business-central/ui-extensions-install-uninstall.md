...
> [!NOTE]
> Чтобы установить расширения из AppSource или добавить расширения для каждого арендатора, у вас должны быть соответствующие разрешения. Вы должны либо быть участником группы пользователей РАСШИР. УПР. - АДМИН. или у вас должен быть набор расширений РАСШИР. УПР. - АДМИН. Если вы являетесь администратором, вы можете назначать группы пользователей и разрешения другим пользователям в вашей компании.
>
