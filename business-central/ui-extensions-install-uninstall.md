...
# <a name="install-and-uninstall-extensions-apps-in-business-central" />Установка и удаление расширений (приложений) в Business Central
...
## <a name="set-up-an-app" />Настройка приложения
...
## <a name="upload-a-per-tenant-extension-pte" />Отправка расширения для каждого клиента (PTE)
...
## <a name="uninstall-an-app" />Удаление приложения
