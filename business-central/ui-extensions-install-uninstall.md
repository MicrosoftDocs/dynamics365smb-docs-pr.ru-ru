---
title: Установка и удаление расширений
...
ms.locfileid: "8804660"
---
# <a name="install-and-uninstall-extensions-in-business-central"></a>Установка и удаление расширений в Business Central
...
## <a name="install-an-extension"></a><a name="install"></a>Установить расширение
...
## <a name="uninstall-an-extension"></a>Удалить расширение

Вы удаляете расширение с помощью страницы **Управление расширениями**. Чтобы удалить расширение, выберите его на странице, затем выберите действие **Удалить**. Если вы удалили расширение, а потом передумали, вы можете снова установить его.

При удалении расширения, которое вы использовали, данные по умолчанию сохраняются на случай, если вы будете устанавливать расширение снова. Вместо этого вы можете удалить данные с расширением. Эта операция контролируется переключателем **Удалить данные расширения**. По умолчанию этот переключатель **выключен**. При попытке включить переключатель **Удалить данные расширения** для расширения вы получите диалоговое окно запроса подтверждения, и вы должны выбрать **Да**, чтобы включить этот переключатель. После того как переключатель **Удалить данные расширения** включен, вы можете удалить расширение, и вам будет предложено еще раз подтвердить, что вы хотите удалить расширение и удалить данные.

> [!IMPORTANT]  
> - Могут быть другие расширения, для работы которых требуется наличие расширения, которое вы хотите удалить, или которые зависят от этого расширения. Эти другие расширения называются *зависимыми*. Вы не можете удалить расширение, только если его зависимые расширения также удаляются.
> - Когда вы решите удалить расширение, имеющее одну или несколько зависимостей, вы получите диалоговое окно запроса подтверждения со списком зависимостей и вопросом, хотите ли вы удалить расширение и все его зависимые элементы. Вам придется выбрать **Да**, чтобы продолжить.
> - Если вы включите переключатель **Удалить данные расширения**, удаление расширения приведет к удалению всех данных для расширения **плюс** данных для всех зависимых расширений. Отменить это действие невозможно.
