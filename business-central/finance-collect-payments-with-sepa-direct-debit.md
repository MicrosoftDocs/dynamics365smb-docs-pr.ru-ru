...
## <a name="how-to-set-up-sepa-direct-debit"></a>Настройка прямого дебетования SEPA
...
3. На экспресс-вкладке **Общие** в поле **Формат экспорта прямого дебетования SEPA** выберите вариант для прямого дебета SEPA.  
