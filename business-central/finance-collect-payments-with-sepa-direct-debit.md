...
---
# <a name="collect-payments-with-sepa-direct-debit"></a>Собирайте платежи с помощью SEPA Direct Debit
...
## <a name="how-to-set-up-sepa-direct-debit"></a>Как настроить прямой дебет SEPA
...
### <a name="to-set-up-your-bank-account-for-sepa-direct-debit"></a>Чтобы настроить свой банковский счет для прямого дебета SEPA
...
### <a name="to-set-up-the-customers-payment-method-for-sepa-direct-debit"></a>Чтобы настроить способ оплаты клиента для SEPA Direct Debit
