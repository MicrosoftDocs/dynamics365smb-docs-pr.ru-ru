...
# <a name="use-profile-questionnaires-to-classify-business-contacts" />Использование анкет профилей для классификации бизнес-контактов
...
## <a name="to-add-a-profile-questionnaire" />Добавление анкеты профиля
...
## <a name="to-add-questions-to-a-profile-questionnaire" />Добавление вопросов в анкету профиля
...
## <a name="apply-questionnaires-to-contacts" />Применение анкет к контактам
...
## <a name="the-automatic-classification-of-contacts" />Автоматическая классификация контактов
