...
Вы можете автоматически классифицировать свои контакты по клиенту, поставщику и контактной информации путем настройки профильных вопросов, на которые программа отвечает автоматически, в окне **Настройка анкеты профиля**.  
...
Чтобы это сделать, заполните окно **Настройка анкеты профиля** следующим образом:
...
Затем заполните окно **Вопрос профиля - подробности** следующим образом:
<table>
<colgroup>
<col style="width: 50%" />
<col style="width: 50%" />
