...
ms.author: bholtorf
---
# <a name="set-up-vat-statement-templates-and-vat-statement-names" />Настройка шаблонов отчетов НДС и названий отчетов НДС
...
## <a name="to-define-a-vat-statement" />Определение отчета по НДС
...
## <a name="to-preview-the-vat-statement" />Предварительный просмотр отчета по НДС
