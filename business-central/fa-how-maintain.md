...
ms.author: edupont
---
# <a name="maintain-fixed-assets" />Обслуживание основных средств
...
## <a name="to-record-maintenance-work-on-a-fixed-asset" />Запись работ по обслуживанию основного средства
...
## <a name="to-post-maintenance-costs-from-a-fixed-asset-gl-journal" />Учет стоимости обслуживания из журнала ГК учета основных средств
...
## <a name="to-follow-up-on-fixed-assets-service-visits" />Отслеживание сервисных посещений для обслуживания основных средств
...
## <a name="to-monitor-maintenance-costs" />Просмотр значений стоимости обслуживания
...
## <a name="to-view-or-print-maintenance-costs-for-multiple-fixed-assets" />Просмотр или печатать значений стоимости обслуживания для нескольких основных средств
...
## <a name="to-view-maintenance-ledger-entries" />Просмотр операций книги обслуживания
...
## <a name="to-view-or-print-maintenance-ledger-entries-for-multiple-fixed-assets" />Просмотр или печатать операций книги обслуживания для нескольких основных средств
