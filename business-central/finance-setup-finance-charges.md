...
ms.author: edupont
---
# <a name="set-up-finance-charge-terms" />Настройка процентных ставок
...
## <a name="finance-charge-terms" />Процентные ставки
...
### <a name="to-set-up-finance-charge-terms" />Настройка процентных ставок
...
## <a name="see-related-microsoft-trainingtrainingmodulessend-memos-dynamics--business-central" />См. соответствующее [обучение Microsoft](/training/modules/send-memos-dynamics-365-business-central/)
