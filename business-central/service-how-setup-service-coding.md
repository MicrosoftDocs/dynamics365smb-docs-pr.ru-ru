...
# <a name="set-up-standard-service-codes" />Настройка стандартных сервисных кодов
...
## <a name="to-set-up-a-standard-service-code" />Настройка стандартного сервисного кода
...
## <a name="to-assign-a-standard-service-code-to-a-service-item-group" />Присвоение стандартного сервисного кода группе сервисных товаров
