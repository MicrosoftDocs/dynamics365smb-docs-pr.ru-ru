...
<!-- Contoso-->
### <a name="contoso-coffee-demo-data"></a>Демонстрационные данные Contoso Coffee
...
#### <a name="warehousing"></a>Складское хозяйство
...
#### <a name="design-details-inventory-costing"></a>Технические подробности: учет себестоимости запасов
...
#### <a name="design-details-posting-date-on-adjustment-value-entry"></a>Технические подробности: дата учета в корректирующей операции стоимости
...
#### <a name="design-details-dimension-set-entries"></a>Технические подробности: записи наборов измерений
...
#### <a name="design-details-supply-planning"></a>Технические подробности: планирование поставок
...
#### <a name="design-details-item-tracking"></a>Технические подробности: трассировка товаров
...
#### <a name="design-details-general-journal-post-line"></a>Технические подробности: учет строки финансового журнала
...
### <a name="ai-powered-item-marketing-text-with-copilot"></a>Написание маркетинговых текстов для товаров на базе ИИ с помощью Copilot
...
<!--use-->
## <a name="get-productive-in-business-central"></a>Продуктивная работа в Business Central
...
### <a name="personalize-business-central"></a>Персонализация Business Central
...
### <a name="run-and-print-reports"></a>Запуск и печать отчетов
...
### <a name="change-the-look-of-externally-facing-documents"></a>Изменение внешнего вида внешних документов
...
#### <a name="using-legacy-features"></a>Использование устаревших функций
...
### <a name="sharing-business-data"></a>Совместное использование бизнес-данных
...
#### [Просмотр и редактирование в Excel](across-work-with-excel.md)
### <a name="accessibility-keyboard-shortcuts-and-touch-gestures"></a>Специальные возможности, сочетания клавиш и сенсорные жесты
...
# <a name="business-functionality"></a>Бизнес-функциональность
## [Обзор бизнес-функциональности](across-business-functionality.md)
<!--general-->
## <a name="general-business-functionality"></a>Общая бизнес-функциональность
...
#### <a name="use-approval-workflows"></a>Использование рабочих процессов утверждения
...
<!--data exchange-->
### <a name="exchange-data-electronically"></a>Электронный обмен данными
#### [Обзор OData Exchange](across-data-exchange.md)
#### [О платформе обмена данными](across-about-the-data-exchange-framework.md)
#### <a name="set-up-data-exchange"></a>Настройка обмена данными
...
#### <a name="exchange-data"></a>Обмен данными
...
### <a name="manage-receivables"></a>Управление расчетами с клиентами
...
#### <a name="applying-payments-automatically-and-reconcile-bank-accounts"></a>Автоматическое применение платежей и выверка банковских счетов
...
### <a name="manage-payables"></a>Управление расчетами с поставщиками
...
##### [Совершение платежей с помощью расширения AMC Banking 365 Fundamentals или кредитового перевода SEPA](finance-make-payments-with-bank-data-conversion-service-or-sepa-credit-transfer.md)
##### [Быстрая оплата счетов покупки](finance-how-to-settle-purchase-invoices-promptly.md)
##### [Экспорт файла Positive Pay](finance-how-positive-pay.md)
#### <a name="applying-payments-automatically-and-reconcile-bank-accounts-1"></a>Автоматическое применение платежей и выверка банковских счетов
##### [Обзор применения платежей](receivables-apply-payments-auto-reconcile-bank-accounts.md)
##### [Выверка платежей с использованием автоматического применения](receivables-how-reconcile-payments-auto-application.md)
##### [Проверка или применение платежей вручную после автоматического применения](receivables-how-review-apply-payments-auto-application.md)
##### [Выверка платежей, которые не могут быть применены автоматически](receivables-how-reconcile-payments-cannot-apply-auto.md)
...
### <a name="manage-vat"></a>Управление НДС
#### [Обзор управления НДС](finance-manage-vat.md)
#### <a name="setup-vat"></a>Настройка НДС
...
### <a name="manage-intercompany-transactions"></a>Управление межфирменными транзакциями
...
### <a name="accounting-for-costs"></a>Учет затрат
...
### <a name="manage-inventory-costs"></a>Управление себестоимостью запасов
...
#### <a name="report-costs-and-reconcile-with-the-general-ledger"></a>Отчетность по себестоимости и ее выверка с главной книгой
...
### <a name="manage-cash-flow"></a>Управление движением денежных средств
...
### <a name="consolidate-financial-data-from-multiple-companies"></a>Консолидация финансовых данных из нескольких организаций
...
### <a name="work-with-the-chart-of-accounts-and-general-ledger"></a>Работа с планом счетов и главной книгой
...
## <a name="financial-business-intelligence-and-reporting"></a>Финансовая бизнес-аналитика и отчетность
...
### <a name="manage-contacts"></a>Управление контактами
...
### <a name="manage-interactions"></a>Управление взаимодействиями
...
## <a name="manufacturing-1"></a>Производство
...
## <a name="warehouse-management"></a>Управление складами
### [Обзор управления складами](design-details-warehouse-management.md)
<!-- ### [Warehouse Management](warehouse-manage-warehouse.md) -->
### [Отчеты по запасам и складам](inventory-WMS-reports.md)

### <a name="inbound-warehouse-processes"></a>Входящие складские процессы
...
#### [Размещение товаров с использованием товарных размещений](warehouse-how-to-put-items-away-with-inventory-put-aways.md)
...
### <a name="outbound-warehouse-processes"></a>Исходящие складские процессы
...
### <a name="internal-warehouse-processes"></a>Внутренние складские процессы
#### <a name="production-assembly-and-job-activities"></a>Действия, связанные с производством, сборкой и работами
...
#### <a name="move-items"></a>Перемещение товаров
...
#### <a name="warehouse-counting"></a>Складская инвентаризация
...
## <a name="service-management"></a>Управление сервисом
### [Управление сервисом](service-service.md)
### <a name="planning-service"></a>Планирование сервиса
...
### <a name="fulfill-service-contracts"></a>Выполнение сервисных контрактов
...
### <a name="deliver-service"></a>Осуществление сервиса
...
<!--Shopify-->
## <a name="online-store-with-shopify"></a>Интернет-магазин с Shopify
...
<!--Company Hub-->
## <a name="company-hub"></a>Мои организации
...
#### <a name="banking--payments"></a>Банковские операции и платежи
...
#### <a name="core-finance"></a>Базовые финансы
...
##### [Австралийские деловые номера и акты корректировки](LocalFunctionality/Australia/australian-business-numbers-and-adjustment-notes.md)
...
#### <a name="banking--payments-2"></a>Банковские операции и платежи
...
##### [Ручной перенос и учет выписок CODA](LocalFunctionality/Belgium/how-to-manually-transfer-and-post-coda-statements.md)
##### [Импорт выписок CODA](LocalFunctionality/Belgium/how-to-import-coda-statements.md)
#### <a name="core-finance-1"></a>Базовые финансы
...
##### <a name="deferrals-in-sales-and-purchase-ledger-reportslocalfunctionalitybelgiumhow-to-use-deferralsmd"></a>[Отнесения на будущие периоды в отчетах по книгам продаж и покупок](LocalFunctionality/Belgium/how-to-use-deferrals.md}
...
#### <a name="banking--payments-3"></a>Банковские операции и платежи
...
#### <a name="core-finance-2"></a>Базовые финансы
...
#### <a name="fixed-assets-1"></a>Основные средства
...
#### <a name="banking-and-payments"></a>Банковские операции и платежи
...
#### <a name="payables-and-receivables"></a>Расчеты с поставщиками и клиентами
...
#### <a name="inventory-1"></a>Запасы
##### [Запасы](LocalFunctionality/Czech/inventory.md)
#### <a name="general-4"></a>Общее
...
#### <a name="banking--payments-4"></a>Банковские операции и платежи
...
#### <a name="electronic-invoicing"></a>Электронное выставление счетов
...
#### <a name="banking--payments-5"></a>Банковские операции и платежи
...
#### <a name="core-finance-3"></a>Базовые финансы
...
#### <a name="banking--payments-6"></a>Банковские операции и платежи
...
#### <a name="core-finance-4"></a>Базовые финансы
...
##### [Печать отчетов по главной книге](LocalFunctionality/France/how-to-print-general-ledger-reports.md)
...
#### <a name="fixed-assets-2"></a>Основные средства
...
#### <a name="banking--payments-7"></a>Банковские операции и платежи
##### [Печать отчетов со списками оплат поставщикам](LocalFunctionality/Germany/how-to-print-vendor-payments-list-reports.md)
#### <a name="core-finance-5"></a>Базовые финансы
...
#### <a name="electronic-invoicing-1"></a>Электронное выставление счетов
...
##### <a name="tax-engine-configuration"></a>Конфигурация механизма начисления налогов
...
##### <a name="gst-on-purchase"></a>GST с покупок
...
##### <a name="gst-on-purchase-return"></a>GST с возвратов покупок
...
##### <a name="gst-on-journalspaymentapplication"></a>GST в журналах/платежах/применениях
...
##### <a name="gst-on-sales"></a>GST с продаж
...
##### <a name="gst-on-sales-return"></a>GST с возвратов продаж
...
##### <a name="gst-on-transfer"></a>GST с перемещений
...
##### <a name="gst-on-bank-charge"></a>GST с банковских комиссий
...
##### <a name="gst-adjustmentsperiodic-activities"></a>Корректировки/периодические операции по GST
...
##### <a name="gst-on-service-management"></a>GST при управлении сервисом
###### [GST при управлении сервисом](LocalFunctionality/India/GST-Service-Management.md)
##### <a name="gst-input-service-distribution"></a>GST при распределении входящих услуг
...
#### <a name="tds-for-customer"></a>TDS для клиента
...
#### <a name="voucher-interface"></a>Ваучерный интерфейс
...
#### <a name="fixed-asset"></a>Основные средства
##### [Обзор основных средств](LocalFunctionality/India/FA_Overview.md)
##### [Амортизация основных средств](LocalFunctionality/India/FA_Depreciation.md)
#### <a name="gate-entry"></a>Прохождение через ворота
...
##### [Печать отчетов по подоходному налогу](LocalFunctionality/Italy/how-to-print-withholding-tax-reports.md)
#### <a name="banking--payments-8"></a>Банковские операции и платежи
##### [Настройка условий платежа](LocalFunctionality/Italy/how-to-set-up-payment-terms.md)
...
#### <a name="core-finance-6"></a>Базовые финансы
...
#### <a name="inventory-2"></a>Запасы
##### [Настройка исходной себестоимости товаров](LocalFunctionality/Italy/how-to-set-up-initial-item-costs.md)
##### [Финансовая оценка стоимости запасов](LocalFunctionality/Italy/fiscal-inventory-valuation.MD)
##### [Настройка финансовой оценки стоимости запасов](LocalFunctionality/Italy/how-to-set-up-fiscal-inventory-valuation.md)
#### <a name="fixed-assets-3"></a>Основные средства
...
##### [Создание множественных карточек основных средств](LocalFunctionality/Italy/how-to-create-multiple-fixed-asset-cards.md)
##### [Печать отчетов по книге амортизации](LocalFunctionality/Italy/how-to-print-depreciation-book-reports.md)
#### <a name="general-7"></a>Общее
##### [Настройка информации об организации](LocalFunctionality/Italy/how-to-set-up-company-information.md)
...
#### <a name="electronic-invoicing-2"></a>Электронное выставление счетов
...
#### <a name="general-8"></a>Общее
##### [Правила электронного учета в Мексике](LocalFunctionality/Mexico/electronic-accounting-regulations.md)
##### [Совершение электронных платежей](finance-make-payments-with-bank-data-conversion-service-or-sepa-credit-transfer.md#exporting-payments-to-a-bank-file)
##### [Печать отчетов для устранения неполадок](LocalFunctionality/Mexico/how-to-print-troubleshooting-reports.md)  
##### [Создание внесений на счет](LocalFunctionality/Mexico/how-to-create-deposits.md)  
...
#### <a name="banking--payments-9"></a>Банковские операции и платежи
##### [Электронные банковские операции в Нидерландах](LocalFunctionality/Netherlands/dutch-electronic-banking.md)
##### [Телебанкинг](LocalFunctionality/Netherlands/telebanking.md)
##### [Платежные сценарии](LocalFunctionality/Netherlands/payment-scenarios.md)
##### [Платежный сценарий 1: платежи внутри страны (из МВ в МВ)](LocalFunctionality/Netherlands/payment-scenario-1-domestic-payments-lcy-to-lcy-.md)  
##### [Платежный сценарий 2: зарубежный платеж (из иностранной валюты в иностранную валюту)](LocalFunctionality/Netherlands/payment-scenario-2-foreign-payment-fcy-to-fcy-.md)  
##### [Платежный сценарий 3: зарубежный платеж (из МВ в иностранную валюту)](LocalFunctionality/Netherlands/payment-scenario-3-foreign-payment-lcy-to-fcy-.md)
##### [Создание предложений](LocalFunctionality/Netherlands/how-to-create-proposals.md)
##### [Отчеты-квитанции](LocalFunctionality/Netherlands/docket-reports.md)
...
#### <a name="core-finance-7"></a>Базовые финансы
##### [Применение и отмена применения операций главной книги](LocalFunctionality/Netherlands/how-to-apply-and-unapply-general-ledger-entries.md)
##### [Обязательные описания в операциях главной книги](LocalFunctionality/Netherlands/required-descriptions-in-g-l-entry.md)
#### <a name="purchasing-3"></a>Покупки
##### [Проверка сумм покупок](LocalFunctionality/Netherlands/check-purchase-amounts.md)
...
##### [Расчет подоходного налога и учет сопоставлений по нему](LocalFunctionality/NewZealand/how-to-calculate-and-post-withholding-tax-settlements.md)
...
#### <a name="banking--payments-10"></a>Банковские операции и платежи
##### [Сравнение движения денежных средств по банку](LocalFunctionality/NewZealand/how-to-compare-bank-cash-flow.md)
##### [Создание рассрочки по чеку](LocalFunctionality/NewZealand/how-to-create-check-installments.md)
##### [Электронный платеж](LocalFunctionality/NewZealand/electronic-funds-transfer-eft-.md)
##### [Печать отчетов по внесениям на счет](LocalFunctionality/NewZealand/how-to-print-deposit-slip-reports.md)
...
#### <a name="core-finance-8"></a>Базовые финансы
##### [Расчет сумм распределения](LocalFunctionality/NewZealand/calculating-distribution-amounts.md)
##### [Печать балансовых отчетов](LocalFunctionality/NewZealand/how-to-print-balance-sheet-reports.md)
##### [Печать отчетов о прибылях и убытках](LocalFunctionality/NewZealand/how-to-print-income-statements.md)
#### <a name="general-10"></a>Общее
...
##### [Номера департамента внутренних доходов Новой Зеландии и акты корректировки](LocalFunctionality/NewZealand/new-zealand-business-numbers-and-adjustment-notes.md)
...
#### <a name="banking--payments-11"></a>Банковские операции и платежи
##### [Электронные банковские операции в Норвегии](LocalFunctionality/Norway/electronic-banking-in-norway.md)
##### [Электронные платежи поставщикам в Норвегии](LocalFunctionality/Norway/electronic-payments-to-vendors-in-norway.md)
##### [Электронное выставление счетов (EHF) в Норвегии](LocalFunctionality/Norway/ehf-electronic-invoicing-in-norway.md)
##### [Настройка клиентов для использования EHF](LocalFunctionality/Norway/how-to-set-up-customers-for-ehf.md)  
...
##### [Создание переводных платежей вручную](LocalFunctionality/Norway/how-to-create-manual-remittance-payments.md)  
##### [Настройка соглашений о переводах](LocalFunctionality/Norway/how-to-set-up-remittance-agreements.md)  
##### [Настройка поставщиков для получения переводов](LocalFunctionality/Norway/how-to-set-up-vendors-for-remittance.md)
##### [Справочные коды получателей](LocalFunctionality/Norway/recipient-reference-codes.md)
...
##### [Тестирование переводных платежей](LocalFunctionality/Norway/how-to-test-remittance-payments.md)
##### [Создание предложений по переводам](LocalFunctionality/Norway/how-to-create-remittance-suggestions.md)
##### [Типы возвратных файлов по платежам](LocalFunctionality/Norway/types-of-payment-returns-files.md)
##### [Импорт возвратных данных по платежам](LocalFunctionality/Norway/how-to-import-payment-return-data.md)
...
##### [Экспорт переводных платежей](LocalFunctionality/Norway/how-to-export-remittance-payments.md)
##### [Норвежский жиро и шрифт OCR-B](LocalFunctionality/Norway/norwegian-giro-and-ocr-b-font.md)
##### [Настройка платежей с использованием OCR](LocalFunctionality/Norway/how-to-set-up-ocr-payments.md)
##### [Импорт и учет платежей с использованием OCR](LocalFunctionality/Norway/how-to-import-and-post-ocr-payments.md)
##### [Печать тестового отчета журнала OCR](LocalFunctionality/Norway/how-to-print-the-ocr-journal-test-report.md)  
#### <a name="core-finance-9"></a>Базовые финансы
##### [Применение операций главной книги в закрытых периодах](LocalFunctionality/Norway/how-to-apply-general-ledger-entries-in-closed-periods.md)  
#### <a name="general-11"></a>Общее
##### [Периодические заказы](LocalFunctionality/Norway/recurring-orders.md)  
##### [Создание периодических заказов](LocalFunctionality/Norway/how-to-create-recurring-orders.md)
##### [Настройка периодических групп](LocalFunctionality/Norway/how-to-set-up-recurring-groups.md)  
##### [Настройка периодических заказов](LocalFunctionality/Norway/how-to-set-up-recurring-orders.md)
##### [Определения данных для зарплаты](LocalFunctionality/Norway/ui-extensions-payroll-data-definitions-no.md)
##### [Импорт зарплатных транзакций](LocalFunctionality/Norway/how-to-import-payroll-transactions.md)
...
#### [Локальная функциональность в российской версии](LocalFunctionality/Russia/russia-local-functionality.md)
#### <a name="core-finance-10"></a>Базовые финансы
##### [Обзор бухгалтерских отчетов](LocalFunctionality/Russia/account-schedules-overview.md)
##### [Импорт и экспорт бухгалтерских отчетов](LocalFunctionality/Russia/How-to-Import-and-Export-Account-Schedules.md)
##### [Определение расширения для бухгалтерского отчета](LocalFunctionality/Russia/How-to-Define-an-Account-Schedule-Extension.md)
##### [Определение постоянной для бухгалтерского отчета](LocalFunctionality/Russia/How-to-Define-an-Account-Schedule-Constant.md)
##### [Работа с бухгалтерскими отчетами](LocalFunctionality/Russia/How-to-Work-with-Account-Schedules.md)
##### [Корреспонденция счетов](LocalFunctionality/Russia/general-ledger-correspondence.md)
...
#### <a name="payables-and-receivables-1"></a>Расчеты с поставщиками и клиентами
##### [Расчеты с поставщиками и клиентами в российской версии](LocalFunctionality/Russia/Payables-and-Receivables.md)
##### [Ввод сведений таможенных деклараций](LocalFunctionality/Russia/how-to-enter-custom-declarations-information.md)
##### [Настройка и создание доверенностей](LocalFunctionality/Russia/how-to-set-up-and-create-letters-of-attorney.md)
##### [Отчеты по расчетам с поставщиками в России](LocalFunctionality/Russia/russian-payables-reports.md)
##### [Отчеты по расчетам с клиентами в России](LocalFunctionality/Russia/russian-receivables-reports.md)
##### [Настройка предоплат от клиентов](LocalFunctionality/Russia/how-to-set-up-customer-prepayments.md)
##### [Настройка предоплат поставщикам](LocalFunctionality/Russia/how-to-set-up-vendor-prepayments.md)
##### [Учет предоплат поставщиков и клиентов](LocalFunctionality/Russia/prepayments-vendor-and-customers.md)
...
#### <a name="fixed-assets-4"></a>Основные средства
##### [Основные средства в российской версии](LocalFunctionality/Russia/fixed-assets.md)
...
##### [Увеличение стоимости основных средств](LocalFunctionality/Russia/Fixed-Asset-Charges.md)
...
##### [Основные средства: местоположения и ответственные сотрудники](LocalFunctionality/Russia/Fixed-Asset-Locations-and-Employees.md)
...
##### [Создание увеличения стоимости основных средств](LocalFunctionality/Russia/How-to-Create-a-Fixed-Asset-Charge.md)
##### [Создание кредит-ноты для увеличения стоимости основных средств](LocalFunctionality/Russia/How-to-Create-a-Credit-Memo-for-a-Fixed-Asset-Charge.md)
##### [Продажа основных средств](LocalFunctionality/Russia/Sale-of-fixed-assets.md)
##### [Ввод в эксплуатацию, отслеживание и списание основных средств](LocalFunctionality/Russia/How-to-Release-Track-Write-Off-Fixed-Assets.md)
##### [Просмотр учтенных операций по увеличению стоимости основных средств](LocalFunctionality/Russia/How-to-View-Posted-Entries-on-a-Fixed-Asset-Charge.md)
##### [Настройка счета нематериальных активов](LocalFunctionality/Russia/How-to-Set-Up-an-Intangible-Assets-Account.md)
##### [Учет затрат на ликвидацию основного средства](LocalFunctionality/Russia/How-to-Account-for-the-Cost-to-Dispose-a-Fixed-Asset.md)
...
##### [Настройка секций налоговых регистров](LocalFunctionality/Russia/How-to-Set-Up-Tax-Register-Sections.md)
##### [Налоговые разницы](LocalFunctionality/Russia/Tax-Differences.md)  
##### [Учет уплаты подоходного налога](LocalFunctionality/Russia/Accounting-for-personal-income-tax-payments.md)  
...
##### [Формы накладных](LocalFunctionality/Russia/Item-Obligatory-Acts.md)
##### [Акт инвентаризации расчетов с покупателями, поставщиками и прочими дебиторами и кредиторами ИНВ-17](LocalFunctionality/Russia/Inventory-Act-of-Receivables-And-Payables-INV-17.md)
...
#### <a name="human-resources-1"></a>Персонал и зарплата
##### [Персонал и зарплата в российской версии](LocalFunctionality/Russia/Human-Resources.md)
...
##### [Создание шаблонов для отправляемых через Интернет отчетов по НДС в формате текстового файла](LocalFunctionality/Spain/how-to-create-templates-for-telematic-vat-statements-in-text-file-format.md)
##### [Создание шаблонов для отправляемых через Интернет отчетов по НДС в формате XML-файла](LocalFunctionality/Spain/how-to-create-templates-for-telematic-vat-statements-in-xml-file-format.md)
...
##### [Эквивалентные наценки](LocalFunctionality/Spain/equivalence-charges-ec-.md)
#### <a name="banking--payments-12"></a>Банковские операции и платежи
...
##### [Платежи поставщикам с использованием электронных платежей](LocalFunctionality/Spain/how-to-pay-vendors-by-using-electronic-payments.md)
##### [Экспорт электронных платежей](LocalFunctionality/Spain/how-to-export-electronic-payments.md)
...
#### <a name="electronic-invoicing-3"></a>Электронное выставление счетов
...
#### <a name="core-finance-11"></a>Базовые финансы
...
##### [Создание отступов и проверка плана счетов](LocalFunctionality/Spain/how-to-indent-and-validate-chart-of-accounts.md)
##### [Игнорирование скидок на счетах главной книги](LocalFunctionality/Spain/how-to-ignore-discounts-in-general-ledger-accounts.md)
##### [Экспорт бухгалтерских отчетов в формат ASC](LocalFunctionality/Spain/how-to-export-account-schedules-to-asc-format.md)
##### [Печать отчетов по бухгалтерским книгам](LocalFunctionality/Spain/how-to-print-account-book-reports.md)
...
#### <a name="core-finance-12"></a>Базовые финансы
##### [Автоматические коды счетов](LocalFunctionality/Sweden/automatic-account-codes.md)  
##### [Настройка автоматических учетных групп счетов](LocalFunctionality/Sweden/how-to-set-up-automatic-account-posting-groups.md)
...
##### [Печать балансового отчета и отчета о прибылях и убытках](LocalFunctionality/Sweden/how-to-print-balance-sheet-and-income-statement-reports.md)  
...
#### <a name="vat-14"></a>НДС
##### [Создание и печать отчета по НДС в Швейцарии](LocalFunctionality/Switzerland/how-to-create-and-print-a-swiss-vat-statement.md)
##### [Печать отчетов по НДС в Швейцарии (предыдущие версии)](LocalFunctionality/Switzerland/how-to-print-swiss-vat-statements-older-version-.md)
##### [Налог на добавленную стоимость в Швейцарии](LocalFunctionality/Switzerland/swiss-value-added-tax.md)
##### [Ставки НДС в Швейцарии](LocalFunctionality/Switzerland/vat-rates-for-switzerland.md)
#### <a name="banking--payments-13"></a>Банковские операции и платежи
##### [Управление QR-счетами](LocalFunctionality/Switzerland/ui-extensions-qr-bill-management.md)
##### [Электронные платежи в Швейцарии](LocalFunctionality/Switzerland/swiss-electronic-payments.md)
##### [Электронные платежи в Швейцарии с использованием ESR](LocalFunctionality/Switzerland/swiss-electronic-payments-using-esr.md)
##### [Электронные платежи в Швейцарии с использованием LSV](LocalFunctionality/Switzerland/swiss-electronic-payments-using-lsv-.md)
##### [Обработка инкассо LSV](LocalFunctionality/Switzerland/how-to-process-an-lsv-collection.md)
##### [Учет платежей LSV](LocalFunctionality/Switzerland/how-to-post-lsv-payments.md)
##### [Закрытие инкассо LSV](LocalFunctionality/Switzerland/how-to-close-an-lsv-collection.md)
##### [Экспорт платежей с использованием LSV](LocalFunctionality/Switzerland/how-to-export-payments-using-lsv.md)
...
##### [Импорт клиринговых кодов швейцарских банков](LocalFunctionality/Switzerland/how-to-import-swiss-bank-clearing-numbers.md)
##### [Печать отчетов со списками оплат поставщикам](LocalFunctionality/Switzerland/how-to-print-vendor-payments-list-reports.md)
#### <a name="core-finance-13"></a>Базовые финансы
##### [Счета главной книги для Швейцарии](LocalFunctionality/Switzerland/swiss-general-ledger-accounts.md)
...
##### [Настройка условий, уровней и текста напоминаний о доставке](LocalFunctionality/Switzerland/how-to-set-up-delivery-reminder-terms-levels-and-text.md)
##### [Назначение поставщикам кодов доставки](LocalFunctionality/Switzerland/how-to-assign-delivery-reminder-codes-to-vendors.md)
...
#### <a name="inventory-4"></a>Запасы
##### [Управление запасами в Швейцарии](LocalFunctionality/Switzerland/swiss-inventory-management.md)
...
#### [Локальная функциональность в версии для Соединенного Королевства](LocalFunctionality/UnitedKingdom/united-kingdom-local-functionality.md)
#### <a name="vat-15"></a>НДС
##### [Налоги в цифровом виде — подача отчетов по НДС](LocalFunctionality/UnitedKingdom/making-tax-digital-submit-vat-return.md)
##### [Изменение конфигурации НДС в журналах](LocalFunctionality/UnitedKingdom/how-to-change-vat-setup-in-journals.md)
...
#### <a name="banking--payments-14"></a>Банковские операции и платежи
##### [Печать чеков для APACS](LocalFunctionality/UnitedKingdom/how-to-print-checks-for-apacs.md)
##### [Печать платежного авизо](LocalFunctionality/UnitedKingdom/how-to-print-remittance-advice.md)
#### <a name="fixed-assets-5"></a>Основные средства
...
#### <a name="general-14"></a>Общее
##### [Настройка предупреждения о дате учета](LocalFunctionality/UnitedKingdom/how-to-set-up-a-posting-date-warning.md)
##### [Ввод обязательной информации](LocalFunctionality/UnitedKingdom/how-to-enter-statutory-information.md)
##### [Отправка данных для предотвращения мошенничества](LocalFunctionality/UnitedKingdom/fraud-prevention-data.md)
...
#### <a name="banking--payments-15"></a>Банковские операции и платежи
##### [Создание внесений на счет](LocalFunctionality/UnitedStates/how-to-create-deposits.md)  
##### [Выверка банковских счетов](LocalFunctionality/UnitedStates/how-to-reconcile-bank-accounts.md)
##### [Совершение электронных платежей](finance-make-payments-with-bank-data-conversion-service-or-sepa-credit-transfer.md#exporting-payments-to-a-bank-file)
#### <a name="general-15"></a>Общее
##### [Печать отчетов для устранения неполадок](LocalFunctionality/UnitedStates/how-to-print-troubleshooting-reports.md)
### [Отправка нормативных оповещений](submit-regulatory-alerts.md)

<!--setup-->
## <a name="set-up-business-central"></a>Настройка Business Central
### [Обзор задач](setup.md)
### <a name="set-up-finance"></a>Настройка финансов
...
#### [Применение операций книги учета в разных валютах](finance-how-enable-application-ledger-entries-different-currencies.md)
...
#### [Настройка округления сумм в счетах](finance-set-up-invoice-rounding.md)
...
### <a name="set-up-banking"></a>Настройка банковских операций
...
#### [Регистрация новых клиентов](sales-how-register-new-customers.md)
#### [Прием платежей клиентов через службу платежей](sales-how-enable-payment-service-extensions.md)
...
#### [Настройка ценовых групп клиентов](sales-how-to-set-up-customer-price-groups.md)
#### [Настройка скидочных групп клиентов](sales-how-to-set-up-customer-discount-groups.md)
...
### <a name="set-up-purchasing"></a>Настройка закупок
...
#### [Определение политики учета счетов для пользователей](admin-setup-invoice-posting-policy.md)
### <a name="set-up-inventory"></a>Настройка запасов
...
### <a name="set-up-warehouse-management"></a>Настройка управления складами
...
#### [Создание содержимого ячеек](warehouse-how-to-set-up-bin-contents.md)
...
### <a name="set-up-manufacturing"></a>Настройка производства
#### [Настройка производства](production-configure-production-processes.md)
#### [Создание календарей производственных центров](production-how-to-create-work-center-calendars.md)
...
#### [Списание компонентов в соответствии с выходом операций](production-how-to-flush-components-according-to-operation-output.md)
...
#### [Субподрядное производство](production-how-to-subcontract-manufacturing.md)
### <a name="set-up-service-management"></a>Настройка управления сервисом
...
#### [Настройка устранения неполадок](service-how-setup-troubleshooting.md)
#### [Настройка распределения ресурсов](service-how-setup-resource-allocation.md)
#### [Настройка цен и дополнительных затрат для услуг](service-how-setup-service-costs-pricing.md)
...
### <a name="set-up-complex-application-areas-using-best-practices"></a>Рекомендации по настройке сложных областей приложения
...
##### [Рекомендации по настройке: настройка глобального планирования](setup-best-practices-global-planning-setup.md)
##### [Рекомендации по настройке: политики дозаказа](setup-best-practices-reordering-policies.md)
...
#### <a name="set-up-your-business-inbox-in-microsoft-outlook"></a>Настройка папки "Входящие" для бизнеса в Microsoft Outlook
...
### <a name="set-up-reports"></a>Настройка отчетов
#### [Выбор отчетов для документов](across-report-selections.md)
### <a name="set-up-approval-workflows-based-on-templates"></a>Настройка рабочих процессов утверждения на основе шаблонов
...
#### [Уведомления рабочих процессов утверждения](across-setting-up-workflow-notifications.md)
#### [Задание времени и порядка получения уведомлений рабочих процессов](across-how-to-specify-when-and-how-to-receive-notifications.md)
...
###### [Настройка синхронизации контактов для локального экземпляра](admin-contact-sync-setup-onprem.md)
##### [Использование Business Central без Outlook](admin-no-outlook.md)
#### <a name="use-microsoft-teams-with-business-central"></a>Использование Microsoft Teams с Business Central
...
##### [Изменение организации и других параметров](across-teams-settings.md)
##### [Вопросы и ответы о Teams](teams-faq.md)
##### [Устранение неполадок интеграции с Teams](admin-teams-troubleshooting.md)
#### <a name="use-onedrive-for-business-with-business-central"></a>Использование OneDrive для бизнеса с Business Central
##### [Обзор](across-onedrive-overview.md)
##### [Управление интеграцией с OneDrive для бизнеса](admin-onedrive-integration.md)
###### [Настройка интеграции OneDrive с локальным экземпляром Business Central](admin-onedrive-integration-onpremises.md)
##### [Открытие файлов в OneDrive и общий доступ к ним](across-share-onedrive.md)
##### [Вопросы и ответы о OneDrive](admin-onedrive-faq.md)
#### <a name="use-power-bi-with-business-central"></a>Использование Power BI с Business Central
##### [Введение](admin-powerbi.md)
##### <a name="administrator"></a>Администратор
###### [Обзор интеграции](admin-powerbi-overview.md)
###### [Включение интеграции с Power BI](admin-powerbi-setup.md)
##### <a name="report-creator"></a>Создатель отчетов
###### [Начало создания отчетов](across-how-use-financials-data-source-powerbi.md)
...
#### <a name="use-power-automate-with-business-central"></a>Использование Power Automate с Business Central
...
#### <a name="use-power-apps-with-business-central"></a>Использование Power Apps с Business Central
...
### [Информация об организации](admin-company-information.md)
...
#### [Обзор](admin-printer-setup-overview.md)
#### [Принтеры универсальной печати](admin-printer-setup-universal-print.md)
#### [Принтеры для печати по электронной почте](admin-printer-setup-email.md)
#### [Задание принтера по умолчанию](ui-specify-printer-selection-reports.md)
...
# <a name="business-intelligence-and-reporting"></a>Бизнес-аналитика и отчетность

## [Обзор](reports-bi-reporting.md)

## <a name="use-reports-in-daily-work"></a>Использование отчетов в повседневной работе
...
### [Управление сохраненными параметрами отчетов](reports-saving-reusing-settings.md)
### [Установка макета для отчета](ui-set-report-layout.md)
### [(Устар.) Установка макета для отчета](ui-how-change-layout-currently-used-report.md)

## <a name="built-in-reports"></a>Встроенные отчеты
### [Обзор отчетов](reports-available-reports.md)
### <a name="finance-1"></a>Финансы
...
### <a name="fixed-assets-6"></a>Основные средства
...
### <a name="assembly-management-1"></a>Управление сборкой
...
## <a name="analyze-data-in-business-intelligence-tools"></a>Анализ данных в инструментах бизнес-аналитики
...
## <a name="developing-reports"></a>Разработка отчетов
...
# <a name="security-privacy-compliance"></a>Безопасность, конфиденциальность, соответствие
## <a name="security-and-protection"></a>Защита и безопасность
...
## <a name="administration-tasks-in-business-central"></a>Задачи администрирования в Business Central
...
#### <a name="access-with-microsoft-365-licenses"></a>Доступ с лицензиями на Microsoft 365
...
#### <a name="grant-user-permissions"></a>Предоставление разрешений пользователям
...
### <a name="manage-user-settings"></a>Управление параметрами пользователей
#### [Управление профилями](admin-users-profiles-roles.md)
#### [Управление параметрами и предпочтениями пользователей](admin-manage-user-settings-preferences.md)
### <a name="control-your-data"></a>Контроль над данными
...
## <a name="customize-business-central"></a>Пользовательская настройка Business Central
...
### <a name="customize-with-extensions"></a>Настройка с помощью расширений
...
#### [Прогнозирование просрочек оплаты](ui-extensions-late-payment-prediction.md)
...
#### [Расширение "Декларация услуг"](finance-how-setup-use-service-declaration.md)
#### [UK — Почтовые индексы Великобритании GetAddress.io](LocalFunctionality/UnitedKingdom/ui-extensions-getaddressio.md)
#### [UK — Управление группами зачета НДС](ui-extensions-vat-group.md)
...
## <a name="integrate-with-dynamics-365-sales"></a>Интеграция с Dynamics 365 Sales
...
## <a name="synchronize-master-data-across-companies"></a>Синхронизация основных данных между организациями
...
## <a name="design-details-1"></a>Технические подробности
### [О технических подробностях решений, реализованных в приложении](design-details-application-design.md)
### <a name="design-details-supply-planning-1"></a>Технические подробности: планирование поставок
...
#### [Технические подробности: таблица "Назначение произ. плана"](design-details-planning-assignment-table.md)  
#### [Технические подробности: перемещения при планировании](design-details-transfers-in-planning.md)
### <a name="design-details-inventory-costing-1"></a>Технические подробности: учет себестоимости запасов
#### [Обзор учета себестоимости](design-details-inventory-costing.md)
#### [Технические подробности: методы учета себестоимости](design-details-costing-methods.md)  
#### [Технические подробности: изменение методов учета себестоимости для товаров](design-details-changing-costing-methods.md)
#### [Технические подробности: применение товара](design-details-item-application.md)  
#### [Технические подробности: известная проблема, связанная с применением товара](design-details-inventory-zero-level-open-item-ledger-entries.md)  
#### [Технические подробности: коррекция себестоимости](design-details-cost-adjustment.md)  
#### <a name="design-details-posting-date-on-adjustment-value-entry-1"></a>Технические подробности: дата учета в корректирующей операции стоимости
...
<!-- #### [Design Details: Outbound Warehouse Flow](design-details-outbound-warehouse-flow.md)  -->
<!-- #### [Design Details: Integration with Inventory](design-details-integration-with-inventory.md)-->
### <a name="design-details-item-tracking-1"></a>Технические подробности: трассировка товаров
...
#### [Технические подробности: трассировка товаров и резервирования](design-details-item-tracking-and-reservations.md)  
#### [Технические подробности: трассировка товаров на складе](design-details-item-tracking-in-the-warehouse.md)
### <a name="design-details-general-journal-post-line-1"></a>Технические подробности: учет строки финансового журнала
#### [Учет строки финансового журнала](design-details-general-journal-post-line.md)
#### [Об учете строки финансового журнала](design-details-general-journal-post-line-overview.md)  
#### [Технические подробности: структура интерфейса учета](design-details-posting-interface-structure.md)  
#### [Технические подробности: структура механизма учета](design-details-posting-engine-structure.md)  
### <a name="design-details-dimension-set-entries-1"></a>Технические подробности: записи наборов измерений
#### [Технические подробности: о записях наборов измерений](design-details-dimension-set-entries-overview.md)  
#### [Технические подробности: поиск комбинаций измерений](design-details-searching-for-dimension-combinations.md)  
#### [Технические подробности: структура таблиц](design-details-table-structure.md)
<!--migrate to BC online-->
## <a name="migrate-to-business-central-online"></a>Миграция на Business Central Online
### [Миграция локальных данных](/dynamics365/business-central/dev-itpro/administration/migrate-data?toc=/dynamics365/business-central/toc.json)
### [Запуск инструмента миграции в облако](/dynamics365/business-central/dev-itpro/administration/migration-tool?toc=/dynamics365/business-central/toc.json)
...
### [Миграция из локального экземпляра Business Central](/dynamics365/business-central/dev-itpro/administration/migrate-business-central-on-premises?toc=/dynamics365/business-central/toc.json)
### [Миграция из Dynamics GP](/dynamics365/business-central/dev-itpro/administration/migrate-dynamics-gp?toc=/dynamics365/business-central/toc.json)
### [Миграция из Dynamics NAV](/dynamics365/business-central/dev-itpro/upgrade/Upgrade-Considerations#online?toc=/dynamics365/business-central/toc.json)
### [Вопросы и ответы о миграции в облако](/dynamics365/business-central/dev-itpro/administration/faq-intelligent-cloud?toc=/dynamics365/business-central/toc.json)
## [Администрирование Business Central Online](/dynamics365/business-central/dev-itpro/administration/tenant-administration?toc=/dynamics365/business-central/toc.json)
