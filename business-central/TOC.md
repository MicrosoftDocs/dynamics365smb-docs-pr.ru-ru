...
## [Станьте реселлером Dynamics 365 Business Central](product-sell.md)
...
### [Расширения для Microsoft Business Central от других поставщиков](ui-extensions-other.md)
...
## [О поиске и фильтрации в Business Central](ui-search-filter-faq.md)
## [Ввод данных](ui-enter-data.md)
## [Умные уведомления](ui-smart-notifications.md)
...
## [Добавление и просмотр заметок в записях](ui-work-with-notes.md)
...
### [Определение макетов платежных документов](finance-how-define-check-layouts.md)
...
#### [Рекомендации по настройке. Политики повторного заказа](reports-saving-reusing-settings.md)
#### [Рекомендации по настройке. Параметры планирования](setup-best-practices-planning-parameters.md)
#### [Рекомендации по настройке. Глобальная настройка планирования](setup-best-practices-global-planning-setup.md)
...
### [Управление взаимодействием и сегментами](marketing-interaction-segments.md)
## [Управление взаимодействиями](marketing-interactions.md)
...
## [Чехия](LocalFunctionality/Czech/czech-local-functionality.md)
...
### [Расширения форматов файлов налогов (DK)](ui-extensions-tax-file-formats-dk.md)
