...
# <a name="the-basic-experience-extension"></a><a name="the-basic-experience-extension"></a>Расширение базового взаимодействия
...
## <a name="whats-available"></a><a name="whats-available"></a>Что доступно
...
## <a name="migrating-data"></a><a name="migrating-data"></a>Миграция данных
