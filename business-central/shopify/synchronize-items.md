...
|Цена|Расчет цены для конечного покупателя включает в себя цену единицы товара, ценовую группу клиента, скидочную группу клиента и код валюты. Узнайте больше в разделе [Синхронизация цен](synchronize-items.md#sync-prices-with-shopify)|**Цена единицы**|
