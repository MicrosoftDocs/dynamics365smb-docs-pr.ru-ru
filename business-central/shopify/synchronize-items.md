...
* При определении цены [!INCLUDE[prod_short](../includes/prod_short.md)] использует логику "самая низкая цена". Логика минимальной цены означает, что если цена за единицу, указанная в карточке товара, ниже цены, определенной в ценовой группе, используется цена за единицу из карточки товара.
