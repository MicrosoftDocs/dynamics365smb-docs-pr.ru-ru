...
### <a name="price-synchronization-for-b2b"></a>Синхронизация цен для B2B
...
#### <a name="synchronize-catalogs-from-the-shopify"></a>Синхронизировать каталоги из Shopify
...
#### <a name="sync-prices-for-b2b-catalog"></a>Синхронизировать цены для B2B-каталога
...
#### <a name="example-of-calculation-of-free-inventory-not-reserved"></a>Пример расчета свободных запасов (не зарезервированных)
