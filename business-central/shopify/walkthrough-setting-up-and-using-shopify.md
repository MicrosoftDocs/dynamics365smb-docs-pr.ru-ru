...
# <a name="walkthrough-set-up-and-use-the-shopify-connector"></a><a name="walkthrough-set-up-and-use-the-shopify-connector"></a><a name="walkthrough-set-up-and-use-the-shopify-connector"></a>Пошаговое руководство: настройка и использование соединителя Shopify
...
## <a name="connect-business-central-to-the-shopify-shop"></a><a name="connect-business-central-to-the-shopify-shop"></a><a name="connect-business-central-to-the-shopify-shop"></a>Подключение Business Central к магазину Shopify
...
## <a name="walkthrough-start-selling-products-online"></a><a name="walkthrough-start-selling-products-online"></a><a name="walkthrough-start-selling-products-online"></a>Пошаговое руководство: начало продаж товаров в Интернете
...
## <a name="walkthrough-invite-your-customers-to-your-new-online-store"></a><a name="walkthrough-invite-your-customers-to-your-new-online-store"></a><a name="walkthrough-invite-your-customers-to-your-new-online-store"></a>Пошаговое руководство: приглашение клиентов в новый интернет-магазин

### <a name="scenario-1"></a><a name="scenario-1"></a><a name="scenario-1"></a>Сценарий
...
### <a name="steps-1"></a><a name="steps-1"></a><a name="steps-1"></a>Шаги
...
## <a name="walkthrough-fine-tuning-of-item-management"></a><a name="walkthrough-fine-tuning-of-item-management"></a><a name="walkthrough-fine-tuning-of-item-management"></a>Пошаговое руководство: тонкая настройка управления товарами

### <a name="scenario-2"></a><a name="scenario-2"></a><a name="scenario-2"></a>Сценарий
...
### <a name="steps-2"></a><a name="steps-2"></a><a name="steps-2"></a>Шаги
...
3. Добавьте следующий текст с HTML-тегами: `<b>Simple stylish design</b> blends with any ensemble. <i>Available in two editions.</i>`.
...
## <a name="walkthrough-import-items-from-shopify"></a><a name="walkthrough-import-items-from-shopify"></a><a name="walkthrough-import-items-from-shopify"></a>Пошаговое руководство: импорт товаров из Shopify

### <a name="scenario-3"></a><a name="scenario-3"></a><a name="scenario-3"></a>Сценарий
...
### <a name="steps-3"></a><a name="steps-3"></a><a name="steps-3"></a>Шаги
...
#### <a name="prepare-data"></a><a name="prepare-data"></a><a name="prepare-data"></a>Подготовка данных
...
16. Заполните **Счет для расходов на доставку**, **Счет чаевых** со счетом доходов. Например, в США используйте `40100`.
17. Включите переключатель **Автоматическое создание заказов**.

#### <a name="run-the-synchronization"></a><a name="run-the-synchronization"></a><a name="run-the-synchronization"></a>Выполните синхронизацию
