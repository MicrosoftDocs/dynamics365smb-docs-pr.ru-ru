...
# <a name="walkthrough-set-up-and-use-the-shopify-connector" />Пошаговое руководство: настройка и использование соединителя Shopify
...
## <a name="connect-business-central-to-the-shopify-shop" />Подключение Business Central к магазину Shopify
...
## <a name="walkthrough-start-selling-products-online" />Пошаговое руководство: начало продаж товаров в Интернете
...
#### <a name="prepare-data" />Подготовка данных
...
#### <a name="run-the-synchronization" />Выполните синхронизацию
