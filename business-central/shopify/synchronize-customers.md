...
ms.locfileid: "9361426"
---
# <a name="synchronize-customers"></a>Синхронизация клиентов

При импорте заказа из Shopify получение информации о клиенте необходимо для дальнейшей обработки документа в [!INCLUDE[prod_short](../includes/prod_short.md)]. Существует два основных варианта обеспечения этого и их комбинации:
