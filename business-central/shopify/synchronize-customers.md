...
5. Поле **Налоговая область** также содержит пару значений: **Код страны** и **Название района**. Эта пара полезна, когда соединителю необходимо преобразовать код в имя или наоборот.
