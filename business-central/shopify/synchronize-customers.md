---
title: Синхронизация клиентов и организаций
description: Импорт клиентов из или экспорт клиентов в Shopify.
ms.date: 03/25/2024
ms.topic: article
...
Инструкции по экспорту клиента из [!INCLUDE[prod_short](../includes/prod_short.md)] в Shopify различаются в зависимости от того, что вы хотите сделать:
...
## <a name="important-settings-when-exporting-dtc-customers-to-shopify"></a>Важные параметры при экспорте DTC-клиентов в Shopify
...
## <a name="export-a-b2b-company-to-shopify"></a>Экспорт B2B-организации в Shopify
