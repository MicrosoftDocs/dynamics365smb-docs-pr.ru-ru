...
# <a name="synchronize-customers" />Синхронизация клиентов
...
## <a name="important-settings-when-importing-customers-from-shopify" />Важные настройки при импорте клиентов из Shopify
...
### <a name="customer-template-per-country" />Шаблон клиента для каждой страны
...
## <a name="export-customers-to-shopify" />Экспорт клиентов в Shopify
...
### <a name="populate-customer-information-in-shopify" />Заполните информацию о клиенте в Shopify
...
## <a name="sync-customers" />Синхронизация клиентов
