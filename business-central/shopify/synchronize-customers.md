...
При импорте заказа из Shopify получение информации о клиенте необходимо для дальнейшей обработки документа в [!INCLUDE[prod_short](../includes/prod_short.md)]. Существует два основных варианта обеспечения этого и их сочетаний:
...
## Важные настройки при импорте клиентов из Shopify
...
### Шаблон клиента для каждой страны
...
Для адресов, где используется страна или провинция, выберите *Код* или *Имя* в поле **Источник страны** в **карточке магазина Shopify**. Код или имя определяет тип данных, хранящихся в [!INCLUDE[prod_short](../includes/prod_short.md)] в поле **Страна**.
