...
* **Всегда брать клиента по умолчанию**, затем соединитель используйте клиента, определенного в поле **№ клиента по умолчанию** на странице **Карточка магазина Shopify**.
...
|**Код шаблона клиента**|Используется вместе с параметром **Автоматическое создание неизвестных клиентов**.<br> Выберите шаблон по умолчанию, который будет использоваться для автоматически созданных клиентов. Убедитесь, что выбранный шаблон содержит обязательные поля, такие как **Общая бизнес-группа**,**Учетная группа клиента** или поля, связанные с НДС и налогами.<br> Вы можете определить шаблоны для каждой страны или региона на странице **Шаблон клиентов Shopify**, которое удобно для правильного расчета налога. <br>Дополнительные сведения см. в разделе [Настройка налогов](setup-taxes.md).|
...
3. Укажите, включают ли цены налог/НДС для импортированных заказов.
4. В некоторых случаях **кода шаблона клиента**, определенного для страны, недостаточно для правильного расчета налогов. Например, для стран, в которых действует налог с продаж. В этом случае **Налоговые зоны** может быть полезным дополнением.
...
|Поле|Описанием|
|------|-----------|
|**Экспорт клиентов в Shopify**|Выберите этот пункт, если вы планируете экспортировать всех клиентов с действительным адресом электронной почты из [!INCLUDE[prod_short](../includes/prod_short.md)] в Shopify оптом; либо вручную с помощью действия **Синхронизировать клиентов**, либо через очередь заданий для повторяющихся обновлений.<br> При экспорте клиентов с провинциями/штатами убедитесь, что **Код ISO** заполнен для стран/регионов.|
|**Может обновлять клиентов Shopify**|Используется вместе с настройкой **Экспорт клиента в Shopify**. Включите его, если вы хотите генерировать обновления позже из [!INCLUDE[prod_short](../includes/prod_short.md)] для клиентов, которые уже существуют в Shopify.|
...
1. Выберите ![Лампочка, которая открывает функцию Что вы хотите сделать 1.](../media/ui-search/search_small.png "Что вы хотите сделать") значок, введите **Магазин Shopify**, а затем выберите связанную ссылку.
