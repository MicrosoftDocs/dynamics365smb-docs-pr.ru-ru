...
3. В некоторых случаях **кода шаблона клиента**, определенного для страны, недостаточно для правильного расчета налогов. Например, для стран, в которых действует налог с продаж. В этом случае **Налоговые зоны** может быть полезным дополнением.
