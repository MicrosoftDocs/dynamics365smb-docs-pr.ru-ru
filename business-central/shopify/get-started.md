...
## <a name="install-the-dynamics--business-central-app-to-your-shopify-online-store" />Установка приложения Dynamics 365 Business Central для вашего интернет-магазина Shopify
...
## <a name="see-related-microsoft-trainingtrainingpathsuse-shopify-connector-dynamics--business-central" />См. соответствующее [обучение Microsoft](/training/paths/use-shopify-connector-dynamics-365-business-central/)
