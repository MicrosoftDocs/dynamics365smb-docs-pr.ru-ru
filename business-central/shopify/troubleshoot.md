...
### <a name="the-gen-bus-posting-group-cannot-be-zero-or-empty-there-must-be-a-value-in-the-customer-field"></a>*Общая бизнес-группа* не может быть нулевой или пустой; в поле клиента должно быть значение
...
### <a name="oauth-error-invalid_request-could-not-find-shopify-api-application-with-api_key"></a>Сообщение об ошибке Oauth error invalid_request: Could not find Shopify API application with api_key
