...
Если заказ Shopify требует выполнения, будет создан **Заказ на продажу**. Для полностью выполненных заказов Shopify, таких как те заказы, которые содержат только подарочную карту или которые уже обработаны в Shopify, создается **Счет продажи**.
