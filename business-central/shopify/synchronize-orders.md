...
|Изменить|Воздействие|
|------|-----------|
|Измените местоположение на другое местоположение, сопоставленное с местоположениями Shopify. Учет отгрузки. | После синхронизации выполнения склад будет обновлен в Shopify. |
...
>[Важно] Склад, включая пустой склад, указанный в учтенной строке отгрузки, должен иметь соответствующую запись в таблице складов Shopify. В противном случае эта строка не будет отправлена обратно в Shopify. Подробнее см. в разделе [Сопоставление складов](synchronize-orders.md#location-mapping).
