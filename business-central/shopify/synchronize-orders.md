...
|Измените место выполнения и зарегистрируйте выполнение в Shopify| Если заказ уже был импортирован, то строки обновляться не будут. В противном случае импортированный заказ будет использовать место выполнения. |
