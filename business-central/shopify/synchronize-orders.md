...
# <a name="synchronize-and-fulfill-sales-orders" />Синхронизация и выполнение заказов на продажу
...
## <a name="set-the-import-of-orders-on-the-shopify-shop-card" />Установите импорт заказов в карточке магазина Shopify
...
В поле **Приоритет налоговой области** можно указать приоритет выбора кода налоговой области по адресам в заказе. Импортированный заказ Shopify содержит информацию о налогах. Налоги пересчитываются при создании документа продажи, поэтому важно, чтобы параметры НДС/налога в [!INCLUDE[prod_short](../includes/prod_short.md)] были правильными. Подробнее о налогах см. в статье [Настройка налогов для подключения к Shopify](setup-taxes.md).
...
### <a name="shipment-method-mapping" />Сопоставление способов доставки
...
### <a name="location-mapping" />Сопоставление складов
...
## <a name="run-the-order-synchronization" />Запуск синхронизации заказов
...
## <a name="review-imported-orders" />Проверка импортированных заказов
...
## <a name="create-sales-documents-in-business-central" />Создание документов продажи в Business Central
...
### <a name="to-create-sales-documents" />Для создания документов продажи
...
### <a name="manage-missing-customers" />Управление отсутствующими клиентами
...
### <a name="how-the-connector-chooses-which-customer-to-use" />Как соединитель выбирает, какого клиента использовать
...
### <a name="different-processing-rules-for-orders" />Различные правила обработки заказов
...
>![Важно] Во избежание конфликтов при обработке заказов не забывайте использовать одну и ту же категорию очереди заданий для обеих операций очереди заданий.

### <a name="impact-of-order-editing" />Влияние правок заказов
...
## <a name="synchronize-shipments-to-shopify" />Синхронизация отгрузок в Shopify
...
### <a name="shipping-agents-and-tracking-url" />Экспедиторы и URL-адрес для отслеживания
...
## <a name="returns-and-refunds" />Возвраты товаров и денег
...
## <a name="gift-cards" />Подарочные карты
