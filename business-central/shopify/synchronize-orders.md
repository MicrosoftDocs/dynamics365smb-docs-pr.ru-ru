...
Валюту магазина можно узнать в разделе [Store details](https://www.shopify.com/admin/settings/general) панели администрирования Shopify. Shopify можно настроить для приема разных валют, однако в заказах, импортированных в [!INCLUDE[prod_short](../includes/prod_short.md)], используется валюта магазина.
