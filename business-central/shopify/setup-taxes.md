...
<!--Should this be "window" or "page"? I haven't been seeing "window" is use elsewhere, but I don't know what the interface looks like for this action.--> Они также могут определять **№ клиента по умолчанию** или **№ шаблона клиента**. В любом случае убедитесь, что для выбранного клиента или шаблона определены следующие поля:
