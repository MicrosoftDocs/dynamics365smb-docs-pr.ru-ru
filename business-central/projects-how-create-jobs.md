...
ms.author: edupont
---
# <a name="create-jobs"></a><a name="create-jobs"></a>Создание работ
...
## <a name="to-create-a-job-card"></a><a name="to-create-a-job-card"></a>Создание карточки работы
...
## <a name="to-create-tasks-for-a-job"></a><a name="to-create-tasks-for-a-job"></a>Создание задач для работы
...
## <a name="to-create-planning-lines-for-a-job"></a><a name="to-create-planning-lines-for-a-job"></a>Создание строк планирования для работы
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>См. соответствующее [обучение Microsoft](/training/modules/create-new-job/)
