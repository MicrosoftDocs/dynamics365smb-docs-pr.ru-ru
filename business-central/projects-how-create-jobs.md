...
Иногда сторона, получающая услугу, отличается от стороны, оплачивающей счет. На странице **Задания** вы можете указать клиента, который пользуется проектом в полях **Покупатель**, а сторона для выставления счета в полях **Плательщик**. Вы также можете указать, где будет происходить работа, выбрав из списка адреса доставки для клиента, добавить информацию о внешних ссылках, чтобы упростить общение по проекту, и перезаписать стандартные финансовые условия проекта.
