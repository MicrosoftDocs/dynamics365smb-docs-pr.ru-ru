---
title: Практическое руководство. Отгрузка товаров
description: В этом разделе описывается, как отгружать товары со склада в зависимости от конфигурации вашего склада для обработки отгрузки.
author: SorenGP
...
1. Выберите ![Лампочка, которая открывает функцию Что вы хотите сделать.](media/ui-search/search_small.png "Что вы хотите сделать") значок, введите **Складские отгрузки**, а затем выберите связанную ссылку.  
...
4. Выберите ![Лампочка, которая открывает функцию Что вы хотите сделать.](media/ui-search/search_small.png "Что вы хотите сделать") значок, введите **Складской подбор**, а затем выберите связанную ссылку. Выберите необходимый складской подбор.
