...
ms.author: edupont
---
# <a name="combine-receipts-on-a-single-invoice" />Объединение приходных накладных в один счет
...
## <a name="to-combine-receipts" />Объединение приемок
...
## <a name="to-remove-open-purchase-orders-after-combined-receipt-posting" />Удаление открытых заказов на покупку после совмещенного учета приходных накладных
