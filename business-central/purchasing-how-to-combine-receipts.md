...
Обработчики заказов и работники склада должны уметь справляться с такими избыточными приходами, не прибегая к длительной процедуре подготовки и получения утверждения нового заказа на покупку.
