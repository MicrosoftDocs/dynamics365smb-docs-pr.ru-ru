...
ms.author: edupont
---
# <a name="save-and-personalize-list-views"></a><a name="save-and-personalize-list-views"></a>Сохранение и персонализация представлений списков
...
## <a name="to-save-a-view"></a><a name="to-save-a-view"></a>Сохранение представления
...
## <a name="to-rename-or-remove-a-view"></a><a name="to-rename-or-remove-a-view"></a>Переименование или удаление вида
...
## <a name="managing-many-views"></a><a name="managing-many-views"></a>Управление большим количеством представлений
