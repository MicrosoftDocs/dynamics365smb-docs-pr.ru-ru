...
# <a name="walkthrough-of-inbound-and-outbound-flow-in-mixed-warehouse-configurations" />Пошаговое руководство. Приход и расход в смешанных конфигурациях склада
...
## <a name="inbound-flow-receiving-and-putting-away-in-basic-warehouse-configurations" />Входящий поток: приемка и размещение в базовых конфигурациях склада
...
## <a name="outbound-flow-picking-and-shipping-in-advanced-warehouse-configurations" />Исходящий поток: подбор и отгрузка в расширенных конфигурациях склада
