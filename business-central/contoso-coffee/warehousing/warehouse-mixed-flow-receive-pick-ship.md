...
# <a name="walkthrough-of-inbound-and-outbound-flow-in-mixed-warehouse-configurations"></a><a name="walkthrough-of-inbound-and-outbound-flow-in-mixed-warehouse-configurations"></a><a name="walkthrough-of-inbound-and-outbound-flow-in-mixed-warehouse-configurations"></a>Пошаговое руководство. Приход и расход в смешанных конфигурациях склада
...
## <a name="inbound-flow-receiving-and-putting-away-in-basic-warehouse-configurations"></a><a name="inbound-flow-receiving-and-putting-away-in-basic-warehouse-configurations"></a><a name="inbound-flow-receiving-and-putting-away-in-basic-warehouse-configurations"></a>Входящий поток: приемка и размещение в базовых конфигурациях склада
...
## <a name="outbound-flow-picking-and-shipping-in-advanced-warehouse-configurations"></a><a name="outbound-flow-picking-and-shipping-in-advanced-warehouse-configurations"></a><a name="outbound-flow-picking-and-shipping-in-advanced-warehouse-configurations"></a>Исходящий поток: подбор и отгрузка в расширенных конфигурациях склада
...
1. Выпустите заказы на продажу на склад.  
    ...
    2. Выберите заказы для клиента 10000 для склада ЖЕЛТЫЙ. Внешние номера заказов: *Y-3*, *Y-4* и *Y-5*. Используйте инструменты персонализации, если поле **Внешний номер заказа** не отображается. Дополнительные сведения см. в разделе [Персонализация рабочей области](../../ui-personalization-user.md).
...
### <a name="results-1"></a><a name="results-1"></a><a name="results-1"></a>Результаты
