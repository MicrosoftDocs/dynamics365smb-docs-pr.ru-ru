...
# <a name="walkthrough-of-inbound-and-outbound-flow-in-basic-warehouse-configurations"></a>Пошаговое руководство. Приход и расход в базовых конфигурациях склада
...
5. Изменение размещения запасов на основе фактического размещения товаров и принятие к учету документа
    ...
    2.  Введите 20 в поле **Кол-во для обработки** в строке размещения запасов с товаром WBR-1000.  
    ...
    4. Введите коды ячеек для товара WBR-1001:

    |Товар|Код ячейки|количество;|  
    |----------|-------------------|--------------|  
    |WRB-1001|С-1-03|20|  
    |WRB-1001|С-1-04|10|
...
## <a name="outbound-flow-picking-and-shipping-in-basic-warehouse-configurations"></a>Исходящий поток: подбор и отгрузка в базовых конфигурациях склада
