...
# <a name="introduction-to-contoso-coffee-manufacturing"></a>Знакомство с производством Contoso Coffee
...
## <a name="set-up-contoso-coffee-manufacturing-data"></a>Настройка данных Contoso Coffee для производства
