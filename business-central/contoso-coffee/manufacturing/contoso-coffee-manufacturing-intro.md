...
# <a name="introduction-to-contoso-coffee-manufacturing" />Знакомство с производством Contoso Coffee
...
## <a name="set-up-contoso-coffee-manufacturing-data" />Настройка данных Contoso Coffee для производства
