...
# Знакомство с управлением сервисом Contoso Coffee
...
>
> 
## Настройка данных Contoso Coffee для управления сервисом

[!INCLUDE [contoso-coffee-app-install](../contoso-coffee-app-install.md)].

После установки соответствующих приложений перейдите на страницу [Демонстрационные данные Contoso](https://businesscentral.dynamics.com/?page=5194) в [!INCLUDE [prod_short](../../includes/prod_short.md)], выберите строку *Модуль «Сервис»* и с помощью действия **Настроить** подготовьте модули. Параметры рассматриваются в таблицах ниже:  
...
|**№ ресурса 2**  |Ресурс, используемый для сценарий с ремонтами.|
