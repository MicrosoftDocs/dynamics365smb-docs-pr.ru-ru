...
# <a name="introduction-to-contoso-coffee-demo-data" />Введение в демонстрационные данные Contoso Coffee
...
## <a name="set-up-contoso-coffee-data" />Настройка данных Contoso Coffee
...
## <a name="manufacturing-scenarios" />Производственные сценарии
...
## <a name="warehousing-scenarios" />Складские сценарии
