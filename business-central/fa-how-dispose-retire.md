...
ms.author: edupont
---
# <a name="dispose-of-or-retire-fixed-assets" />Списание или выбытие основных средств
...
## <a name="to-post-a-disposal-from-the-fixed-asset-gl-journal" />Учет выбытия с использованием журнала ГК учета основных средств
...
## <a name="to-view-disposal-ledger-entries" />Просмотр операций книги выбытия
