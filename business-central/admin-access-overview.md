...
# <a name="manage-access-to-business-central" />Управление доступом к Business Central
...
## <a name="layered-access" />Многоуровневый доступ
...
## <a name="business-central-administrator-tasks" />Задачи администратора Business Central
...
## <a name="business-central-developer-tasks" />Задачи разработчика Business Central
