...
# <a name="manage-access-to-business-central"></a><a name="manage-access-to-business-central"></a>Управление доступом к Business Central
...
## <a name="layered-access"></a><a name="layered-access"></a>Многоуровневый доступ
...
## <a name="licenses"></a><a name="licenses"></a>Лицензии
...
## <a name="business-central-administrator-tasks"></a><a name="business-central-administrator-tasks"></a>Задачи администратора Business Central
...
## <a name="business-central-developer-tasks"></a><a name="business-central-developer-tasks"></a>Задачи разработчика Business Central
