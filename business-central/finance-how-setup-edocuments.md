...
Поддерживаемые типы документов зависят от выбранного **формата документа**. Чтобы проверить, какие типы документов поддерживаются, на странице **Служба электронных документов** запустите действие **Поддерживаемые типы документов**. Откроется окно **Типы исходных документов, поддерживаемые службой электронных документов**. В столбце **Тип исходного документа** можно найти все поддерживаемые типы документов.  
...
Настраивая рабочий процесс на странице **Рабочий процесс**, наведите указатель мыши на поле **При условии** на экспресс-вкладке **Шаги рабочего процесса**. На странице **Условия события** в поле **Фильтр** выберите профиль отправки документов, который вы хотите использовать.
