...
## Демонстрационные данные электронных документов  
...
После включения модуля у вас будут созданы новые демонстрационные элементы, будет импортировано шесть электронных документов (на базе Peppol BIS 3), а также будет настроена **Служба электронных документов** с созданными рабочими процессами.  
