...
ms.author: edupont
---
# <a name="import-multiple-item-pictures"></a><a name="import-multiple-item-pictures"></a>Импорт нескольких изображений товаров
...
## <a name="to-name-picture-files-by-the-item-names-and-prepare-the-zip-file"></a><a name="to-name-picture-files-by-the-item-names-and-prepare-the-zip-file"></a>Присвоение файлам изображений названий товаров и подготовка ZIP-файла
...
## <a name="to-import-item-pictures"></a><a name="to-import-item-pictures"></a>Импорт изображений товаров
