...
Когда вы настраиваете утверждающих пользователей в рабочих процессах, где вы хотите, чтобы кто-то утверждал изменения, например, когда создаются новые записи или когда кто-то запрашивает утверждение, вы должны указать, как и когда утверждающий пользователь уведомляется. Например, вы можете указать, что утвержденный пользователь немедленно получает электронное письмо, когда кто-то создает нового клиента. Кроме того, вы можете запланировать, чтобы уведомления сохранялись и затем доставлялись совместно, например, еженедельно или ежемесячно.
...
2. На странице **Настройка уведомлений** измените настройки уведомлений, как описано в шагах 3–5 выше.
