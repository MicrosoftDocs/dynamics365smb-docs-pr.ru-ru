---
title: Определение сроков и порядка получения уведомлений пользователями
description: При настройке пользователей в потоках операций утверждения необходимо на страницах "Настройка уведомлений" и "График уведомлений" указать, как и когда каждый пользователь получает уведомления.
author: SorenGP
