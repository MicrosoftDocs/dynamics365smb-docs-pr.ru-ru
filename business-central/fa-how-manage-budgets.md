...
ms.author: edupont
---
# <a name="manage-budgets-for-fixed-assets" />Управление бюджетами основных средств
...
## <a name="to-budget-the-acquisition-cost-of-a-fixed-asset" />Бюджетирование стоимости приобретения основного средства
...
## <a name="to-budget-the-disposal-of-a-fixed-asset" />Бюджетирование реализации основного средства
...
## <a name="to-view-projected-disposal-values" />Просмотр стоимости планируемой реализации
...
## <a name="to-budget-depreciation" />Составление бюджета амортизации
