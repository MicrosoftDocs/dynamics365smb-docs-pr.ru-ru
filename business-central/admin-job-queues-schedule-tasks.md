...
| На удержании | Статус задания в очереди по умолчанию, когда оно создается. Выберите действие **Установить статус Готово** для изменения статуса на **Готово**. Выберите действие **Поставить на удержание**, чтобы вернуть статус **На удержании**. Дополнительную информацию см. в разделе [О постановке на удержание](#about-on-hold).|
...
Перевод операции очереди заданий в статус **На удержании** не влияет на уже запущенное задание. После запуска задания в очереди заданий оно продолжает выполняться до завершения, независимо от любых последующих изменений, вносимых в операцию очереди заданий, таких как постановка на удержание.<br><br>Статус **На удержании** обычно используется для предотвращения автоматического запуска задания по достижении запланированного времени запуска. Это позволяет временно приостановить выполнение задания, прежде чем оно начнет обрабатываться. Однако, если задание уже запущено, изменение статуса на «На удержании» не приводит к прерыванию выполнения задания и никак не влияет на него.<br><br>Если вам необходимо остановить или отменить выполняемое задание, вы можете сделать это, вмешавшись в процесс вручную, например завершив соответствующий сеанс или процесс, ответственный за выполнение задания.
