...
---
# <a name="use-job-queues-to-schedule-tasks" />Использование очередей работ для планирования задач
...
## <a name="monitor-status-or-errors-in-the-job-queue" />Отслеживание состояния или ошибок в очереди заданий
...
### <a name="to-view-status-for-any-job" />Просмотр статуса любого задания
...
## <a name="view-scheduled-tasks" />Просмотр запланированных задач
...
## <a name="the-my-job-queue-part" />Часть "Моя очередь заданий"
...
### <a name="to-view-an-error-from-the-my-job-queue-part" />Просмотр ошибки из части "Моя очередь работ"
...
## <a name="examples-of-what-you-can-schedule-using-job-queue-entries" />Примеры того, что можно запланировать с помощью операций очереди заданий

### <a name="schedule-reports" />Планирование отчетов
...
### <a name="schedule-when-to-post-sales-and-purchase-orders" />Планирование даты и времени учета заказов на продажу и покупку
...
## <a name="handle-job-queue-entry-issues" />Обработка проблем с операциями очереди заданий
...
## <a name="monitor-the-job-queue-with-telemetry" />Мониторинг очереди заданий с помощью телеметрии
