...
---
# <a name="analyze-data-with-statistical-accounts"></a><a name="analyze-data-with-statistical-accounts"></a>Анализ данных с помощью статистических счетов
...
## <a name="set-up-a-statistical-account"></a><a name="set-up-a-statistical-account"></a>Настройка статистического счета
...
## <a name="post-amounts-to-a-statistical-account"></a><a name="post-amounts-to-a-statistical-account"></a>Учет сумм на статистическом счете
...
## <a name="verify-statistical-account-amounts"></a><a name="verify-statistical-account-amounts"></a>Проверка сумм на статистическом счете
...
## <a name="include-the-statistical-account-in-a-financial-report"></a><a name="include-the-statistical-account-in-a-financial-report"></a>Включение статистического счета в финансовый отчет
