...
---
# <a name="analyze-data-with-statistical-accounts" />Анализ данных с помощью статистических счетов
...
## <a name="set-up-a-statistical-account" />Настройка статистического счета
...
## <a name="post-amounts-to-a-statistical-account" />Учет сумм на статистическом счете
...
## <a name="verify-statistical-account-amounts" />Проверка сумм на статистическом счете
...
## <a name="include-the-statistical-account-in-a-financial-report" />Включение статистического счета в финансовый отчет
