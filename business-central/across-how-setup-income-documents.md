...
ms.author: edupont
---
# <a name="set-up-incoming-documents" />Настройка входящих документов
...
## <a name="to-set-up-the-incoming-documents-feature" />Настройка возможности входящих документов
...
## <a name="to-set-up-approvers-of-incoming-document-records" />Настройка утверждающих для записей входящих документов
...
## <a name="to-set-up-an-ocr-service" />Настройка службы распознавания
