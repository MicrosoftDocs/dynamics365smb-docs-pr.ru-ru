...
ms.locfileid: "9606861"
---
# <a name="walkthrough-making-cash-flow-forecasts-using-financial-reports"></a>Пошаговое руководство: создание прогнозов движения денежных средств с помощью финансовых отчетов
...
Иван — контролер в CRONUS, который делает ежемесячные прогнозы движения денежных средств. Он включает финансы, продажи, покупки, а также основные средства в прогнозах, которые он затем представляет в CFO Sara для бизнес-аналитики.  

## <a name="setting-up-a-new-financial-report-name"></a>Настройка нового названия финансового отчета
...
### <a name="set-up-a-new-financial-report-name"></a>Настройка нового названия финансового отчета  
...
## <a name="setting-up-row-definition-lines"></a>Настройка строк определения строк
...
### <a name="set-up-row-definition-lines"></a>Настройка строк определения строк  
...
## <a name="setting-up-a-new-column-definition"></a>Настройка нового определения столбца

Прежде чем Кен сможет распечатать прогноз движения денежных средств, ему нужно создать определение столбцов для числовой информации. В столбцах он определяет информацию, которую нужно использовать из строк.
...
- Наконец, он назначает определение столбцов как параметр по умолчанию для финансового отчета **Прогноз**.  

### <a name="set-up-a-new-column-definition"></a>Настройка нового определения столбцов
...
## <a name="assigning-the-column-definition-to-the-financial-report-name"></a>Назначение определения столбца имени финансового отчета

Иван теперь готов назначить определение столбцов названию финансового отчета.  

### <a name="assign-the-column-definition-to-the-financial-report-name"></a>Назначение определения столбца имени финансового отчета
...
## <a name="view-and-print-the-cash-flow-forecast"></a>Просмотр и печать прогноза движения денежных средств
