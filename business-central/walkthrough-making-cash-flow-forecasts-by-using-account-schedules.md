---
title: Составляйте прогнозы движения денежных средств с использованием финансовых отчетов
...
# <a name="walkthrough-make-cash-flow-forecasts-using-financial-reports"></a>Пошаговое руководство: прогнозирование денежных потоков с использованием финансовых отчетов
...
### <a name="set-up-a-new-financial-report-name-1"></a>Настройка нового названия финансового отчета
...
### <a name="set-up-row-definition-lines-1"></a>Настройка строк определения строк
...
### <a name="set-up-a-new-column-definition-1"></a>Настройка нового определения столбцов
...
## <a name="assig-the-column-definition-to-the-financial-report-name"></a>Присвойте определение столбца названию финансового отчета
