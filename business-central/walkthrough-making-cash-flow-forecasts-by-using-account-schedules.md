...
---
# <a name="walkthrough-make-cash-flow-forecasts-using-financial-reports"></a>Пошаговое руководство: создание прогнозов движения денежных средств с помощью финансовых отчетов
...
## <a name="set-up-a-new-column-definition"></a>Настройка нового определения столбца
...
## <a name="assig-the-column-definition-to-the-financial-report-name"></a>Назначение определения столбца имени финансового отчета
