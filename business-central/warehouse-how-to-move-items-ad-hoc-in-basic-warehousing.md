...
---
# <a name="move-items-internally-in-basic-warehouse-configurations" />Внутреннее перемещение товаров в базовых конфигурациях склада
...
## <a name="internal-movements" />Внутренние перемещения
...
### <a name="to-move-items-as-an-internal-movement" />Перемещение товаров как складское помещение
...
## <a name="to-move-items-with-the-item-reclassification-journal" />Перемещение товаров с помощью журнала реклассификации товара
