...
Вместе с полем **Период перепланирования** поле **Период накопления лота** играет роль в определении цикла дозаказа. Начиная с даты первого спроса весь спрос в следующем периоде накопления лота накапливается в один заказ на поставку на дату первого спроса. Спрос за пределами периода накопления лота не покрывается этим заказом на поставку.
