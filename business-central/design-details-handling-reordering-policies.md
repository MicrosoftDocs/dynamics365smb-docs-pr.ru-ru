...
---
# <a name="design-details-handling-reordering-policies"></a><a name="design-details-handling-reordering-policies"></a>Сведения о проектировании: обработка политик дозаказа
...
## <a name="the-role-of-the-reorder-point"></a><a name="the-role-of-the-reorder-point"></a>Роль точки повтора заказа
...
## <a name="monitoring-the-projected-inventory-level-and-the-reorder-point"></a><a name="monitoring-the-projected-inventory-level-and-the-reorder-point"></a>Отслеживание уровня прогнозируемых запасов и точки повтора заказа
...
### <a name="projected-inventory"></a><a name="projected-inventory"></a>Прогнозируемые запасы
...
### <a name="projected-available-inventory"></a><a name="projected-available-inventory"></a>Прогнозируемые доступные запасы
...
### <a name="time-buckets"></a><a name="time-buckets"></a>Горизонты планирования
...
### <a name="determining-the-projected-inventory-level"></a><a name="determining-the-projected-inventory-level"></a>Определение уровня прогнозируемых запасов
...
## <a name="the-role-of-the-time-bucket"></a><a name="the-role-of-the-time-bucket"></a>Роль горизонта планирования
...
## <a name="stay-below-the-overflow-level"></a><a name="stay-below-the-overflow-level"></a>Оставайтесь ниже уровня допустимого избытка
...
### <a name="calculating-the-overflow-level"></a><a name="calculating-the-overflow-level"></a>Расчет допустимого избытка

Допустимый избыток вычисляется разными способами в зависимости от политики повторного заказа.  

#### <a name="maximum-qty"></a><a name="maximum-qty"></a>Максимальное кол-во
...
#### <a name="fixed-reorder-qty"></a><a name="fixed-reorder-qty"></a>Фикс. кол-во повтора заказа
...
#### <a name="order-multiple"></a><a name="order-multiple"></a>«Заказать несколько»;
...
### <a name="creating-the-planning-line-with-an-overflow-warning"></a><a name="creating-the-planning-line-with-an-overflow-warning"></a>Создание строки планирования с предупреждением о переполнении
...
#### <a name="calculating-the-planning-line-quantity"></a><a name="calculating-the-planning-line-quantity"></a>Расчет количества строки планирования
...
#### <a name="defining-the-action-message-type"></a><a name="defining-the-action-message-type"></a>Определение типа сообщения о действии
...
#### <a name="composing-the-warning-message"></a><a name="composing-the-warning-message"></a>Создание предупреждающего сообщения
...
#### <a name="item-setup"></a><a name="item-setup"></a>Настройка товара
...
#### <a name="situation-before-sales-decrease"></a><a name="situation-before-sales-decrease"></a>Ситуация до снижения продаж
...
#### <a name="situation-after-sales-decrease"></a><a name="situation-after-sales-decrease"></a>Ситуация после снижения продаж
...
#### <a name="resulting-planning-lines"></a><a name="resulting-planning-lines"></a>Результирующие строки планирования
...
## <a name="handling-projected-negative-inventory"></a><a name="handling-projected-negative-inventory"></a>Обработка прогнозируемых отрицательных остатков
...
## <a name="reordering-policies"></a><a name="reordering-policies"></a>Политики дозаказа
...
### <a name="fixed-reorder-quantity"></a><a name="fixed-reorder-quantity"></a>Фиксированное кол-во для дозаказа
...
#### <a name="calculated-per-time-bucket"></a><a name="calculated-per-time-bucket"></a>Расчет на горизонт планирования
...
#### <a name="creates-only-necessary-supply"></a><a name="creates-only-necessary-supply"></a>Создание только необходимой поставки
...
#### <a name="combines-with-order-modifiers"></a><a name="combines-with-order-modifiers"></a>Объединение с модификаторами заказа
...
#### <a name="combines-with-calendars"></a><a name="combines-with-calendars"></a>Объединение с календарями
...
#### <a name="shouldnt-be-used-with-forecasts"></a><a name="shouldnt-be-used-with-forecasts"></a>Не для использования с прогнозами
...
#### <a name="must-not-be-used-with-reservations"></a><a name="must-not-be-used-with-reservations"></a>Не для использования с резервированиями
...
### <a name="maximum-quantity"></a><a name="maximum-quantity"></a>Максимальное количество
...
#### <a name="calculate-per-time-bucket"></a><a name="calculate-per-time-bucket"></a>Расчет на горизонт планирования
...
#### <a name="combine-with-order-modifiers"></a><a name="combine-with-order-modifiers"></a>Объедините с модификаторами заказа
...
### <a name="combine-with-calendars"></a><a name="combine-with-calendars"></a>Объедините с календарями

Прежде чем предложить новый заказ на поставку для достижения точки повторного заказа, система планирования проверяет, запланирован ли заказ на нерабочий день. Она использует календари, указанные вами в поле **Код базового календаря** на страницах **Информация о компании** и **Карточка склада**.  

Если плановая дата является нерабочим днем, система планирования переместит заказ до ближайшего рабочего дня. Смещение даты может привести к тому, что заказ достигнет точки повтора заказа, но не удовлетворит определенному спросу. Если такого несбалансированного спроса система планирования создает дополнительную поставку.

### <a name="order"></a><a name="order"></a>Порядок
...
#### <a name="order-to-order-links-and-past-due-dates"></a><a name="order-to-order-links-and-past-due-dates"></a>Связи "заказ-в-заказ" и просроченные даты
...
### <a name="lot-for-lot"></a><a name="lot-for-lot"></a>Партия на партию
