...
description: В этой статье дается обзор задач, связанных с обработкой политик дозаказа и определением политики дозаказа при планировании поставок.
author: SorenGP
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
