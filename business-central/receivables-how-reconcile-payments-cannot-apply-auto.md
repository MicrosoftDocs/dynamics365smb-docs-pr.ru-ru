...
---
# <a name="reconcile-payments-that-cant-be-applied-automatically"></a>Согласование платежей, которые не могут быть применены автоматически
...
## <a name="to-reconcile-payments-that-cant-be-applied-automatically"></a>Для сверки платежей, которые не могут быть применены автоматически
