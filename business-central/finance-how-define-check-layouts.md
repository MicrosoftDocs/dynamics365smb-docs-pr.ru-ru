...
ms.author: bholtorf
---
# Выбор макета платежного документа
...
## Чтобы выбрать макет платежного документа
...
## Использование шрифтов безопасности и MICR
...
### Спецификации безопасных шрифтов
