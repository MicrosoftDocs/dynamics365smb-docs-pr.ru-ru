...
ms.author: bholtorf
---
# <a name="use-the-same-microsoft-365-account-in--and-microsoft-invoicing"></a><a name="use-the-same-microsoft-365-account-in--and-microsoft-invoicing"></a><a name="use-the-same-microsoft-365-account-in--and-microsoft-invoicing"></a>Использование одной и той же учетной записи Microsoft 365 в [!INCLUDE[prod_short](includes/prod_long.md)] и Microsoft Invoicing
...
## <a name="workaround"></a><a name="workaround"></a><a name="workaround"></a>Обходное решение
...
### <a name="to-rename-your-company"></a><a name="to-rename-your-company"></a><a name="to-rename-your-company"></a>Переименование организации
...
### <a name="what-about-my-data"></a><a name="what-about-my-data"></a><a name="what-about-my-data"></a>Что происходит с данными?
