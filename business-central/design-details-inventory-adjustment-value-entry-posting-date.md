...
ms.author: edupont
---
# <a name="design-details-posting-date-on-adjustment-value-entry" />Подробности разработки: дата учета для операции коррекции стоимости
...
## <a name="how-posting-dates-are-assigned" />Как назначаются даты учета
...
#### <a name="item-ledger-entry" />Товары - книга операций
...
#### <a name="inventory-periods" />Периоды учета запасов
...
#### <a name="general-ledger-setup" />Настройка ГК
...
## <a name="common-problems-with-the-adjust-cost---item-entries-batch-job" />Общие проблемы с пакетным заданием Коррекция себест. запасов
...
### <a name="error-message-posting-date-is-not-within-your-range-of-allowed-posting-dates" />Сообщение об ошибке "Дата учета вне пределов разрешенного диапазона дат учета"
...
### <a name="posting-date-on-adjustment-value-entry-versus-posting-date-on-entry-causing-the-adjustment-such-as-revaluation-or-item-charge" />Дата учета в операции коррекции стоимости и дата учета в операции, вызывающей коррекцию, такую как переоценка или товарная издержка
