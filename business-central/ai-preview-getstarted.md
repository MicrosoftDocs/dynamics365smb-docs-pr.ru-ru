...
# <a name="get-started-with-a-business-central-preview-version-for-copilot"></a>Начало работы с предварительной версией Business Central для Copilot
...
## <a name="your-organization-already-uses-business-central"></a>Ваша организация уже использует Business Central
...
## <a name="your-organization-doesnt-use-business-central"></a>Ваша организация не использует Business Central
