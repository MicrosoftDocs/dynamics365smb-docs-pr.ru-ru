...
- Другой способ — использовать страницу  **Состояние уведомлений о конфиденциальности**  в Business Central и согласиться на интеграцию **Azure OpenAI**  для всех пользователи. Чтобы узнать больше, перейдите на страницу [Согласие с условиями](enable-ai.md#consent-to-or-reject-preview-and-privacy-terms-and-conditions-for-all-users).
