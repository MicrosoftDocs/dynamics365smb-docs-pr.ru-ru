...
ms.author: edupont
---
# <a name="revalue-fixed-assets" />Переоценка основных средств
...
## <a name="to-post-an-appreciation-from-the-fixed-asset-gl-journal" />Учет повышения стоимости с использованием журнала ГК учета основных средств
...
## <a name="to-post-a-write-down-from-the-fixed-asset-gl-journal" />Учет понижения стоимости с использованием журнала ГК учета основных средств
...
## <a name="to-perform-general-revaluation-of-fixed-assets" />Выполнение общей переоценки основных средств
...
## <a name="to-post-additional-acquisition-costs" />Учет дополнительной стоимости приобретения
...
### <a name="example---posting-additional-acquisition-costs" />Пример. Учет дополнительной стоимости приобретения
