...
## Учет дополнительной стоимости приобретения
...
### Пример. Учет дополнительной стоимости приобретения
...
## См. соответствующее [обучение Microsoft](/training/paths/manage-advanced-fixed-assets-transactions/)
