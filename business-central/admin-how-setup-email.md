...
### <a name="connect-prod_short-to-your-app-registration"></a>Подключение [!INCLUDE[prod_short](includes/prod_short.md)] к регистрации приложения
