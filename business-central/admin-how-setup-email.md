...
Вы можете использовать отчеты для включения ключевой информации из документов продаж покупок и сервиса в тексты сообщений электронной почты. Эта процедура описывает, как настроить отчет **Счет продажи** по разнесенным счетам продаж, но процесс аналогичен для других отчетов.
