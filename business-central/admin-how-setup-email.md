...
# <a name="set-up-email"></a><a name="set-up-email"></a><a name="set-up-email"></a>Настройка электронной почты
...
## <a name="requirements"></a><a name="requirements"></a><a name="requirements"></a>Требования
...
## <a name="adding-email-accounts"></a><a name="adding-email-accounts"></a><a name="adding-email-accounts"></a>Добавление учетных записей электронной почты
...
## <a name="using-smtp"></a><a name="using-smtp"></a><a name="using-smtp"></a>Использование SMTP
...
## <a name="add-email-accounts"></a><a name="add-email-accounts"></a><a name="add-email-accounts"></a>Добавление учетных записей электронной почты
...
is this still true?-->
## <a name="assign-email-scenarios-to-email-accounts"></a><a name="assign-email-scenarios-to-email-accounts"></a><a name="assign-email-scenarios-to-email-accounts"></a>Назначение сценариев электронной почты учетной записям электронной почты
...
<!--
## <a name="to-set-up-email"></a><a name="to-set-up-email"></a><a name="to-set-up-email"></a>To set up email
...
## <a name="set-up-view-policies"></a><a name="set-up-view-policies"></a><a name="set-up-view-policies"></a>Настройка политик просмотра
...
## <a name="specify-how-many-messages-an-account-can-send-per-minute"></a><a name="specify-how-many-messages-an-account-can-send-per-minute"></a><a name="specify-how-many-messages-an-account-can-send-per-minute"></a>Задание максимального количества сообщений, которое учетная запись может отправлять в минуту
...
## <a name="set-up-reusable-email-texts-and-layouts"></a><a name="set-up-reusable-email-texts-and-layouts"></a><a name="set-up-reusable-email-texts-and-layouts"></a>Настройка многократно используемых текстов и макетов сообщений электронной почты
...
## <a name="use-a-substitute-sender-address-on-outbound-email-messages"></a><a name="use-a-substitute-sender-address-on-outbound-email-messages"></a><a name="use-a-substitute-sender-address-on-outbound-email-messages"></a>Использование замещающего адреса отправителя в исходящих сообщениях электронной почты
...
<!--
### <a name="to-set-up-the-substitute-sender-address-for-all-outbound-email-messages"></a><a name="to-set-up-the-substitute-sender-address-for-all-outbound-email-messages"></a><a name="to-set-up-the-substitute-sender-address-for-all-outbound-email-messages"></a>To set up the substitute sender address for all outbound email messages
...
### <a name="to-use-the-substitute-address-in-approval-workflows"></a><a name="to-use-the-substitute-address-in-approval-workflows"></a><a name="to-use-the-substitute-address-in-approval-workflows"></a>To use the substitute address in approval workflows
...
## <a name="optional-set-up-email-logging-in-exchange-online"></a><a name="optional-set-up-email-logging-in-exchange-online"></a><a name="optional-set-up-email-logging-in-exchange-online"></a>(Необязательно) Настройка регистрации электронной почты в Exchange Online
...
## <a name="setting-up-email-for-business-central-on-premises"></a><a name="setting-up-email-for-business-central-on-premises"></a><a name="setting-up-email-for-business-central-on-premises"></a>Настройка электронной почты для Business Central On-Premises
...
### <a name="create-an-app-registration-for-business-central-in-azure-portal"></a><a name="create-an-app-registration-for-business-central-in-azure-portal"></a><a name="create-an-app-registration-for-business-central-in-azure-portal"></a>Создание регистрации приложения для Business Central на портале Azure
...
### <a name="connect--to-your-app-registration"></a><a name="connect--to-your-app-registration"></a><a name="connect--to-your-app-registration"></a>Подключение [!INCLUDE[prod_short](includes/prod_short.md)] к регистрации приложения
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>См. соответствующее [обучение Microsoft](/training/modules/set-up-email/)
