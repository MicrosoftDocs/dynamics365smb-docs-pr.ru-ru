...
# <a name="set-up-email" />Настройка электронной почты
...
## <a name="adding-email-accounts" />Добавление учетных записей электронной почты
...
## <a name="using-smtp" />Использование SMTP
...
## <a name="add-email-accounts" />Добавление учетных записей электронной почты
...
is this still true?-->
## <a name="assign-email-scenarios-to-email-accounts" />Назначение сценариев электронной почты учетной записям электронной почты
...
## <a name="set-up-view-policies" />Настройка политик просмотра
...
## <a name="specify-how-many-messages-an-account-can-send-per-minute" />Задание максимального количества сообщений, которое учетная запись может отправлять в минуту
...
## <a name="set-up-reusable-email-texts-and-layouts" />Настройка многократно используемых текстов и макетов сообщений электронной почты
...
## <a name="use-a-substitute-sender-address-on-outbound-email-messages" />Использование замещающего адреса отправителя в исходящих сообщениях электронной почты
...
## <a name="set-up-document-sending-profiles" />Настройка профилей отправки документов
...
## <a name="optional-set-up-email-logging-in-exchange-online" />(Необязательно) Настройка регистрации электронной почты в Exchange Online
...
## <a name="setting-up-email-for-business-central-on-premises" />Настройка электронной почты для Business Central On-Premises
...
### <a name="create-an-app-registration-for-business-central-in-azure-portal" />Создание регистрации приложения для Business Central на портале Azure
