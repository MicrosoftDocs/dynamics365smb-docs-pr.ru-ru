...
description: 'Эти вопросы и ответы содержат информацию о технологии ИИ, используемой в предлагаемых маркетинговых текстах в Business Central, включая ключевые соображения и сведения о том, как используется ИИ, как он тестировался и оценивался, а также о конкретных ограничениях, если они существуют.'
ms.date: 10/07/2023
ms.custom:
  - responsible-ai-faqs
ms.topic: article
