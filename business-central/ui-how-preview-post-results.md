...
ms.author: solsen
---
# <a name="preview-posting-results" />Предварительный просмотр результатов учета
...
## <a name="to-preview-gl-entries-that-will-result-from-posting-a-purchase-invoice" />Просмотр операций ГК, которые появятся в результате учета счета покупки
