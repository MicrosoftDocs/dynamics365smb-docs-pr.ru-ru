...
# <a name="ai-powered-item-marketing-text-preview-with-copilot-faq" />Создание маркетинговых текстов для товаров на базе ИИ с помощью Copilot: вопросы и ответы
...
### <a name="what-is-copilot" />Что такое Copilot?
...
### <a name="why-isnt-copilot-available-for-marketing-text-on-my-items-in-business-central" />Почему Copilot недоступен для маркетингового текста на моих товарах в Business Central?
...
### <a name="is-copilot-available-for-preview-in-business-central-on-premises" />Доступен ли Copilot для предварительной версии в локальной версии Business Central?

Нет, он не поддерживается в настоящее время в локальной версии Business Central.

### <a name="how-does-copilot-work-where-does-the-suggested-text-come-from" />Как работает Copilot, откуда берется предлагаемый текст?
...
### <a name="whats-the-quality-of-the-text-suggested-by-copilot" />Каково качество текста, предлагаемого Copilot?
...
### <a name="how-can-i-improve-the-suggestions-i-get-from-copilot" />Как я могу улучшить предложения, которые я получаю от Copilot?
...
### <a name="what-if-im-not-satisfied-with-the-generated-text" />Что делать, если меня не устраивает сгенерированный текст?
...
### <a name="can-admins-disable-copilot-if-so-how" />Могут ли администраторы отключить Copilot? Если да, то как?
...
### <a name="does-copilot-work-with-languages-other-than-english" />Работает ли Copilot с языками, отличными от английского?
...
### <a name="whats-done-about-abusive-and-harmful-text-suggestions" />Что делать с оскорбительными и вредными текстовыми предложениями?
...
### <a name="can-i-opt-out-of-the-logging-and-human-review-process" />Могу ли я отказаться от процесса ведения журнала и проверки человеком?
...
### <a name="what-data-does-the-capability-collect-how-is-the-data-used" />Какие данные собирает эта функция? Как эти данные используются?
