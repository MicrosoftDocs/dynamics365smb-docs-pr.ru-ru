...
ms.author: edupont
---
# <a name="create-blanket-assembly-orders" />Создание общих заказов на сборку
...
## <a name="to-create-a-blanket-assembly-order-for-an-assemble-to-order-item" />Создание общего сборочного заказа для товара сборки\-на\-заказ
