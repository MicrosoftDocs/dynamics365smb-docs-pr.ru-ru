...
---
# <a name="manage-attachments-links-and-notes-on-cards-and-documents" />Управление вложениями, ссылками и заметками в карточках и документах
...
## <a name="to-attach-a-file-to-a-purchase-invoice" />Прикрепление файла к счету покупки
...
## <a name="to-view-an-attached-file" />Просмотр вложенного файла
...
## <a name="to-save-a-document-as-a-pdf-attachment" />Чтобы сохранить документ в виде PDF-вложения
...
## <a name="to-add-a-link-from-an-item-card" />Добавление ссылки из карточки товара
...
## <a name="to-write-a-note-on-a-sales-order" />Написание заметки о заказе на продажу
