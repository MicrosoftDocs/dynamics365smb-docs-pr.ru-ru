...
---
# Управление вложениями, ссылками и заметками в карточках и документах
...
## Прикрепление файла к счету покупки
...
## Чтобы сохранить документ в виде PDF-вложения
...
## Добавление ссылки из карточки товара
...
## Написание заметки о заказе на продажу
