...
## Сценарии ad-hoc-анализа данных по запасам
...
## Пример: отслеживание старых запасов или запасов с истекающим сроком годности
...
## Пример: возвращенные товары по причине возврата
...
## Пример: оборачиваемость запасов
...
## Данные, используемые для ad-hoc-анализа запасов
