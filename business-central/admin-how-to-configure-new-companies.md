...
3. Чтобы убедиться, что теперь данные находятся в базе данных и что применение прошло успешно, вернитесь к окну **Журнал конфигураций** и выберите действие **Данные базы данных**.  
...
3. В окне **Записи пакета конфигураций** выполните изменения. Например, можно удалить параметры, которые не применяются.  
4. Выберите действие **Применить данные**, затем выберите кнопку **ОК**.  
5. Чтобы убедиться, что теперь данные находятся в базе данных и что применение прошло успешно, вернитесь к окну **Журнал конфигураций** и выберите действие **Данные базы данных**.  
...
3. Выберите поле **Число ошибок пакета** для открытия окна **Записи пакета конфигураций**, в котором приведен список записей с ошибками.  
