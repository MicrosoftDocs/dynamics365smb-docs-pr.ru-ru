...
5. Выберите значок ![Лампочка, которая открывает функцию Что вы хотите сделать](media/ui-search/search_small.png "Что вы хотите сделать"), введите **Информация о компании**, а затем выберите соответствующую ссылку. Введите информацию об организации в карточку информации об организации. Включите информацию, например сведения о банке. Можно также предоставить логотип для организации.  
