...
---
# <a name="work-with-intercompany-documents-and-journals" />Работа с межфирменными документами и журналами
...
## <a name="fill-in-and-send-an-intercompany-sales-order" />Заполнение и отправка межфирменного заказа на продажу
...
## <a name="fill-in-and-post-an-intercompany-journal" />Заполнение и учет межфирменного журнала
