...
ms.author: jswymer
---
# <a name="create-interactions-on-contacts-and-segments" />Создание взаимодействий для контактов и сегментов
...
## <a name="to-create-an-interaction" />Создание взаимодействия
...
## <a name="to-finish-and-delete-postponed-interactions" />Завершение и удаление отложенных взаимодействий
1. Откройте контакт, менеджера по продажам или операцию журнала взаимодействий.
...
## <a name="to-create-an-interaction-on-a-segment" />Создание взаимодействия для сегмента
