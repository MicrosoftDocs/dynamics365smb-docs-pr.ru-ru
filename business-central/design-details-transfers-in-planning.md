...
![Содержимое окна заказа на перемещение](media/nav_app_supply_planning_7_transfers3.png "Содержимое окна заказа на перемещение")  
...
![Содержимое окна карточки единицы хранения](media/nav_app_supply_planning_7_transfers6.gif "Содержимое окна карточки единицы хранения")  
