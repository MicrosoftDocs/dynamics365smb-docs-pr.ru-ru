...
ms.author: bholtorf
---
# <a name="upgrading-an-integration-with-dynamics-365-sales" />Обновление интеграции с Dynamics 365 Sales
...
## <a name="to-upgrade-your-connection-to-use-dataverse" />Обновление подключения для использования Dataverse
