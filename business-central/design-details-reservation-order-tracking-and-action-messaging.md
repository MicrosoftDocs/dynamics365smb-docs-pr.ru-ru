...
ms.author: edupont
---
# <a name="design-details-reservation-order-tracking-and-action-messaging" />Сведения о проектировании: резервирование, трассировка заказов и отправка сообщений о действиях
...
## <a name="reservation" />Резервирование
...
### <a name="offsetting-in-reservations" />Смещение в резервированиях
...
### <a name="manual-reservation" />Резервирование вручную
...
### <a name="automatic-reservations" />Автоматические резервирования
...
## <a name="order-tracking" />Трассировка заказов
...
### <a name="the-order-network" />Сеть заказов
...
### <a name="offsetting-in-order-tracking" />Смещение в трассировке заказов
...
### <a name="example-order-tracking-in-sales-production-and-transfers" />Пример. Трассировка заказов в продажах, производстве и перемещениях
...
### <a name="entry-numbers-8-and-9" />Номера операций 8 и 9
...
### <a name="entry-numbers-10" />Номер операции 10
...
### <a name="entry-numbers-8-and-9-1" />Номера операций 8 и 9
...
### <a name="entry-numbers-12-to-16" />Номера операций с 12 по 16
...
### <a name="entry-numbers-21-and-22" />Номера операций 21 и 22
...
## <a name="action-messaging" />Отправка сообщений о действиях
...
## <a name="order-tracking-and-planning" />Трассировка и планирование заказа
...
### <a name="planning-system-versus-order-tracking-and-action-messaging" />Система планирования, трассировка заказов и отправка сообщений о действиях
