...
ms.author: edupont
---
# <a name="design-details-reservation-order-tracking-and-action-messaging"></a><a name="design-details-reservation-order-tracking-and-action-messaging"></a><a name="design-details-reservation-order-tracking-and-action-messaging"></a>Сведения о проектировании: резервирование, трассировка заказов и отправка сообщений о действиях
...
## <a name="reservation"></a><a name="reservation"></a><a name="reservation"></a>Резервирование
...
### <a name="offsetting-in-reservations"></a><a name="offsetting-in-reservations"></a><a name="offsetting-in-reservations"></a>Смещение в резервированиях
...
### <a name="manual-reservation"></a><a name="manual-reservation"></a><a name="manual-reservation"></a>Резервирование вручную
...
### <a name="automatic-reservations"></a><a name="automatic-reservations"></a><a name="automatic-reservations"></a>Автоматические резервирования
...
## <a name="order-tracking"></a><a name="order-tracking"></a><a name="order-tracking"></a>Трассировка заказов
...
### <a name="the-order-network"></a><a name="the-order-network"></a><a name="the-order-network"></a>Сеть заказов
...
### <a name="offsetting-in-order-tracking"></a><a name="offsetting-in-order-tracking"></a><a name="offsetting-in-order-tracking"></a>Смещение в трассировке заказов
...
### <a name="example-order-tracking-in-sales-production-and-transfers"></a><a name="example-order-tracking-in-sales-production-and-transfers"></a><a name="example-order-tracking-in-sales-production-and-transfers"></a>Пример. Трассировка заказов в продажах, производстве и перемещениях
...
На странице **Настройка модуля Производство** в поле **Компоненты по складам** установлено значение **КРАСНЫЙ**.
 ...
 ![Первый пример записей отслеживания заказов в таблице "Операция резервирования".](media/supply_planning_RTAM_1.png "supply_planning_RTAM_1")  

### <a name="entry-numbers-8-and-9"></a><a name="entry-numbers-8-and-9"></a><a name="entry-numbers-8-and-9"></a>Номера операций 8 и 9
...
### <a name="entry-numbers-10"></a><a name="entry-numbers-10"></a><a name="entry-numbers-10"></a>Номер операции 10
...
>  На этом этапе учитывается только отгрузка заказа на перемещение, а не приемка.  
 ...
 ![Второй пример записей отслеживания заказов в таблице "Операция резервирования".](media/supply_planning_RTAM_2.png "supply_planning_RTAM_2")  

### <a name="entry-numbers-8-and-9-1"></a><a name="entry-numbers-8-and-9-1"></a><a name="entry-numbers-8-and-9-1"></a>Номера операций 8 и 9
...
### <a name="entry-numbers-12-to-16"></a><a name="entry-numbers-12-to-16"></a><a name="entry-numbers-12-to-16"></a>Номера операций с 12 по 16
 ...
 ![Третий пример записей отслеживания заказов в таблице "Операция резервирования".](media/supply_planning_RTAM_3.png "supply_planning_RTAM_3")  
 ...
 ![Четвертый пример записей отслеживания заказов в таблице "Операция резервирования".](media/supply_planning_RTAM_4.png "supply_planning_RTAM_4")  

### <a name="entry-numbers-21-and-22"></a><a name="entry-numbers-21-and-22"></a><a name="entry-numbers-21-and-22"></a>Номера операций 21 и 22
...
## <a name="action-messaging"></a><a name="action-messaging"></a><a name="action-messaging"></a>Отправка сообщений о действиях
...
## <a name="order-tracking-and-planning"></a><a name="order-tracking-and-planning"></a><a name="order-tracking-and-planning"></a>Трассировка и планирование заказа
...
### <a name="planning-system-versus-order-tracking-and-action-messaging"></a><a name="planning-system-versus-order-tracking-and-action-messaging"></a><a name="planning-system-versus-order-tracking-and-action-messaging"></a>Система планирования, трассировка заказов и отправка сообщений о действиях
