...
ms.reviewer: jswymer
---
# Подключение к Power BI из локальной версии Business Central
...
## Управление отчетами и их изменение
...
[Отправка отчетов](across-working-with-business-central-in-powerbi.md#upload-reports)
