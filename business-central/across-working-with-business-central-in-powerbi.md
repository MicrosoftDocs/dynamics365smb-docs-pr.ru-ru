...
ms.author: jswymer
---
# <a name="work-with--data-in-power-bi"></a><a name="work-with--data-in-power-bi"></a>Работа с данными [!INCLUDE [prod_short](includes/prod_short.md)] в Power BI
...
## <a name="get-the-latest-data"></a><a name="get-the-latest-data"></a>Получение новейших данных
...
### <a name="refresh-manually"></a><a name="refresh-manually"></a>Обновление вручную
...
### <a name="schedule-a-refresh"></a><a name="schedule-a-refresh"></a>Обновление по расписанию
...
## <a name="upload-reports-from-files"></a><a name="upload-reports-from-files"></a><a name="upload"></a>Отправка отчетов из файлов
...
## <a name="share-reports-with-others"></a><a name="share-reports-with-others"></a><a name="share"></a>Предоставление доступа к отчетам другим пользователям
