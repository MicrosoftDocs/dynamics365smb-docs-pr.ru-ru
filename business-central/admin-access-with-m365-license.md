...
# Доступ к Business Central с лицензиями на Microsoft 365
...
## Преимущества предоставления доступа с лицензиями на Microsoft 365  
...
### Требования для организации доступа

- Business Central Online (SaaS).

- Среды должны иметь версию платформы 21.1 или более позднюю.

### Требования к отдельным пользователям для доступа к данным в Teams
