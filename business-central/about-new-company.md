...
При создании новой организации мастер настройки помогает правильно задать основные параметры. После этого вы можете импортировать данные из своей старой системы или другой организации в [!INCLUDE[prod_short](includes/prod_short.md)].  
...
- **Ознакомительная — демонстрационные данные**  
    Создается организация, аналогичная демонстрационной организации, с демонстрационными данными и данными настройки. Этот тип организаци доступен без перехода на 30-дневный пробный период, как в других типах.  
- **Расширенная ознакомительная — полные демонстрационные данные** Создается организация с расширенной функциональностью, которая содержит все необходимое для оценки использования продукта в организациях со сложными процессами. Этот тип организации доступен без перехода на 30-дневный пробный период, как в других типах.
- **Рабочая — только данные настройки**  
    Создается организация, похожая на **Мою организацию**, с данными настройки, такими как план счетов, способы оплаты и определения бухгалтерских отчетов, но без демонстрационных данных. Вы можете использовать эту организацию в течение 30-дневного пробного периода.
- **Новая — без данных**  
    Создается пустая организация без данных настройки. Вы можете использовать эту организацию в течение 30-дневного пробного периода.  
...
В течение 30-дневного пробного периода можно создать любое число новых организаций, но они будут доступны только в рамках пробного периода. Для получения дополнительных сведений обратитесь к партнеру [!INCLUDE[prod_short](includes/prod_short.md)]. См. также статью [Вопросы и ответы по пробной версии Dynamics 365 Business Central](trial-faq.md).  
