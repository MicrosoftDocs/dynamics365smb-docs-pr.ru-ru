...
# <a name="add-business-central-tab-in-microsoft-teams" />Добавление вкладки Business Central в Microsoft Teams
...
## <a name="about-business-central-tabs" />О вкладках Business Central
...
## <a name="add-tab-using-recommended-content" />Добавление вкладки с рекомендуемым содержимым
...
## <a name="add-tab-using-a-page-link" />Добавление вкладки с использованием ссылки на страницу
...
## <a name="add-tab-by-pinning-card-details" />Добавление вкладки путем закрепления подробностей карточки
...
## <a name="change-a-tab-and-its-content" />Изменение вкладки и ее содержимого
