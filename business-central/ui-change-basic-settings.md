...
Ролевой центр представляет начальную страницу и разработан в соответствии с задачами конкретной роли. Ролевой центр предоставляет вам обзор бизнеса, отражаю информацию, задачи и приоритеты для вашей роли.
