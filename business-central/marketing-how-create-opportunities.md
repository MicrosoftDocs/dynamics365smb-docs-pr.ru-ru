...
ms.author: jswymer
---
# <a name="create-sales-opportunities" />Создание возможностей продаж
...
## <a name="to-create-an-opportunity-from-a-salesperson" />Создание возможности для менеджера по продажам
...
## <a name="to-create-an-opportunity-from-a-contact" />Создание возможности для контакта
