...
ms.author: edupont
---
# <a name="understanding-the-general-ledger-and-chart-of-accounts" />Принципы работы с главной книгой и планом счетов
...
## <a name="general-ledger-setup-and-general-posting-setup" />Настройка главной книги и общая настройка учета
...
## <a name="account-categories" />Категории счетов
...
## <a name="get-a-quick-overview" />Получение краткого обзора
...
## <a name="access-to-create-and-edit-accounts-and-account-categories" />Доступ для создания и редактирования счетов и категорий счетов
