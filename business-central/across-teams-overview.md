...
Независимо от того, где вы находитесь в Teams, вы можете найти подробную информацию о клиентах, поставщиках и других контактах [!INCLUDE [prod_short](includes/prod_short.md)]. Эта функция не только позволяет просматривать общую информацию о контактах, но также дает доступ к истории взаимодействий, связанным документам и многому другому.
 ...
 [![Найдите контакты Business Central в командной строке Teams.](media/teams-contacts-overview-2.png)](media/teams-contacts-overview-2.png#lightbox)
...
Вы также можете поделиться данными контакта в беседе. Оттуда участники также получают доступ к более подробной информации о контакте.
 ...
 [![Найдите контакты Business Central в поле ввода сообщений Teams.](media/teams-contacts-2.png)](media/teams-contacts-2.png#lightbox)

Подробнее читайте в разделе [Поиск контактов Microsoft Teams](across-search-contacts-teams.md).
...
Узнайте больше в разделе [Поделиться записями в Microsoft Teams](across-working-with-teams.md).
...
Подробнее читайте в разделе [Поделиться записями и ссылками на страницы в Microsoft Teams](across-working-with-teams.md#share-link).
...
Подробнее читайте в статье [Добавление вкладки Business Central в Teams](across-teams-tab.md).
...
1. Учетная запись пользователя [!INCLUDE [prod_short](includes/prod_short.md)] Online требуется для приложения [!INCLUDE [prod_short](includes/prod_short.md)] для Teams.
    ...
    > [!TIP]
    > Если в вашей организации нет подписки на [!INCLUDE [prod_short](includes/prod_short.md)], вы можете зарегистрироваться на бесплатную пробную версию. Узнайте больше на странице [Зарегистрируйтесь для бесплатной Dynamics 365 Business Central пробной версии](trial-signup.md).
...
4. Как только приложение установлено, вы готовы к работе. Узнайте больше в разделах [Поиск клиентов, поставщиков и других контактов из Microsoft Teams](across-search-contacts-teams.md) и [Обмен записями в Microsoft Teams](across-working-with-teams.md).
