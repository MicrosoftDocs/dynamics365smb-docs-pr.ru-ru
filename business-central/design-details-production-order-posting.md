...
ms.author: edupont
---
# <a name="design-details-production-order-posting" />Сведения о проектировании: учет производственного заказа
...
## <a name="posting-structure" />Структура учета
...
## <a name="capacity-posting" />Учет производственной мощности
...
## <a name="production-order-costing" />Учет себестоимости по производственному заказу
