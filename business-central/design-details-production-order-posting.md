...
ms.author: edupont
---
# <a name="design-details-production-order-posting"></a><a name="design-details-production-order-posting"></a>Сведения о проектировании: учет производственного заказа
...
## <a name="posting-structure"></a><a name="posting-structure"></a>Структура учета
...
## <a name="capacity-posting"></a><a name="capacity-posting"></a>Учет производственной мощности
...
## <a name="production-order-costing"></a><a name="production-order-costing"></a>Учет себестоимости по производственному заказу
