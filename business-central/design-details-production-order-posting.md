...
ms.author: edupont
---
# <a name="design-details-production-order-posting"></a><a name="design-details-production-order-posting"></a><a name="design-details-production-order-posting"></a>Сведения о проектировании: учет производственного заказа
...
## <a name="posting-structure"></a><a name="posting-structure"></a><a name="posting-structure"></a>Структура учета
...
![Процедуры учета производственных заказов.](media/design_details_inventory_costing_14_production_posting_1.png "Процедуры учета производственных заказов")  

На следующей схеме показаны связи между результирующими операциями и объектами затрат.  

![Схема производственных операций.](media/design_details_inventory_costing_14_production_posting_2.png "Схема производственных операций")  
...
## <a name="capacity-posting"></a><a name="capacity-posting"></a><a name="capacity-posting"></a>Учет производственной мощности
...
## <a name="production-order-costing"></a><a name="production-order-costing"></a><a name="production-order-costing"></a>Учет себестоимости по производственному заказу
