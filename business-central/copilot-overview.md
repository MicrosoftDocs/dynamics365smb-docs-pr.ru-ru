...
## <a name="how-does-copilot-use-the-azure-ai-time-quota-that-comes-with-licenses"></a>Как Copilot использует квоту времени Azure AI, предоставляемую вместе с лицензиями?
...
## <a name="does-copilot-need-to-be-trained-on-my-data"></a>Нужно ли обучать Copilot работе с моими данными?
...
## <a name="how-do-i-keep-up-with-the-latest-news-about-copilot-in-business-central"></a>Как мне быть в курсе последних новостей о Copilot в Business Central?
