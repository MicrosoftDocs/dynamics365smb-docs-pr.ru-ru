...
ms.author: jswymer
---
# <a name="a-namedefaultaspecify-a-default-printer" /><a name="default"></a>Установка принтера по умолчанию
...
## <a name="set-a-printer-as-a-default-printer-for-all-print-jobs" />Установка принтера в качестве принтера по умолчанию для всех заданий печати
...
## <a name="set-a-default-printer-for-specific-reports" />Установка принтера по умолчанию для конкретных отчетов
...
## <a name="choosing-the-printer-when-running-a-report" />Выбор принтера при запуске отчета
...
## <a name="sizing-print-jobs" />Величина заданий печати
