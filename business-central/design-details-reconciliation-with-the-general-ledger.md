...
ms.author: edupont
---
# <a name="design-details-reconciliation-with-the-general-ledger" />Сведения о проектировании: выверка с главной книгой
...
## <a name="post-inventory-cost-to-gl-batch-job" />Пакетное задание "Учет себест. запасов в ГК".
...
## <a name="automatic-cost-posting" />Автомат. учет себест.
...
## <a name="account-types" />Типы счета
