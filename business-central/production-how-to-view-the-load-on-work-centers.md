...
ms.author: edupont
---
# <a name="view-load-on-work-and-machine-centers" />Просмотр загрузки производственных и машинных центров
...
## <a name="to-view-the-load-on-work-centers" />Просмотр загрузки рабочих центров
