...
* Загрузите и установите приложение Field Service Integration с сайта [AppSource](https://go.microsoft.com/fwlink/?linkid=2277917). После этого на странице  **Управление расширениями**  найдите приложение Field Service Integration и выберите действие  **Настроить**, чтобы запустите руководство по вспомогательной настройке.
