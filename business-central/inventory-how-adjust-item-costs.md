...
ms.author: edupont
---
# <a name="adjust-item-costs" />Корректировка себестоимости товаров
...
## <a name="to-adjust-item-costs-manually" />Корректировка себестоимости товара вручную
...
## <a name="to-make-general-changes-in-the-direct-unit-cost" />Внесение общих изменений в прямую себестоимость единицы
...
## <a name="understanding-unit-cost-calculation" />Расчет себестоимости единицы
...
### <a name="costing-method-fifo-lifo-specific-or-average" />Метод учета себестоимости FIFO, LIFO, по серийным номерам или по средней
