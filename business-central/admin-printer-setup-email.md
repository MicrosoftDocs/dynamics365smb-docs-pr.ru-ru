...
---
# <a name="set-up-email-printers" />Настройка принтеров с поддержкой электронной почты
...
## <a name="add-an-email-printer" />Добавление принтера, работающего по электронной почте
