...
### <a name="-release-a-source-document-to-create-a-request-for-an-inventory-put-away" />1. Запрос размещения запасов путем выпуска исходного документа
...
### <a name="-create-an-inventory-put-away" />2. Создание размещения запасов
...
### <a name="-post-an-inventory-put-away" />3. Учет размещения запасов
...
### <a name="-release-the-source-document" />1. Выпуск исходного документа
...
### <a name="-create-a-warehouse-receipt" />2. Создание складской приемки
...
### <a name="-post-the-warehouse-receipt" />3. Учесть складскую приемку
...
### <a name="-optional-generate-put-away-worksheet-lines" />4. Создание строк журнала размещения (необязательно)
...
### <a name="-create-a-warehouse-put-away-document" />5. Создание документа складского размещения
...
### <a name="-register-a-warehouse-put-away" />6. Регистрация складского размещения
