...
* На складе с последовательным выполнением заказов, на котором выполняются более сложные процессы размещения или где сотрудники склада отделяют свои действия по размещению от документа заказа, можно использовать метод Б.
...
> * Размещение запасов, используемое в методе Б, вместе с регистрацией информации о размещении, также учитывает получение исходного документа.
