...
---
# <a name="use-power-automate-flows-in-"></a><a name="use-power-automate-flows-in-"></a><a name="use-power-automate-flows-in-"></a>Использование потоков Power Automate в [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="about-power-automate-flows"></a><a name="about-power-automate-flows"></a><a name="about-power-automate-flows"></a>О потоках Power Automate
...
## <a name="power-automate-features"></a><a name="power-automate-features"></a><a name="power-automate-features"></a>Функции Power Automate
...
## <a name="run-instant-flows"></a><a name="run-instant-flows"></a><a name="run-instant-flows"></a>Запуск мгновенных потоков
...
## <a name="create-edit-and-manage-flows"></a><a name="create-edit-and-manage-flows"></a><a name="create-edit-and-manage-flows"></a>Создание и редактирование потоков, а также управление ими
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>См. соответствующее [обучение Microsoft](/training/modules/use-power-automate/)
