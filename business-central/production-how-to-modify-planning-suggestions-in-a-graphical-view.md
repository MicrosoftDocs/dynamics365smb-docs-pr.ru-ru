...
ms.locfileid: "3786025"
---
# <a name="modify-planning-suggestions-in-a-graphical-view"></a><span data-ttu-id="636c4-104">Изменение предложений по планированию в графическом виде</span><span class="sxs-lookup"><span data-stu-id="636c4-104">Modify Planning Suggestions in a Graphical View</span></span>

<span data-ttu-id="636c4-105">Типичное действие планирования — изменить или добавить строки журнала планирования для изменения предлагаемых заказов на поставку до того, как они будут зафиксированы выполнением функции **Выполнить указание**.</span><span class="sxs-lookup"><span data-stu-id="636c4-105">A typical planning activity is to change or add planning worksheet lines to modify the suggested supply orders before you commit them by running the **Carry out Action Message** function.</span></span> <span data-ttu-id="636c4-106">Альтернатива такому действию в журнале планирования — использовать графическое представление.</span><span class="sxs-lookup"><span data-stu-id="636c4-106">An alternative to doing this in the planning worksheet is to use a graphical view.</span></span> <span data-ttu-id="636c4-107">Однако в настоящее время в [!INCLUDE[prodshort](includes/prodshort.md)] это не поддерживается.</span><span class="sxs-lookup"><span data-stu-id="636c4-107">However, this is currently not supported in [!INCLUDE[prodshort](includes/prodshort.md)].</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="636c4-108">См. также</span><span class="sxs-lookup"><span data-stu-id="636c4-108">See Also</span></span>

[<span data-ttu-id="636c4-109">Планирование</span><span class="sxs-lookup"><span data-stu-id="636c4-109">Planning</span></span>](production-planning.md)  
[<span data-ttu-id="636c4-110">Настройка производства</span><span class="sxs-lookup"><span data-stu-id="636c4-110">Setting Up Manufacturing</span></span>](production-configure-production-processes.md)  
[<span data-ttu-id="636c4-111">Производство</span><span class="sxs-lookup"><span data-stu-id="636c4-111">Manufacturing</span></span>](production-manage-manufacturing.md)  
[<span data-ttu-id="636c4-112">Наличие</span><span class="sxs-lookup"><span data-stu-id="636c4-112">Inventory</span></span>](inventory-manage-inventory.md)  
[<span data-ttu-id="636c4-113">Покупки</span><span class="sxs-lookup"><span data-stu-id="636c4-113">Purchasing</span></span>](purchasing-manage-purchasing.md)  
[<span data-ttu-id="636c4-114">Сведения о проектировании: планирование поставок</span><span class="sxs-lookup"><span data-stu-id="636c4-114">Design Details: Supply Planning</span></span>](design-details-supply-planning.md)  
[<span data-ttu-id="636c4-115">Рекомендации по настройке. Планирование поставок</span><span class="sxs-lookup"><span data-stu-id="636c4-115">Setup Best Practices: Supply Planning</span></span>](setup-best-practices-supply-planning.md)  
<span data-ttu-id="636c4-116">[Работа с [!INCLUDE[d365fin](includes/d365fin_md.md)]](ui-work-product.md)</span><span class="sxs-lookup"><span data-stu-id="636c4-116">[Working with [!INCLUDE[d365fin](includes/d365fin_md.md)]](ui-work-product.md)</span></span>
