...
ms.author: edupont
---
# <a name="modify-planning-suggestions-in-a-graphical-view"></a><a name="modify-planning-suggestions-in-a-graphical-view"></a><a name="modify-planning-suggestions-in-a-graphical-view"></a>Изменение предложений по планированию в графическом виде
