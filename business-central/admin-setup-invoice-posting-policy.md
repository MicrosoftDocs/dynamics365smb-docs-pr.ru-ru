...
# <a name="define-an-invoice-posting-policy-for-users" />Определение политики учета счетов для пользователей
...
## <a name="to-specify-a-posting-policy" />Указание политики учета
...
## <a name="effect-on-documents" />Влияние на документы
