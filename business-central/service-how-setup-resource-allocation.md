...
# <a name="set-up-resource-allocation" />Настройка распределения ресурсов
...
## <a name="to-set-up-skills" />Настройка навыков
...
## <a name="to-assign-skills-to-service-items-and-resources" />Назначение квалификации сервисным товарам и ресурсам
...
## <a name="to-set-up-zones" />Настройка зон
...
## <a name="to-assign-zones-to-customers-and-resources" />Назначение зон клиентам и ресурсам
...
## <a name="to-specify-what-to-show-when-a-resource-is-chosen" />Указание, что должно отображаться при выборе ресурса
...
## <a name="to-update-resource-capacity" />Обновление производственной мощности ресурсов
...
## <a name="to-update-skills-for-items-service-items-or-service-item-groups" />Обновление квалификации для товаров, сервисных товаров или групп сервисных товаров
