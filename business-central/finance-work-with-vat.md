...
При выборе номенклатурного номера в поле **Номер** документа на продажу [!INCLUDE[prod_short](includes/prod_short.md)] заполняет также поле **Цена единицы**. Цена за единицу берется с карточки **Товар** или из цен, разрешенных для данного продукта и клиента. [!INCLUDE[prod_short](includes/prod_short.md)] рассчитывает значение **Сумма строки** только после ввода количества в данную строку.  
