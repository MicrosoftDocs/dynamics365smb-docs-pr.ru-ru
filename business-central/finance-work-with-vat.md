...
#### <a name="using-vat-business-posting-groups-and-customer-price-groups"></a>Использование учетных бизнес-групп НДС и групп цен клиентов 
...
### <a name="correcting-vat-date-in-posted-entries"></a>Коррекция даты НДС с учтенных операциях
В некоторых случаях необходимо изменить дату НДС, даже если документ был проведен, и это можно сделать в [!INCLUDE[prod_short](includes/prod_short.md)]. Чтобы изменить значение **Дата НДС** для проведенных документов, необходимо выполнить следующие действия:
...
4. Закрытие страницы.
5. Новая дата НДС будет изменена в соответствующих полях **Записи ГК** и в проведенном документе, если он существует.
