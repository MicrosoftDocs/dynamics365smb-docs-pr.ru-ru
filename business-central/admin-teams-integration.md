...
# <a name="managing-microsoft-teams-integration-with-"></a><a name="managing-microsoft-teams-integration-with-"></a><a name="managing-microsoft-teams-integration-with-"></a>Управление интеграцией Microsoft Teams с [!INCLUDE [prod_short](includes/prod_short.md)]
...
## <a name="in-microsoft-teams"></a><a name="in-microsoft-teams"></a><a name="in-microsoft-teams"></a>В Microsoft Teams
...
### <a name="managing-the--app-optional"></a><a name="managing-the--app-optional"></a><a name="managing-the--app-optional"></a>Управление приложением [!INCLUDE [prod_short](includes/prod_short.md)] (необязательно)
...
## <a name="in-"></a><a name="in-"></a><a name="in-"></a>В [!INCLUDE [prod_short](includes/prod_short.md)]

### <a name="minimum-requirements-1"></a><a name="minimum-requirements-1"></a><a name="minimum-requirements-1"></a>Минимальные требования
...
## <a name="installing-the-business-central-app-by-using-centralized-deployment"></a><a name="installing-the-business-central-app-by-using-centralized-deployment"></a><a name="installing-the-business-central-app-by-using-centralized-deployment"></a>Установка приложения Business Central с помощью централизованного развертывания
...
## <a name="managing-privacy-and-compliance"></a><a name="managing-privacy-and-compliance"></a><a name="managing-privacy-and-compliance"></a>Управление конфиденциальностью и соблюдением требований
...
### <a name="understanding-where--cards-are-stored"></a><a name="understanding-where--cards-are-stored"></a><a name="understanding-where--cards-are-stored"></a>Сведения о том, где хранятся карточки [!INCLUDE [prod_short](includes/prod_short.md)]
...
### <a name="restricting-sharing-of-cards"></a><a name="restricting-sharing-of-cards"></a><a name="restricting-sharing-of-cards"></a>Ограничение доступа к карточкам
...
### <a name="responding-to-data-requests"></a><a name="responding-to-data-requests"></a><a name="responding-to-data-requests"></a>Ответы на запросы данных
...
## <a name="show-or-hide-record-data-on-cards"></a><a name="show-or-hide-record-data-on-cards"></a><a name="show-or-hide-record-data-on-cards"></a>Отображение или скрытие данных записей на карточках
