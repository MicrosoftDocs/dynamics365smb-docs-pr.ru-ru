...
> [!NOTE]
> Для настройки централизованного развертывания ваша учетная запись Teams должна иметь как минимум роль [Администратор Teams](/entra/identity/role-based-access-control/permissions-reference#teams-administrator].
