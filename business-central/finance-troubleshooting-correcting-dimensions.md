...
# <a name="troubleshoot-and-correct-dimensions"></a>Диагностика и исправление измерений
...
### <a name="set-up-dimension-corrections"></a>Настройка корректировок измерений
...
### <a name="correct-a-dimension"></a>Корректировка измерения
...
### <a name="validate-dimension-corrections"></a>Проверка корректировок измерений
...
### <a name="undo-a-correction"></a>Отмена корректировки
...
### <a name="view-historical-dimension-corrections"></a>Просмотр исторических корректировок измерений
...
### <a name="handle-incomplete-corrections"></a>Обработка незавершенных корректировок
