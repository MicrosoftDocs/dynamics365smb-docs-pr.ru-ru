...
5. Чтобы проверить исправление, выберите **Проверить изменения измерений**. Для получения дополнительной информации см. раздел [Проверка корректировок измерений](finance-troubleshooting-correcting-dimensions.md#validate-dimension-corrections).
