...
# Устранение неполадок и исправление измерений
...
## Изменение назначений измерений после разноски
...
### Корректировки измерений для больших наборов данных
...
### Использование аналитических представлений с коррекциями измерений
...
### Использование учета затрат с исправленными записями главной книги
...
## См. соответствующее [обучение Microsoft](/training/modules/dimensions-dynamics-365-business-central/)
