...
### <a name="use-analysis-views-with-dimension-corrections"></a>Использование аналитических представлений с коррекциями измерений
...
### <a name="use-cost-accounting-with-corrected-gl-entries"></a>Использование учета затрат с исправленными записями главной книги
