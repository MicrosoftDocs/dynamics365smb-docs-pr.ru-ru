---
title: Диагностика и исправление измерений
...
# <a name="troubleshooting-and-correcting-dimensions"></a>Диагностика и исправление измерений
...
1. Чтобы начать корректировку измерений, используйте одну из следующих страниц:
    ...
    * На странице **Регистр ГК**, выбрав регистр, а затем выбрав действие **Корректировать измерения**. Это действие запускает корректировку операций в выбранном регистре.
...
### <a name="undoing-a-correction"></a>Отмена корректировки
