...
# <a name="troubleshooting-and-correcting-dimensions" />Устранение неполадок и исправление измерений
...
## <a name="troubleshooting-dimensions-errors" />Устранение ошибок измерений
...
## <a name="changing-dimension-assignments-after-posting" />Изменение назначений измерений после разноски
...
### <a name="setting-up-dimension-corrections" />Настройка корректировок измерений
...
### <a name="correcting-a-dimension" />Корректировка измерения
...
### <a name="validating-dimension-corrections" />Проверка корректировок измерений
...
### <a name="undoing-a-correction" />Отмена коррекции
...
### <a name="dimension-corrections-on-large-data-sets" />Корректировки измерений для больших наборов данных
...
### <a name="use-analysis-views-with-dimension-corrections" />Использование аналитических представлений с коррекциями измерений
...
### <a name="viewing-historical-dimension-corrections" />Просмотр исторических корректировок измерений
...
### <a name="handling-incomplete-corrections" />Обработка незавершенных корректировок
...
### <a name="use-cost-accounting-with-corrected-gl-entries" />Использование учета затрат с исправленными записями главной книги
...
## <a name="see-related-microsoft-trainingtrainingmodulesdimensions-dynamics-365-business-central" />См. соответствующее [обучение Microsoft](/training/modules/dimensions-dynamics-365-business-central/)
