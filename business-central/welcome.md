...
ms.author: jswymer
---
# <a name="welcome-to-includeprodlongincludesprodlongmd" />Добро пожаловать в [!INCLUDE[prod_long](includes/prod_long.md)]
...
## <a name="see-related-microsoft-learn-trainingtrainingdynamics365business-centralwtmciddyn365bclandingpage-docs" />См. соответствующее [обучение Microsoft Learn](/training/dynamics365/business-central?WT.mc_id=dyn365bc_landingpage-docs)
