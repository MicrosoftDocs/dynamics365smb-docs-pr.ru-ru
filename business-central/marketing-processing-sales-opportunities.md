...
ms.author: jswymer
---
# <a name="process-sales-opportunities" />Обработка возможностей продаж
После создания возможности есть ряд функций для управления возможностью и ее перемещения по этапам до завершения.

## <a name="to-view-opportunities" />Просмотр возможностей
...
## <a name="to-close-opportunities" />Закрытие возможностей
...
## <a name="to-create-quotes-for-opportunities" />Создание предложений для возможностей
> [!NOTE]
...
## <a name="to-create-sales-orders-for-opportunities" />Создание заказов на продажу для возможностей
...
## <a name="to-delete-opportunities" />Удаление возможностей
...
## <a name="to-move-an-opportunity-through-sales-cycle-stages" />Перемещение возможности по этапам цикла продаж
