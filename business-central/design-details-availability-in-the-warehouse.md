...
---
# <a name="design-details-availability-in-the-warehouse" />Сведения о проектировании: наличие на складе
...
## <a name="bin-content-and-reservations" />Содержимое ячейки и резервирования
...
## <a name="quantity-available-to-pick" />Количество, доступное для подбора
...
### <a name="calculating-the-quantity-available-to-pick" />Расчет количества, доступного для подбора
...
## <a name="quantity-available-to-reserve" />Количество, доступное для резервирования
...
### <a name="calculating-the-quantity-available-to-reserve" />Расчет количества, доступного для резервирования
