...
ms.author: edupont
---
# <a name="record-payments-and-refunds-in-the-payment-journal" />Запись платежей и возмещения в журнале платежей
...
## <a name="to-make-payments-in-the-payment-journal" />Чтобы сделать оплату в журнале платежей
...
## <a name="to-issue-a-refund-check" />Оформить чек на возврат
