...
ms.author: edupont
---
# <a name="record-payments-and-refunds-in-the-payment-journal"></a><a name="record-payments-and-refunds-in-the-payment-journal"></a>Запись платежей и возмещения в журнале платежей
...
## <a name="to-make-payments-in-the-payment-journal"></a><a name="to-make-payments-in-the-payment-journal"></a>Чтобы сделать оплату в журнале платежей
...
## <a name="to-issue-a-refund-check"></a><a name="to-issue-a-refund-check"></a>Оформить чек на возврат
