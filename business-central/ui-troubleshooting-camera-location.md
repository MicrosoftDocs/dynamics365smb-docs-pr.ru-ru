...
# <a name="troubleshooting-accessing-camera-and-location"></a><a name="troubleshooting-accessing-camera-and-location"></a>Устранение неполадок: доступ к камере и геопозиции
...
## <a name="device-must-have-camera-and-location-capabilities"></a><a name="device-must-have-camera-and-location-capabilities"></a>На устройстве должны быть камера и механизм определения геопозиции
...
## <a name="access-permissions-not-enabled"></a><a name="access-permissions-not-enabled"></a>Не даны разрешения на доступ
...
## <a name="web-client-connection-not-secure"></a><a name="web-client-connection-not-secure"></a>Соединение с веб-клиентом небезопасно
...
## <a name="work-with-virtualization-technologies"></a><a name="work-with-virtualization-technologies"></a>Работа с технологиями виртуализации
...
## <a name="antivirus-software"></a><a name="antivirus-software"></a>Антивирусное программное обеспечение
