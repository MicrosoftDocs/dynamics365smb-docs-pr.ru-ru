...
ms.author: edupont
---
# <a name="restructure-warehouses" />Изменение структуры складов
...
## <a name="to-restructure-a-basic-warehouse-that-uses-bins-only" />Изменение структуры основного склада, для которого используются только ячейки
...
## <a name="to-restructure-an-advanced-warehouse-that-uses-directed-put-away-and-pick" />Изменение структуры склада расширенной конфигурации, для которого используются расширенные подбор и размещение
...
## <a name="to-delete-a-bin" />Удаление ячейки
...
## <a name="to-rename-a-bin-and-change-the-bin-code-in-all-records" />Удаление ячейки и изменение кода ячейки во всех записях
