...
1. Выберите значок ![Лампочка, которая открывает функцию Что вы хотите сделать](media/ui-search/search_small.png "Что вы хотите сделать"), введите **Изменить глобальные измерения**, затем выберите связанную ссылку.
2. Наводите указатель на действия и поля на странице, чтобы узнать, как изменять глобальные измерения и ярлыки измерений.
