...
> [!NOTE]
> Аналитические представления часто используют данные из измерений. Если вы обнаружите, что в разнесенных записях главной книги использовалось неверное измерение, вы можете исправить значения измерений и обновить аналитические представления. Это поможет поддерживать точность ваших финансовых отчетов и анализов. Дополнительную информацию см. в разделе [Устранение неполадок и исправление измерений](finance-troubleshooting-correcting-dimensions.md#changing-dimension-assignments-after-posting)
...
1. Выберите ![Лампочка, которая открывает функцию Что вы хотите сделать.](media/ui-search/search_small.png "Что вы хотите сделать") значок введите **Измерения**, а затем выберите связанную ссылку.  
...
1. Выберите ![Лампочка, которая открывает функцию Что вы хотите сделать.](media/ui-search/search_small.png "Что вы хотите сделать") значок, введите **Приоритеты измерения по умолчанию**, а затем выберите связанную ссылку.  
...
7. Выберите действие **Запуск**, чтобы начать параллельную обработку изменений измерений. <!--is this also dependent on the mode?-->
