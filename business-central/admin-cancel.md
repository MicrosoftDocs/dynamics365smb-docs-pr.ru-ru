...
ms.author: edupont
---
# <a name="unsubscribe-or-remove-includeprodshortincludesprodshortmd" />Отмена подписки или удаление [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="removing-includeprodshortincludesprodshortmd-from-your-app-launcher" />Удаление [!INCLUDE[prod_short](includes/prod_short.md)] из средства запуска приложений
