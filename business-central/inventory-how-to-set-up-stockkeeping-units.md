...
# <a name="set-up-stockkeeping-units" />Настройка единиц хранения
...
## <a name="to-set-up-a-stockkeeping-unit" />Настройка единицы хранения
...
## <a name="see-related-microsoft-trainingtrainingmodulescontrol-inventory-multiple-locations" />См. соответствующее [обучение Microsoft](/training/modules/control-inventory-multiple-locations/)
