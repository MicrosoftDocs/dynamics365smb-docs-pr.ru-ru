...
ms.author: bholtorf
---
# <a name="status-field-on-documents"></a><a name="status-field-on-documents"></a><a name="status-field-on-documents"></a>Поле статуса на документах
...
## <a name="release-process"></a><a name="release-process"></a><a name="release-process"></a>Процесс выпуска
...
### <a name="approval-procedures"></a><a name="approval-procedures"></a><a name="approval-procedures"></a>Процедуры утверждения
...
### <a name="warehouse-activities"></a><a name="warehouse-activities"></a><a name="warehouse-activities"></a>Складские задания
...
## <a name="reopen-a-released-order"></a><a name="reopen-a-released-order"></a><a name="reopen-a-released-order"></a>Повторное открытие выпущенного заказа
