...
# <a name="the-payments-and-reconciliations-dk-extension" />Расширение платежей и выверки (DK)
...
## <a name="supported-bank-formats" />Поддерживаемые банковские форматы
...
## <a name="to-set-up-the-extension" />Настройка расширения
...
### <a name="to-allow-includeprodshortincludesprodshortmd-to-export-payment-data" />Чтобы разрешить [!INCLUDE[prod_short](includes/prod_short.md)] экспортировать данные платежей
...
### <a name="to-specify-a-payment-method-for-a-vendor" />Указание способ оплаты для поставщика
...
### <a name="to-specify-the-format-to-use-for-a-bank-account" />Указание формата для использования для банковского счета
...
## <a name="choosing-the-fik-or-giro-payment-information-for-vendor-invoices" />Выбор информации о платеже FIK или Жиро для счета поставщика
...
## <a name="to-use-the-extension-to-export-payment-data" />Использование расширения для экспорта данных платежа
