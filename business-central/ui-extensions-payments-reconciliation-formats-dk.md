...
### <a name="to-allow-included365finincludesd365fin_mdmd-to-export-payment-data"></a>Чтобы разрешить [!INCLUDE[d365fin](includes/d365fin_md.md)] экспортировать данные платежей
