...
---
# <a name="power-bi-integration-component-and-architecture-overview"></a>Обзор компонентов и архитектуры интеграции Power BI для [!INCLUDE[prod_short](includes/prod_short.md)]
