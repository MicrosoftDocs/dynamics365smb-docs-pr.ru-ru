...
ms.author: edupont
---
# <a name="manage-job-supplies" />Управление запасами для работы
...
## <a name="to-purchase-items-or-services-for-a-job" />Приобретение товаров или услуг для работы
...
## <a name="to-view-the-value-of-purchases-for-a-job" />Просмотр значения покупок для работы
...
## <a name="to-post-a-job-related-expense" />Учет связанных с работой расходов
