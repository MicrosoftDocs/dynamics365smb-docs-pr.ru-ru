...
---
# <a name="manage-project-supplies"></a>Управление запасами для работы
...
## <a name="to-purchase-items-or-services-for-a-project"></a>Приобретение товаров или услуг для работы
...
## <a name="to-view-the-value-of-purchases-for-a-project"></a>Просмотр значения покупок для работы
...
## <a name="to-post-a-project-related-expense"></a>Учет связанных с работой расходов
