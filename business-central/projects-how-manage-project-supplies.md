...
ms.author: edupont
---
# <a name="manage-job-supplies"></a><a name="manage-job-supplies"></a>Управление запасами для работы
...
## <a name="to-purchase-items-or-services-for-a-job"></a><a name="to-purchase-items-or-services-for-a-job"></a>Приобретение товаров или услуг для работы
...
## <a name="to-view-the-value-of-purchases-for-a-job"></a><a name="to-view-the-value-of-purchases-for-a-job"></a>Просмотр значения покупок для работы
...
## <a name="to-post-a-job-related-expense"></a><a name="to-post-a-job-related-expense"></a>Учет связанных с работой расходов
