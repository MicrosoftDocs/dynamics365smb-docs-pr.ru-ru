---
title: Управление запасами для работы
description: 'Описываются разные способы, как управлять запасами и закупками материалов и услуг для работ.'
author: SorenGP
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
...
ms.author: edupont
---
# <a name="manage-job-supplies"></a><a name="manage-job-supplies"></a><a name="manage-job-supplies"></a>Управление запасами для работы
...
Если в процессе покупки не требуется отдельная запись физической транзакции, то покупка может быть обработана на странице **Журнал ГК работы**. Для получения дополнительной информации см. [Учет связанных с работой расходов](projects-how-manage-project-supplies.md#to-post-a-job-related-expense).

## <a name="to-purchase-items-or-services-for-a-job"></a><a name="to-purchase-items-or-services-for-a-job"></a><a name="to-purchase-items-or-services-for-a-job"></a>Приобретение товаров или услуг для работы
...
## <a name="to-view-the-value-of-purchases-for-a-job"></a><a name="to-view-the-value-of-purchases-for-a-job"></a><a name="to-view-the-value-of-purchases-for-a-job"></a>Просмотр значения покупок для работы
...
## <a name="to-post-a-job-related-expense"></a><a name="to-post-a-job-related-expense"></a><a name="to-post-a-job-related-expense"></a>Учет связанных с работой расходов
...
1. Выберите ![Лампочка, которая открывает функцию Что вы хотите сделать.](media/ui-search/search_small.png "Что вы хотите сделать") значок, введите **Журналы ГК работ**, а затем выберите связанную ссылку.  
