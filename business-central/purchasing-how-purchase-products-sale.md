...
ms.author: edupont
---
# <a name="purchase-items-for-a-sale-by-creating-purchase-invoices" />Покупка товаров для продажи путем создания счетов покупки
...
## <a name="to-create-one-or-more-purchase-orders-from-a-sales-order" />Создание одного или нескольких заказов на покупку из заказа на продажу
...
## <a name="to-create-a-purchase-invoice-from-a-sales-order-or-sales-invoice" />Создание счета покупки из заказа на продажу или счета продажи
