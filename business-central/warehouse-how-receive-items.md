...
2. Выберите кнопку подстановки в поле **Код переприхода**.
3. Выберите действие **Создать**.
4. На странице **Коды переприхода** создайте одну или несколько новых строк, которые определяют различные политики переприхода. [!INCLUDE[tooltip-inline-tip](includes/tooltip-inline-tip_md.md)].
5. Выберите строку, затем нажмите кнопку **ОК**.
