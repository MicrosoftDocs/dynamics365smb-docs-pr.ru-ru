...
ms.author: edupont
---
# <a name="correct-or-cancel-unpaid-sales-invoices" />Исправление или отмена неоплаченных счетов продажи
...
## <a name="to-cancel-a-posted-sales-invoice" />Отмена учтенного счета продажи
...
## <a name="to-correct-a-posted-sales-invoice" />Коррекция учтенного счета продажи
