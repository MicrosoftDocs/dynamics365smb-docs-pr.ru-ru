...
ms.author: jswymer
---
# <a name="analyzing-report-data-with-excel-and-xml" />Анализ данных отчета с помощью Excel и XML
...
## <a name="more-about-excel-data-only" />Подробнее об Excel (только данные)
...
## <a name="for-administrators" />Для администраторов
...
## <a name="for-developers-and-advanced-users" />Для разработчиков и опытных пользователей
