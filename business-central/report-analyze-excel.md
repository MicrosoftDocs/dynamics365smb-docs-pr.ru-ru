...
ms.author: jswymer
---
# <a name="analyzing-report-data-with-excel-and-xml"></a><a name="analyzing-report-data-with-excel-and-xml"></a>Анализ данных отчета с помощью Excel и XML
...
## <a name="more-about-excel-data-only"></a><a name="more-about-excel-data-only"></a>Подробнее об Excel (только данные)
...
## <a name="for-administrators"></a><a name="for-administrators"></a>Для администраторов
...
## <a name="for-developers-and-advanced-users"></a><a name="for-developers-and-advanced-users"></a>Для разработчиков и опытных пользователей
