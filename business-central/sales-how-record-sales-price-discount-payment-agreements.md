...
* **Предл. цены продажи в журнале** предлагает изменения путем применения поправочного коэффициента к существующим ценам продажи или путем копирования существующих соглашений о ценах продажи для других клиентов, групп цен клиентов или кампаний продаж.
* **Предложить цены товаров в журнале** предлагает изменения, применяя поправочный коэффициент к существующим ценам за единицу в карточках товаров или предлагая цены для новых комбинаций валюты, единиц измерения и т. д. Это пакетное задание не изменяет цены за единицу для товара.  
...
После записи специальных цен и скидок строк для продаж и покупок, [!INCLUDE[d365fin](includes/d365fin_md.md)] гарантирует, что ваша прибыль всегда оптимальна. Он вычисляет наилучшую цену в документах о продаже и покупке, а также в строках журнала заданий и товаров.

Лучшая цена — это наиболее низкая допустимая цена с наиболее высокой допустимой скидкой строки на конкретную дату. [!INCLUDE[d365fin](includes/d365fin_md.md)] рассчитывает лучшие цены, когда вставляет цену за единицу и процент скидки по строке для товаров в строках нового документа и журнала.
...
2. [!INCLUDE[d365fin](includes/d365fin_md.md)] проверяет, применяются ли какие-либо соглашения о цене/скидке к информации в документе или строке журнала. Затем он вставляет применимую цену за единицу и процент скидки по строке, используя следующие критерии:
...
Для каждого клиента вы можете указать, будете ли вы предоставлять скидки по счету, если счет соответствует определенным критериям. Например, если сумма счета достаточно велика. Скидки счета могут быть настроены местной валюте для отечественных или в иностранной валюте для иностранных клиентов.  
