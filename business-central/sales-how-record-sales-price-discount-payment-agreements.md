...
1. В окне **Карточка клиента** выберите действие **Скидки по счету**. Откроется окно **Клиент - скидки по счету**.
...
6.  Нажмите кнопку **ОК** для заполнения строк в окне **Журнал цен продажи** предложенными новыми ценами, указав тем самым, что они действительны для выбранного **Типа продажи**.  
