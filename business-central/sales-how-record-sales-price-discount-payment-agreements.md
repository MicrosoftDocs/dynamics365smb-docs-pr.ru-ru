...
# <a name="record-special-sales-prices-and-discounts" />Регистрация специальных цен продажи и скидок
...
## <a name="to-set-up-a-sales-price-for-a-customer" />Настройка цены продажи для клиента
...
## <a name="using-sales-and-purchase-price-lists" />Использование прайс-листов продаж и покупки
...
### <a name="converting-existing-prices-when-you-turn-on-the-pricing-feature-update" />Преобразование существующих цен при включении обновления функции ценообразования
...
### <a name="editing-active-price-lists" />Редактирование активных прайс-листов
...
#### <a name="create-sales-price-lines-based-on-the-unit-price" />Создание строк цены продажи на основе цены за единицу
...
#### <a name="create-sales-price-lines-based-on-existing-price-lists" />Создание строк цены продажи на основе существующих прайс-листов
...
## <a name="sales-invoice-discounts-and-service-charges" />Скидки по счетам продажи и плата за сервисное обслуживание
...
## <a name="see-related-microsoft-trainingtrainingmodulesmanage-sales-prices-dynamics-365-business-centralindex" />См. соответствующее [обучение Microsoft](/training/modules/manage-sales-prices-dynamics-365-business-central/index)
