...
После того, как вы установите специальные цены, [!INCLUDE[prod_short](includes/prod_short.md)] может рассчитывать лучшие цены в документах продажи и покупки, а также в строках журнала заданий и товаров. Узнайте больше в разделе [Расчет лучшей цены](sales-how-record-sales-price-discount-payment-agreements.md#best-price-calculation).
