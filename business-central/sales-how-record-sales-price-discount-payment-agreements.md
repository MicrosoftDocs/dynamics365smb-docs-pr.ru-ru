...
После записи специальных цен и скидок строки по продажам и покупкам, [!INCLUDE[d365fin](includes/d365fin_md.md)] рассчитывает лучшую цену в документах продажи и покупки, а также в строках журнала заданий и товаров.

Лучшая цена — это наиболее низкая цена с наиболее высокой допустимой скидкой строки на конкретную дату. [!INCLUDE[d365fin](includes/d365fin_md.md)] рассчитывает лучшие цены, когда добавляет цену за единицу и процент скидки по строке в строках документа и журнала.
