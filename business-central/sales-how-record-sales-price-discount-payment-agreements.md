...
После настройки специальных цен [!INCLUDE[prod_short](includes/prod_short.md)] сможет рассчитывать лучшие цены в документах продажи и покупки, а также в строках журналов проектов и товаров. Узнайте больше в разделе [Расчет лучшей цены](sales-how-record-sales-price-discount-payment-agreements.md#best-price-calculation).
...
* Если вы хотите работать со всеми ценами на одной странице, включите его. Существующие цены конвертируются в один прайс-лист по умолчанию для каждого из следующих документов:
  ...
  * Покупки работы
  ...
  Вы можете редактировать все цены для этих областей на странице **Лист цен**. Прайс-листы по умолчанию устанавливаются на страницах **Настройка модуля «Продажи»**, **Настройка модуля «Покупки»** и **Настройка модуля «Проекты»**.
...
После записи специальных цен и скидок по строке для продаж и продуктов [!INCLUDE[prod_short](includes/prod_short.md)] рассчитывает лучшую цену в документах продажи и покупки, а также в строках журналов проектов и товаров.
