...
ms.author: edupont
---
# <a name="add-comments-to-cards-and-documents" />Добавление комментариев к картам и документам
...
## <a name="to-add-a-comments-to-an-item-card" />Для добавления комментариев в карточку товара
