...
### <a name="copying-a-project"></a>Копирование работы
...
1.  На карточке **Работа** для новой работы выберите действие **Строки задач проекта**.  
...
## <a name="creating-and-posting-a-project-sales-invoice"></a>Создание и учет счета продажи для работы
...
### <a name="to-create-a-project-sales-invoice"></a>Процедура создания счета продажи для работы
...
1.  Откройте работу, затем выберите действие **Строки планирования проекта**.  
...
### <a name="to-manage-fixed-pricing-in-projects"></a>Управление фиксированной ценой в работах
...
Будучи добавленной в график для данной строки задачи, Татьяна выполняет эту работу в течение 25 часов и вводит эти часы в журнал проектов.  
...
8. В окне **Журнал проектов** создайте новую строку со следующими данными. Убедитесь, что оба номера работ следуют непосредственно за уже использованными номерами:  
...
На странице **Копировать проект** можно выбрать работу и строки задач, которые необходимо скопировать. Кроме того, можно скопировать исходные операции книги проектов, что приведет к созданию строк планирования на основе фактического потребления, или скопировать строки планирования исходного проекта, что приведет к копированию в новую работу исходных строк планирования. Затем можно выбрать строку планирования или тип строки книги операций, которые необходимо добавить, выбрав только те данные, которые касаются этой новой работы. И, наконец, можно выбрать работу, в которую необходимо скопировать данные, и указать, следует ли также копировать цены и количества.  
...
Путем сравнения цен, строк задач проекта и строк планирования проекта для двух работ можно увидеть, что информация была успешно скопирована.  
...
4. На карточке **Работа** в разделе **Задачи** добавьте строки задач проекта, как описано в следующей таблице:  
