...
ms.author: edupont
---
# <a name="register-consumption-and-output-for-one-released-production-order-line" />Регистрация потребления и выхода для одной строки запущенного производственного заказа
...
## <a name="to-register-consumption-and-output" />Регистрация потребления и выхода продукции
