...
# <a name="troubleshooting-microsoft-teams-integration-with-include-prodshortincludesprodshortmd" />Устранение неполадок интеграции Microsoft Teams с [!INCLUDE [prod_short](includes/prod_short.md)]
...
## <a name="the-sign-in-link-doesnt-work" />Ссылка для входа не работает
...
## <a name="the-settings-page-is-empty" />Страница параметров пустая
...
## <a name="i-changed-company-but-it-didnt-seem-to-work" />Я сменил компанию, но, похоже, это не сработало
...
## <a name="something-went-wrong-error-when-searching-for-contacts" />Ошибка "Что-то пошло не так" при поиске контактов
...
## <a name="cannot-find-the-contactcontact-summary-api-error-when-searching-for-contacts" />Ошибка "Не удается найти контакт или API сводки контактов" при поиске контактов
...
## <a name="none-of-my-links-expand-into-a-card" />Ни одна из моих ссылок не разворачивается в карточку
...
## <a name="my-link-sometimes-doesnt-expand-into-a-card" />Моя ссылка иногда не расширяется в карточку
...
## <a name="the-details-window-opens-but-shows-an-error-before-details-are-shown" />Окно сведений открывается, но перед отображением сведений отображается ошибка
...
## <a name="im-having-problems-with-the-camera-or-location-in-teams" />У меня проблемы с камерой или местоположением в Teams
...
## <a name="teams-displays-mixed-languages-for-my-cards-and-card-details" />В Teams отображаются разные языки для моих карточек и сведений карточек
...
## <a name="i-edited-a-field-in-the-details-window-but-my-change-wasnt-saved" />Я отредактировал поле в окне сведений, но мои изменения не были сохранены
...
## <a name="a-new-tile-appeared-in-the-app-launcher-how-do-i-remove-it" />На панели средства запуска приложений появилась новая плитка. Как ее удалить?
...
## <a name="duplicate-text-in-the-share-to-teams-window" />Повторяющийся текст в окне «Поделиться в Teams»
...
## <a name="unable-to-sign-into-the-share-to-teams-window" />Невозможно войти в окно «Поделиться в Teams»
...
## <a name="my-cards-no-longer-have-a-popout-button" />На моих карточках больше нет всплывающей кнопки
...
## <a name="cant-pin-a-card-to-tab" />Не удается прикрепить карточку к вкладке
...
## <a name="someone-added-a-tab-but-the-tab-doesnt-show-up-for-me" />Кто-то добавил вкладку, но у меня она не отображается
...
## <a name="others-see-different-sorting-or-column-layout-than-what-the-tab-author-sees" />Другие пользователи видят другую сортировку или компоновку столбцов (не такие, как у автора)
