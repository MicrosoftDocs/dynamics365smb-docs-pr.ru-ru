...
ms.author: bholtorf
---
# <a name="calculate-dates-for-purchases" />Расчет дат для покупок
...
## <a name="calculating-with-a-requested-receipt-date" />Вычисление с требуемой датой приемки
...
## <a name="calculating-without-a-requested-receipt-date" />Вычисление без требуемой даты приемки
...
## <a name="default-values-for-lead-time-calculation" />Значения по умолчанию для расчета времени подготовки
...
## <a name="see-related-microsoft-training" />См. соответствующее [обучение Microsoft](/training/modules/estimate-receipt-dates-dynamics-365-business-central/)
