...
ms.author: edupont
---
# <a name="create-production-order-headers" />Создание заголовков производственных заказов
...
## <a name="to-create-a-production-order-header" />Создание заголовка производственного заказа
