...
ms.author: edupont
---
# <a name="register-employees" />Регистрация сотрудников
...
## <a name="adding-new-employees" />Добавление новых сотрудников
...
## <a name="to-set-up-an-employee" />Настройка сотрудника
...
## <a name="to-insert-a-picture-of-an-employee" />Вставка фотографии сотрудника
...
## <a name="to-register-various-information-about-an-employee" />Регистрация различной информации о сотруднике
