...
ms.author: edupont
---
# <a name="copy-existing-items-to-create-new-items" />Копирование существующих товаров для создания новых товаров
...
## <a name="to-copy-an-existing-item-to-a-new-item" />Для копирования имеющегося товара в новый товар
