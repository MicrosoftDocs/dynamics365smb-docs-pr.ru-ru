...
## <a name="set-up-prod_short-to-log-email-messages"></a>Настройка [!INCLUDE[prod_short](includes/prod_short.md)] для регистрации сообщений электронной почты
...
## <a name="connect-to-exchange-on-premises"></a>Подключение к локальной версии Exchange
## <a name="current-experience"></a>[Текущая версия](#tab/current-experience)
...
### <a name="prod_short-on-premises"></a>Локальная версия [!INCLUDE[prod_short](includes/prod_short.md)]
1. Выберите ![Лампочка, которая открывает функцию Что вы хотите сделать.](media/ui-search/search_small.png "Что вы хотите сделать") введите **Регистрация электронной почты**, а затем выберите связанную ссылку. 
