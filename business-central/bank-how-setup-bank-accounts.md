...
## <a name="to-set-up-bank-accounts"></a><a name="to-set-up-bank-accounts"></a>Настройка банковских счетов
...
## <a name="to-enter-an-opening-balance"></a><a name="to-enter-an-opening-balance"></a>Ввод начального сальдо
...
## <a name="to-set-up-your-bank-account-for-import-or-export-of-bank-files"></a><a name="to-set-up-your-bank-account-for-import-or-export-of-bank-files"></a>Настройка банковского счета для импорта или экспорта банковских файлов
...
## <a name="to-set-up-vendor-bank-accounts-for-export-of-bank-files"></a><a name="to-set-up-vendor-bank-accounts-for-export-of-bank-files"></a>Настройка банковских счетов поставщиков для экспорта банковских файлов
...
## <a name="changing-your-bank-account"></a><a name="changing-your-bank-account"></a>Изменение банковского счета
