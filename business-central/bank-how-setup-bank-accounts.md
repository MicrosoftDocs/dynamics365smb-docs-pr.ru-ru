...
Вы можете сэкономить время на вводе данных, сделав банковский счет счетом по умолчанию для использования в валюте, указанной для счета. Если вы это сделаете, счет будет назначен документам продаж и обслуживания, в которых используется валюта. Чтобы сделать счет по умолчанию для торговых и сервисных документов, на странице **Карточка банковского счета** включите **Использовать по умолчанию для валюты**. При необходимости вы можете выбрать другой счет при работе с документом.
...
## <a name="entering-an-opening-balance"></a>Ввод начального сальдо
