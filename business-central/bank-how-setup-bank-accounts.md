...
## <a name="to-set-up-bank-accounts" />Настройка банковских счетов
...
## <a name="to-enter-an-opening-balance" />Ввод начального сальдо
...
## <a name="to-set-up-your-bank-account-for-import-or-export-of-bank-files" />Настройка банковского счета для импорта или экспорта банковских файлов
...
## <a name="to-set-up-vendor-bank-accounts-for-export-of-bank-files" />Настройка банковских счетов поставщиков для экспорта банковских файлов
...
## <a name="changing-your-bank-account" />Изменение банковского счета
