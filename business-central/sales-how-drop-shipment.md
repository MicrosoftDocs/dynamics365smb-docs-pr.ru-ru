...
Теперь можно проинструктировать поставщика, чтобы он отгрузил товары клиенту, например, переслав заказ на покупку в виде файла PDF. Если ваш поставщик предоставляет номер для отслеживания или аналогичную информацию, вы можете записать эту информацию в строке заказа на покупку типа *Комментарий*.  
