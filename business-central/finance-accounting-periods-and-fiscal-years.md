...
ms.author: bholtorf
---
# <a name="work-with-accounting-periods-and-fiscal-years" />Работа с учетными периодами и финансовыми годами
...
## <a name="creating-a-new-fiscal-year" />Создание нового финансового года

Создавать учетные периоды можно массово с помощью пакетного задания **Создать финансовый год** или вручную.

### <a name="how-to-create-accounting-periods-in-bulk" />Массовое создание учетных периодов
...
### <a name="how-to-create-accounting-periods-manually" />Создание учетных периодов вручную
...
## <a name="closing-a-fiscal-year" />Закрытие финансового года
...
## <a name="posting-entries-to-a-closed-fiscal-year" />Учет операций в закрытом финансовому году
