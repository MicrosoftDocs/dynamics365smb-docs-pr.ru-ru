...
ms.author: edupont
---
# <a name="available-fonts" />Доступные шрифты
...
## <a name="document-fonts" />Шрифты документов
...
## <a name="fonts-for-checks" />Шрифты для чеков
...
## <a name="fonts-for-barcodes" />Шрифты для штрих-кодов
