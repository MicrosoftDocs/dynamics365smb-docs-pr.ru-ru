...
ms.author: edupont
---
# <a name="available-fonts"></a><a name="available-fonts"></a><a name="available-fonts"></a>Доступные шрифты
...
## <a name="document-fonts"></a><a name="document-fonts"></a><a name="document-fonts"></a>Шрифты документов
...
## <a name="fonts-for-checks"></a><a name="fonts-for-checks"></a><a name="fonts-for-checks"></a>Шрифты для чеков
...
## <a name="fonts-for-barcodes"></a><a name="fonts-for-barcodes"></a><a name="fonts-for-barcodes"></a>Шрифты для штрих-кодов
...
[Шрифты штрих-кода в Business Central Online](/dynamics365/business-central/dev-itpro/developer/devenv-report-barcode-fonts)
