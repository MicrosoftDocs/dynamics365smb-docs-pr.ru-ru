...
---
# <a name="set-up-customer-discount-groups" />Настройка групп скидок клиента
...
## <a name="create-sales-line-discounts-for-a-customer-group" />Создание скидок по строкам продажи для группы клиентов
...
## <a name="assign-a-customer-to-a-discount-group" />Назначение клиента в группу скидок
