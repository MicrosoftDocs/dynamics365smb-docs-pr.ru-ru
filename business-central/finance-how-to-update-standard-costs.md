---
title: Обновление стандартных затрат
...
4.  Просмотрите и опубликуйте страницу **Журналы переоценки позиций**, которая заполнена записями из предыдущих этапов этого процесса.  
