...
ms.author: bholtorf
---
# <a name="connect-to-microsoft-dataverse" />Подключение к Microsoft Dataverse
...
### <a name="to-use-the-dataverse-connection-setup-assisted-setup-guide" />Использование мастера настройки подключения Dataverse
...
### <a name="to-create-or-maintain-the-connection-manually" />Создание или ведение подключения вручную
...
<!--
## <a name="show-me-the-process" />Show Me the Process
...
## <a name="customize-the-match-based-coupling" />Настройка связывания на основе совпадений
...
### <a name="view-the-results-of-the-coupling-job" />Посмотреть результаты задания соединения
...
## <a name="upgrade-connections-from-business-central-online-to-use-certificate-based-authentication" />Обновление подключений к Business Central Online для использования аутентификации на основе сертификатов
...
### <a name="to-upgrade-your-business-central-online-connection-to-use-certificate-based-authentication" />Обновление подключения Business Central Online для использования аутентификации на основе сертификатов
...
## <a name="connecting-on-premises-versions" />Подключение локальных версий
...
### <a name="to-register-an-application-in-azure-ad-for-connecting-from-business-central-to-dataverse" />Чтобы зарегистрировать заявку в Azure AD для подключения из Business Central к Dataverse
