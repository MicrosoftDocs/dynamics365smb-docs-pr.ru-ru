...
## <a name="link-your-business-central-and-dataverse-environments"></a>Связывание сред Business Central и Dataverse
...
## <a name="allow-for-different-currencies"></a>Использование разных валют
...
### <a name="to-register-an-application-in-microsoft-entra-id-for-connecting-from-business-central-to-dataverse"></a>Регистрация приложения в Microsoft Entra ID для подключения из Business Central к Dataverse
