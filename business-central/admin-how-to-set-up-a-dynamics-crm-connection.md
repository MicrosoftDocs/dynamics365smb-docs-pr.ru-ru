...
## <a name="set-up-test-and-enable-a-connection-to-includecrmmdincludescrmmdmd"></a>Настройка, тестирование и активизация подключения к [!INCLUDE[crm_md](includes/crm_md.md)]  
