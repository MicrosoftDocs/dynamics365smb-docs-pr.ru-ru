...
> [!NOTE]
> Нельзя изменить метод учета себестоимости товара, если для этого товара существуют операции книги товаров.<br /><br />
> Здесь информация будет опубликована скоро о временных решениях для изменения метода учета себестоимости в особенных ситуациях.
...
|<!--blank -->|FIFO|Среднее|Стандартное|Определенный|  
|-|----------|-------------|--------------|--------------|  
