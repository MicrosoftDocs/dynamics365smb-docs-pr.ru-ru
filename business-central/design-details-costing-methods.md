...
ms.author: bholtorf
---
# <a name="design-details-costing-methods" />Сведения о проектировании: методы учета себестоимости

Методом учета себестоимости определяется, будет ли фактическая или бюджетная стоимость выделяться заглавными буквами, или использована при расчете себестоимости. Наряду с датой и порядком учета метод учета себестоимости также влияет на способ записи потока затрат.
...
### <a name="effect-of-costing-methods-on-valuing-inventory-increases" />Влияние методов расчета себестоимости на оценку приходов склада
...
#### <a name="standard" />Стандартная

Для товаров, использующих метод учета себестоимости **По стандартной**, приходы склада оцениваются по текущей стандартной себестоимости товара.  

### <a name="effect-of-costing-methods-on-valuing-inventory-decreases" />Влияние методов расчета себестоимости на оценку расходов склада
