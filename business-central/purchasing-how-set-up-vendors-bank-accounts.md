...
---
# <a name="set-up-vendor-bank-accounts" />Настройка банковских счетов поставщика
...
## <a name="add-or-edit-a-vendor-bank-account" />Добавление и изменение банковского счета поставщика
...
## <a name="set-up-a-preferred-vendor-bank-account" />Настройка предпочтительного банковского счета поставщика
