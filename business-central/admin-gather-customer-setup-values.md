...
1. Выберите ![Лампочка, которая открывает функцию Что вы хотите сделать.](media/ui-search/search_small.png "Что вы хотите сделать") значок введите **Анкета конфигурации**, а затем выберите связанную ссылку.  
...
2. Выберите ![Лампочка, которая открывает функцию Что вы хотите сделать.](media/ui-search/search_small.png "Что вы хотите сделать") значок введите **Анкета конфигурации**, а затем выберите связанную ссылку.  
...
1. Выберите ![Лампочка, которая открывает функцию Что вы хотите сделать.](media/ui-search/search_small.png "Что вы хотите сделать") значок введите **Анкета конфигурации**, а затем выберите связанную ссылку. Откроется страница **Анкета конфигурации**.  
