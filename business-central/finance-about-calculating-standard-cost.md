...
ms.author: edupont
---
# <a name="about-calculating-standard-cost"></a><a name="about-calculating-standard-cost"></a>О расчете стандартной себестоимости
...
## <a name="setting-up-standard-costs"></a><a name="setting-up-standard-costs"></a>Настройка стандартных себестоимостей
...
### <a name="material-costs"></a><a name="material-costs"></a>Затраты на материалы
...
### <a name="capacity-costs"></a><a name="capacity-costs"></a>Затраты на производственные мощности
...
### <a name="subcontractor-costs"></a><a name="subcontractor-costs"></a>Затраты на субподряд
...
## <a name="updating-standard-costs"></a><a name="updating-standard-costs"></a>Обновление стандартных себестоимостей
