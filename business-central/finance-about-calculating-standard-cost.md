...
ms.author: edupont
---
# <a name="about-calculating-standard-cost" />О расчете стандартной себестоимости
...
## <a name="setting-up-standard-costs" />Настройка стандартных себестоимостей
...
### <a name="material-costs" />Затраты на материалы
...
### <a name="capacity-costs" />Затраты на производственные мощности
...
### <a name="subcontractor-costs" />Затраты на субподряд
...
## <a name="updating-standard-costs" />Обновление стандартных себестоимостей
