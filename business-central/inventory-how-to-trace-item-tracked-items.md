...
ms.author: edupont
---
# <a name="trace-item-tracked-items" />Трассировка товаров, трассируемых по товарам
...
## <a name="to-trace-item-tracked-items" />Трассировка товаров, трассируемых по товарам
...
## <a name="to-find-item-tracked-items-with-find-entries" />Поиск отслеживаемых товаров с помощью "Найти записи"
