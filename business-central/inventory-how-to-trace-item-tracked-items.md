---
title: Отслеживание отслеживаемых товаров
description: 'С помощью функций отслеживания предметов и поиска записей можно увидеть, где использовался отслеживаемый предмет, в том числе, как и когда он был получен, произведен или возвращен.'
author: brentholtorf
ms.topic: conceptual
ms.devlang: al
...
---
# <a name="trace-item-tracked-items"></a>Отслеживание отслеживаемых товаров
...
Эти функции могут быть полезны при контроле качества, когда вам необходимо выяснить, какие клиенты получили продукцию с определенным номером партии или когда вам необходимо выяснить, из какой партии поступил дефектный компонент.  
 ...
 На странице **Найти записи**  вы не можете увидеть последовательность транзакций, но вы можете увидеть все записи серийного номера или номера партии, как размещенные записи, так и открытые записи.  
...
2. Выберите **Поиск ссылок на элементы**.
