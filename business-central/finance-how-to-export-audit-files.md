...
# <a name="audit-file-export" />Экспорт файлов аудита
...
## <a name="set-up-audit-file-export" />Настройка экспорта файлов аудита
...
## <a name="provide-the-gl-account-mapping-for-audit-file-export" />Задание сопоставления счетов ГК для экспорта файла аудита
...
## <a name="export-the-audit-file" />Экспорт файла аудита
