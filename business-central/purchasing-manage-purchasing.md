...
## <a name="get-started-with-purchase-capabilities"></a>Начало работы с функциональностью для покупок
...
## <a name="purchase-analytics"></a>Аналитика покупок
...
## <a name="quote-to-order-to-purchase-invoice"></a>От предложения до заказа и счета покупки
