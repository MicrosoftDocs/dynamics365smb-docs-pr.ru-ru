...
# <a name="set-up-unrealized-vat-for-cash-based-accounting" />Настройка нереализованного НДС для учета на основании кассы
...
## <a name="to-use-general-ledger-accounts-for-unrealized-vat" />Использование счетов главной книги для нереализованного НДС
