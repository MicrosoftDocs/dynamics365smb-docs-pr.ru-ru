...
Во всех других аспектах заказы на продажу и счета продажи аналогичны. Дополнительные сведения о том, как использовать заказы на продажу, см. в разделе [Продажа продукции](sales-how-sell-products.md).
