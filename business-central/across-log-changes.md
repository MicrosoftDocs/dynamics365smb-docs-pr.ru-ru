...
ms.author: edupont
---
# <a name="auditing-changes-in-business-central"></a><a name="auditing-changes-in-business-central"></a>Изменение аудита в Business Central
...
## <a name="about-the-change-log"></a><a name="about-the-change-log"></a>О журнале изменений
...
### <a name="work-with-the-change-log"></a><a name="work-with-the-change-log"></a>Работа с журналом изменений
...
## <a name="about-activity-logs"></a><a name="about-activity-logs"></a>О журналах действий
...
### <a name="work-with-activity-logs"></a><a name="work-with-activity-logs"></a>Работа с журналами действий
...
## <a name="monitoring-sensitive-fields"></a><a name="monitoring-sensitive-fields"></a>Мониторинг конфиденциальных полей
...
### <a name="setting-up-field-monitoring"></a><a name="setting-up-field-monitoring"></a>Настройка мониторинга полей
...
### <a name="work-with-field-monitoring"></a><a name="work-with-field-monitoring"></a>Работа с мониторингом полей
...
### <a name="viewing-field-monitoring-telemetry"></a><a name="viewing-field-monitoring-telemetry"></a>Просмотр телеметрии мониторинга полей
...
## <a name="defining-retention-policies"></a><a name="defining-retention-policies"></a>Определение политик хранения
