...
Отслеживание изменений может негативно сказаться на быстродействии (что может стоить вам времени), а также привести к увеличению размера базы данных (что может стоить вам денег). Чтобы свести эти затраты к минимуму:
