...
---
# <a name="auditing-changes"></a>Аудит изменений
...
## <a name="setting-up-the-change-log"></a>Настройка журнала изменений
...
## <a name="analyze-data-in-the-change-log"></a>Анализ данных в журнале изменений
...
### <a name="change-log-ad-hoc-analysis-scenarios"></a>Сценарии ad-hoc-анализа данных журнала изменений
...
### <a name="example-who-changed-what-data-and-when"></a>Пример: кто изменил какие данные и когда
...
### <a name="example-data-changes-by-tablefield"></a>Пример: изменения данных по таблице/полю
...
## <a name="monitor-sensitive-fields"></a>Мониторинг конфиденциальных полей
...
### <a name="set-up-field-monitoring"></a>Настройка мониторинга полей
...
### <a name="view-field-monitoring-telemetry"></a>Просмотр телеметрии мониторинга полей
