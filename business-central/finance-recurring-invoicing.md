...
ms.author: andreipa
---
# <a name="work-with-recurring-revenue-in-" />Работа с повторяющимся доходом в [!INCLUDE[prod_short](includes/prod_short.md)]
...
### <a name="why-use-this-option-1" />Зачем использовать эту опцию
...
### <a name="why-use-this-option-2" />Зачем использовать эту опцию
...
### <a name="why-use-this-option-3" />Зачем использовать эту опцию
...
#### <a name="why-use-this-option-4" />Зачем использовать эту опцию
...
#### <a name="why-use-this-option-5" />Зачем использовать эту опцию
