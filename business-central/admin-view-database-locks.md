...
ms.author: jswymer
---
# <a name="viewing-database-locks"></a><a name="viewing-database-locks"></a>Просмотр блокировок базы данных
...
## <a name="to-view-database-locks"></a><a name="to-view-database-locks"></a>Для просмотра блокировок базы данных
