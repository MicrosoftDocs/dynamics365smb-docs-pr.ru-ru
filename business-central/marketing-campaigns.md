...
ms.author: edupont
---
# <a name="managing-marketing-campaigns" />Управление маркетинговыми кампаниями
...
## <a name="defining-individual-campaigns" />Определение отдельных кампаний
...
### <a name="registering-discount-percentages" />Регистрация процентов скидки
...
## <a name="conducting-campaigns" />Проведение кампаний
