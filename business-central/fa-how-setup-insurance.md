...
ms.author: edupont
---
# <a name="set-up-fixed-asset-insurance" />Настройка страхования основного средства
...
## <a name="to-set-up-general-insurance-information" />Настройка общей информации по страхованию
...
## <a name="to-set-up-insurance-types" />Настройка типов страхования
...
## <a name="to-set-up-insurance-cards" />Настройка карточек страхования
...
## <a name="to-set-up-insurance-journal-templates" />Настройка шаблонов журнала страхования
...
## <a name="to-set-up-insurance-journal-batches" />Настройка разделов журналов страхования
