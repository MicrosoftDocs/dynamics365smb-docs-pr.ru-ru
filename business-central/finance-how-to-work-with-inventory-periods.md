...
ms.author: edupont
---
# <a name="work-with-inventory-periods" />Работа с учетными периодами
...
## <a name="to-create-an-inventory-period" />Создание периода учета запасов
...
## <a name="closing-inventory-periods" />Закрытие периода учета запасов
...
### <a name="to-close-an-inventory-period" />Закрытие периода учета запасов
...
## <a name="reopening-inventory-periods" />Открытие учетных периодов
...
### <a name="to-reopen-an-inventory-period" />Повторное открытие периода учета запасов
1. Выберите ![Лампочка, которая открывает функцию Что вы хотите сделать.](media/ui-search/search_small.png "Что вы хотите сделать") значок введите **Периоды учета запасов**, а затем выберите связанную ссылку.  
