...
ms.author: edupont
---
# <a name="create-number-series" />Создание серий номеров
...
## <a name="gaps-in-number-series" />Пропуски в сериях номеров
...
## <a name="behavior-of-the-no-field-on-documents-and-cards" />Поведение поля "Номер" в документах и карточках
...
## <a name="to-create-a-new-number-series" />Создание новой серии номеров
...
## <a name="to-create-relationships-between-number-series" />Создание связей между сериями номеров
...
## <a name="to-set-up-where-a-number-series-is-used" />Настройка области использования серии номеров
...
## <a name="see-related-microsoft-trainingtrainingmodulesnumber-series-trail-codes-dynamics--business-centralindex" />См. соответствующее [обучение Microsoft](/training/modules/number-series-trail-codes-dynamics-365-business-central/index)
