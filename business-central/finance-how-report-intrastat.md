...
ms.author: altotovi
---
# <a name="work-with-intrastat-reporting"></a><a name="work-with-intrastat-reporting"></a>Работа с отчетностью Интрастат
...
## <a name="fill-in-the-intrastat-report"></a><a name="fill-in-the-intrastat-report"></a>Заполнение отчета Интрастат
...
## <a name="modify-the-intrastat-report"></a><a name="modify-the-intrastat-report"></a>Изменение отчета Интрастат
...
## <a name="validate-intrastat-lines"></a><a name="validate-intrastat-lines"></a>Проверка строк Интрастат
...
## <a name="recalculating-weight-or-supplementary-unit-of-measure"></a><a name="recalculating-weight-or-supplementary-unit-of-measure"></a>Пересчет веса или дополнительной единицы измерения
...
## <a name="intrastat-rules"></a><a name="intrastat-rules"></a>Правила Интрастат

### <a name="grouping-lines"></a><a name="grouping-lines"></a>Группирование строк
...
### <a name="fixed-assets-reporting"></a><a name="fixed-assets-reporting"></a>Отчеты по основным средствам
...
### <a name="intrastat-report-statuses"></a><a name="intrastat-report-statuses"></a>Статусы отчетов Интрастат
