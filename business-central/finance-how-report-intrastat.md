...
ms.author: altotovi
---
# <a name="work-with-intrastat-reporting" />Работа с отчетностью Интрастат
...
## <a name="fill-in-the-intrastat-report" />Заполнение отчета Интрастат
...
## <a name="modify-the-intrastat-report" />Изменение отчета Интрастат
...
## <a name="validate-intrastat-lines" />Проверка строк Интрастат
...
## <a name="recalculating-weight-or-supplementary-unit-of-measure" />Пересчет веса или дополнительной единицы измерения
...
## <a name="intrastat-rules" />Правила Интрастат

### <a name="grouping-lines" />Группирование строк
...
### <a name="fixed-assets-reporting" />Отчеты по основным средствам
...
### <a name="intrastat-report-statuses" />Статусы отчетов Интрастат
