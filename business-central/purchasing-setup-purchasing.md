...
ms.author: edupont
---
# <a name="setting-up-purchasing" />Настройка покупки
...
## <a name="purchases-and-payables-setup" />Настройка модуля "Покупки и поставщики"
...
### <a name="general-settings" />Общие настройки
...
### <a name="number-series-settings" />Параметры серий номеров
...
## <a name="exact-cost-reversing" />Точное сторнирование себестоимости
...
## <a name="more-purchasing-setups" />Дополнительные настройки покупки
...
## <a name="see-related-training-at-microsoft-learnlearnpathstrade-get-started-dynamics--business-central" />См. соответствующее обучение на странице [Microsoft Learn](/learn/paths/trade-get-started-dynamics-365-business-central/).
