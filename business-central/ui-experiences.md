...
Затем вы можете определить, к каким конкретным функциям и окнам в пределах функциональности имеют доступ эти пользователи, путем назначения наборов разрешений. Дополнительные сведения см. в разделе [Управление пользователями и разрешениями](ui-how-users-permissions.md).
...
3. В окне **Пользователи** выберите действие **Обновить все группы пользователей**.
...
2. В окне **Информация о компании** на экспресс-вкладке **Опыт пользователя** выберите Premium в поле **Функциональность**.
