...
ms.author: edupont
---
# <a name="change-which-features-are-displayed" />Изменение набора отображаемых функций
...
## <a name="enabling-premium-features-after-upgrading-a-plan" />Включение функций Premium после перехода на план Premium
...
### <a name="to-update-plan-changes-in-users-groups" />Обновление в соответствии с изменением плана в группах пользователей
...
### <a name="to-select-the-premium-experience" />Выбор функциональности Premium
...
## <a name="help-assumes-premium-experience" />Справка предполагает уровень Premium
