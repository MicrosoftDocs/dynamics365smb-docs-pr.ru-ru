...
Есть несколько функций, которые вы можете использовать для переключения между организациями во время работы, например переключатель организации (CTRL+O). Подробнее см. в статье [Переключение на другую организацию или среду](ui-organization-switch.md).
...
2. Закончив, обновите страницу браузера (нажмите CTRL+F5), чтобы обновить значок в клиенте.  
