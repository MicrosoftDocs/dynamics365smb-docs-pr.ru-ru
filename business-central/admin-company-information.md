...
# <a name="company-information-overview"></a><a name="company-information-overview"></a>Обзор информации о компании
...
## <a name="working-with-multiple-companies"></a><a name="working-with-multiple-companies"></a>Работа с несколькими организациями
...
## <a name="display-a-company-badge"></a><a name="display-a-company-badge"></a><a name="badge"></a>Отображение эмблемы организации
...
## <a name="change-company-display-name"></a><a name="change-company-display-name"></a>Изменение отображаемого названия организации
...
## <a name="experience"></a><a name="experience"></a>Функциональность
