...
## <a name="decide-what-type-of-layout-you-want"></a><a name="decide"></a>Решите, какой тип макета вам нужен
...
## <a name="create-a-new-layout"></a><a name="create"></a>Создание нового макета
...
## <a name="copying"></a>[Копирование](#tab/copy)
...
### <a name="exportingimporting"></a>[Экспорт/импорт](#tab/export)
...
## <a name="modify-a-layout"></a><a name="modify"></a>Измените макет
...
## <a name="replace-a-layout"></a><a name="replace"></a>Заменить макет
...
## <a name="rename-a-layout"></a><a name="rename"></a>Переименовать макет
