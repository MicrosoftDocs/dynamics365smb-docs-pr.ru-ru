...
## <a name="decide-what-type-of-layout-you-want" /><a name="decide"></a>Решите, какой тип макета вам нужен
...
## <a name="create-a-new-layout" /><a name="create"></a>Создание нового макета
...
## <a name="modify-a-layout" /><a name="modify"></a>Измените макет
...
## <a name="replace-a-layout" /><a name="replace"></a>Заменить макет
...
## <a name="rename-a-layout" /><a name="rename"></a>Переименовать макет
