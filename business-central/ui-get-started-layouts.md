...
ms.author: jswymer
---
# Приступайте к созданию макетов отчетов
...
## <a name="decide"></a>Решите, какой тип макета вам нужен
...
## <a name="create"></a>Создание нового макета
...
## <a name="modify"></a>Измените макет
...
## <a name="replace"></a>Заменить макет
...
## <a name="rename"></a>Переименовать макет
