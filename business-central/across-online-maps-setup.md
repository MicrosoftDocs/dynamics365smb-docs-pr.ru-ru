...
---
# <a name="set-up-online-maps" />Настройка онлайн-карт
...
## <a name="set-up-the-online-map-feature" />Настройка функции онлайн-карты
...
### <a name="customize-the-online-map-provider-features" />Настройка функций поставщика онлайн-карт
