...
ms.author: edupont
---
# <a name="set-up-shop-calendars" />Настройка производственных календарей
...
## <a name="to-create-work-shifts" />Создание рабочих смен
...
## <a name="to-set-up-a-shop-calendar" />Настройка производственного календаря
...
## <a name="to-calculate-a-work-center-calendar" />Расчет календаря рабочего центра
...
## <a name="to-record-work-center-absence" />Запись простоев рабочего центра
