...
---
# Пошаговое руководство. Настройка и использование рабочего процесса утверждения покупки
...
#### Чтобы указать себя и Алисию в качестве пользователей утверждения
...
#### Настройка способа и момента получения уведомлений
...
## Создание рабочего процесса утверждения
...
### Чтобы создать и включить рабочий процесс утверждения заказа на покупку
