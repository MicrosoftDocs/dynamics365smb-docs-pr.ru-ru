...
1.  Выберите значок ![Лампочка, которая открывает функцию Что вы хотите сделать](media/ui-search/search_small.png "Что вы хотите сделать"), введите **Настройка пользователя для утверждений**, а затем выберите соответствующую ссылку.  
...
7.  На странице **График уведомлений** в поле **Вхождение** выберите **Сразу**.  
8. Нажмите кнопку **ОК**.  
...
1.  Выберите значок ![Лампочка, которая открывает функцию Что вы хотите сделать](media/ui-search/search_small.png "Что вы хотите сделать"), введите **Рабочие процессы**, а затем выберите соответствующую ссылку.  
...
2.  Выберите значок ![Лампочка, которая открывает функцию Что вы хотите сделать](media/ui-search/search_small.png "Что вы хотите сделать"), введите **Заказы на покупку**, а затем выберите соответствующую ссылку.  
3.  Выберите строку для открытого заказа на покупку 104001, затем выберите действие **Изменить**.  
...
2.  В ролевом центре, на странице **Мои уведомления**, найдите новую записку от Алисии.  
3.  Если заметка отображается на странице **Мои уведомления**, выберите значение **Операция утверждения: XX, XX** в поле **Страница**. Откроется страница **Запросы на утверждение** с выделенным запросом на утверждение заказа на покупку от Алисии.  
4.  На странице **Запросы на утверждение** выберите действие **Утвердить**.  
