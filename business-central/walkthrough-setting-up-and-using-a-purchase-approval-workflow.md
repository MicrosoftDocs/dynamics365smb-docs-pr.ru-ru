...
### <a name="set-up-approval-users"></a>Настройка пользователей утверждения
...
#### <a name="to-set-up-how-and-when-youre-notified"></a>Чтобы настроить способ и момент получения уведомлений
