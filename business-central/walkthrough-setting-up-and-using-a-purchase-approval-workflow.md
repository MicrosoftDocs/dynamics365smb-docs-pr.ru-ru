...
ms.author: edupont
---
# <a name="walkthrough-setting-up-and-using-a-purchase-approval-workflow" />Пошаговое руководство. Настройка и использование рабочего процесса утверждения покупки
...
### <a name="setting-up-approval-users" />Настройка пользователей утверждения
...
#### <a name="to-set-up-yourself-and-alicia-as-approval-users" />Чтобы указать себя и Алисию в качестве пользователей утверждения
...
### <a name="setting-up-notifications" />Настройка уведомлений
...
#### <a name="to-set-up-how-and-when-you-are-notified" />Чтобы настроить способ и момент получения уведомлений
...
## <a name="creating-the-approval-workflow" />Создание рабочего процесса утверждения
...
### <a name="to-create-and-enable-a-purchase-order-approval-workflow" />Чтобы создать и включить рабочий процесс утверждения заказа на покупку
...
## <a name="use-the-approval-workflow" />Использование рабочего процесса утверждения
...
### <a name="to-request-approval-of-a-purchase-order-as-alicia" />Чтобы запросить утверждение заказа на покупку от имени Алисии
...
### <a name="to-approve-the-purchase-order-as-sean" />Чтобы утвердить заказ на покупку от имени Шона
