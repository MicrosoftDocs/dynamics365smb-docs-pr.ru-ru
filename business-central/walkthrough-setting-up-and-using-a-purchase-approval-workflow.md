...
---
# <a name="walkthrough-set-up-and-use-a-purchase-approval-workflow"></a>Пошаговое руководство. Настройка и использование рабочего процесса утверждения покупки
...
#### <a name="to-set-up-how-and-when-youre-notified"></a>Настройка способа и момента получения уведомлений
...
## <a name="create-the-approval-workflow"></a>Создание рабочего процесса утверждения
...
## <a name="use-the-approval-workflow"></a>Использование рабочего процесса утверждения
