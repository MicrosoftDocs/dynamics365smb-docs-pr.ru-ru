...
ms.author: edupont
---
# <a name="set-up-base-calendars"></a><a name="set-up-base-calendars"></a>Настройка базовых календарей
...
## <a name="to-set-up-a-base-calendar"></a><a name="to-set-up-a-base-calendar"></a>Настройка базового календаря
...
## <a name="to-customize-a-calendar"></a><a name="to-customize-a-calendar"></a>Настройка календаря
...
## <a name="to-assign-a-base-calendar"></a><a name="to-assign-a-base-calendar"></a>Присвоение базового календаря
