...
ms.author: edupont
---
# <a name="set-up-base-calendars" />Настройка базовых календарей
...
## <a name="to-set-up-a-base-calendar" />Настройка базового календаря
...
## <a name="to-customize-a-calendar" />Настройка календаря
...
## <a name="to-assign-a-base-calendar" />Присвоение базового календаря
