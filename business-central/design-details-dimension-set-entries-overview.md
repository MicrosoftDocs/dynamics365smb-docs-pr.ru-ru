...
ms.author: edupont
---
# <a name="dimension-set-entries-overview" />Обзор записей набора измерений
...
## <a name="dimension-set-entries" />Записи набора измерений
...
## <a name="performance-improvement" />Повышение производительности
