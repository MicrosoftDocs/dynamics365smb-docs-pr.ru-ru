...
ms.author: edupont
---
# <a name="dimension-set-entries-overview"></a><a name="dimension-set-entries-overview"></a><a name="dimension-set-entries-overview"></a>Обзор записей набора измерений
...
## <a name="dimension-set-entries"></a><a name="dimension-set-entries"></a><a name="dimension-set-entries"></a>Записи набора измерений
...
## <a name="codeunit-408-dimension-management"></a><a name="codeunit-408-dimension-management"></a><a name="codeunit-408-dimension-management"></a>Codeunit 408 Dimension Management
...
## <a name="performance-improvement"></a><a name="performance-improvement"></a><a name="performance-improvement"></a>Повышение производительности
