...
# <a name="posting-date-on-adjustment-value-entry-compared-to-the-source-entry" />Дата учета в операции значения корректировки по сравнению с исходной операцией
...
## <a name="revaluation-scenario" />Сценарий переоценки
