...
ms.author: edupont
---
# <a name="batch-post-production-consumption" />Учет потребления для производства в пакетном режиме
...
## <a name="to-post-consumption-for-one-or-more-production-order-lines" />Учет потребления для одной или нескольких строк производственного заказа
