...
ms.author: edupont
---
# <a name="setting-up-relationship-management" />Настройка управления отношениями
...
## <a name="automatically-recording-interactions" />Автоматическая регистрация взаимодействий
...
## <a name="synchronizing-contacts-with-customers-and-more" />Синхронизация контактов с клиентами и т. д.
...
## <a name="assigning-a-number-series-to-contacts-and-opportunities" />Назначение серий номеров контактам и возможностям
...
## <a name="searching-for-duplicate-contacts-when-contacts-are-created" />Поиск повторяющихся контактов при создании контактов
