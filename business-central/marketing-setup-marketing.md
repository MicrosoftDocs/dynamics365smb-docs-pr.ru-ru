...
Параметры маркетинга и управления контактами задаются в окне **Настройка модуля Маркетинг**. Чтобы открыть окно **Настройка модуля "Маркетинг"**, выберите значок ![Лампочка, которая открывает функцию Что вы хотите сделать](media/ui-search/search_small.png "Что вы хотите сделать"), введите **Настройка модуля "Маркетинг"**, затем выберите связанную ссылку.
