...
ms.author: edupont
---
# <a name="setting-up-relationship-management"></a><a name="setting-up-relationship-management"></a>Настройка управления отношениями
...
## <a name="automatically-recording-interactions"></a><a name="automatically-recording-interactions"></a>Автоматическая регистрация взаимодействий
...
## <a name="synchronizing-contacts-with-customers-and-more"></a><a name="synchronizing-contacts-with-customers-and-more"></a>Синхронизация контактов с клиентами и т. д.
...
## <a name="assigning-a-number-series-to-contacts-and-opportunities"></a><a name="assigning-a-number-series-to-contacts-and-opportunities"></a>Назначение серий номеров контактам и возможностям
...
## <a name="searching-for-duplicate-contacts-when-contacts-are-created"></a><a name="searching-for-duplicate-contacts-when-contacts-are-created"></a>Поиск повторяющихся контактов при создании контактов
