...
ms.author: bholtorf
---
# Настройка управления отношениями
...
## Автоматическая регистрация взаимодействий
...
## Синхронизация контактов с клиентами и т. д.
...
## Назначение серий номеров контактам и возможностям
...
## Поиск повторяющихся контактов при создании контактов
