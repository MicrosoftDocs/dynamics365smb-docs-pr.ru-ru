...
ms.author: edupont
---
# <a name="design-details-known-item-application-issue"></a><a name="design-details-known-item-application-issue"></a>Сведения о проектировании: известная проблема применения товара
...
## <a name="symptoms-of-the-issue"></a><a name="symptoms-of-the-issue"></a>Признаки проблемы
...
## <a name="basics-of-item-application"></a><a name="basics-of-item-application"></a>Основы применения товара
...
### <a name="quantity-application"></a><a name="quantity-application"></a>Применение количества
...
### <a name="cost-application"></a><a name="cost-application"></a>Применение себестоимости
...
## <a name="illustration-of-a-basic-cost-flow"></a><a name="illustration-of-a-basic-cost-flow"></a>Иллюстрация базового потока стоимости
...
## <a name="reasons-for-the-issue"></a><a name="reasons-for-the-issue"></a>Причины проблемы
...
## <a name="identifying-the-issue"></a><a name="identifying-the-issue"></a>Идентификация проблемы
...
## <a name="workaround-for-the-issue"></a><a name="workaround-for-the-issue"></a>Обходное решение проблемы
