...
ms.author: edupont
---
# <a name="design-details-known-item-application-issue" />Сведения о проектировании: известная проблема применения товара
...
## <a name="symptoms-of-the-issue" />Признаки проблемы
...
## <a name="basics-of-item-application" />Основы применения товара
...
### <a name="quantity-application" />Применение количества
...
### <a name="cost-application" />Применение себестоимости
...
## <a name="illustration-of-a-basic-cost-flow" />Иллюстрация базового потока стоимости
...
## <a name="reasons-for-the-issue" />Причины проблемы
...
## <a name="identifying-the-issue" />Идентификация проблемы
...
## <a name="workaround-for-the-issue" />Обходное решение проблемы
