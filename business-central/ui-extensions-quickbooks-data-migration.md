...
# <a name="the-quickbooks-data-migration-extension" />Расширение для миграции данных QuickBooks
...
## <a name="data-from-quickbooks-desktop" />Данные из QuickBooks Desktop
...
## <a name="finding-the-quickbooks-data-migration-extension" />Поиск расширения для миграции данных QuickBooks
