...
ms.author: edupont
---
# <a name="calculate-order-promising-dates"></a><a name="calculate-order-promising-dates"></a>Расчет сроков планирования заказов
...
## <a name="about-order-promising"></a><a name="about-order-promising"></a>О планировании заказов
...
### <a name="available-to-promise"></a><a name="available-to-promise"></a>Доступно для распределения
...
### <a name="capable-to-promise"></a><a name="capable-to-promise"></a>В наличии
...
### <a name="calculations"></a><a name="calculations"></a>Расчеты
...
## <a name="to-set-up-order-promising"></a><a name="to-set-up-order-promising"></a>Настройка планирования заказов
...
### <a name="inbound-and-outbound-warehouse-handling-times-in-order-promising"></a><a name="inbound-and-outbound-warehouse-handling-times-in-order-promising"></a>Время обработки входящего и исходящего складского заказа при обещании заказа
...
#### <a name="to-enter-inbound-and-outbound-warehouse-handling-times-on-locations"></a><a name="to-enter-inbound-and-outbound-warehouse-handling-times-on-locations"></a>Ввод времени обработки на складе входящих и исходящих товаров на складах
...
## <a name="to-make-an-item-critical"></a><a name="to-make-an-item-critical"></a>Создание критического товара
...
## <a name="to-calculate-an-order-promising-date"></a><a name="to-calculate-an-order-promising-date"></a>Расчет сроков планирования заказов
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>См. соответствующее [обучение Microsoft](/training/modules/promising-sales-order-delivery-dynamics-365-business-central/)
