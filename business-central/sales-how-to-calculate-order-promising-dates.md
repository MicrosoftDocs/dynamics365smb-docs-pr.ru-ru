...
ms.author: edupont
---
# <a name="calculate-order-promising-dates" />Расчет сроков планирования заказов
...
## <a name="about-order-promising" />О планировании заказов
...
### <a name="available-to-promise" />Доступно для распределения
...
### <a name="capable-to-promise" />В наличии
...
## <a name="to-set-up-order-promising" />Настройка планирования заказов
...
### <a name="inbound-and-outbound-warehouse-handling-times-in-order-promising" />Время обработки входящего и исходящего складского заказа при обещании заказа
...
#### <a name="to-enter-default-inbound-and-outbound-warehouse-handling-times-for-sales-and-purchase-documents" />Ввод времени обработки входящих и исходящих складских документов по умолчанию для документов покупки и продажи
...
#### <a name="to-enter-inbound-and-outbound-warehouse-handling-times-on-locations" />Ввод времени обработки на складе входящих и исходящих товаров на складах
...
## <a name="to-make-an-item-critical" />Создание критического товара
...
## <a name="to-calculate-an-order-promising-date" />Расчет сроков планирования заказов
