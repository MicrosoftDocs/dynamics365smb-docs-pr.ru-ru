---
title: Расчет сроков доставки заказов
...
---
# Расчет сроков доставки заказов
...
Если на дату отгрузки товар имеется в наличии, процесс продажи может быть продолжен. Если на дату отгрузки товар отсутствует, отображается предупреждение об исчерпании запасов.  

Если не указать требуемую дату доставки в строке заказа продажи, либо если соблюсти требуемую дату доставки невозможно, вычисляется самая ранняя дата, на которую доступны товары. Затем эта дата вводится в поле **Дата отгрузки** в строке, и дата, в которую планируется отгрузки товаров, а также дата, в которую они будут доставлены клиенту, рассчитываются по следующим формулам:  
...
## Настройка планирования заказов
...
### Время обработки входящего и исходящего складского заказа при обещании заказа
...
#### Ввод времени обработки входящих и исходящих складских документов по умолчанию для документов покупки и продажи
...
#### Ввод времени обработки на складе входящих и исходящих товаров на складах
...
## Создание критического товара

Чтобы товар можно было включить в расчет планирования заказа, его необходимо отметить как критически важный. Эта настройка гарантирует, что некритические товары не станут причиной нерелевантных расчетов планирования заказов.   
...
## Расчет сроков планирования заказов
