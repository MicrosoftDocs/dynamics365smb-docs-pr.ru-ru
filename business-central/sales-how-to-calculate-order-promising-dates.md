...
На основе известных и ожидаемых дат доступности для товара [!INCLUDE[prod_short](includes/prod_short.md)] немедленно вычисляет даты отгрузки и доставки, которые затем могут быть обещаны клиенту.  
...
1. Выберите значок ![Лампочка, которая открывает функцию "Что вы хотите сделать"](media/ui-search/search_small.png "Что вы хотите сделать"), введите **Настройка планирования заказов**, затем выберите соответствующую ссылку.  
...
1. Выберите значок ![Лампочка, которая открывает функцию "Что вы хотите сделать"](media/ui-search/search_small.png "Что вы хотите сделать"), введите **Склад**, затем выберите соответствующую ссылку.  
