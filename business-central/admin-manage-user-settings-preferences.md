...
ms.author: soalex
---
# <a name="manage-user-settings-and-preferences" />Управление пользовательскими параметрами и настройками
...
## <a name="types-of-user-settings" />Типы пользовательских параметров
...
## <a name="overview-of-all-user-specific-changes" />Обзор всех изменений для конкретных пользователей
...
## <a name="to-review-or-delete-user-personalizations" />Чтобы просмотреть или удалить персональные настройки пользователя
