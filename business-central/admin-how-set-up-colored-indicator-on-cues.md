...
ms.author: jswymer
---
# <a name="set-up-a-colored-indicator-on-cues-for-the-company-or-individual-users" />Настройка цветного индикатора в очередях для организации или отдельных пользователей
...
### <a name="to-set-up-colored-indicators-on-cues" />Настройка цветных индикаторов в очередях
