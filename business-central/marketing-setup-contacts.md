...
Можно выбрать автоматическое назначение приложением определенного кода языка, кода территории, кода менеджера и кода страны/региона по умолчанию каждому вновь создаваемому контакту. Также можно ввести стандартный код цикла продажи, который будет автоматически присваиваться программой каждой новой создаваемой возможности. Это настраивается на экспресс-вкладке **По умолчанию** на странице **Настройка модуля "Маркетинг"**
