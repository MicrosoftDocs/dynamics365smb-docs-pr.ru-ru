...
description: Вы можете использовать свою систему автоматического сбора данных (ADCS) для регистрации перемещения товаров на складе и регистрации некоторых операций в журнале.
author: SorenGP
...
1.  Выберите ![Лампочка, которая открывает функцию Что вы хотите сделать.](media/ui-search/search_small.png "Что вы хотите сделать") значок, введите **Пользователи ADCS**, а затем выберите связанную ссылку.  
2. Выберите действие **Создать**.  
