...
>
> В случае, если вам необходимо выставить счет на продажу без регистрации отгрузки в [!INCLUDE[prod_short](prod_short.md)], создайте документ на странице **Счета продаж** или выберите действие **Создать счет** на странице **Предложения по продаже**. Узнайте больше в разделе [Счета продажи](../sales-how-invoice-sales.md).
