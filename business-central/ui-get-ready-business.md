...
Либо, чтобы открыть список мастеров настройки, выберите значок ![Лампочка, которая открывает функцию Что вы хотите сделать](media/ui-search/search_small.png "Что вы хотите сделать"), введите **Мастер настройки**, а затем выберите соответствующую ссылку.
