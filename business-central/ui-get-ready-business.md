...
Или же, выберите значок ![Значок шестеренки, чтобы открыть меню параметров](media/ui-experience/settings_icon_small.png), затем выберите действие **Мастер настройки**.

Можно также открыть список мастеров настройки, если выбрать значок ![Лампочка, которая открывает функцию "Что вы хотите сделать&quot;](media/ui-search/search_small.png &quot;Что вы хотите сделать"), введите **Мастер настройки**, затем выберите соответствующую ссылку.  
