...
ms.author: edupont
---
# <a name="get-ready-for-doing-business"></a><a name="get-ready-for-doing-business"></a>Подготовка к ведению бизнеса
...
## <a name="teaching-tips-and-tours"></a><a name="teaching-tips-and-tours"></a>Обучающие советы и туры
...
## <a name="role-specific-home-pages"></a><a name="role-specific-home-pages"></a>Домашние страницы для конкретных ролей
...
## <a name="company-information"></a><a name="company-information"></a>Информация о компании
...
## <a name="adding-users-and-permissions"></a><a name="adding-users-and-permissions"></a>Добавление пользователей и разрешений
...
## <a name="product-help"></a><a name="product-help"></a>Справка продукта
...
### <a name="set-up-your-company-in-"></a><a name="set-up-your-company-in-"></a>Настройка компании в [!INCLUDE[prod_short](includes/prod_short.md)]
