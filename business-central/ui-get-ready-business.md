...
ms.author: edupont
---
# <a name="get-ready-for-doing-business" />Подготовка к ведению бизнеса
...
## <a name="teaching-tips-and-tours" />Обучающие советы и туры
...
## <a name="role-specific-home-pages" />Домашние страницы для конкретных ролей
...
## <a name="adding-users-and-permissions" />Добавление пользователей и разрешений
