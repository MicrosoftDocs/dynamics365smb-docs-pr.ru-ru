...
ms.author: edupont
---
# <a name="set-up-purchasers"></a><a name="set-up-purchasers"></a>Настройка менеджеров по закупкам
...
## <a name="to-set-up-purchasers"></a><a name="to-set-up-purchasers"></a>Настройка менеджеров
...
## <a name="to-assign-purchasers-to-vendors"></a><a name="to-assign-purchasers-to-vendors"></a>Назначение менеджеров поставщикам
