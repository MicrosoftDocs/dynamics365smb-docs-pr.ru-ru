...
ms.author: edupont
---
# <a name="set-up-purchasers" />Настройка менеджеров по закупкам
...
## <a name="to-set-up-purchasers" />Настройка менеджеров
...
## <a name="to-assign-purchasers-to-vendors" />Назначение менеджеров поставщикам
