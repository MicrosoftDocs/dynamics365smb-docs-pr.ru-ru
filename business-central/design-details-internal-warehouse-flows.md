...
---
# <a name="flows-for-production-assembly-and-jobs"></a><a name="flows-for-production-assembly-and-jobs"></a>Потоки для производства, сборки и работ
...
### <a name="inbound-flow-put-away"></a><a name="inbound-flow-put-away"></a>Входящий поток (размещение)
...
### <a name="outbound-flow-pick"></a><a name="outbound-flow-pick"></a>Исходящий поток (подбор)
...
## <a name="warehouses-without-dedicated-warehouse-activity"></a><a name="warehouses-without-dedicated-warehouse-activity"></a>Склады без выделенной складского задания
...
## <a name="basic-warehouse-configuration"></a><a name="basic-warehouse-configuration"></a>Базовая конфигурация склада
...
### <a name="flows-to-and-from-production-in-a-basic-warehouse-configuration"></a><a name="flows-to-and-from-production-in-a-basic-warehouse-configuration"></a>Перемещение в производство и из него в базовой конфигурации склада
...
### <a name="flows-to-and-from-assembly-in-a-basic-warehouse-configuration"></a><a name="flows-to-and-from-assembly-in-a-basic-warehouse-configuration"></a>Перемещение в сборку и из него в базовой конфигурации склада
...
### <a name="flows-for-project-management-in-a-basic-warehouse-configuration"></a><a name="flows-for-project-management-in-a-basic-warehouse-configuration"></a>Потоки для управление проектами в базовой конфигурации склада
...
### <a name="flows-to-and-from-production-in-advanced-warehouse-configurations"></a><a name="flows-to-and-from-production-in-advanced-warehouse-configurations"></a>Перемещение в производство и из него в расширенной конфигурации склада
...
### <a name="flows-to-and-from-assembly-in-advanced-warehouse-configurations"></a><a name="flows-to-and-from-assembly-in-advanced-warehouse-configurations"></a>Перемещение в сборку и из него в расширенной конфигурации склада
...
### <a name="flows-to-project-management-in-advanced-warehouse-configurations"></a><a name="flows-to-project-management-in-advanced-warehouse-configurations"></a>Потоки для управление проектами в расширенной конфигурации склада
