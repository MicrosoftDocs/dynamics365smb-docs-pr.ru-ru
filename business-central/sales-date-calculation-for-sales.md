---
title: Расчет дат доставки для продаж
...
---
# Расчет дат доставки для продаж
...
* Если клиент не требует, чтобы поставка была произведена на конкретную дату, то вычисляется дата, на которую товары могут быть поставлены. Расчет начинается с даты, когда товары доступны для комплектации.
