...
ms.author: edupont
---
# <a name="delivery-date-calculation-for-sales"></a><a name="delivery-date-calculation-for-sales"></a>Расчет даты доставки для продаж
...
## <a name="calculating-a-requested-delivery-date"></a><a name="calculating-a-requested-delivery-date"></a>Вычисление требуемой даты доставки
...
## <a name="calculating-the-earliest-possible-delivery-date"></a><a name="calculating-the-earliest-possible-delivery-date"></a>Расчет наиболее ранней возможной даты доставки
