...
ms.author: edupont
---
# <a name="reconcile-vendor-payments-with-the-payment-journal-or-from-vendor-ledger-entries" />Выверка платежей поставщикам с журналом платежей или из книги операций по поставщикам
...
## <a name="to-apply-a-payment-to-a-single-or-multiple-vendor-ledger-entries" />Применение платежа к одной или нескольким операциям книги поставщиков
...
## <a name="to-apply-a-credit-memo-to-a-single-or-multiple-vendor-ledger-entries" />Применение кредит-ноты к одной или нескольким операциям в книге поставщиков
...
## <a name="to-apply-posted-vendor-ledger-entries" />Применение учтенных операций книги поставщиков
...
## <a name="to-apply-vendor-ledger-entries-in-different-currencies-to-one-another" />Применение операций книги поставщиков в различных валютах друг к другу
...
## <a name="to-unapply-an-application-of-vendor-entries" />Отмена применения операций поставщика
