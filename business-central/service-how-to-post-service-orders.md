...
4. Найдите необходимые операции и укажите количества, для которых необходимо учесть потребление, в поле **Количество для потребления**. Данное количество не может превышать уже отгруженное количество и оставшееся количество, не включенное в выставленные счета после частичного выставления счетов по данной отгрузке.  
    ...
    > [!NOTE]  
    >  Чтобы зарегистрировать потребление в связи с проектом, заполните поля **№ проекта**, **№ задачи проекта** и **Тип строки проекта** в сервисной строке.  
...
>    * Оно учтено в области «Работы», поэтому с ним связаны операции книги проектов.  
