...
ms.author: edupont
---
# <a name="post-service-orders-and-credit-memos" />Учет сервисных заказов и кредит-нот
...
## <a name="to-post-a-service-order" />Учет сервисного заказа
...
## <a name="to-batch-post-service-orders" />Выполнение пакетного учета сервисных заказов
1. Выберите ![Лампочка, которая открывает функцию Что вы хотите сделать.](media/ui-search/search_small.png "Что вы хотите сделать") значок, введите **Сервисные заказы**, а затем выберите связанную ссылку.  
...
## <a name="to-post-a-service-credit-memo" />Учет сервисной кредит-ноты
...
## <a name="to-post-consumption-from-a-service-order" />Учет потребления из сервисного заказа
...
## <a name="to-post-shipments-from-service-orders" />Учет отгрузок из сервисных заказов
...
## <a name="to-undo-posted-consumption" />Отмена учтенного потребления
...
## <a name="to-post-service-lines" />Учет сервисных строк
