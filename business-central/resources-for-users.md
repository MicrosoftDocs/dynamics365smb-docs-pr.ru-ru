...
description: 'Ресурсы для пользователей — это набор ресурсов, служб и инструментов для использования Business Central.'
author: brentholtorf
ms.author: bholtorf
...
- Почитайте наш блог для ИТ-специалистов и ответственных за принятие решений: [cloudblogs.microsoft.com/dynamics365/it/product/business-central](https://www.microsoft.com/en-us/dynamics-365/blog/business-leader/product/dynamics-365-business-central/)
...
- Знакомство с [!INCLUDE [prod_short](includes/prod_short.md)] и Power BI: [aka.ms/BCPBI](https://aka.ms/BCPBI)
...
- Данные телеметрии сред и Power BI: [aka.ms/BCTelemetryReport](https://aka.ms/BCTelemetryReport) 
