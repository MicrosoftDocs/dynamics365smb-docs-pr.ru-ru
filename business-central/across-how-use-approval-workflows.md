...
ms.author: edupont
---
# <a name="how-to-use-approval-workflows" />Как использовать рабочие процессы утверждения
...
## <a name="request-a-record-approval" />Запрос утверждения записи
...
## <a name="cancel-approval-requests" />Отмена запросов на утверждение
...
## <a name="approve-or-reject-approval-requests" />Утверждение или отклонение запросов утверждения
...
## <a name="delegate-approval-requests" />Делегирование запросов на утверждение
...
## <a name="manage-overdue-approval-requests" />Управление просроченными запросами утверждения
