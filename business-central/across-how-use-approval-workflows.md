...
ms.locfileid: "9585545"
---
# <a name="how-to-use-approval-workflows"></a>Как использовать рабочие процессы утверждения
...
## <a name="request-a-record-approval"></a>Запрос утверждения записи
...
## <a name="cancel-approval-requests"></a>Отмена запросов на утверждение
...
## <a name="approve-or-reject-approval-requests"></a>Утверждение или отклонение запросов утверждения
...
## <a name="delegate-approval-requests"></a>Делегирование запросов на утверждение
...
## <a name="manage-overdue-approval-requests"></a>Управление просроченными запросами утверждения
