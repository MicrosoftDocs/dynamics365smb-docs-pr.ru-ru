...
ms.author: edupont
---
# <a name="how-to-use-approval-workflows"></a><a name="how-to-use-approval-workflows"></a>Как использовать рабочие процессы утверждения
...
## <a name="request-a-record-approval"></a><a name="request-a-record-approval"></a>Запрос утверждения записи
...
## <a name="cancel-approval-requests"></a><a name="cancel-approval-requests"></a>Отмена запросов на утверждение
...
## <a name="approve-or-reject-approval-requests"></a><a name="approve-or-reject-approval-requests"></a>Утверждение или отклонение запросов утверждения
...
## <a name="delegate-approval-requests"></a><a name="delegate-approval-requests"></a>Делегирование запросов на утверждение
...
## <a name="manage-overdue-approval-requests"></a><a name="manage-overdue-approval-requests"></a>Управление просроченными запросами утверждения
