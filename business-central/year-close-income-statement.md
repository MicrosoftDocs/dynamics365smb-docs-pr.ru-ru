...
ms.author: jswymer
---
# <a name="closing-income-statement-accounts" />Закрытие счетов отчета о прибылях и убытках
...
## <a name="to-run-the-close-income-statement-batch-job" />Запуск пакетного задания "Закрытие отчета о прибылях и убытках".
...
## <a name="about-the-close-income-statement-batch-job" />О пакетном задании "Закрытие отчета о прибылях и убытках".
