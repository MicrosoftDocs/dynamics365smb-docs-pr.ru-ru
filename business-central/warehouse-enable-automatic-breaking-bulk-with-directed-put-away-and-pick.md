...
ms.author: bholtorf
---
# <a name="enable-automatic-breaking-bulk-with-directed-put-away-and-pick"></a><a name="enable-automatic-breaking-bulk-with-directed-put-away-and-pick"></a>Разрешение автоматической разбивки с расширенным подбором и размещением
...
## <a name="breakbulk-in-picks"></a><a name="breakbulk-in-picks"></a>Разбивка при подборах
...
## <a name="breakbulk-in-put-aways"></a><a name="breakbulk-in-put-aways"></a>Разбивка при размещениях
...
## <a name="breakbulk-in-movements"></a><a name="breakbulk-in-movements"></a>Разбивка при перемещениях
