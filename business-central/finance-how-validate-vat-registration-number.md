...
# <a name="validate-vat-registration-numbers" />Проверка номеров ИНН
...
## <a name="configure-the-service-to-verify-vat-registration-numbers-automatically" />Настройте службу для автоматической проверки ИНН
...
## <a name="validation-templates" />Шаблоны проверки
