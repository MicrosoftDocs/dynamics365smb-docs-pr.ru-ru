...
# <a name="work-with-calendar-dates-and-times"></a><a name="work-with-calendar-dates-and-times"></a><a name="work-with-calendar-dates-and-times"></a>Работа с календарными датами и значениями времени
...
## <a name="check-your-region-and-language-settings"></a><a name="check-your-region-and-language-settings"></a><a name="check-your-region-and-language-settings"></a>Проверьте свои настройки региона и языка
...
### <a name="picking-dates-from-the-calendar"></a><a name="picking-dates-from-the-calendar"></a><a name="picking-dates-from-the-calendar"></a>Выбор дат из календаря
...
### <a name="day-week-year-pattern"></a><a name="day-week-year-pattern"></a><a name="day-week-year-pattern"></a>Структура день\-неделя\-год
...
### <a name="digit-patterns"></a><a name="digit-patterns"></a><a name="digit-patterns"></a>Цифровые схемы
...
### <a name="today"></a><a name="today"></a><a name="today"></a>Сегодня
...
### <a name="period"></a><a name="period"></a><a name="period"></a>периоду
...
### <a name="closing-date"></a><a name="closing-date"></a><a name="closing-date"></a>Дата закрытия
...
## <a name="setting-ranges"></a><a name="setting-ranges"></a><a name="setting-ranges"></a><a name="BKMK_SettingDateRanges"></a> Диапазоны дат
...
## <a name="use-date-formulas"></a><a name="use-date-formulas"></a><a name="use-date-formulas"></a>Формулы расчета дат
...
## <a name="entering-combined-dates-and-times"></a><a name="entering-combined-dates-and-times"></a><a name="entering-combined-dates-and-times"></a>Ввод комбинированных дат и времени
