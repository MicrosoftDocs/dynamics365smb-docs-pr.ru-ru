...
# <a name="work-with-calendar-dates-and-times" />Работа с календарными датами и значениями времени
...
## <a name="check-your-region-and-language-settings" />Проверьте свои настройки региона и языка
...
### <a name="picking-dates-from-the-calendar" />Выбор дат из календаря
...
### <a name="day-week-year-pattern" />Структура день\-неделя\-год
...
### <a name="digit-patterns" />Цифровые схемы
...
### <a name="closing-date" />Дата закрытия
...
## <a name="use-date-formulas" />Формулы расчета дат
...
## <a name="entering-combined-dates-and-times" />Ввод комбинированных дат и времени
