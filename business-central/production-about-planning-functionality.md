...
ms.author: bholtorf
---
# <a name="about-planning-functionality"></a><a name="about-planning-functionality"></a>О функциональности планирования
...
## <a name="demand-and-supply"></a><a name="demand-and-supply"></a>Спрос и предложение
...
## <a name="planning-calculation"></a><a name="planning-calculation"></a>Расчет плана
...
## <a name="planning-with-manual-transfer-orders"></a><a name="planning-with-manual-transfer-orders"></a>Планирование с использованием заказов на перемещение, созданных вручную
...
## <a name="other-important-planning-fields"></a><a name="other-important-planning-fields"></a>Другие важные поля планирования
...
### <a name="warning"></a><a name="warning"></a>Предупреждение
...
## <a name="planning-worksheets-and-requisition-worksheets"></a><a name="planning-worksheets-and-requisition-worksheets"></a>Листы планирования и листы заявок
...
### <a name="requisition-worksheet"></a><a name="requisition-worksheet"></a>Лист заявок
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>См. соответствующее [обучение Microsoft](/training/modules/plan-items-dynamics-365-business-central/)
