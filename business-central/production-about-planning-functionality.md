...
ms.author: bholtorf
---
# <a name="about-planning-functionality" />О функциональности планирования
...
## <a name="demand-and-supply" />Спрос и предложение
...
## <a name="planning-calculation" />Расчет плана
...
## <a name="planning-with-manual-transfer-orders" />Планирование с использованием заказов на перемещение, созданных вручную
...
## <a name="other-important-planning-fields" />Другие важные поля планирования
...
## <a name="planning-worksheets-and-requisition-worksheets" />Листы планирования и листы заявок
...
### <a name="requisition-worksheet" />Лист заявок
...
## <a name="see-related-microsoft-trainingtrainingmodulesplan-items-dynamics--business-central" />См. соответствующее [обучение Microsoft](/training/modules/plan-items-dynamics-365-business-central/)
