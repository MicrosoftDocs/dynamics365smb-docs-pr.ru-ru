...
ms.author: edupont
---
# <a name="set-up-fixed-asset-maintenance"></a><a name="set-up-fixed-asset-maintenance"></a>Настройка обслуживания основного средства
...
## <a name="to-set-up-general-maintenance-information"></a><a name="to-set-up-general-maintenance-information"></a>Настройка общей информации об обслуживании
...
## <a name="to-set-up-maintenance-codes"></a><a name="to-set-up-maintenance-codes"></a>Настройка кодов обслуживания
...
## <a name="to-set-up-maintenance-expense-accounts"></a><a name="to-set-up-maintenance-expense-accounts"></a>Настройка счетов расходов на обслуживание
