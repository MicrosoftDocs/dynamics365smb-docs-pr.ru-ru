...
ms.author: edupont
---
# <a name="set-up-fixed-asset-maintenance" />Настройка обслуживания основного средства
...
## <a name="to-set-up-general-maintenance-information" />Настройка общей информации об обслуживании
...
## <a name="to-set-up-maintenance-codes" />Настройка кодов обслуживания
...
## <a name="to-set-up-maintenance-expense-accounts" />Настройка счетов расходов на обслуживание
