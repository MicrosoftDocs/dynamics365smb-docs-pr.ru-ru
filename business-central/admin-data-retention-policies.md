...
## <a name="required-setups-and-permissions"></a>Требуемые настройки и разрешения
...
### <a name="create-retention-periods"></a>Создание периодов хранения
...
## <a name="apply-retention-policies"></a>Применение политик хранения
...
## <a name="view-retention-policy-log-entries"></a>Просмотр операций журнала политики хранения
...
## <a name="include-your-extension-in-a-retention-policy-requires-help-from-a-developer"></a>Включение вашего расширения в политику хранения (требуется помощь разработчика)
