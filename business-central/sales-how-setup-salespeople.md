...
ms.author: edupont
---
# <a name="set-up-salespeople"></a><a name="set-up-salespeople"></a>Настройка менеджеров по продажам
...
## <a name="to-set-up-a-salesperson-code"></a><a name="to-set-up-a-salesperson-code"></a>Настройка кода менеджера
