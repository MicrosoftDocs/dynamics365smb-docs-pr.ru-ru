...
2. На ленте перейдите к **[!INCLUDE[prod_short](includes/prod_short.md)]** и выберите **Информация о контакте**. Или, если вы используете Outlook в Интернете, вверху сообщения выберите **Приложения** ![Показана кнопка «Приложения» в Outlook.](media/apps-icon.png) > **Business Central** ![Значок надстройки Business Central в Outlook.](media/outlook-business-central-icon.png) > **Информация о контакте**.
