...
ms.author: jswymer
---
# <a name="use-business-central-as-your-business-inbox-in-outlook" />Использование Business Central в качестве папки "Входящие" для бизнеса в Outlook
...
## <a name="work-with-contacts-and-documents-using-the-contact-insights-add-in" />Работа с контактами и документами с помощью надстройки Информация о контакте
...
### <a name="look-up-a-business-contact-when-composing-an-email" />Найдите бизнес-контакт при составлении электронного письма
...
### <a name="view-and-change-the-contact-details-or-switch-company" />Просмотр и изменение контактных данных или изменение компании
...
### <a name="track-incoming-documents" />Отслеживание входящих документов
...
### <a name="create-and-send-new-document-to-a-contact" />Создать и отправить новый документ контакту
...
### <a name="attach-files-to-records" />Прикрепить файлы к записям
...
#### <a name="how-to-attach-a-file" />Как прикрепить файл
...
## <a name="view-a-document-from-an-email-using-the-document-view-add-in" />Просмотр документа из электронного письма с помощью надстройки представления документа
