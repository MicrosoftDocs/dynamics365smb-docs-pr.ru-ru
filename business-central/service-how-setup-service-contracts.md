...
# <a name="set-up-service-contracts" />Настройка сервисных контрактов
...
## <a name="to-set-up-a-service-contract-group" />Настройка группы сервисных контрактов
...
## <a name="to-set-up-a-service-contract-account-group" />Настройка учетной группы сервисных контрактов
...
## <a name="to-set-up-a-contract-template" />Настройка шаблона контрактов
...
## <a name="to-set-up-a-customer-template" />Настройка шаблона клиентов
