...
# <a name="set-up-service-contracts"></a><a name="set-up-service-contracts"></a>Настройка сервисных контрактов
...
## <a name="to-set-up-a-service-contract-group"></a><a name="to-set-up-a-service-contract-group"></a>Настройка группы сервисных контрактов
...
## <a name="to-set-up-a-service-contract-account-group"></a><a name="to-set-up-a-service-contract-account-group"></a>Настройка учетной группы сервисных контрактов
...
## <a name="to-set-up-a-contract-template"></a><a name="to-set-up-a-contract-template"></a>Настройка шаблона контрактов
...
## <a name="to-set-up-a-customer-template"></a><a name="to-set-up-a-customer-template"></a>Настройка шаблона клиентов
