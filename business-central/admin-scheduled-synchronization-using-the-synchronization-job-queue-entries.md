...
# <a name="scheduling-a-synchronization-between-business-central-and-dataverse" />Планирование синхронизации между Business Central и Dataverse
...
## <a name="synchronization-process" />Процесс синхронизации
...
## <a name="about-inactivity-timeouts" />О таймаутах неактивности
...
## <a name="to-view-the-synchronization-job-log" />Просмотр журнала заданий синхронизации
...
## <a name="to-view-the-synchronization-job-log-from-the-table-mappings" />Просмотр журнала заданий синхронизации из сопоставлений таблиц
...
## <a name="to-view-the-synchronization-error-log" />Просмотр журнала ошибок синхронизации
