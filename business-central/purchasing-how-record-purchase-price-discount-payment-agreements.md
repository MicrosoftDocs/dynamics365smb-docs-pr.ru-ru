...
---
# Регистрация специальных цен покупки и скидок
...
## Настройка специальных цен покупки для поставщика
...
## Настройка скидки строки для поставщика
...
## Настройка скидки по счету для поставщика
...
## Выбор принципа учета скидок покупки
...
## Скидки по счетам покупки и плата за сервисное обслуживание
...
После регистрации специальных цен и скидок по строке для покупок и продаж [!INCLUDE[prod_short](includes/prod_short.md)] гарантирует, что ваша прибыль от торговли товаром будет всегда оптимальна, автоматически рассчитывая наилучшую цену в документах продажи и покупки и в строках журнала товаров и проектов.
