...
2. Открывает страницу **Выберите учетную запись**. Выберите свою учетную запись или **используйте другую учетную запись**, если вы не видите свою, и при появлении запроса введите соответствующие имя пользователя и пароль.
3. Создает папку с именем [!INCLUDE[prod_short](includes/prod_short.md)] в OneDrive. 
4. В папке [!INCLUDE[prod_short](includes/prod_short.md)] создается папка с именем, совпадающим с именем организации, в которой вы работаете. Если вы работаете в нескольких организациях, [!INCLUDE[prod_short](includes/prod_short.md)] создает папку для каждой организации, в которой вы работаете, при использовании действия **Открыть в OneDrive** или **Поделиться**. 
5. Помещает копию выбранного файла в папку с именем организациии, а затем открывает файл. 
