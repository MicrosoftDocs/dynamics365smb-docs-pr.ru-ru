...
ms.author: edupont
---
# <a name="general-journal-post-line-overview"></a><a name="general-journal-post-line-overview"></a><a name="general-journal-post-line-overview"></a>Обзор строки учета финансового журнала
...
## <a name="old-architecture"></a><a name="old-architecture"></a><a name="old-architecture"></a>Старая архитектура
...
### <a name="new-architecture"></a><a name="new-architecture"></a><a name="new-architecture"></a>Новая архитектура
