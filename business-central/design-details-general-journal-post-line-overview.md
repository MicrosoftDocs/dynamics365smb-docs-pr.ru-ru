...
ms.author: edupont
---
# <a name="general-journal-post-line-overview" />Обзор строки учета финансового журнала
...
## <a name="old-architecture" />Старая архитектура
...
### <a name="new-architecture" />Новая архитектура
