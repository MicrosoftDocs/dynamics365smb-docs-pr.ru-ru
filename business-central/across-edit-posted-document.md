...
ms.author: edupont
---
# <a name="edit-posted-documents" />Изменение учтенных документов
...
## <a name="to-edit-a-posted-sales-shipment" />Чтобы отредактировать учтенную расходную накладную продажи
