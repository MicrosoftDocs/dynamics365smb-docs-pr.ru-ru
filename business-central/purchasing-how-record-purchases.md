...
ms.author: edupont
---
# <a name="record-purchases-with-purchase-invoices-and-orders" />Регистрация покупок со счетами покупок и заказами
...
## <a name="record-purchases-with-purchase-invoices" />Регистрация покупок со счетами покупок
...
### <a name="create-a-and-post-purchase-invoice" />Создайте и учтите счет покупки
...
## <a name="purchasing-non-inventory-items" />Покупка товаров, не относящихся к запасам
...
## <a name="when-to-use-purchase-orders" />Когда использовать заказы на покупку
...
## <a name="receive-items-with-a-purchase-order" />Приемка товаров с помощью заказа на покупку
...
## <a name="receive-more-items-than-ordered" />Получение большего количества товаров, чем заказано
...
### <a name="set-up-over-receipts" />Настройка переприхода
...
### <a name="assign-the-over-receipt-code-to-an-item" />Код переприхода присваивается товару
...
### <a name="over-receive-an-order" />Получение заказа сверх нормы
...
## <a name="posting-purchases" />Учет покупок
...
## <a name="viewing-ledger-entries" />Просмотр операций книги
...
## <a name="editing-ledger-entries" />Изменение операций книги
...
## <a name="see-related-microsoft-training-1" />См. соответствующее [обучение Microsoft](/training/modules/processing-invoices-dynamics-365-business-central/index)
