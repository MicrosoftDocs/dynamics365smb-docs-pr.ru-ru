...
ms.author: edupont
---
# <a name="work-with-assembly-boms" />Работа со сборочными спецификациями
...
## <a name="to-create-an-assembly-bom" />Создание сборочной спецификации
...
## <a name="to-edit-assembly-boms" />Редактирование сборочных спецификаций
...
## <a name="to-view-components-and-resources-indented-according-to-the-bom-structure" />Просмотр компонентов и ресурсов с отступом согласно структуре спецификации
...
## <a name="to-replace-the-assembly-item-with-its-components-on-document-lines" />Замена сборочного элемента его компонентами в строках документа
...
## <a name="to-calculate-the-standard-cost-of-an-assembly-item" />Вычисление стандартной себестоимости сборочного элемента
...
## <a name="see-related-microsoft-trainingtrainingmodulesset-up-assembly-items-dynamics--business-central" />См. соответствующее [обучение Microsoft](/training/modules/set-up-assembly-items-dynamics-365-business-central/).
