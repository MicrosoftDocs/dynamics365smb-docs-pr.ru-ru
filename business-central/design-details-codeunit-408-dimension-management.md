...
ms.locfileid: "1970974"
---
# <a name="design-details-codeunit-408-dimension-management"></a><span data-ttu-id="c2d73-103">Сведения о проектировании: Codeunit 408 Dimension Management</span><span class="sxs-lookup"><span data-stu-id="c2d73-103">Design Details: Codeunit 408 Dimension Management</span></span>
<span data-ttu-id="c2d73-104">Codeunit 408 Dimension Management — это библиотека функций, обрабатывающих общие задачи, связанные с измерениями, такие как копирование из одной таблицы в другую или из одного документа в другой.</span><span class="sxs-lookup"><span data-stu-id="c2d73-104">Codeunit 408 Dimension Management is a function library that handles common tasks that are related to dimensions, such as copying from one table to another or from one document to another.</span></span> <span data-ttu-id="c2d73-105">В этом разделе перечислены изменяемые в Microsoft Dynamics NAV 2013 R2 функции и указано, какие изменения внесены в функции.</span><span class="sxs-lookup"><span data-stu-id="c2d73-105">This topic lists the functions that are modified in Microsoft Dynamics NAV 2013 R2 and specifies what has to be done to the functions.</span></span> <span data-ttu-id="c2d73-106">Множество функций удалено, поскольку нет необходимости копировать данные между таблицами измерений.</span><span class="sxs-lookup"><span data-stu-id="c2d73-106">Many functions are deleted because there is no need for copying between dimension tables.</span></span>  

## <a name="modified-functions"></a><span data-ttu-id="c2d73-107">Измененные функции</span><span class="sxs-lookup"><span data-stu-id="c2d73-107">Modified Functions</span></span>  

|<span data-ttu-id="c2d73-108">Имя функции</span><span class="sxs-lookup"><span data-stu-id="c2d73-108">Function Name</span></span>|<span data-ttu-id="c2d73-109">Описание изменения</span><span class="sxs-lookup"><span data-stu-id="c2d73-109">Modification Description</span></span>|  
|-------------------|------------------------------|  
|<span data-ttu-id="c2d73-110">CheckDimSetIDComb</span><span class="sxs-lookup"><span data-stu-id="c2d73-110">CheckDimSetIDComb</span></span>|<span data-ttu-id="c2d73-111">Новая функция, которая заменяет собой другие функции проверки и принимает код набора измерений в качестве аргумента вместо таблицы измерений.</span><span class="sxs-lookup"><span data-stu-id="c2d73-111">New function that substitutes the other check functions and takes a Dimension Set ID as an argument instead of a dimension table.</span></span>|  
|<span data-ttu-id="c2d73-112">CheckDimSetIDComb</span><span class="sxs-lookup"><span data-stu-id="c2d73-112">CheckDimSetIDComb</span></span><br /><br /> <span data-ttu-id="c2d73-113">CheckDocDimComb</span><span class="sxs-lookup"><span data-stu-id="c2d73-113">CheckDocDimComb</span></span><br /><br /> <span data-ttu-id="c2d73-114">CheckServContractDimComb</span><span class="sxs-lookup"><span data-stu-id="c2d73-114">CheckServContractDimComb</span></span><br /><br /> <span data-ttu-id="c2d73-115">CheckDimBuffer</span><span class="sxs-lookup"><span data-stu-id="c2d73-115">CheckDimBuffer</span></span><br /><br /> <span data-ttu-id="c2d73-116">CheckDimComb</span><span class="sxs-lookup"><span data-stu-id="c2d73-116">CheckDimComb</span></span><br /><br /> <span data-ttu-id="c2d73-117">CheckDimValueComb</span><span class="sxs-lookup"><span data-stu-id="c2d73-117">CheckDimValueComb</span></span>|<span data-ttu-id="c2d73-118">Удаление.</span><span class="sxs-lookup"><span data-stu-id="c2d73-118">Delete.</span></span> <span data-ttu-id="c2d73-119">Все потребление должно быть изменено на CheckDimSetIDComb.</span><span class="sxs-lookup"><span data-stu-id="c2d73-119">All usage should be changed to CheckDimSetIDComb.</span></span>|  
|<span data-ttu-id="c2d73-120">GetDefaultDim</span><span class="sxs-lookup"><span data-stu-id="c2d73-120">GetDefaultDim</span></span>|<span data-ttu-id="c2d73-121">Изменение для возврата кода набора измерений вместо набора записей.</span><span class="sxs-lookup"><span data-stu-id="c2d73-121">Modify to return an integer Dimension Set ID instead of a set of records.</span></span>|  
|<span data-ttu-id="c2d73-122">CopyJnlLineDimToICJnlDim</span><span class="sxs-lookup"><span data-stu-id="c2d73-122">CopyJnlLineDimToICJnlDim</span></span><br /><br /> <span data-ttu-id="c2d73-123">CopyICJnlDimToJnlLineDim</span><span class="sxs-lookup"><span data-stu-id="c2d73-123">CopyICJnlDimToJnlLineDim</span></span><br /><br /> <span data-ttu-id="c2d73-124">CopyDocDimtoICDocDim</span><span class="sxs-lookup"><span data-stu-id="c2d73-124">CopyDocDimtoICDocDim</span></span><br /><br /> <span data-ttu-id="c2d73-125">CopyICDocDimtoICDocDim</span><span class="sxs-lookup"><span data-stu-id="c2d73-125">CopyICDocDimtoICDocDim</span></span>|<span data-ttu-id="c2d73-126">Изменение для работы с DimSetID -> ICJnlLineDim</span><span class="sxs-lookup"><span data-stu-id="c2d73-126">Modify to work with DimSetID -> ICJnlLineDim</span></span>|  

## <a name="deleted-functions"></a><span data-ttu-id="c2d73-127">Удаленные функции</span><span class="sxs-lookup"><span data-stu-id="c2d73-127">Deleted Functions</span></span>  
...
>  <span data-ttu-id="c2d73-129">В ходе обновления кода приложения с Microsoft Dynamics NAV 2009 или предыдущих версий до Microsoft Dynamics NAV 2016 следующие функции будут недоступны для Microsoft Dynamics NAV 2016.</span><span class="sxs-lookup"><span data-stu-id="c2d73-129">During the upgrade of application code from Microsoft Dynamics NAV 2009 or earlier versions to Microsoft Dynamics NAV 2016, the following functions are not available in Microsoft Dynamics NAV 2016.</span></span> <span data-ttu-id="c2d73-130">Если у вас имеются настройки, использующие какие-либо из этих функций, вам потребуется внести в код соответствующие изменения.</span><span class="sxs-lookup"><span data-stu-id="c2d73-130">If you have customizations that use one or more of the functions, you must upgrade that code accordingly.</span></span>
 ...
 <span data-ttu-id="c2d73-144">GetDocDim</span><span class="sxs-lookup"><span data-stu-id="c2d73-144">GetDocDim</span></span>  
 ...
 <span data-ttu-id="c2d73-164">ShowTempDim</span><span class="sxs-lookup"><span data-stu-id="c2d73-164">ShowTempDim</span></span>  
 ...
 <span data-ttu-id="c2d73-184">CopySCDimToDocDim</span><span class="sxs-lookup"><span data-stu-id="c2d73-184">CopySCDimToDocDim</span></span>  
 ...
 <span data-ttu-id="c2d73-205">CopyJnlLineDimToBuffer</span><span class="sxs-lookup"><span data-stu-id="c2d73-205">CopyJnlLineDimToBuffer</span></span>  
