...
# <a name="searching-for-customers-vendors-and-other-contacts-from-microsoft-teams" />Поиск клиентов, поставщиков и других контактов из Microsoft Teams
...
## <a name="look-up-contacts-from-the-command-box" />Поиск контактов из командного поля
...
## <a name="look-up-contacts-from-the-message-compose-box" />Поиск контактов из поля создания сообщения
...
### <a name="heres-another-way" />Вот другой способ
...
## <a name="viewing-contact-card-details" />Просмотр сведений в карточке контакта
