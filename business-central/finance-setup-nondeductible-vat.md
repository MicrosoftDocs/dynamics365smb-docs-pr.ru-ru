...
# <a name="set-up-nondeductible-vat"></a>Настройка невычитаемого НДС
...
## <a name="use-nondeductible-vat"></a>Использование невычитаемого НДС
...
## <a name="use-the-nondeductible-vat-percentage"></a>Использование процента невычитаемого НДС
...
2. На странице **Настройка учета НДС** заполните поля, как описано в следующей таблице.
    ...
    | **невычитаемый НДС %** | Укажите процент от суммы транзакции, к которой не применяется НДС. |
    | **Счет НДС по покупкам, не подлежащий вычету** | Укажите счет, связанный с суммой НДС, не подлежащей вычету ввиду типа приобретаемых товаров или услуг. |
