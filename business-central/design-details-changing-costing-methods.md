...
# <a name="design-details-change-the-costing-method-for-items" />Сведения о проектировании: изменение методов учета себестоимости для товаров
...
## <a name="about-costing-methods" />О методах расчета себестоимости
...
## <a name="use-assembly-orders-to-change-costing-method-assignments" />Использование заказов на сборку для изменения назначений метода учета себестоимости
...
### <a name="define-a-default-costing-method" />Определите метод учета себестоимости по умолчанию
...
### <a name="identify-the-items-to-change-the-costing-method-for-and-renumber-them" />Определите товары, для которых необходимо изменить метод учета себестоимости, и перенумеруйте их
...
### <a name="create-new-items-with-the-old-numbering-scheme-and-copy-the-master-data-in-a-batch" />Создайте новые товары со старой схемой нумерации и скопируйте основные данные в пакете
...
### <a name="manually-copy-related-master-data-from-the-original-item-to-the-new-item" />Вручную скопируйте связанные основные данные из исходного товара в новый товар
...
### <a name="determine-the-inventory-quantity-to-convert-from-the-original-item-to-the-new-item" />Определите количество запасов для преобразования из исходного товара в новый
...
### <a name="transfer-the-inventory-to-the-new-item" />Перенести запас на новый товар
...
### <a name="handle-inventory-quantities-that-are-allocated-to-demand" />Обработка количества запасов, которые распределены по требованию
...
### <a name="block-the-original-item-from-further-use" />Заблокируйте исходный товар от дальнейшего использования
