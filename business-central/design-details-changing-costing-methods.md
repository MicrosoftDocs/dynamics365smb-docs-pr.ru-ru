...
# Сведения о проектировании: изменение методов учета себестоимости для товаров
...
## О методах расчета себестоимости
...
## Использование заказов на сборку для изменения назначений метода учета себестоимости
...
### Определите метод учета себестоимости по умолчанию
...
### Определите товары, для которых необходимо изменить метод учета себестоимости, и перенумеруйте их
...
### Создайте новые товары со старой схемой нумерации и скопируйте основные данные в пакете
...
### Вручную скопируйте связанные основные данные из исходного товара в новый товар
...
|Работа |Цена работы |Проверьте, определены ли цены по проекту для исходного товара и перенесите эти данные в новый товар. Эта информация доступна на страница **Карточка проекта** в части **Сведения о проекте — Количество цен** на **информационной панели**. |
|Услуга |Квалификация сервисного ресурса |Проверьте, определены ли квалификации сервисного ресурса для исходного товара и перенесите эти данные в новый товар. Для просмотра квалификации ресурсов используйте действие **Квалификация ресурсов** на странице **Карточка товара**.  |
...
### Определите количество запасов для преобразования из исходного товара в новый
...
### Перенести запас на новый товар
...
### Обработка количества запасов, которые распределены по требованию
...
|Работы |Строки планирования проекта и строки журнала проекта |
|Услуга |Сервисные документы и сервисные контракты |
|Зона производства |Производственные заказы (запланированные, утвержденные производственные и выпущенные) |

### Заблокируйте исходный товар от дальнейшего использования
