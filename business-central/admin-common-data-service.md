...
## Приступая к работе с [!INCLUDE[prod_short](includes/cds_long_md.md)]
...
## Стандартные и пользовательские объекты
...
## См. соответствующее [обучение Microsoft](/training/modules/use-model-driven-apps-common-data-service/)
