...
# <a name="integrating-with-microsoft-dataverse" />Интеграция с Microsoft Dataverse
...
## <a name="bi-directional-or-uni-directional-data-synchronization" />Двунаправленная или однонаправленная синхронизация данных
...
## <a name="standard-and-custom-entities" />Стандартные и пользовательские объекты
...
## <a name="about-the-business-central-base-integration-solution" />О базовом решении интеграции Business Central
