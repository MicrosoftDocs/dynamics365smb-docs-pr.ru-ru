...
> [!NOTE]  
> Выбор языков будет сброшен на ваши настройки на вашем профиль Office 365, если ваш администратор синхронизирует пользователей из Office 365 в [!INCLUDE[d365fin](includes/d365fin_md.md)].
...
Можно изменить регион на вкладке браузера, который используется для работы в [!INCLUDE[d365fin](includes/d365fin_md.md)]. Изменение применяется только к вам, а не к другим пользователям в вашей организации.  Обратите внимание, что выбор региона будет сброшен на ваши настройки в вашем профиле Office, если ваш администратор синхронизирует пользователей из Office 365 в [!INCLUDE[d365fin](includes/d365fin_md.md)].
