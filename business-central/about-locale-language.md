...
ms.author: edupont
---
# <a name="changing-language-and-region"></a><a name="changing-language-and-region"></a><a name="changing-language-and-region"></a>Изменение языка и региона
...
## <a name="changing-your-region-setting"></a><a name="changing-your-region-setting"></a><a name="changing-your-region-setting"></a>Изменение настроек вашего региона
...
## <a name="changing-the-region-setting-for-customers-contacts-and-vendors"></a><a name="changing-the-region-setting-for-customers-contacts-and-vendors"></a><a name="changing-the-region-setting-for-customers-contacts-and-vendors"></a>Изменение настроек региона для клиентов, контактов и поставщиков
...
## <a name="application-version"></a><a name="application-version"></a><a name="application-version"></a>Версия приложения
...
## <a name="languages-of-the--help"></a><a name="languages-of-the--help"></a><a name="languages-of-the--help"></a>Языки справки [!INCLUDE[prod_short](includes/prod_short.md)]
...
### <a name="how-do-i-change-the-language-of-the-microsoft-learn-site"></a><a name="how-do-i-change-the-language-of-the-microsoft-learn-site"></a><a name="how-do-i-change-the-language-of-the-microsoft-learn-site"></a>Как изменить язык сайта Microsoft Learn?
