...
ms.author: edupont
---
# <a name="set-up-currencies"></a><a name="set-up-currencies"></a>Настройка валют
...
## <a name="currencies"></a><a name="currencies"></a><a name="curr"></a>Валюты
...
### <a name="available-currency-functions"></a><a name="available-currency-functions"></a>Доступные валютные функции
...
## <a name="lcy-and-other-currencies"></a><a name="lcy-and-other-currencies"></a>Местная и другие валюты

[!INCLUDE [finance-currencies-lcy-def](includes/finance-currencies-lcy-def.md)]

## <a name="rounding-currencies"></a><a name="rounding-currencies"></a>Валюты для округления
...
### <a name="unit-amount-rounding"></a><a name="unit-amount-rounding"></a>Округление цены
...
### <a name="amount-rounding"></a><a name="amount-rounding"></a>Округление суммы
...
## <a name="general-ledger-accounts"></a><a name="general-ledger-accounts"></a>Счета ГК
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>См. соответствующее [обучение Microsoft](/training/modules/currencies-exchange-rates-dynamics-365-business-central/)
