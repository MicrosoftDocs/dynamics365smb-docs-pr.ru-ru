...
ms.author: edupont
---
# <a name="set-up-currencies"></a><a name="set-up-currencies"></a><a name="set-up-currencies"></a>Настройка валют
...
## <a name="currencies"></a><a name="currencies"></a><a name="currencies"></a><a name="curr"></a>Валюты
