...
ms.author: edupont
---
# <a name="set-up-time-sheets" />Настройка табелей учета рабочего времени
...
## <a name="set-up-time-sheets-with-the-assisted-setup-guide" />Настройте табели учета рабочего времени с помощью мастера настройки
...
## <a name="set-up-time-sheets-manually" />Настройка табелей учета рабочего времени вручную
...
### <a name="to-set-up-general-information-for-time-sheets-manually" />Настройка общей информации для табелей вручную
...
### <a name="to-assign-a-time-sheet-administrator-manually" />Назначение администратора табелей учета рабочего времени вручную
...
### <a name="to-assign-a-time-sheets-owner-and-approver-manually" />Назначение владельца и утверждающего для табелей вручную
