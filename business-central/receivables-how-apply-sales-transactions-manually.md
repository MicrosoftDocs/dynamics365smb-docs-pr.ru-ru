...
---
# <a name="reconcile-customer-payments-manually"></a>Сводка клиентских платежей вручную
...
* Вводя информацию на специальных страницах, например на страницах **Журнал приходных кассовых ордеров** и **Журнал выверки платежей**.
...
Платежи клиентов можно вручную применять на странице **Журнал приходных кассовых ордеров**. Журнал кассовых поступлений представляет собой тип финансового журнала, так что его можно использовать для учета транзакций в Главной книге, банковских счетах, счетах клиентов, поставщиков и основных средств. При учете платежа можно применить его к одной или нескольким дебетовым операциям или можно применить платеж из учтенной операции позднее.

Вы также можете применять платежи клиентов и поставщиков на странице **Журнал выверки платежей** с помощью функций импорта банковской выписки, автоматического применения и выверки банковского счета. Дополнительные сведения см. в разделе [Выверка платежей с использованием автоматического применения](receivables-how-reconcile-payments-auto-application.md). Кроме того, вы можете выверять платежи клиентов на основании списка неоплаченных документов продажи на странице **Регистрация платежей**. Дополнительные сведения см. в разделе [Выверка платежей клиентов из списка неоплаченных документов продажи](receivables-how-reconcile-customer-payments-list-unpaid-sales-documents.md).
