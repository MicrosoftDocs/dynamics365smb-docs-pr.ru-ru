...
ms.author: edupont
---
# <a name="set-up-units-of-measure" />Настройка единиц измерения
...
## <a name="to-set-up-units-of-measure" />Чтобы настроить единицы измерения
...
## <a name="to-set-up-multiple-item-units-of-measure" />Чтобы настроить несколько единиц измерения товара
...
## <a name="to-set-up-unit-of-measure-translations" />Настройка переводов единиц измерения
...
## <a name="to-enter-a-default-unit-of-measure-code-for-sales-and-purchasing-transactions" />Ввод кода единицы измерения по умолчанию для транзакций продаж и покупок
