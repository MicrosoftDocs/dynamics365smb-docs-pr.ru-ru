...
ms.author: edupont
---
# <a name="setting-up-source-codes-and-reason-codes-for-audit-trails" />Настройка кодов источников и кодов причин для журналов аудита
...
## <a name="define-source-codes" />Определение кодов источника
...
### <a name="to-define-source-codes" />Определение кодов источников
...
## <a name="change-source-codes" />Изменение кодов источников
...
### <a name="to-change-source-codes" />Изменение кодов источников
...
## <a name="define-reason-codes" />Определение кодов причин
...
### <a name="to-set-up-reason-codes" />Настройка кодов причин
...
### <a name="to-assign-reason-codes-to-journal-templates" />Назначение кодов причин шаблонам журналов
...
### <a name="to-use-reason-codes-on-sales-and-purchase-documents" />Использование кодов причин в документах продажи и покупки
