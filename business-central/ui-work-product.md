...
## <a name="links-to-learn-more" />Ссылки для получения дополнительных сведений
...
## <a name="getting-around-in-business-central" />Навигация в Business Central
Здесь приведено короткое видео о том, как перемещаться в [!INCLUDE[prod_short](includes/prod_short.md)].

> [!VIDEO https://www.youtube.com/embed/zqz03iMihx0]

## <a name="choosing-a-desktop-browser" />Выбор браузера рабочего стола
...
## <a name="action-bars" />Панели действий
