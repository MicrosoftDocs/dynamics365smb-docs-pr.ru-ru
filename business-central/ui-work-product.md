...
ms.author: edupont
---
# <a name="work-with-"></a><a name="work-with-"></a>Работа с [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="tips-and-tricks"></a><a name="tips-and-tricks"></a><a name="cheatsheet"></a>Советы и подсказки
...
## <a name="links-to-learn-more"></a><a name="links-to-learn-more"></a>Ссылки для получения дополнительных сведений
...
## <a name="getting-around-in-business-central"></a><a name="getting-around-in-business-central"></a>Навигация в Business Central
Здесь приведено короткое видео о том, как перемещаться в [!INCLUDE[prod_short](includes/prod_short.md)].

> [!VIDEO https://www.youtube.com/embed/zqz03iMihx0]

## <a name="choosing-a-desktop-browser"></a><a name="choosing-a-desktop-browser"></a>Выбор браузера рабочего стола
...
## <a name="action-bars"></a><a name="action-bars"></a>Панели действий
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>См. соответствующее [обучение Microsoft](/training/paths/work-pro-data-dynamics-365-business-central/)
