...
---
# <a name="included365fin_longincludesd365fin_long_mdmd-trials-and-subscriptions"></a>Пробные версии и подписки [!INCLUDE[d365fin_long](includes/d365fin_long_md.md)]
...
Вы можете зарегистрироваться на бесплатную пробную версию [здесь](https://go.microsoft.com/fwlink/?linkid=847861). В зависимости от вашей страны или региона пробная версия включает в себя языки и функциональные возможности, необходимые для вашей страны или региона. Для получения дополнительной информации см. [Изменение языка и языкового стандарта](about-locale-language.md).  
...
Если вы столкнулись с трудностями, страница [Вопросы и ответы](across-faq.md) поможет вам ответить на некоторые ваши вопросы. Если вы не смогли подписаться на пробную версию, вам поможет страница [Устранение неполадок при самостоятельной регистрации](ui-troubleshoot-self-signup.md). Вы также можете связаться с [партнером](across-faq.md#findpartner) и попросить его создать для вас бесплатную пробную версию.  

### <a name="try-out-your-own-company"></a>Попробуйте создать собственную компанию

Если вы хотите попробовать [!INCLUDE [prodshort](includes/prodshort.md)] с собственными данными, вы можете перейти на бесплатную 30-дневную пробную версию с пустой компанией, чтобы вы могли импортировать в нее свои собственные данные.  
...
### <a name="setting-up-your-company-in-include-prodshortincludesprodshortmd"></a>Настройка собственной компании в [!INCLUDE [prodshort](includes/prodshort.md)]

Чтобы помочь вам создать собственной компанию, на странице **Мастер настройки** есть необходимые руководства. В зависимости от вашей роли, страны или региона, на этой странице приводятся различные руководства по настройке, например:
...
На странице **Мастер настройки** могут быть доступны и другие материалы. Когда вы пройдете этап, он будет помечен как **Завершенный**. Вы можете настроить дополнительные области компании вручную. Дополнительные сведения см. в разделе [Настройка [!INCLUDE[d365fin](includes/d365fin_md.md)]](setup.md).  

### <a name="resetting-your-includeprodshortincludesprodshortmd-trial-experience"></a>Сброс пробной версии [!INCLUDE[prodshort](includes/prodshort.md)]

Если вы добавили данные в свою бесплатную пробную версию [!INCLUDE[prodshort](includes/prodshort.md)] и хотите начать с нуля, вы можете создать новую пробную организацию, а затем сбросить первую организацию. Если вы откроете страницу **Компании** и выберите **Создать**, мастер настройки **Создать новую компанию** поможет вам создать новую пробную компанию с примерами данных. Вы также можете создать копию вашей текущей компании, выйти, а затем войти в новую компанию.  
...
Среды "песочницы" позволяют попрактиковаться с [!INCLUDE[d365fin](includes/d365fin_md.md)]. Песочница — это непроизводственная среда, которую можно использовать поверх производственного экземпляра [!INCLUDE[d365fin](includes/d365fin_md.md)].  

Песочница позволяет безопасно построить и протестировать расширения и разработать новую функциональность для настройки сервиса без влияния на данные и настройки в производственных экземплярах. Например, если вы хотите пройти бесплатное онлайн-обучение от [Microsoft Learn](/learn/browse/?products=dynamics-business-central), вы можете создать среду "песочницы" и практиковаться там, а не в своей производственной среде.  

Прямо сейчас все клиенты могут использовать песочницу. Дополнительные сведения о том, как начать работать с песочницей, см. в разделе [Создание среды "песочницы"](across-how-create-sandbox-environment.md).  
