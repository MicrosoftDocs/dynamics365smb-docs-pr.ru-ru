...
### <a name="setting-up-your-company-in-prod_short"></a>Настройка собственной компании в [!INCLUDE[prod_short](includes/prod_short.md)]
...
На странице **Мастер настройки** могут быть доступны и другие материалы. Когда вы пройдете настройку, настройка будет помечена как **Завершено**. Вы можете настроить дополнительные области компании вручную. Дополнительные сведения см. в разделе [Настройка [!INCLUDE[prod_short](includes/prod_short.md)]](setup.md).  
