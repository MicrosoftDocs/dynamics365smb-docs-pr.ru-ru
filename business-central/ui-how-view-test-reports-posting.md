...
ms.author: solsen
---
# <a name="view-test-reports-before-posting" />Просмотр тестовых отчетов перед учетом
...
## <a name="to-print-a-test-report-before-posting-a-purchase-invoice" />Печать тестового отчета до учета счета покупки
