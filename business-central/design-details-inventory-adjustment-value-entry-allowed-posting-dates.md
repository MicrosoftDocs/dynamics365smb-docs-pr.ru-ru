...
## <a name="change-the-user-setup" />Измените настройки пользователя
...
### <a name="overview-of-involved-posting-date-setup" />Обзор соответствующей настройки дат учета
...
#### <a name="user-setup" />Настройка пользователя
