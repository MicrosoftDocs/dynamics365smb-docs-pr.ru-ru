...
| --------------------- | -------------------- |
| Для адресов электронной почты Office 365, которые не зарегистрированы в поддерживаемой стране, при регистрации появится примерно следующее сообщение:<br /><br />**Ошибка. Мы еще не поддерживаем вашу страну или регион.** |[!INCLUDE[d365fin](includes/d365fin_md.md)] в данный момент поддерживает только учетные данные электронной почты Office 365, которые зарегистрированы на ограниченном числе рынков. Дополнительные сведения см. в разделе [Региональная доступность](#regional-availability). |
