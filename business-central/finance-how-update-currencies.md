...
## <a name="preview-the-effect-of-an-adjustment"></a>Предварительный просмотр результатов корректировки
...
#### <a name="dimensions-on-customer-and-vendor-ledger-entries"></a>Измерения в операциях клиентов или поставщиков
...
## <a name="correct-mistakes"></a>Исправление ошибок
