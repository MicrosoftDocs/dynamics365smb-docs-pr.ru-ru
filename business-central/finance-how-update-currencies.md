...
ms.locfileid: "7939930"
---
# <a name="update-currency-exchange-rates"></a>Обновление валютных курсов

Поскольку сфера действия организаций включает все новые и новые страны и регионы, растет необходимость в изучении и составлении финансовых данных в нескольких валютах. Местная валюта (МВ) определяется на странице **Настройка ГК**, как описано в статье [Настройка финансов](finance-setup-finance.md). После определения местной валюты (МВ) она будет представлена как пустая валюта, поэтому, когда поле **Валюта** пустое, это означает, что валюта — МВ.  
