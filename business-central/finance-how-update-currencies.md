...
ms.author: edupont
---
# <a name="update-currency-exchange-rates" />Обновление валютных курсов
...
### <a name="effect-on-customers-and-vendors" />Влияние на клиентов и поставщиков
...
#### <a name="dimensions-on-customer-and-vendor-ledger-entries" />Измерения в книге операции клиентов и поставщиков
...
### <a name="effect-on-bank-accounts" />Влияние на банковские счета
...
#### <a name="dimensions-on-bank-account-entries" />Измерения в операциях банковских счетов
...
### <a name="effect-on-gl-accounts" />Влияние на счета ГК
...
##### <a name="dimensions-on-gl-account-entries" />Измерения в операциях счетов ГК
...
## <a name="to-set-up-a-currency-exchange-rate-service" />Настройка служб валютных курсов
...
## <a name="to-update-currency-exchange-rates-through-a-service" />Обновление валютных курсов с использованием службы
