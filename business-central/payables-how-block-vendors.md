...
ms.author: bholtorf
---
# <a name="block-vendors"></a><a name="block-vendors"></a><a name="block-vendors"></a>Блокировка поставщиков
...
## <a name="to-block-a-vendor"></a><a name="to-block-a-vendor"></a><a name="to-block-a-vendor"></a>Для блокировки поставщика
