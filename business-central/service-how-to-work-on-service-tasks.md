...
ms.author: edupont
---
# <a name="work-on-service-tasks" />Работа с сервисными задачами
...
## <a name="to-work-on-a-service-task" />Работа над сервисной задачей
...
## <a name="to-register-service-operations" />Регистрация сервисных операций
...
## <a name="to-register-spare-parts" />Регистрация запчастей
...
## <a name="to-register-spare-parts-from-a-service-order" />Регистрация запчастей из сервисного заказа
...
## <a name="to-replace-a-service-item-or-a-service-item-component" />Замена сервисного товара или компонента сервисного товара
...
## <a name="to-change-the-response-time-for-a-service-item-line" />Изменение времени отклика для строки сервисного товара
...
## <a name="to-register-faultresolution-codes" />Регистрация кодов проблем/решений
