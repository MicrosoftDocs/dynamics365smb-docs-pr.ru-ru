...
ms.author: edupont
---
# <a name="work-on-service-tasks"></a><a name="work-on-service-tasks"></a>Работа с сервисными задачами
...
## <a name="to-work-on-a-service-task"></a><a name="to-work-on-a-service-task"></a>Работа над сервисной задачей
...
## <a name="to-register-service-operations"></a><a name="to-register-service-operations"></a>Регистрация сервисных операций
...
## <a name="to-register-spare-parts"></a><a name="to-register-spare-parts"></a>Регистрация запчастей
...
## <a name="to-register-spare-parts-from-a-service-order"></a><a name="to-register-spare-parts-from-a-service-order"></a>Регистрация запчастей из сервисного заказа
...
## <a name="to-replace-a-service-item-or-a-service-item-component"></a><a name="to-replace-a-service-item-or-a-service-item-component"></a>Замена сервисного товара или компонента сервисного товара
...
## <a name="to-change-the-response-time-for-a-service-item-line"></a><a name="to-change-the-response-time-for-a-service-item-line"></a>Изменение времени отклика для строки сервисного товара
...
## <a name="to-register-faultresolution-codes"></a><a name="to-register-faultresolution-codes"></a>Регистрация кодов проблем/решений
