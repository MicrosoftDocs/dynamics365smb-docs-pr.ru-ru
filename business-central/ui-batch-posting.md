...
ms.author: edupont
---
# <a name="post-multiple-documents-at-the-same-time" />Одновременный учет нескольких документов
...
## <a name="to-post-multiple-purchase-orders-immediately" />Немедленный одновременный учет нескольких заказов на покупку
...
## <a name="to-batch-post-multiple-purchase-orders" />Пакетный учет нескольких заказов на покупку
...
## <a name="to-set-up-background-posting-with-job-queues" />Настройка фонового учета с очередями работ
...
### <a name="to-view-status-from-a-sales-or-purchase-document" />Просмотр статуса из документа продажи или покупки
...
## <a name="to-create-a-job-queue-entry-for-batch-posting-of-sales-orders" />Создание записи очереди заданий для фонового учета заказов на продажу
...
## <a name="monitor-the-job-queue" />Отслеживание очереди заданий
