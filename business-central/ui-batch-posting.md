...
## Немедленный одновременный учет нескольких заказов на покупку
...
## Пакетный учет нескольких заказов на покупку
...
## Настройка фонового учета с очередями работ
...
### Просмотр статуса из документа продажи или покупки
...
## Создание записи очереди заданий для фонового учета заказов на продажу
