---
title: Работа с общими заказами на продажу или заказами на закупку
...
ms.author: edupont
---
# <a name="work-with-blanket-sales-orders-or-blanket-purchase-orders"></a><a name="work-with-blanket-sales-orders-or-blanket-purchase-orders"></a><a name="work-with-blanket-sales-orders-or-blanket-purchase-orders"></a>Работа с общими заказами на продажу или общими заказами на закупку
...
## <a name="to-create-a-blanket-sales-order"></a><a name="to-create-a-blanket-sales-order"></a><a name="to-create-a-blanket-sales-order"></a>Создание общего заказа на продажу
...
## <a name="to-create-a-sales-order-from-a-blanket-sales-order"></a><a name="to-create-a-sales-order-from-a-blanket-sales-order"></a><a name="to-create-a-sales-order-from-a-blanket-sales-order"></a>Создание заказа на продажу из общего заказа на продажу
...
## <a name="to-view-the-status-of-a-blanket-sales-order"></a><a name="to-view-the-status-of-a-blanket-sales-order"></a><a name="to-view-the-status-of-a-blanket-sales-order"></a>Просмотр статуса общего заказа на продажу

Статус общих заказов на продажу можно просматривать на странице **Статистика общего заказа на продажу**. Это может потребоваться, когда пользователь начинает выставлять счет по заказу, созданному из общего заказа на продажу.  

1.  Выберите ![Лампочка, которая открывает функцию Что вы хотите сделать.](media/ui-search/search_small.png "Что вы хотите сделать") значок введите **Общие заказы на продажу**, а затем выберите связанную ссылку.  
2.  Выберите общий заказ на продажу, затем выберите действие **Статистика**.  
3.  На странице **Статистика общих заказов на продажу** на экспресс-вкладке **Общее** можно просмотреть суммарную информацию по всему заказу, основанную на общем количестве из различных полей **Количество** в строках общего заказа на продажу.  
...
## <a name="to-view-unposted-and-posted-blanket-sales-order-lines"></a><a name="to-view-unposted-and-posted-blanket-sales-order-lines"></a><a name="to-view-unposted-and-posted-blanket-sales-order-lines"></a>Для просмотра неучтенных и учтенных строк общего заказа на продажу
