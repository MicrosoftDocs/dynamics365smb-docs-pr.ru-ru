...
ms.author: edupont
---
# <a name="work-with-blanket-sales-orders-or-blanket-purchase-orders" />Работа с общими заказами на продажу или общими заказами на закупку
...
## <a name="to-create-a-blanket-sales-order" />Создание общего заказа на продажу
...
## <a name="to-create-a-sales-order-from-a-blanket-sales-order" />Создание заказа на продажу из общего заказа на продажу
...
## <a name="to-view-the-status-of-a-blanket-sales-order" />Просмотр статуса общего заказа на продажу
...
## <a name="to-view-unposted-and-posted-blanket-sales-order-lines" />Для просмотра неучтенных и учтенных строк общего заказа на продажу
