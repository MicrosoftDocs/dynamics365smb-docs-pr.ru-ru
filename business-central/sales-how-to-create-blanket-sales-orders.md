---
title: "Практическое руководство. Создание общих заказов на продажу | Документы Майкрософт"
...
---
# <a name="work-with-blanket-sales-orders"></a>Работа с общими заказами на продажу
...
Статус общих заказов на продажу можно просматривать на странице **Статистика контрактов общего заказа**. Это может потребоваться, когда пользователь начинает выставлять счет по заказу, созданному из общего заказа на покупку.  

1.  Выберите значок ![Лампочка, которая открывает функцию Что вы хотите сделать](media/ui-search/search_small.png "Что вы хотите сделать"), введите **Общие заказы на покупку**, затем выберите связанную ссылку.  
2.  Выберите общий заказ на покупку, затем выберите действие **Статистика**.  
3.  На странице **Статистика общих заказов на покупку** на экспресс-вкладке **Общее** можно просмотреть суммарную информацию по всему заказу, основанную на общем количестве из различных полей **Количество** в строках общего заказа на покупку.  
