...
ms.author: edupont
---
# <a name="customize-pages-for-profiles" />Настройка страниц для профилей
...
## <a name="to-customize-pages-for-a-profile" />Настройка страниц для профиля
...
## <a name="to-view-all-customized-pages-for-a-profile" />Просмотр всех настроенных страниц для профиля
...
## <a name="to-delete-all-customizations-for-a-profile" />Удаление всех настроек для профиля.
...
## <a name="to-delete-customization-for-specific-pages-for-a-profile" />Удаление настройки для конкретных страниц профиля
