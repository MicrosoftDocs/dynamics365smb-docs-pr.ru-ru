...
ms.author: bholtorf
---
# <a name="block-items-from-sales-or-purchasing" />Блокировка товаров для продажи или покупки
...
## <a name="to-block-an-item-from-being-entered-on-sales-lines" />Блокировка ввода товара в строки продажи
...
## <a name="to-block-an-item-from-being-entered-on-purchase-lines" />Блокировка ввода товара в строки покупки

1. Выберите ![Лампочка, которая открывает функцию Что вы хотите сделать.](media/ui-search/search_small.png "Что вы хотите сделать") значок введите **Товары**, а затем выберите связанную ссылку.  
2. Выберите товар, который необходимо заблокировать, а затем установите флажок **Покупки заблокированы**.  

## <a name="to-block-an-item-from-being-posted" />Блокировка товара для учета
