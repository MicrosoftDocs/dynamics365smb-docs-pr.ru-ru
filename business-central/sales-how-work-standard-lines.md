---
title: Стандартные типовые строки продажи и покупки
description: Настройте часто используемые строки покупок и продаж, а затем вставьте их в документы продажи и покупки, чтобы быстро заполнять строки стандартной информацией.
author: SorenGP
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
...
1. Выберите ![Лампочка, которая открывает функцию Что вы хотите сделать.](media/ui-search/search_small.png "Что вы хотите сделать") значок введите **Счета**, а затем выберите связанную ссылку.
