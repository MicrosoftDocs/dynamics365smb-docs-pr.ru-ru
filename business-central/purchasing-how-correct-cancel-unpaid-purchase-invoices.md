...
## Коррекция учтенного счета покупки
...
## Отмена учтенного счета покупки
...
## См. соответствующее [обучение Microsoft](/training/modules/receive-invoice-dynamics-d365-business-central/)
