...
ms.author: edupont
---
# <a name="correct-or-cancel-unpaid-purchase-invoices" />Исправление или отмена неоплаченных счетов покупки
...
## <a name="to-correct-a-posted-purchase-invoice" />Коррекция учтенного счета покупки
...
## <a name="to-cancel-a-posted-purchase-invoice" />Отмена учтенного счета покупки
...
### <a name="partial-invoice-posting-also-supported" />Также поддерживается частичный учет счетов
...
## <a name="see-related-microsoft-trainingtrainingmodulesreceive-invoice-dynamics-d-business-central" />См. соответствующее [обучение Microsoft](/training/modules/receive-invoice-dynamics-d365-business-central/)
