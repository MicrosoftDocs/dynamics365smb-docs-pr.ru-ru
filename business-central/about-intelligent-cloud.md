...
# <a name="intelligent-insights-in--online" />Интеллектуальная аналитика в [!INCLUDE[prod_short](includes/prod_short.md)] Online
...
## <a name="viewing-insights-in--online" />Просмотр аналитики в [!INCLUDE[prod_short](includes/prod_short.md)] Online
