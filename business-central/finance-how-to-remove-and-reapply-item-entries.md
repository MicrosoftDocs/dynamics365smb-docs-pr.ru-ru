...
ms.author: edupont
---
# <a name="remove-and-reapply-item-ledger-entries" />Удаление и повторное применение операций журнала товаров
...
## <a name="to-remove-an-item-application-by-using-the-application-worksheet" />Удаление товара с использованием листа применения
...
## <a name="to-reapply-an-item-application-by-using-the-application-worksheet" />Повторное применение товара с использованием листа применения
