...
ms.author: edupont
---
# <a name="design-details-expected-cost-posting"></a><a name="design-details-expected-cost-posting"></a>Сведения о проектировании: учет ожидаемой себестоимости
...
## <a name="prerequisites-for-posting-expected-costs"></a><a name="prerequisites-for-posting-expected-costs"></a>Предварительные требования для учета ожидаемой себестоимости
