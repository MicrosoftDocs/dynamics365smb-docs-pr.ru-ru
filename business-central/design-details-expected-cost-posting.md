...
ms.author: edupont
---
# <a name="design-details-expected-cost-posting" />Сведения о проектировании: учет ожидаемой себестоимости
...
## <a name="prerequisites-for-posting-expected-costs" />Предварительные требования для учета ожидаемой себестоимости
