...
# <a name="keyboard-quick-reference---pc-only" />Краткая справка по сочетаниям клавиш — только ПК
...
#### <a name="navigate--select-rows" />Навигация и выбор строк
...
#### <a name="copy--paste" />Копирование и вставка
...
#### <a name="search-filter--sort" />Поиск, фильтрация и сортировка
...
#### <a name="quick-entry" />Экспресс-ввод
...
##### <a name="report-preview" />Предварительный просмотр отчета

|Выберите эти клавиши|Действие|
|-|-|
|<kbd>Ctrl</kbd>+<kbd>Home</kbd>/<kbd>End</kbd>|Перейти к первой/последней странице|

#### <a name="numeric-keypad" />Цифровая клавиатура
