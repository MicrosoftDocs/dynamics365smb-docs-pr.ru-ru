...
# <a name="keyboard-quick-reference---pc-only"></a><a name="keyboard-quick-reference---pc-only"></a>Краткая справка по сочетаниям клавиш — только ПК

#### <a name="general"></a><a name="general"></a>Общие
...
#### <a name="navigate--select-rows"></a><a name="navigate--select-rows"></a>Навигация и выбор строк
...
#### <a name="copy--paste"></a><a name="copy--paste"></a>Копирование и вставка
...
#### <a name="search-filter--sort"></a><a name="search-filter--sort"></a>Поиск, фильтрация и сортировка
...
#### <a name="quick-entry"></a><a name="quick-entry"></a>Экспресс-ввод
...
##### <a name="report-preview"></a><a name="report-preview"></a>Предварительный просмотр отчета

|Выберите эти клавиши|Действие|
|-|-|
|<kbd>Ctrl</kbd>+<kbd>Home</kbd>/<kbd>End</kbd>|Перейти к первой/последней странице|

#### <a name="numeric-keypad"></a><a name="numeric-keypad"></a>Цифровая клавиатура
