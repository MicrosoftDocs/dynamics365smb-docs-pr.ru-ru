...
8. На экспресс-вкладке **Определения столбца** измените или заполните поля, как описано в следующей таблице.  
    ...
    |**Формат данных**|Укажите формат данных, если есть. Например, **ММ-дд-гггг**, если используется тип данных **Дата**. **Примечание.** Для экспорта укажите формат данных в соответствии с [!INCLUDE[prod_short](includes/prod_short.md)]. Для импорта укажите формат данных в соответствии с платформой .NET. Дополнительные сведения см. в разделе [Стандартные строки форматирования даты и времени](https://go.microsoft.com/fwlink/?LinkID=323466).|  
