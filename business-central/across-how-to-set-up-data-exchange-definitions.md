...
### <a name="to-map-columns-in-the-data-file-to-fields-in-prod_short"></a><a name=mapfields></a>Сопоставление столбцов в файле данных с полями в [!INCLUDE[prod_short](includes/prod_short.md)]
