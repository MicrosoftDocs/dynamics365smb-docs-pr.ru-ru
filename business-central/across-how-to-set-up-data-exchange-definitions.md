...
---
# Создание определений обмена данными
...
### <a name=formatlinescolumns></a>Описание форматирования строк и столбцов в файле
...
### <a name=mapfields></a>Сопоставление столбцов в файле данных с полями в [!INCLUDE[prod_short](includes/prod_short.md)]
