...
ms.author: edupont
---
# <a name="correct-prepayments"></a><a name="correct-prepayments"></a><a name="correct-prepayments"></a>Корректировка предоплат
...
## <a name="to-correct-a-prepayment"></a><a name="to-correct-a-prepayment"></a><a name="to-correct-a-prepayment"></a>Корректировка предоплаты
