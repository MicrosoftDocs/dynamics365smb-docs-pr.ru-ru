...
# <a name="correct-prepayments"></a>Правильные предоплаты

Можно скорректировать заказ после учета счета на предоплату по данному заказу. Вы можете добавлять новые строки в заказ после внесения предоплаты, а затем выставлять еще один счет на предоплату, но вы не можете удалить строку из заказа после того, как по ней был выставлен счет на предоплату.  
