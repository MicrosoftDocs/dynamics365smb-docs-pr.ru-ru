...
ms.author: edupont
---
# <a name="design-details-integration-with-inventory" />Сведения о проектировании: интеграция с запасом
...
## <a name="physical-inventory" />Склад
...
## <a name="warehouse-adjustments-to-the-item-ledger" />Складские коррекции в журнале товаров
