...
ms.author: jswymer
---
# <a name="managing-database-access-intent" />Управление намерением доступа к базе данных
...
## <a name="to-change-the-database-access-intent" />Изменение намерения доступа к базе данных
...
## <a name="see-related-microsoft-training" />См. соответствующее [обучение Microsoft](/training/paths/deploy-configure-dynamics-365-business-central/)
