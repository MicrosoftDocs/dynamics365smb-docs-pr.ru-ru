...
# <a name="get-ready-to-synchronize-master-data" />Подготовка к синхронизации основных данных
...
## <a name="uni-directional-synchronization-only" />Данные синхронизируются только в одном направлении
...
## <a name="specify-the-source-company" />Указание исходной компании
...
## <a name="enable-or-disable-tables-and-fields" />Включение или выключение таблиц и полей
...
### <a name="use-match-based-coupling" />Использование связывания на основе совпадений
...
## <a name="synchronize-for-the-first-time" />Синхронизация, производимая в первый раз
...
## <a name="add-or-delete-tables-from-the-synchronization-tables-list" />Добавление или удаление таблиц из списка таблиц синхронизации

### <a name="add-a-table" />Добавление таблицы
...
### <a name="delete-a-table" />Удаление таблицы
...
## <a name="use-export-and-import-to-share-a-synchronization-setup" />Использование экспорта и импорта для обмена настройками синхронизации
