...
ms.author: jswymer
---
# <a name="set-up-opportunity-sales-cycles-and-cycle-stages" />Настройка циклов возможных продаж и этапов циклов
...
## <a name="to-set-up-opportunity-sales-cycle-codes" />Настройка кодов циклов продаж для возможностей
...
## <a name="to-define-opportunity-sales-cycle-stages" />Определение этапов цикла продаж
...
## <a name="to-assign-stage-cycles-to-opportunities" />Назначение циклов стадий возможностям
...
## <a name="to-set-up-activities-with-tasks" />Настройка действий с задачами
...
## <a name="to-assign-tasks-or-activities-of-tasks-to-opportunities" />Назначение задач или действий задач возможностям
