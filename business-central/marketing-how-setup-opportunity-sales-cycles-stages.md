...
ms.author: jswymer
---
# <a name="set-up-opportunity-sales-cycles-and-cycle-stages"></a><a name="set-up-opportunity-sales-cycles-and-cycle-stages"></a>Настройка циклов возможных продаж и этапов циклов
...
## <a name="to-set-up-opportunity-sales-cycle-codes"></a><a name="to-set-up-opportunity-sales-cycle-codes"></a>Настройка кодов циклов продаж для возможностей
...
## <a name="to-define-opportunity-sales-cycle-stages"></a><a name="to-define-opportunity-sales-cycle-stages"></a>Определение этапов цикла продаж
...
## <a name="to-assign-stage-cycles-to-opportunities"></a><a name="to-assign-stage-cycles-to-opportunities"></a>Назначение циклов стадий возможностям
...
## <a name="to-set-up-activities-with-tasks"></a><a name="to-set-up-activities-with-tasks"></a>Настройка действий с задачами
...
## <a name="to-assign-tasks-or-activities-of-tasks-to-opportunities"></a><a name="to-assign-tasks-or-activities-of-tasks-to-opportunities"></a>Назначение задач или действий задач возможностям
