---
title: Составление бюджетов затрат
description: 'В этой статье представлен обзор того, где следует создавать и анализировать бюджеты затрат. Бюджетирование при учете затрат напоминает бюджетирование в Главной книге.'
author: brentholtorf
ms.topic: conceptual
ms.devlang: al
...
# <a name="creating-cost-budgets"></a>Составление бюджетов затрат
