...
ms.author: jswymer
---
# <a name="working-with-microsoft-excel-layouts" />Работа с макетами Microsoft Excel
...
## <a name="why-use-excel-layouts" />Зачем использовать макеты Excel?
...
## <a name="task-1-create-the-excel-layout-file" />Задача 1. Создайте новый файл макета Excel
...
#### <a name="approach-1-export-the-layout-from-the-report-layouts-page" />Подход 1. Экспорт макета на странице **Макеты отчетов**
...
#### <a name="approach-2-download-the-layout-from-the-reports-request-page" />Подход 2. Загрузите макет со страницы запроса отчета
...
## <a name="task-2-add-the-excel-layout-to-the-report" />Задача 2. Добавьте макет Excel в отчет
...
## <a name="understanding-excel-layouts" />Сведения о макетах Excel
