...
## <a name="task--create-the-excel-layout-file" />Задача 1. Создайте новый файл макета Excel
...
#### <a name="approach--export-the-layout-from-the-report-layouts-page" />Подход 1. Экспорт макета на странице **Макеты отчетов**
...
#### <a name="approach--download-the-layout-from-the-reports-request-page" />Подход 2. Загрузите макет со страницы запроса отчета
...
## <a name="task--add-the-excel-layout-to-the-report" />Задача 2. Добавьте макет Excel в отчет
