...
ms.author: bholtorf
---
# <a name="service-price-management" />Управление сервисной ценой
...
## <a name="service-price-adjustment-groups" />Группы коррекции цен на сервисное обслуживание
...
## <a name="service-price-groups" />Ценовые группы сервисного обслуживания
...
## <a name="service-pricing" />Сервисные цены
...
## <a name="service-price-adjustment" />Коррекции цен на сервисное обслуживание
