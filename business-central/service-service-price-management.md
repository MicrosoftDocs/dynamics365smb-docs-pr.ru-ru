...
ms.author: bholtorf
---
# <a name="service-price-management"></a><a name="service-price-management"></a>Управление сервисной ценой
...
## <a name="service-price-adjustment-groups"></a><a name="service-price-adjustment-groups"></a>Группы коррекции цен на сервисное обслуживание
...
## <a name="service-price-groups"></a><a name="service-price-groups"></a>Ценовые группы сервисного обслуживания
...
## <a name="service-pricing"></a><a name="service-pricing"></a>Сервисные цены
...
## <a name="service-price-adjustment"></a><a name="service-price-adjustment"></a>Коррекции цен на сервисное обслуживание
