...
| [Несколько регистрационных номеров плательщика НДС](finance-how-use-multiple-vat-registrations.md) | Узнайте, как настроить несколько регистрационных номеров плательщика налога на добавленную стоимость (НДС) (в качестве альтернативной ставки НДС) для ваших клиентов, которые работают в разных странах. |
