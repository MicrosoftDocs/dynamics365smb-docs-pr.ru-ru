...
ms.author: edupont
---
# <a name="set-up-reminder-terms-and-levels"></a><a name="set-up-reminder-terms-and-levels"></a>Настройка условий и уровней напоминаний
...
## <a name="reminder-terms"></a><a name="reminder-terms"></a>Условия напоминания
...
### <a name="to-set-up-reminder-terms"></a><a name="to-set-up-reminder-terms"></a>Настройка условий напоминания
...
## <a name="reminder-levels"></a><a name="reminder-levels"></a>Уровни напоминаний
...
### <a name="to-set-up-reminder-levels"></a><a name="to-set-up-reminder-levels"></a>Настройка уровней напоминания
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>См. соответствующее [обучение Microsoft](/training/modules/send-reminders-dynamics-365-business-central/)
