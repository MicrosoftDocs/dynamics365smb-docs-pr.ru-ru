...
ms.author: edupont
---
# <a name="set-up-reminder-terms-and-levels" />Настройка условий и уровней напоминаний
...
## <a name="reminder-terms" />Условия напоминания
...
### <a name="to-set-up-reminder-terms" />Настройка условий напоминания
...
## <a name="reminder-levels" />Уровни напоминаний
...
### <a name="to-set-up-reminder-levels" />Настройка уровней напоминания
...
## <a name="see-related-microsoft-trainingtrainingmodulessend-reminders-dynamics--business-central" />См. соответствующее [обучение Microsoft](/training/modules/send-reminders-dynamics-365-business-central/)
