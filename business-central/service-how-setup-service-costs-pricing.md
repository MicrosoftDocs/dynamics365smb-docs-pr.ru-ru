...
# <a name="set-up-pricing-and-additional-costs-for-services" />Настройка цен и дополнительных издержек для сервисов
...
## <a name="to-set-up-a-service-price-group" />Настройка ценовой группы сервиса
...
## <a name="to-set-up-a-service-price-adjustment-group" />Настройка группы коррекции цен на сервисное обслуживание
...
## <a name="to-set-up-additional-costs-for-services" />Для настройки дополнительных затрат для сервисов
...
### <a name="to-set-up-service-costs" />Настройка затрат на сервисное обслуживание
...
### <a name="to-specify-a-default-cost-for-service-orders" />Задание затрат по умолчанию для сервисных заказов
