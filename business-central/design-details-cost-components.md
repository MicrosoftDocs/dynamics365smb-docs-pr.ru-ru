...
ms.author: edupont
---
# <a name="design-details-cost-components"></a><a name="design-details-cost-components"></a><a name="design-details-cost-components"></a>Сведения о проектировании: компоненты себестоимости
