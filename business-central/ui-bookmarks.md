...
# <a name="bookmark-a-page-or-report-on-your-role-center" />Добавление закладки на страницу или отчет в ролевом центре
...
## <a name="to-bookmark-the-target-page" />Добавление закладки на целевую страницу
...
## <a name="to-bookmark-the-target-report" />Добавление закладки на целевой отчет
...
## <a name="to-bookmark-a-page-or-report-from-the-tell-me-window" />Добавление закладки на страницу или отчет из окна "Что вы хотите сделать"
...
## <a name="frequently-asked-questions" />Вопросы и ответы
