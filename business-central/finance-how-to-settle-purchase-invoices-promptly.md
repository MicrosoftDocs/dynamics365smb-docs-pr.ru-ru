...
ms.author: bholtorf
---
# <a name="settle-purchase-invoices-promptly" />Немедленное создание счетов покупки
...
## <a name="to-settle-purchase-invoices-promptly" />Немедленное создание счетов покупки
