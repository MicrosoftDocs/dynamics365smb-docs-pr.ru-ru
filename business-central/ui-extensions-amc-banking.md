...
# <a name="use-the-amc-banking-365-fundamentals-extension"></a>Используйте расширение AMC banking 365 fundamentals
...
Начало работы с расширением включает в себя всего несколько простых шагов, и мастер настройки установит соединение и включит расширение. Руководство поможет вам в таких вопросах, как установка определений обмена данными для настроек экспорта/импорта банковских выписок и инициализация серий номеров, используемых для сообщений о переводе кредита.  
...
3. В поле **Имя**  выберите формат, требуемый вашим банком.  
