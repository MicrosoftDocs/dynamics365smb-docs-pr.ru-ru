...
---
# <a name="use-resources-for-projects"></a>Использование ресурсов для работ
...
## <a name="to-assign-resources-to-projects"></a>Назначение ресурсов работам
...
## <a name="to-record-resource-usage-for-a-project"></a>Регистрация потребления ресурсов для работы
