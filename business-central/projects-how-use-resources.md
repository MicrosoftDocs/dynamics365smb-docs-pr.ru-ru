...
ms.author: edupont
---
# <a name="use-resources-for-jobs" />Использование ресурсов для работ
...
## <a name="to-assign-resources-to-jobs" />Назначение ресурсов работам
...
## <a name="to-record-resource-usage-for-a-job" />Регистрация потребления ресурсов для работы
...
## <a name="to-adjust-resource-prices" />Корректировка цен ресурсов
...
## <a name="to-get-resource-price-change-suggestions-based-on-existing-alternate-prices" />Получения предложений по изменению цены ресурса на основе существующих альтернативных цен
...
## <a name="to-get-resource-price-change-suggestions-based-on-standard-prices" />Получение предложений по изменению цены ресурса на основе стандартных цен
...
## <a name="to-get-resource-price-change-suggestions-based-on-alternate-prices" />Получение предложений по изменению цены ресурса на основе альтернативных цен
