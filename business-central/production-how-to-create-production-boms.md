...
> [!TIP]
> Приложение **Демонстрационные данные Contoso Coffee** включает демонстрационные продукты для различных сценариев производственных спецификаций, которые можно использовать в тестовой среде, в том числе во время пробной версии. Узнайте, как настроить данные Contoso Coffee, и найдите пошаговые руководства для различных сценариев на странице [Введение в демонстрационные данные Contoso Coffee](/contoso-coffee/contoso-coffee-intro.md).
...
В спецификации требуется 70 металлических деталей с размерами: длина = 0,20 м и ширина = 0,15 м. Значения вводятся следующим образом: Формула расчета = Длина x Ширина, Длина = 20, Ширина = 15, Кол-во в = 70. Количество задается как Кол-во в x Длина * Ширина, таким образом, Кол-во = 70 x 0,20 м x 0,15 м = 2,1 м2.  
