...
ms.author: bholtorf
---
# <a name="create-production-boms"></a><a name="create-production-boms"></a><a name="create-production-boms"></a>Создание производственных спецификаций
...
## <a name="to-create-a-production-bom"></a><a name="to-create-a-production-bom"></a><a name="to-create-a-production-bom"></a>Создание производственной спецификации
...
## <a name="to-create-a-new-version-of-a-production-bom"></a><a name="to-create-a-new-version-of-a-production-bom"></a><a name="to-create-a-new-version-of-a-production-bom"></a>Создание новой версии производственной спецификации
...
## <a name="quantity-calculation-formula-on-production-boms"></a><a name="quantity-calculation-formula-on-production-boms"></a><a name="quantity-calculation-formula-on-production-boms"></a>Формула расчета количества в производственных спецификациях
