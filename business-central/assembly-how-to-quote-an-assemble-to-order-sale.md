...
ms.author: edupont
---
# <a name="quote-an-assemble-to-order-sale" />Предложения продажи сборки на заказ
...
## <a name="to-create-a-sales-quote-for-an-assemble-to-order-item" />Создание предложения по продаже для товара сборки на заказ
