...
ms.author: jswymer
---
# <a name="finding-related-entries-for-documents"></a><a name="finding-related-entries-for-documents"></a><a name="finding-related-entries-for-documents"></a>Поиск связанных операций для документов
...
## <a name="search-for-entries"></a><a name="search-for-entries"></a><a name="search-for-entries"></a>Искать операции
