...
ms.author: bholtorf
---
# <a name="set-up-items-and-locations-for-directed-put-away-and-pick" />Настройка товаров и складов для использования расширенного подбора и размещения
...
## <a name="to-set-up-an-item-for-directed-put-away-and-pick" />Настройка товара для использования расширенного подбора и размещения
...
## <a name="to-start-using-directed-put-away-and-pick" />Чтобы начать использовать направленный подбор и размещение
...
## <a name="to-set-up-a-zone-in-your-warehouse" />Настройка зоны на складе
