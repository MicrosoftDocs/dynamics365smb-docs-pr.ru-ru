...
description: Настройте склады на расширенный подбор и размещение, чтобы использовать новый набор функций, которые обеспечивают поддержку максимально эффективного функционирования склада.
author: SorenGP
