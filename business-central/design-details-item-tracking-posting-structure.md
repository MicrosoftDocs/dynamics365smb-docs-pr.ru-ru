...
ms.author: edupont
---
# <a name="design-details-item-tracking-posting-structure"></a><a name="design-details-item-tracking-posting-structure"></a>Сведения о проектировании: структура учета трассировки товаров
...
## <a name="one-to-many-relation"></a><a name="one-to-many-relation"></a>Отношение "один-ко-многим"
...
## <a name="codeunits-80-and-90"></a><a name="codeunits-80-and-90"></a>Codeunit 80 и 90
...
## <a name="posting-the-item-journal"></a><a name="posting-the-item-journal"></a>Учет журнала товаров
...
## <a name="code-unit-22"></a><a name="code-unit-22"></a>Модуль 22
