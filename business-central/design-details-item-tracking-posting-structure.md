...
## <a name="codeunits-80-sales-post--and-90-purch-post"></a>Кодовые единицы 80 (продажа-последующая) и 90 (покупка-последующая)
...
## <a name="code-unit-22--item-jnl-post-line"></a>Код единицы 22 (пункт Jnl.-Post Line)
