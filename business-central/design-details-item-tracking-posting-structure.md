...
ms.author: edupont
---
# <a name="design-details-item-tracking-posting-structure" />Сведения о проектировании: структура учета трассировки товаров
...
## <a name="one-to-many-relation" />Отношение "один-ко-многим"
...
## <a name="codeunits-80-and-90" />Codeunit 80 и 90
...
## <a name="posting-the-item-journal" />Учет журнала товаров
