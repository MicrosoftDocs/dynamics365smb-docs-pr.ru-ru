...
# <a name="the-data-archive-extension"></a><a name="the-data-archive-extension"></a>Расширение архива данных
...
## <a name="start-archiving-data"></a><a name="start-archiving-data"></a>Начать архивирование данных
...
## <a name="storage-considerations"></a><a name="storage-considerations"></a>Рекомендации по хранению
