...
# Просмотр статуса заданий синхронизации
...
## Чтобы просмотреть и устранить ошибки синхронизации для связанных записей
...
## Просмотр журнала синхронизации для конкретной (синхронизированной вручную) записи
...
## Удаление связей между записями
