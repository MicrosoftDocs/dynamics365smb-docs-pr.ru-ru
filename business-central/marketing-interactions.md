...
ms.author: jswymer
---
# <a name="record-interactions-with-contacts"></a><a name="record-interactions-with-contacts"></a>Регистрация взаимодействий с контактами
...
## <a name="setting-up-interaction-templates"></a><a name="setting-up-interaction-templates"></a>Настройка шаблонов взаимодействий
...
## <a name="creating-interactions"></a><a name="creating-interactions"></a>Создание взаимодействий
...
## <a name="viewing-and-managing-recorded-interactions"></a><a name="viewing-and-managing-recorded-interactions"></a>Просмотр записанных взаимодействий и управление ими
