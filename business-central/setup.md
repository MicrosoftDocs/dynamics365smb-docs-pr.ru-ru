...
|Укажите отчеты по умолчанию для использования с различными типами документов.|[Выбор отчетов для документов](across-report-selections.md)|
| Настройка ресурсов, табелей учета рабочего времени и проектов для управления проектами. |[Настройка управления проектами](projects-setup-projects.md) |
