...
|Повысьте качество реализации и сократите время развертывания, используя набор инструментов для настройки новой организации с помощью мастеров, шаблонов, листов и анкет клиента.|[Настройка компании с помощью служб RapidStart Services](admin-set-up-a-company-with-rapidstart.md)|
