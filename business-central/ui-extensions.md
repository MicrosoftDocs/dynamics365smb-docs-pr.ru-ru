...
ms.author: edupont
---
# <a name="customizing-business-central-online-with-apps"></a><a name="customizing-business-central-online-with-apps"></a><a name="customizing-business-central-online-with-apps"></a>Настройка Business Central Online с помощью приложений
...
## <a name="manage-apps"></a><a name="manage-apps"></a><a name="manage-apps"></a>Управление приложениями
...
## <a name="apps-and-data-transfer"></a><a name="apps-and-data-transfer"></a><a name="apps-and-data-transfer"></a>Приложения и передача данных
...
## <a name="connect-your-business"></a><a name="connect-your-business"></a><a name="connect-your-business"></a>Обмен данными для вашего бизнеса
...
## <a name="recommended-apps"></a><a name="recommended-apps"></a><a name="recommended-apps"></a>Рекомендуемые приложения
