...
description: Назначьте товарные издержки, если требуется перенести на товары дополнительные издержки, например в связи с транспортировкой и физическим обращением, которые возникли при покупке или продаже товаров.
author: SorenGP
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
...
1. Выберите ![Лампочка, которая открывает функцию Что вы хотите сделать.](media/ui-search/search_small.png "Что вы хотите сделать") значок, введите **Товарные издержки**, а затем выберите связанную ссылку.
