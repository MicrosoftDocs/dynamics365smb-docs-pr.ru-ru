...
ms.author: edupont
---
# <a name="use-item-charges-to-account-for-additional-trade-costs" />Использование товарных издержек для учета дополнительных торговых расходов
...
## <a name="to-set-up-item-charge-numbers" />Настройка номеров товарных издержек
...
## <a name="to-assign-an-item-charge-directly-to-the-purchase-invoice-for-the-item" />Назначение товарной издержки непосредственно счету покупки для товара
...
## <a name="to-assign-an-item-charge-from-a-separate-invoice-to-the-purchase-invoice-for-the-item" />Назначение товарной издержки из отдельного счета счету покупки для товара
...
## <a name="handle-item-charges-for-partial-receipts" />Обработка товарных издержек при частичной приемке
...
## <a name="see-related-microsoft-training" />См. соответствующее [обучение Microsoft](/training/modules/post-purchase-item-charges-dynamics-365-business-central/)
