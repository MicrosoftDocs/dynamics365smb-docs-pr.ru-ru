...
ms.author: bholtorf
---
# <a name="onedrive-for-business-faq" />Вопросы и ответы по OneDrive для бизнеса
...
## <a name="is-onedrive-the-same-as-sharepoint-for-storing-files" />OneDrive то же самое, что и SharePoint, для хранения файлов?
...
## <a name="are-all-onedrive-for-business-plans-supported" />Поддерживаются все планы OneDrive для бизнеса?
...
## <a name="where-can-i-see-onedrive-service-health" />Где посмотреть работоспособность службы OneDrive?
...
## <a name="how-does-this-work-in-an-organization-with-multiple-environments" />Как это работает в организации с несколькими средами?
...
## <a name="weve-changed-company-name-what-happens-to-my-previous-files" />Мы изменили название компании. Что происходит с моими предыдущими файлами?
...
## <a name="i-want-to-open-files-in-sharepoint-instead-how-do-i-do-this" />Я хочу открывать файлы в SharePoint вместо этого. Как это сделать?
...
## <a name="how-do-i-turn-off-integration-to-onedrive" />Как отключить интеграцию с OneDrive?
...
## <a name="should-i-use-the-sharepoint-connection-setup-page-to-connect-to-sharepoint" />Следует ли мне использовать страницу Настройка подключения SharePoint для подключения к SharePoint?
...
## <a name="will-microsoft-continue-to-improve-the-integration-to-onedrive" />Будет ли Microsoft продолжать улучшать интеграцию с OneDrive?
...
### <a name="business-central-cant-find-my-onedrive" />Business Central не может найти мой OneDrive
...
### <a name="im-having-problems-sharing-from-outlook" />У меня не получается делиться файлами из Outlook
...
### <a name="actions-open-in-onedrive-and-share-are-missing" />Действия "Открыть в OneDrive" и "Поделиться отсутствуют"
