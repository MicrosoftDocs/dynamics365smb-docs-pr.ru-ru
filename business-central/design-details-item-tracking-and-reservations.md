...
ms.author: edupont
---
# <a name="design-details-item-tracking-and-reservations" />Сведения о проектировании: трассировка и резервирование товара
...
## <a name="specific-reservation" />Специальное резервирование
...
## <a name="nonspecific-reservation" />Общее резервирование
...
## <a name="reshuffle" />Изменение последовательности выполнения
...
## <a name="supported-business-scenarios" />Поддерживаемые бизнес-сценарии
...
### <a name="entering-serial-or-lot-numbers-on-an-outbound-document-with-wrong-nonspecific-reservation" />Ввод серийного номера или номера партии в исходящем документе с неправильным общим резервированием
...
### <a name="reserve-specific-serial-or-lot-numbers" />Резервирование определенного серийного номера или номера партии
...
### <a name="posting-an-outbound-document-with-nonspecific-reservation-of-serial-or-lot-numbers" />Учет исходящего документа с общим резервированием серийного номера или номера партии
