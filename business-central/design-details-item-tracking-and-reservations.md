...
description: 'В этой теме рассматриваются отслеживание и резервирование товара, а также описываются концепции, лежащие в основе этих двух операций.'
author: SorenGP
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
...
ms.author: edupont
---
# <a name="design-details-item-tracking-and-reservations"></a><a name="design-details-item-tracking-and-reservations"></a><a name="design-details-item-tracking-and-reservations"></a>Сведения о проектировании: трассировка и резервирование товара
...
При резервировании складских количеств из строки исходящего документа для товара с назначенными номерами трассировки товаров и настроенной конкретной трассировкой товаров страница **Резервирование** позволяет выполнять разные рабочие процессы в зависимости от потребности в серийных номерах или номерах партий.  
  
## <a name="specific-reservation"></a><a name="specific-reservation"></a><a name="specific-reservation"></a>Специальное резервирование
При выборе **Резервировать** из строки исходящего документа отображается диалоговое окно с вопросом, требуется ли зарезервировать конкретные серийные номера или номера партий. Если выбрать значение **Да**, отобразится список со всеми серийными номерами или номерам партий, которые назначены строке документа. Страница **Резервирование** откроется после выбора одного из серийных номеров или номеров партий, и в нем можно выполнить резервирование с использованием выбранных серийных номеров или номеров партий обычным способом.  
...
## <a name="nonspecific-reservation"></a><a name="nonspecific-reservation"></a><a name="nonspecific-reservation"></a>Общее резервирование
Если выбрать значение **Нет** в открывшемся диалоговом окне, откроется страница **Резервирование**, в котором можно выполнить резервирование с использованием всех серийных номеров или номеров партий в запасах.  
...
## <a name="reshuffle"></a><a name="reshuffle"></a><a name="reshuffle"></a>Изменение последовательности выполнения
...
## <a name="supported-business-scenarios"></a><a name="supported-business-scenarios"></a><a name="supported-business-scenarios"></a>Поддерживаемые бизнес-сценарии
...
### <a name="entering-serial-or-lot-numbers-on-an-outbound-document-with-wrong-nonspecific-reservation"></a><a name="entering-serial-or-lot-numbers-on-an-outbound-document-with-wrong-nonspecific-reservation"></a><a name="entering-serial-or-lot-numbers-on-an-outbound-document-with-wrong-nonspecific-reservation"></a>Ввод серийного номера или номера партии в исходящем документе с неправильным общим резервированием
...
### <a name="reserve-specific-serial-or-lot-numbers"></a><a name="reserve-specific-serial-or-lot-numbers"></a><a name="reserve-specific-serial-or-lot-numbers"></a>Резервирование определенного серийного номера или номера партии
...
Перегруппировка осуществляется автоматически, встроенная справка отображается внизу страницы **Резервирование** и содержит следующий текст.  
...
### <a name="posting-an-outbound-document-with-nonspecific-reservation-of-serial-or-lot-numbers"></a><a name="posting-an-outbound-document-with-nonspecific-reservation-of-serial-or-lot-numbers"></a><a name="posting-an-outbound-document-with-nonspecific-reservation-of-serial-or-lot-numbers"></a>Учет исходящего документа с общим резервированием серийного номера или номера партии
