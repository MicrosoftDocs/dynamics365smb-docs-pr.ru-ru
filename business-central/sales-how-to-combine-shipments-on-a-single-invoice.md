---
title: Как объединять расходные накладные в один счет | Документация Майкрософт
...
---
# <a name="combine-shipments-on-a-single-invoice"></a>Объединение расходных накладных в один счет
...
5. Выберите строку расходной накладной, которую необходимо включить в этот счет.  
    ...
    Если была выбрана неверная строка расходной накладной или вы хотите начать сначала, можно удалить строки из счета и запустить функцию **Получить строки расх. накл.** повторно.  
