...
1.  Выберите ![Лампочка, которая открывает функцию Что вы хотите сделать.](media/ui-search/search_small.png "Что вы хотите сделать") значок, введите **Диаграмма типов затрат**, а затем выберите связанную ссылку.  
...
2.  Выберите ![Лампочка, которая открывает функцию Что вы хотите сделать.](media/ui-search/search_small.png "Что вы хотите сделать") значок, введите **Диаграмма центров затрат**, а затем выберите связанную ссылку.  
...
2.  Выберите ![Лампочка, которая открывает функцию Что вы хотите сделать.](media/ui-search/search_small.png "Что вы хотите сделать") значок, введите **Диаграмма объектов затрат**, а затем выберите связанную ссылку.  
