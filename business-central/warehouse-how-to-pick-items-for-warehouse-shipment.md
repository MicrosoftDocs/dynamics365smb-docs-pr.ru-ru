...
Кроме того, можно использовать окно **Журнал подбора** для извлечения и создания строк подбора в пакетном режиме. Дополнительные сведения см. в разделе [Планирование подборов в журналах](warehouse-how-to-plan-picks-in-worksheets.md).  
...
Лицо, ответственное за отгрузку, теперь может перенести товары в отгрузочный отсек и учесть отгрузку, включая соответствующий документ-источник, в окне **Складская отгрузка**. Дополнительные сведения см. в разделе [Отгрузка товаров](warehouse-how-ship-items.md).   
