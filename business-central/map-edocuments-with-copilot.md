...
> [!IMPORTANT]
> - Это предварительная версия функции, готовая к развертыванию в рабочих средах и средах-песочницах в локализации для любой страны/региона<!-- with the exception of Canada -->.
