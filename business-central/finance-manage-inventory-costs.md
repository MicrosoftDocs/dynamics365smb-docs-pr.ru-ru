---
title: Управление затратами на инвентаризацию
...
# <a name="managing-inventory-costs"></a>Управление затратами на инвентаризацию
Управление затратами, также называемое «калькуляцией затрат», связано с регистрацией и составлением отчетности по операционным расходам предприятия. Он включает в себя отчетность по себестоимости производства и запасов, то есть, по себестоимости товаров.   
