...
ms.author: edupont
---
# <a name="displaying-lists-in-different-ways"></a><a name="displaying-lists-in-different-ways"></a><a name="displaying-lists-in-different-ways"></a>Отображение списков различными способами
...
## <a name="item-list"></a><a name="item-list"></a><a name="item-list"></a>Список товаров
