...
### <a name="how-do-i-sign-in-to-the--app-in-teams"></a>Как мне войти в приложение [!INCLUDE [prod_short.md](includes/prod_short.md)] в Teams?
...
### <a name="how-do-i-sign-out-of-the--app-in-teams"></a>Как мне выйти из приложения [!INCLUDE [prod_short.md](includes/prod_short.md)] в Teams?
...
### <a name="does-the-app-for-teams-connect-to--on-premises"></a>Подключается ли приложение для Teams к [!INCLUDE [prod_short.md](includes/prod_short.md)] On Premises?
...
### <a name="in-which-countries-or-regions-is-the--app-available"></a>В каких странах или регионах приложение [!INCLUDE [prod_short.md](includes/prod_short.md)] доступно?
...
### <a name="does-the--app-work-with-any-localization-of-include-prod_shortmd"></a>Работает ли приложение [!INCLUDE [prod_short.md](includes/prod_short.md)] с любой локализацией [!INCLUDE [prod_short.md](includes/prod_short.md)]?
...
### <a name="which-languages-does-the--app-support"></a><a name="language"></a>Какие языки поддерживает приложение [!INCLUDE [prod_short.md](includes/prod_short.md)]?
...
2. Ваш язык в [!INCLUDE [prod_short.md](includes/prod_short.md)], который вы можете увидеть в [!INCLUDE [prod_short.md](includes/prod_short.md)] веб-клиенте (подробнее в [Изменение основных настроек - Язык](ui-change-basic-settings.md#language)).
...
Получите список поддерживаемых языков для [!INCLUDE [prod_short.md](includes/prod_short.md)] в [Поддерживаемые языки](/dynamics365/business-central/dev-itpro/compliance/apptest-countries-and-translations?toc=/dynamics365/business-central/toc.json#supported-languages).

### <a name="does-the--app-work-with-industry-solutions"></a>Совместимо ли приложение [!INCLUDE [prod_short.md](includes/prod_short.md)] с отраслевыми решениями?

Да. Но только некоторые функции приложения работают с приложениями Embed:
...
Подробнее о приложениях emdeb читайте в разделе [Встраиваемые приложения](/dynamics365/business-central/dev-itpro/deployment/embed-app-overview).

### <a name="does--work-with-the-teams-mobile-app"></a>Работает ли [!INCLUDE [prod_short.md](includes/prod_short.md)] с мобильным приложением Teams?

Да. Приложение [!INCLUDE [prod_short.md](includes/prod_short.md)] может быть установлено из классического приложения Teams или браузера либо администратором для всех пользователей. После установки приложения [!INCLUDE [prod_short.md](includes/prod_short.md)] автоматически доступно в Teams для iOS и Android. На мобильных устройствах вы можете просматривать только карточки, отправленные другими, получать доступ к деталям или открывать карточку в полном объеме в мобильном приложении [!INCLUDE [prod_short.md](includes/prod_short.md)]. Вы не можете вставлять ссылки, которые расширяются в карточки при составлении сообщений или искать контакты. Подробнее о минимальных требованиях для мобильных устройств читайте в статье [Минимальные требования для использования Business Central](product-requirements.md).

### <a name="is-the--app-for-teams-the-same-as-the-include-prod_shortmd-app-for-ios-and-android"></a>Приложение [!INCLUDE [prod_short.md](includes/prod_short.md)] для Teams такое же, как приложение [!INCLUDE [prod_short.md](includes/prod_short.md)] для iOS и Android?
...
Мобильным пользователям рекомендуется установить как мобильное приложение, так и приложение для Teams, чтобы получить максимальную отдачу от [!INCLUDE [prod_short.md](includes/prod_short.md)]. Когда оба установлены, вы можете выбрать действие **Открыть на новой вкладке** над карточкой в Teams, чтобы открыть детали карточки в мобильном приложении [!INCLUDE [prod_short.md](includes/prod_short.md)]. Узнайте больше об установке мобильных приложений [!INCLUDE [prod_short.md](includes/prod_short.md)] и Teams в:
...
### <a name="does-the--app-work-in-all-teams-clients"></a>Приложение [!INCLUDE [prod_short.md](includes/prod_short.md)] работает во всех клиентах Teams?
...
Подробнее о минимальных требованиях читайте в разделе [Минимальные требования для использования Business Central](product-requirements.md#teams).

Подробнее о выборе клиентов Teams и о том, как их установить, можно узнать в разделе [Получение клиентов для Microsoft Teams](/microsoftteams/get-clients) в документации Teams.

### <a name="which-teams-client-is-best-for-"></a>Какой клиент Teams лучше всего подходит для [!INCLUDE [prod_short.md](includes/prod_short.md)]?
...
- Использование Microsoft Edge с Teams в браузере позволяет легко работать с несколькими удостоверениями и учетными записями, входя в Teams из разных профилей. Подробнее об использовании профилей можно узнать в Microsoft Edge этой статье [Вход в систему и создание нескольких профилей в Microsoft Edge](https://support.microsoft.com/office/sign-in-and-create-multiple-profiles-in-microsoft-edge-df94e622-2061-49ae-ad1d-6f0e43ce6435) службе поддержки Microsoft.

### <a name="what-is-the-best-way-for-me-to-demonstrate--and-microsoft-teams-to-prospective-customers"></a>Как мне лучше всего продемонстрировать [!INCLUDE [prod_short.md](includes/prod_short.md)] и Microsoft Teams потенциальным клиентам?
...
### <a name="does-the--app-for-teams-cater-to-my-customization-and-personalization"></a>Учитывает ли приложение [!INCLUDE [prod_short.md](includes/prod_short.md)] для Teams мою настройку и персонализацию?
...
### <a name="how-do-i-uninstall-the--app-for-teams"></a>Как мне удалить приложение [!INCLUDE [prod_short.md](includes/prod_short.md)] для Teams?
...
### <a name="will-microsoft-continue-to-improve-the--app-for-teams"></a>Будет ли Microsoft продолжать улучшать приложение [!INCLUDE [prod_short.md](includes/prod_short.md)] для Teams?
...
### <a name="who-can-see-the-content-of-a-tab"></a><a name="who-can-view"></a>Кто может видеть содержимое вкладки?
...
### <a name="where-does-the-recommended-content-come-from"></a><a name=#recommended-content></a>Откуда берется рекомендуемое содержимое?
...
Вы можете добавить в рекомендуемое содержимое страницы-списки путем добавления закладок. Вы также можете удалить рекомендуемое содержимое, удалив закладки. Узнайте больше в разделе [Добавьте страницу в закладки или сообщите о своем ролевом центре](ui-bookmarks.md).
...
### <a name="when-i-create-a-tab-does-it-grant-permissions-to-the-people-in-the-channel-or-chat"></a>Когда я создаю вкладку, означает ли это автоматическое предоставление разрешений пользователям в канале или чате?
...
### <a name="can-i-chat-alongside-a-tab"></a>Можно ли связать чат с вкладкой?

Да. Выберите значок чата, чтобы начать разговор. Эта цепочка чата затем связывается с вкладкой. 

### <a name="if-i-remove-a-tab-from-a-chat-or-channel-is-any-business-central-data-deleted"></a>Если удалить вкладку из чата или канала, будут ли при этом удалены какие-либо данные Business Central?

Нет.

### <a name="can-i-safely-rename-a-tab"></a>Случится ли что-нибудь, если я переименую вкладку?

Да. Содержимое вкладки никак не связано с названием вкладки. Переименовывайте ее как хотите! 

### <a name="i-need-to-work-across-tasks-in-different-windows-can-i-do-this"></a>Мне нужно работать над задачами в разных окнах. Возможно ли это?

Да. Вы можете открыть вкладку в отдельном окне браузера, чтобы отобразить веб-клиент Business Central. 

### <a name="can-i-add-or-pin-tab-in-team-meetings"></a>Можно ли добавить вкладку в собрание Teams или закрепить ее в собрании?

Нет. Приложение Business Central для Teams не поддерживает вкладки в собраниях.

### <a name="cant-add-a-tab-if-using-isv-urls-like-bcdynamicscom-but-can-pin"></a>Не удается добавить вкладку при использовании URL-адресов независимых поставщиков ПО, таких как *.bc.dynamics.com (однако удается ее закрепить)

Не поддерживается.

### <a name="when-i-do-things-in-the-tab-like-navigate-resort-apply-a-filter-or-search-do-others-see-my-changes"></a>Когда я выполняю действия на вкладке, например перемешаюсь по ней, по-другому сортирую данные, применяю фильтры или использую поиск, видят ли другие пользователи вносимые мной изменения?

Нет. На то, как другие пользователи видят содержимое вкладки, влияют только изменения полей или выполняемые действия.

### <a name="does-the-tab-content-refresh-automatically-if-not-how-do-i-refresh-it"></a>Обновляется ли содержимое вкладки автоматически? Если нет, как его обновлять?
...
### <a name="does-this-show-lists-and-records-from-my-customizations-and-add-ons"></a>Отображаются ли на вкладках списки и записи из пользовательских настроек и надстроек?

Да. 

### <a name="when-i-add-a-tab-will-people-see-it-in-my-language"></a>Когда я добавляю вкладку, пользователи видят ее на моем языке?
...
### <a name="can-i-have-multiple-tabs-pointing-to-different-content"></a>Может ли у меня быть несколько вкладок, указывающих на разное содержимое?

Да.

### <a name="can-i-also-add-tabs-to-chat-with-a-single-person"></a>Можно ли также добавлять вкладки в чат с одним человеком?
...
### <a name="can-i-switch-companies-within-a-tab"></a>Можно ли переключать организации на вкладке?

Нет. 

### <a name="is-this-different-than-using-teams-generic-ability-to-create-a-tab-that-hosts-a-website"></a>Отличается ли это чем-то от существующей в Teams возможности создавать вкладки, на которых размещаются веб-сайты?
...
### <a name="can-i-call-a-contact-from-the--app-for-teams"></a>Могу ли я позвонить контакту из приложения [!INCLUDE [prod_short.md](includes/prod_short.md)] для Teams?
...
### <a name="are--contacts-different-than-the-ones-in-the-teams-contacts-screen"></a>Отличаются ли контакты [!INCLUDE [prod_short.md](includes/prod_short.md)] от контактов на экране контактов Teams?
...
### <a name="does--synchronize-contacts-with-teams"></a>Синхронизирует ли [!INCLUDE [prod_short.md](includes/prod_short.md)] контакты с Teams?
...
### <a name="what-is-the-minimum-version-of--for-contact-search"></a>Какая минимальная версия [!INCLUDE [prod_short.md](includes/prod_short.md)] для поиска контактов?
...
### <a name="why-dont-cards-show-more-information-instead-of-just-the-page-name-and-details-button"></a>Почему на карточках не отображается больше информации, а только название страницы и кнопка "Подробности"?
...
### <a name="will-others-see-my-card-if-they-dont-have-the--app-for-teams"></a>Увидят ли мою карточку другие пользователи, если у них нет приложения [!INCLUDE [prod_short.md](includes/prod_short.md)] для Teams?
...
### <a name="how-does-a-guest-user-install-the--app"></a>Как гостевой пользователь устанавливает приложение [!INCLUDE [prod_short.md](includes/prod_short.md)]?
