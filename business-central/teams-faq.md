...
### Как мне войти в приложение [!INCLUDE [prod_short.md](includes/prod_short.md)] в Teams?
...
### Как мне выйти из приложения [!INCLUDE [prod_short.md](includes/prod_short.md)] в Teams?
...
### Подключается ли приложение для Teams к [!INCLUDE [prod_short.md](includes/prod_short.md)] On Premises? 
...
### Работает ли приложение с несколькими компаниями и средами? 
...
### В каких странах или регионах приложение [!INCLUDE [prod_short.md](includes/prod_short.md)] доступно? 
...
### Работает ли приложение [!INCLUDE [prod_short.md](includes/prod_short.md)] с любой локализацией [!INCLUDE [prod_short.md](includes/prod_short.md)]? 
...
### <a name="language"></a>Какие языки поддерживает приложение [!INCLUDE [prod_short.md](includes/prod_short.md)]?
...
### Совместимо ли приложение [!INCLUDE [prod_short.md](includes/prod_short.md)] с отраслевыми решениями?
...
### Работает ли [!INCLUDE [prod_short.md](includes/prod_short.md)] с мобильным приложением Teams?
...
### Приложение [!INCLUDE [prod_short.md](includes/prod_short.md)] для Teams такое же, как приложение [!INCLUDE [prod_short.md](includes/prod_short.md)] для iOS и Android?
...
### Приложение [!INCLUDE [prod_short.md](includes/prod_short.md)] работает во всех клиентах Teams?
...
### Какой клиент Teams лучше всего подходит для [!INCLUDE [prod_short.md](includes/prod_short.md)]?
...
### Как мне лучше всего продемонстрировать [!INCLUDE [prod_short.md](includes/prod_short.md)] и Microsoft Teams потенциальным клиентам?
...
### Учитывает ли приложение [!INCLUDE [prod_short.md](includes/prod_short.md)] для Teams мою настройку и персонализацию?
...
### Как разрешения, требуемые приложением, влияют на мою конфиденциальность?
...
### Где я могу узнать о своей конфиденциальности? 
...
### Как мне удалить приложение [!INCLUDE [prod_short.md](includes/prod_short.md)] для Teams?
...
### Будет ли Microsoft продолжать улучшать приложение [!INCLUDE [prod_short.md](includes/prod_short.md)] для Teams?
...
### Где я могу найти интеграцию Teams в веб-клиенте Business Central? 
...
### <a name="who-can-view"></a>Кто может видеть содержимое вкладки?
...
### <a name=#recommended-content></a>Откуда берется рекомендуемое содержимое?
...
### Когда я создаю вкладку, означает ли это автоматическое предоставление разрешений пользователям в канале или чате?
...
### Можно ли связать чат с вкладкой?

Да. Выберите значок чата, чтобы начать разговор. Эта цепочка чата затем связывается с вкладкой. 

### Если удалить вкладку из чата или канала, будут ли при этом удалены какие-либо данные Business Central?

Нет.

### Случится ли что-нибудь, если я переименую вкладку?

Да. Содержимое вкладки никак не связано с названием вкладки. Переименовывайте ее как хотите! 

### Мне нужно работать над задачами в разных окнах. Возможно ли это?

Да. Вы можете открыть вкладку в отдельном окне браузера, чтобы отобразить веб-клиент Business Central. 

### Можно ли добавить вкладку в собрание Teams или закрепить ее в собрании?

Нет. Приложение Business Central для Teams не поддерживает вкладки в собраниях.

### Не удается добавить вкладку при использовании URL-адресов независимых поставщиков ПО, таких как *.bc.dynamics.com (однако удается ее закрепить)

Не поддерживается.

### Когда я выполняю действия на вкладке, например перемешаюсь по ней, по-другому сортирую данные, применяю фильтры или использую поиск, видят ли другие пользователи вносимые мной изменения?

Нет. На то, как другие пользователи видят содержимое вкладки, влияют только изменения полей или выполняемые действия.

### Обновляется ли содержимое вкладки автоматически? Если нет, как его обновлять?
...
### Отображаются ли на вкладках списки и записи из пользовательских настроек и надстроек?

Да. 

### Когда я добавляю вкладку, пользователи видят ее на моем языке?
...
### Может ли у меня быть несколько вкладок, указывающих на разное содержимое?

Да.

### Можно ли также добавлять вкладки в чат с одним человеком?
...
### Можно ли переключать организации на вкладке?

Нет. 

### Отличается ли это чем-то от существующей в Teams возможности создавать вкладки, на которых размещаются веб-сайты?
...
### В каких таблицах приложение выполняет поиск?
...
### В каких полях таблицы контактов я могу искать?
...
### Включают ли результаты поиска компании и людей?
...
### Появляются ли в результатах контакты, связанные с какими-либо деловыми отношениями?
...
### Могу ли я посмотреть сведения о контактах во время встреч?
...
### Как просмотреть мои последние взаимодействия с контактом?
...
### Как зарегистрировать звонок или встречу Teams как взаимодействие?
...
### Могу ли я позвонить контакту из приложения [!INCLUDE [prod_short.md](includes/prod_short.md)] для Teams?
...
### Как просмотреть последние документы для клиента или поставщика?
...
### Как искать контакты с помощью специальных символов?
...
### Как я могу искать контакты, хранящиеся в другой компании?
...
### Отличаются ли контакты [!INCLUDE [prod_short.md](includes/prod_short.md)] от контактов на экране контактов Teams?
...
### Синхронизирует ли [!INCLUDE [prod_short.md](includes/prod_short.md)] контакты с Teams?
...
### Какая минимальная версия [!INCLUDE [prod_short.md](includes/prod_short.md)] для поиска контактов?
...
### Могу ли я искать со своего мобильного устройства?

Поиск контактов недоступен в Teams для iOS и в Teams для Android в настоящее время.

### Какие разрешения мне нужны для поиска контактов?
...
### Могу ли я использовать поиск по контактам, если я уполномоченный администратор?
...
### На поиск контактов влияют ограничения API?
...
### Почему иногда меня просят настроить приложение?
...
### Я хочу искать элементы или записи из других таблиц. Могу ли я сделать это из Teams?
...
### Какие типы ссылок поддерживает приложение?
...
### Как удалить карточку, отправленную в чат?
...
### Всегда ли на карточках отображается актуальная информация?
...
### Почему на карточках не отображается больше информации, а только название страницы и кнопка "Подробности"?
...
### Увидят ли мою карточку другие пользователи, если у них нет приложения [!INCLUDE [prod_short.md](includes/prod_short.md)] для Teams? 
...
### Как узнать, какой организации принадлежит карточка в Teams?
...
### Где находится кнопка сохранения в окне сведений в Teams?
...
### Если я выберу просмотр сведений для карточки, будут ли другие пользователи видеть мое окно сведений?
...
### Могу ли я начать вызов Teams из окна сведений в Teams?
...
### Могу ли я распечатать документы из окна сведений в Teams?
...
### Могу ли я получить доступ к камере из окна сведений в Teams?
...
### <a name="location"></a>Могу ли я получить доступ к моему местоположению из окна сведений в Teams?
...
### Как открыть сведения в новом окне?
...
### Могу ли я поделиться карточками с пользователями за пределами моей организации?
...
### Отличается ли опыт пользователей, которые являются гостями?
...
### Как гостевой пользователь устанавливает приложение [!INCLUDE [prod_short.md](includes/prod_short.md)]? 
...
### Отправляет ли Отправка данных в Teams компактную карточку? 

Да. Ссылка автоматически превратится в карточку, если у вас установлено приложение Business Central для Teams. 

### Получат ли получатели сообщение от меня или от учетной записи службы Business Central? 
...
### Доступно ли Отправка данных в Teams в локальной версии Business Central? 
...
### Предоставляет ли Отправка данных в Teams разрешения получателям? 
...
### Следует ли мне установить классическое приложение Teams, чтобы использовать Отправка данных в Teams? 

Кол-во Все, что вам нужно, — это действующая учетная запись с доступом к Microsoft Teams. 

### Доступно ли Отправка данных в Teams во всех клиентах Business Central? 
...
### Где найти Отправка данных в Teams в Business Central? 
