...
Нет. Контакты, хранящиеся в [!INCLUDE [prod_short.md](includes/prod_short.md)], остаются отдельными от ваших контактов, хранящихся в Teams.
...
Нет. Значения полей на карточке в Teams, включая любые изображения, основаны на данных, доступных на момент отправки этой карточки в чат. Карточки [!INCLUDE [prod_short.md](includes/prod_short.md)] не обновляются автоматически в Teams. 
...
Нет. Хотя все в чате или встрече могут просматривать саму карточку, окно с подробностями появляется только на вашем устройстве тогда, когда вы выбираете **Сведения**. Другие пользователи должны выбрать **Сведения**, если они хотят просмотреть окно со сведения на своем устройстве.
...
Нет. Аналогично приложению [!INCLUDE [prod_short.md](includes/prod_short.md)] для Teams эта функция доступна только для веб-клиента в локальной версии [!INCLUDE [prod_short.md](includes/prod_short.md)]. Нет планов поддерживать типы развертывания [!INCLUDE [prod_short.md](includes/prod_short.md)], &mdash; например, локальное, гибридное или частное облако, &mdash; которые Microsoft не размещает и не управляет ими напрямую.
...
Нет. Все, что вам нужно, — это действующая учетная запись с доступом к Microsoft Teams. 
