...
---
# <a name="teams-faq"></a><a name="teams-faq"></a>Вопросы и ответы по Teams
...
### <a name="how-do-i-sign-in-to-the--app-in-teams"></a><a name="how-do-i-sign-in-to-the--app-in-teams"></a>Как мне войти в приложение [!INCLUDE [prod_short.md](includes/prod_short.md)] в Teams?
...
### <a name="how-do-i-sign-out-of-the--app-in-teams"></a><a name="how-do-i-sign-out-of-the--app-in-teams"></a>Как мне выйти из приложения [!INCLUDE [prod_short.md](includes/prod_short.md)] в Teams?
...
### <a name="does-the-app-for-teams-connect-to--on-premises"></a><a name="does-the-app-for-teams-connect-to--on-premises"></a>Подключается ли приложение для Teams к [!INCLUDE [prod_short.md](includes/prod_short.md)] On Premises?
...
### <a name="does-the-app-work-with-multiple-companies-and-environments"></a><a name="does-the-app-work-with-multiple-companies-and-environments"></a>Работает ли приложение с несколькими компаниями и средами?
...
### <a name="in-which-countries-or-regions-is-the--app-available"></a><a name="in-which-countries-or-regions-is-the--app-available"></a>В каких странах или регионах приложение [!INCLUDE [prod_short.md](includes/prod_short.md)] доступно?
...
### <a name="does-the--app-work-with-any-localization-of-include-prod_shortmd"></a><a name="does-the--app-work-with-any-localization-of-include-prod_shortmd"></a>Работает ли приложение [!INCLUDE [prod_short.md](includes/prod_short.md)] с любой локализацией [!INCLUDE [prod_short.md](includes/prod_short.md)]?
...
### <a name="which-languages-does-the--app-support"></a><a name="which-languages-does-the--app-support"></a><a name="language"></a>Какие языки поддерживает приложение [!INCLUDE [prod_short.md](includes/prod_short.md)]?
...
### <a name="does-the--app-work-with-industry-solutions"></a><a name="does-the--app-work-with-industry-solutions"></a>Совместимо ли приложение [!INCLUDE [prod_short.md](includes/prod_short.md)] с отраслевыми решениями?
...
### <a name="does--work-with-the-teams-mobile-app"></a><a name="does--work-with-the-teams-mobile-app"></a>Работает ли [!INCLUDE [prod_short.md](includes/prod_short.md)] с мобильным приложением Teams?
...
### <a name="is-the--app-for-teams-the-same-as-the-include-prod_shortmd-app-for-ios-and-android"></a><a name="is-the--app-for-teams-the-same-as-the-include-prod_shortmd-app-for-ios-and-android"></a>Приложение [!INCLUDE [prod_short.md](includes/prod_short.md)] для Teams такое же, как приложение [!INCLUDE [prod_short.md](includes/prod_short.md)] для iOS и Android?
...
### <a name="does-the--app-work-in-all-teams-clients"></a><a name="does-the--app-work-in-all-teams-clients"></a>Приложение [!INCLUDE [prod_short.md](includes/prod_short.md)] работает во всех клиентах Teams?
...
### <a name="which-teams-client-is-best-for-"></a><a name="which-teams-client-is-best-for-"></a>Какой клиент Teams лучше всего подходит для [!INCLUDE [prod_short.md](includes/prod_short.md)]?
...
### <a name="what-is-the-best-way-for-me-to-demonstrate--and-microsoft-teams-to-prospective-customers"></a><a name="what-is-the-best-way-for-me-to-demonstrate--and-microsoft-teams-to-prospective-customers"></a>Как мне лучше всего продемонстрировать [!INCLUDE [prod_short.md](includes/prod_short.md)] и Microsoft Teams потенциальным клиентам?
...
### <a name="does-the--app-for-teams-cater-to-my-customization-and-personalization"></a><a name="does-the--app-for-teams-cater-to-my-customization-and-personalization"></a>Учитывает ли приложение [!INCLUDE [prod_short.md](includes/prod_short.md)] для Teams мою настройку и персонализацию?
...
### <a name="how-do-the-permissions-required-by-the-app-affect-my-privacy"></a><a name="how-do-the-permissions-required-by-the-app-affect-my-privacy"></a>Как разрешения, требуемые приложением, влияют на мою конфиденциальность?
...
### <a name="where-can-i-learn-about-my-privacy"></a><a name="where-can-i-learn-about-my-privacy"></a>Где я могу узнать о своей конфиденциальности?
...
### <a name="how-do-i-uninstall-the--app-for-teams"></a><a name="how-do-i-uninstall-the--app-for-teams"></a>Как мне удалить приложение [!INCLUDE [prod_short.md](includes/prod_short.md)] для Teams?
...
### <a name="will-microsoft-continue-to-improve-the--app-for-teams"></a><a name="will-microsoft-continue-to-improve-the--app-for-teams"></a>Будет ли Microsoft продолжать улучшать приложение [!INCLUDE [prod_short.md](includes/prod_short.md)] для Teams?
...
### <a name="where-can-i-find-teams-integration-inside-the-business-central-web-client"></a><a name="where-can-i-find-teams-integration-inside-the-business-central-web-client"></a>Где я могу найти интеграцию Teams в веб-клиенте Business Central?
...
### <a name="who-can-see-the-content-of-a-tab"></a><a name="who-can-see-the-content-of-a-tab"></a><a name="who-can-view"></a>Кто может видеть содержимое вкладки?
...
### <a name="where-does-the-recommended-content-come-from"></a><a name="where-does-the-recommended-content-come-from"></a><a name=#recommended-content></a>Откуда берется рекомендуемое содержимое?
...
### <a name="when-i-create-a-tab-does-it-grant-permissions-to-the-people-in-the-channel-or-chat"></a><a name="when-i-create-a-tab-does-it-grant-permissions-to-the-people-in-the-channel-or-chat"></a>Когда я создаю вкладку, означает ли это автоматическое предоставление разрешений пользователям в канале или чате?
...
### <a name="can-i-chat-alongside-a-tab"></a><a name="can-i-chat-alongside-a-tab"></a>Можно ли связать чат с вкладкой?

Да. Выберите значок чата, чтобы начать разговор. Эта цепочка чата затем связывается с вкладкой. 

### <a name="if-i-remove-a-tab-from-a-chat-or-channel-is-any-business-central-data-deleted"></a><a name="if-i-remove-a-tab-from-a-chat-or-channel-is-any-business-central-data-deleted"></a>Если удалить вкладку из чата или канала, будут ли при этом удалены какие-либо данные Business Central?

Нет.

### <a name="can-i-safely-rename-a-tab"></a><a name="can-i-safely-rename-a-tab"></a>Случится ли что-нибудь, если я переименую вкладку?

Да. Содержимое вкладки никак не связано с названием вкладки. Переименовывайте ее как хотите! 

### <a name="i-need-to-work-across-tasks-in-different-windows-can-i-do-this"></a><a name="i-need-to-work-across-tasks-in-different-windows-can-i-do-this"></a>Мне нужно работать над задачами в разных окнах. Возможно ли это?

Да. Вы можете открыть вкладку в отдельном окне браузера, чтобы отобразить веб-клиент Business Central. 

### <a name="can-i-add-or-pin-tab-in-team-meetings"></a><a name="can-i-add-or-pin-tab-in-team-meetings"></a>Можно ли добавить вкладку в собрание Teams или закрепить ее в собрании?

Нет. Приложение Business Central для Teams не поддерживает вкладки в собраниях.

### <a name="cant-add-a-tab-if-using-isv-urls-like-bcdynamicscom-but-can-pin"></a><a name="cant-add-a-tab-if-using-isv-urls-like-bcdynamicscom-but-can-pin"></a>Не удается добавить вкладку при использовании URL-адресов независимых поставщиков ПО, таких как *.bc.dynamics.com (однако удается ее закрепить)
...
### <a name="does-the-tab-content-refresh-automatically-if-not-how-do-i-refresh-it"></a><a name="does-the-tab-content-refresh-automatically-if-not-how-do-i-refresh-it"></a>Обновляется ли содержимое вкладки автоматически? Если нет, как его обновлять?
...
### <a name="does-this-show-lists-and-records-from-my-customizations-and-add-ons"></a><a name="does-this-show-lists-and-records-from-my-customizations-and-add-ons"></a>Отображаются ли на вкладках списки и записи из пользовательских настроек и надстроек?

Да. 

### <a name="when-i-add-a-tab-will-people-see-it-in-my-language"></a><a name="when-i-add-a-tab-will-people-see-it-in-my-language"></a>Когда я добавляю вкладку, пользователи видят ее на моем языке?
...
### <a name="can-i-have-multiple-tabs-pointing-to-different-content"></a><a name="can-i-have-multiple-tabs-pointing-to-different-content"></a>Может ли у меня быть несколько вкладок, указывающих на разное содержимое?

Да.

### <a name="can-i-also-add-tabs-to-chat-with-a-single-person"></a><a name="can-i-also-add-tabs-to-chat-with-a-single-person"></a>Можно ли также добавлять вкладки в чат с одним человеком?
...
### <a name="can-i-switch-companies-within-a-tab"></a><a name="can-i-switch-companies-within-a-tab"></a>Можно ли переключать организации на вкладке?

Нет. 

### <a name="is-this-different-than-using-teams-generic-ability-to-create-a-tab-that-hosts-a-website"></a><a name="is-this-different-than-using-teams-generic-ability-to-create-a-tab-that-hosts-a-website"></a>Отличается ли это чем-то от существующей в Teams возможности создавать вкладки, на которых размещаются веб-сайты?
...
### <a name="which-tables-does-the-app-search-in"></a><a name="which-tables-does-the-app-search-in"></a>В каких таблицах приложение выполняет поиск?
...
### <a name="which-fields-in-the-contacts-table-can-i-search"></a><a name="which-fields-in-the-contacts-table-can-i-search"></a>В каких полях таблицы контактов я могу искать?
...
### <a name="do-search-results-include-companies-and-persons"></a><a name="do-search-results-include-companies-and-persons"></a>Включают ли результаты поиска компании и людей?
...
### <a name="do-contacts-of-any-business-relationship-appear-in-the-results"></a><a name="do-contacts-of-any-business-relationship-appear-in-the-results"></a>Появляются ли в результатах контакты, связанные с какими-либо деловыми отношениями?
...
### <a name="can-i-look-up-contact-details-during-meetings"></a><a name="can-i-look-up-contact-details-during-meetings"></a>Могу ли я посмотреть сведения о контактах во время встреч?
...
### <a name="how-do-i-view-my-last-interactions-with-a-contact"></a><a name="how-do-i-view-my-last-interactions-with-a-contact"></a>Как просмотреть мои последние взаимодействия с контактом?
...
### <a name="how-do-i-register-a-teams-call-or-meeting-as-an-interaction"></a><a name="how-do-i-register-a-teams-call-or-meeting-as-an-interaction"></a>Как зарегистрировать звонок или встречу Teams как взаимодействие?
...
### <a name="can-i-call-a-contact-from-the--app-for-teams"></a><a name="can-i-call-a-contact-from-the--app-for-teams"></a>Могу ли я позвонить контакту из приложения [!INCLUDE [prod_short.md](includes/prod_short.md)] для Teams?
...
### <a name="how-do-i-view-recent-documents-for-a-customer-or-vendor"></a><a name="how-do-i-view-recent-documents-for-a-customer-or-vendor"></a>Как просмотреть последние документы для клиента или поставщика?
...
### <a name="how-do-i-search-for-contacts-using-special-characters"></a><a name="how-do-i-search-for-contacts-using-special-characters"></a>Как искать контакты с помощью специальных символов?
...
### <a name="how-can-i-search-contacts-stored-in-a-different-company"></a><a name="how-can-i-search-contacts-stored-in-a-different-company"></a>Как я могу искать контакты, хранящиеся в другой компании?
...
### <a name="are--contacts-different-than-the-ones-in-the-teams-contacts-screen"></a><a name="are--contacts-different-than-the-ones-in-the-teams-contacts-screen"></a>Отличаются ли контакты [!INCLUDE [prod_short.md](includes/prod_short.md)] от контактов на экране контактов Teams?
...
### <a name="does--synchronize-contacts-with-teams"></a><a name="does--synchronize-contacts-with-teams"></a>Синхронизирует ли [!INCLUDE [prod_short.md](includes/prod_short.md)] контакты с Teams?
...
### <a name="what-is-the-minimum-version-of--for-contact-search"></a><a name="what-is-the-minimum-version-of--for-contact-search"></a>Какая минимальная версия [!INCLUDE [prod_short.md](includes/prod_short.md)] для поиска контактов?
...
### <a name="can-i-search-from-my-mobile-device"></a><a name="can-i-search-from-my-mobile-device"></a>Могу ли я искать со своего мобильного устройства?

Поиск контактов недоступен в Teams для iOS и в Teams для Android в настоящее время.

### <a name="which-permissions-do-i-need-for-contact-search"></a><a name="which-permissions-do-i-need-for-contact-search"></a>Какие разрешения мне нужны для поиска контактов?
...
### <a name="can-i-use-contact-search-if-im-a-delegated-admin"></a><a name="can-i-use-contact-search-if-im-a-delegated-admin"></a>Могу ли я использовать поиск по контактам, если я уполномоченный администратор?
...
### <a name="is-contact-search-affected-by-api-limits"></a><a name="is-contact-search-affected-by-api-limits"></a>На поиск контактов влияют ограничения API?
...
### <a name="why-does-it-sometimes-ask-me-to-set-up-the-app"></a><a name="why-does-it-sometimes-ask-me-to-set-up-the-app"></a>Почему иногда меня просят настроить приложение?
...
### <a name="id-like-to-search-for-items-or-records-from-other-tables-can-i-do-this-from-teams"></a><a name="id-like-to-search-for-items-or-records-from-other-tables-can-i-do-this-from-teams"></a>Я хочу искать элементы или записи из других таблиц. Могу ли я сделать это из Teams?
...
### <a name="which-types-of-links-does-the-app-support"></a><a name="which-types-of-links-does-the-app-support"></a>Какие типы ссылок поддерживает приложение?
...
### <a name="how-do-i-delete-a-card-i-sent-to-a-chat"></a><a name="how-do-i-delete-a-card-i-sent-to-a-chat"></a>Как удалить карточку, отправленную в чат?
...
### <a name="do-cards-always-show-up-to-date-information"></a><a name="do-cards-always-show-up-to-date-information"></a>Всегда ли на карточках отображается актуальная информация?
...
### <a name="why-dont-cards-show-more-information-instead-of-just-the-page-name-and-details-button"></a><a name="why-dont-cards-show-more-information-instead-of-just-the-page-name-and-details-button"></a>Почему на карточках не отображается больше информации, а только название страницы и кнопка "Подробности"?
...
### <a name="will-others-see-my-card-if-they-dont-have-the--app-for-teams"></a><a name="will-others-see-my-card-if-they-dont-have-the--app-for-teams"></a>Увидят ли мою карточку другие пользователи, если у них нет приложения [!INCLUDE [prod_short.md](includes/prod_short.md)] для Teams?
...
### <a name="how-do-i-find-out-which-company-a-card-in-teams-belongs-to"></a><a name="how-do-i-find-out-which-company-a-card-in-teams-belongs-to"></a>Как узнать, какой организации принадлежит карточка в Teams?
...
### <a name="where-is-the-save-button-in-the-details-window-in-teams"></a><a name="where-is-the-save-button-in-the-details-window-in-teams"></a>Где находится кнопка сохранения в окне сведений в Teams?
...
### <a name="if-i-choose-to-view-details-for-a-card-will-other-users-see-my-details-window"></a><a name="if-i-choose-to-view-details-for-a-card-will-other-users-see-my-details-window"></a>Если я выберу просмотр сведений для карточки, будут ли другие пользователи видеть мое окно сведений?
...
### <a name="can-i-start-a-teams-call-from-the-details-window-in-teams"></a><a name="can-i-start-a-teams-call-from-the-details-window-in-teams"></a>Могу ли я начать вызов Teams из окна сведений в Teams?
...
### <a name="can-i-print-documents-from-the-details-window-in-teams"></a><a name="can-i-print-documents-from-the-details-window-in-teams"></a>Могу ли я распечатать документы из окна сведений в Teams?
...
### <a name="can-i-access-the-camera-from-the-details-window-in-teams"></a><a name="can-i-access-the-camera-from-the-details-window-in-teams"></a>Могу ли я получить доступ к камере из окна сведений в Teams?
...
### <a name="can-i-access-my-location-from-the-details-window-in-teams"></a><a name="can-i-access-my-location-from-the-details-window-in-teams"></a><a name="location"></a>Могу ли я получить доступ к моему местоположению из окна сведений в Teams?
...
### <a name="how-do-i-open-the-details-in-a-new-window"></a><a name="how-do-i-open-the-details-in-a-new-window"></a>Как открыть сведения в новом окне?
...
### <a name="can-i-share-cards-with-users-outside-my-organization"></a><a name="can-i-share-cards-with-users-outside-my-organization"></a>Могу ли я поделиться карточками с пользователями за пределами моей организации?
...
### <a name="is-the-experience-any-different-for-users-that-are-guests"></a><a name="is-the-experience-any-different-for-users-that-are-guests"></a>Отличается ли опыт пользователей, которые являются гостями?
...
### <a name="how-does-a-guest-user-install-the--app"></a><a name="how-does-a-guest-user-install-the--app"></a>Как гостевой пользователь устанавливает приложение [!INCLUDE [prod_short.md](includes/prod_short.md)]?
...
### <a name="does-share-to-teams-send-a-compact-card"></a><a name="does-share-to-teams-send-a-compact-card"></a>Отправляет ли Отправка данных в Teams компактную карточку?

Да. Ссылка автоматически превратится в карточку, если у вас установлено приложение Business Central для Teams. 

### <a name="will-recipients-receive-the-message-from-me-or-from-a-business-central-service-account"></a><a name="will-recipients-receive-the-message-from-me-or-from-a-business-central-service-account"></a>Получат ли получатели сообщение от меня или от учетной записи службы Business Central?
...
### <a name="is-share-to-teams-available-in-business-central-on-premises"></a><a name="is-share-to-teams-available-in-business-central-on-premises"></a>Доступно ли Отправка данных в Teams в локальной версии Business Central?
...
### <a name="does-share-to-teams-grant-permissions-to-recipients"></a><a name="does-share-to-teams-grant-permissions-to-recipients"></a>Предоставляет ли Отправка данных в Teams разрешения получателям?
...
### <a name="must-i-have-the-teams-desktop-app-installed-to-use-share-to-teams"></a><a name="must-i-have-the-teams-desktop-app-installed-to-use-share-to-teams"></a>Следует ли мне установить классическое приложение Teams, чтобы использовать Отправка данных в Teams?

Кол-во Все, что вам нужно, — это действующая учетная запись с доступом к Microsoft Teams. 

### <a name="is-share-to-teams-available-in-all-business-central-clients"></a><a name="is-share-to-teams-available-in-all-business-central-clients"></a>Доступно ли Отправка данных в Teams во всех клиентах Business Central?
...
### <a name="where-do-i-find-share-to-teams-in-business-central"></a><a name="where-do-i-find-share-to-teams-in-business-central"></a>Где найти Отправка данных в Teams в Business Central?
