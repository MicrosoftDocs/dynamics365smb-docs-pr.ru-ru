...
3. На странице **Макеты документов** в строке макета отчета, для которого вы хотите использовать пользовательский макет, выберите поле **Описание пользовательского макета**.
   ...
   > [!TIP]
   > По умолчанию поле «Описание пользовательского макета» скрыто. Если поле недоступно, вы можете персонализировать страницу, чтобы добавить его. Чтобы персонализировать страницу, выберите значок :::image type="content" source="media/ui-experience/settings_icon_small.png" alt-text="Настройки."::: значок, а затем выберите **Персонализация**. Чтобы узнать больше о персонализации страниц, перейдите по ссылке [Персонализация рабочего пространства](ui-personalization-user.md).

1. На странице **Пользовательские макеты отчетов** выберите макет документа, который вы хотите использовать для типа документов продаж. Дополнительные сведения см. в разделе [Создание и изменение пользовательских макетов отчетов](ui-how-create-custom-report-layout.md).

## Чтобы указать, какой контакт получает тот или иной макет документа для клиента
