...
## <a name="to-specify-which-contact-receives-which-document-layout-for-a-customer"></a>Чтобы указать, какой контакт получает тот или иной макет документа для клиента
