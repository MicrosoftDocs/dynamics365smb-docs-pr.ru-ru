...
## <a name="to-specify-which-contact-receives-which-document-layout-for-a-customer"></a>Чтобы задать контакт, который будет получать документ с определенным макетом
