...
description: В этой теме рассказывается, как настроить уведомления рабочего процесса, чтобы предупредить пользователя о том, что произошло событие, на которое следует отреагировать; требуется отклик рабочего процесса.
author: SorenGP
