...
ms.author: edupont
---
# <a name="define-user-tasks" />Определение задач пользователя
...
## <a name="managing-user-tasks" />Управление задачами пользователя
...
### <a name="picking-up-user-tasks" />Выбор задач пользователя
...
### <a name="deleting-user-tasks" />Удаление задач пользователя
