...
ms.author: edupont
---
# <a name="about-cost-accounting"></a><a name="about-cost-accounting"></a>Об учете затрат
...
## <a name="workflow-in-cost-accounting"></a><a name="workflow-in-cost-accounting"></a>Рабочий процесс учета затрат
...
## <a name="cost-types-cost-centers-and-cost-objects"></a><a name="cost-types-cost-centers-and-cost-objects"></a>Типы затрат, места возникновения затрат и объекты затрат
...
## <a name="cost-entries-and-cost-journals"></a><a name="cost-entries-and-cost-journals"></a>Записи затрат и журналы затрат
...
## <a name="cost-allocations"></a><a name="cost-allocations"></a>Распределения затрат
...
## <a name="cost-budgets"></a><a name="cost-budgets"></a>Бюджеты расходов
...
## <a name="cost-reporting"></a><a name="cost-reporting"></a>Отчетность о затратах
