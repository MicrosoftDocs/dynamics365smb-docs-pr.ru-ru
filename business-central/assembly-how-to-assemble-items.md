...
---
# <a name="assemble-items"></a><a name="assemble-items"></a>Сборка товаров
...
## <a name="to-assemble-an-item-to-stock"></a><a name="to-assemble-an-item-to-stock"></a>Сборка товара на склад
