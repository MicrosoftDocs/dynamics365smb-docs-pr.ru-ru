...
ms.author: edupont
---
# <a name="about-the-data-exchange-framework" />О структуре обмена данными
...
## <a name="electronic-documents" />Электронные документы
...
## <a name="bank-files" />Банковские файлы
...
## <a name="currency-exchange-rates" />Валютные курсы
