...
ms.author: edupont
---
# <a name="about-the-data-exchange-framework"></a><a name="about-the-data-exchange-framework"></a>О структуре обмена данными
...
## <a name="electronic-documents"></a><a name="electronic-documents"></a>Электронные документы
...
## <a name="bank-files"></a><a name="bank-files"></a>Банковские файлы
...
## <a name="currency-exchange-rates"></a><a name="currency-exchange-rates"></a>Валютные курсы
...
## <a name="intrastat"></a><a name="intrastat"></a>Интрастат
