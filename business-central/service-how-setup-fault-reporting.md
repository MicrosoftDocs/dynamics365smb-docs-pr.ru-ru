...
# <a name="set-up-fault-reporting" />Настройка отчетности по неисправностям
...
## <a name="to-specify-the-overall-level-of-fault-reporting" />Указание общего уровня отчетности о неисправностях
...
## <a name="to-create-fault-and-resolution-code-relationships" />Создание связей между неисправностями и кодами решений
