...
ms.author: edupont
---
# <a name="publish-a-web-service" />Публикация веб-службы
...
## <a name="creating-and-publishing-a-web-service" />Создание и публикация веб-службы

В следующих шагах объясняется порядок создания и публикации веб-службы.  

### <a name="to-create-and-publish-a-web-service" />Создание и публикация веб-службы
...
### <a name="to-verify-the-availability-of-a-web-service" />Проверка наличия веб-службы
