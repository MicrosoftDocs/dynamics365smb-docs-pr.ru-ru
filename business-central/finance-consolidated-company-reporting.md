...
# <a name="consolidating-financial-data-from-multiple-companies"></a><a name="consolidating-financial-data-from-multiple-companies"></a>Консолидация финансовых данных из нескольких организаций
...
## <a name="use-the-consolidated-trial-balance-report"></a><a name="use-the-consolidated-trial-balance-report"></a>Использование отчета "Консолидированный пробный баланс"
...
## <a name="consolidate-data"></a><a name="consolidate-data"></a>Консолидировать данные
...
### <a name="to-test-the-data-before-you-consolidate"></a><a name="to-test-the-data-before-you-consolidate"></a>Для тестирования базы данных перед консолидацией
...
### <a name="run-the-consolidation"></a><a name="run-the-consolidation"></a>Выполнение консолидации
...
## <a name="eliminate-repeated-transactions"></a><a name="eliminate-repeated-transactions"></a>Исключение повторных транзакций
...
## <a name="export-and-import-consolidated-data-between-databases"></a><a name="export-and-import-consolidated-data-between-databases"></a>Экспорт и импорт консолидированных данных между базами данных
