...
# <a name="consolidating-financial-data-from-multiple-companies" />Консолидация финансовых данных из нескольких организаций
...
## <a name="use-the-consolidated-trial-balance-report" />Использование отчета "Консолидированный пробный баланс"
...
## <a name="consolidate-data" />Консолидировать данные
...
### <a name="to-test-the-data-before-you-consolidate" />Для тестирования базы данных перед консолидацией
...
### <a name="run-the-consolidation" />Выполнение консолидации
...
## <a name="eliminate-repeated-transactions" />Исключение повторных транзакций
...
## <a name="export-and-import-consolidated-data-between-databases" />Экспорт и импорт консолидированных данных между базами данных
