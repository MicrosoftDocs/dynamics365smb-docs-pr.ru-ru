...
ms.author: edupont
---
# <a name="replan-or-refresh-production-orders-directly" />Прямое перепланирование или обновление производственных заказов
...
## <a name="to-replan-a-production-order" />Перепланировка производственного заказа
...
## <a name="to-refresh-a-production-order" />Обновление производственного заказа
