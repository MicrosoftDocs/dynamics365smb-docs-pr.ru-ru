...
ms.author: bholtorf
---
# <a name="work-with-responsibility-centers" />Работа с центрами ответственности
...
## <a name="to-set-up-a-responsibility-center" />Настройка центра ответственности
...
## <a name="to-assign-responsibility-centers-to-users" />Присвоение центров ответственности пользователям
