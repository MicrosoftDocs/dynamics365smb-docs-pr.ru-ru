...
description: Узнайте о различных способах учета документов покупки, а также о том, как обновлять учтенные документы.
author: SorenGP
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
...
>
> Для учета счета покупки без записи квитанции о покупке в [!INCLUDE[prod_short](includes/prod_short.md)] создайте документ на странице **Счета покупки**. Подробнее в разделе [Регистрация покупок со счетами покупок](purchasing-how-record-purchases.md).
