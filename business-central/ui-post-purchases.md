---
title: Учет документов покупки
description: Узнайте о различных функциях учета для учета документов о покупке, а также о том, как обновлять учтенные документы.
author: SorenGP
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
