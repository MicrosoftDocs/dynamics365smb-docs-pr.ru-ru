...
ms.author: bholtorf
---
# Пошаговое руководство. Автоматическое планирование поставок
...
### Изменение выбранных параметров планирования  
...
## Создание регенеративного плана поставок  
...
### Создание регенеративного плана для заполнения требования на складе "СИНИЙ"  
...
4.  Нажмите кнопку **ОК**, чтобы начать процесс планирования.  
     ...
     Создается одна строка планирования, в которой предлагается учесть плановый производственный заказ для создания десяти туристических велосипедов — товара 1001 — к 05.02.2021, то есть дате поставки заказа на продажу.  
...
### Включение в MRP требований подчиненных компонентов  
...
### Просмотр операций трассировки заказов для товара 1300  
...
### Проверка параметра планирования  
...
### Просмотр дополнительных операций трассировки заказов  
...
1.  Выберите строку планирования для товара 1110, "Обод", затем выберите действие **Трассировка заказов**.  
     ...
     Такая же трассировка заказов применяется к строкам планирования для товаров 1120, 1160 и 1170. Для товара 1120 значение в поле **Кол-во в** в производственной спецификации каждого колеса равно 50 шт., что дает полную потребность, равную100.  
...
### Процедура автоматического создания предлагаемых заказов на поставку  
...
## Анализ измененных результатов планирования  
...
### Процедура просмотра существующего заказа  
