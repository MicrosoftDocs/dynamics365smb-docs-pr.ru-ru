...
ms.author: edupont
---
# <a name="walkthrough-planning-supplies-automatically" />Пошаговое руководство. Автоматическое планирование поставок
...
### <a name="to-create-stockkeeping-units" />Создание единиц хранения
...
### <a name="to-change-selected-planning-parameters" />Изменение выбранных параметров планирования
...
## <a name="creating-a-regenerative-supply-plan" />Создание регенеративного плана поставок
...
### <a name="to-create-the-sales-order" />Создание заказа на продажу
...
### <a name="to-create-a-regenerative-plan-to-fulfill-demand-at-location-east" />Создание регенеративного плана для заполнения требования на складе "СИНИЙ"
...
### <a name="to-calculate-mrp-to-include-underlying-component-needs" />Включение в MRP требований подчиненных компонентов
...
## <a name="analyzing-the-planning-result" />Анализ результатов планирования
...
### <a name="to-view-order-tracking-entries-for-item-1300" />Просмотр операций трассировки заказов для товара 1300
...
### <a name="to-check-the-planning-parameter" />Проверка параметра планирования
...
### <a name="to-view-more-order-tracking-entries" />Просмотр дополнительных операций трассировки заказов
...
## <a name="carrying-out-action-messages" />Выполнение указаний
 Далее Эдуард преобразует предлагаемые строки планирования в заказы на поставку, используя функцию **Выполнить указание**.  

### <a name="to-automatically-create-the-suggested-supply-orders" />Процедура автоматического создания предлагаемых заказов на поставку
...
## <a name="creating-a-net-change-plan" />Создание плана оборота
...
### <a name="to-create-the-new-sales-demand-and-replan-accordingly" />Создание нового требования продаж и соответствующее перепланирование
...
## <a name="analyzing-the-changed-planning-result" />Анализ измененных результатов планирования
...
### <a name="to-view-order-tracking-entries-for-item-1250" />Просмотр операций трассировки заказов для товара 1250
...
### <a name="to-view-an-existing-order" />Процедура просмотра существующего заказа
