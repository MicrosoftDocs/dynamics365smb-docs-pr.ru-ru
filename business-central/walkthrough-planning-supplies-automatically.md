...
## <a name="preparing-sample-data"></a>Подготовка демонстрационных данных
...
### <a name="to-create-a-regenerative-plan-to-fulfill-demand-at-location-east"></a>Создание регенеративного плана для заполнения требования на складе "СИНИЙ"
...
## <a name="analyze-the-planning-result"></a>Анализ результатов планирования
...
## <a name="analyze-the-changed-planning-result"></a>Анализ измененных результатов планирования
