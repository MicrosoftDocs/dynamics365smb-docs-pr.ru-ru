...
---
# <a name="overview-of-ai-powered-item-marketing-text-preview-with-copilot"></a><a name="overview-of-ai-powered-item-marketing-text-preview-with-copilot"></a>Обзор маркетинговых текстов для товаров на базе ИИ (предварительная версия) с помощью Copilot

[!INCLUDE[ai-preview](includes/ai-preview.md)]

В этой статье представлен обзор возможностей на базе ИИ, предоставляемых Copilot в Business Central.

## <a name="what-is-ai-powered-item-marketing-text-with-copilot"></a><a name="what-is-ai-powered-item-marketing-text-with-copilot"></a>Что такое маркетинговый текст для товаров на базе ИИ с помощью Copilot
...
## <a name="where-its-used"></a><a name="where-its-used"></a>Где она используется
...
## <a name="why-and-how-to-use-it"></a><a name="why-and-how-to-use-it"></a>Зачем и как это использовать
...
## <a name="current-limitations"></a><a name="current-limitations"></a>Каковы текущие ограничения?
