...
ms.author: bholtorf
---
# Рекомендации по настройке. Политики повторного заказа
...
## См. соответствующее [обучение Microsoft](/training/paths/replenish-items-dynamics-365-business-central/)
