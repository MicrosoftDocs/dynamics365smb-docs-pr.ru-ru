---
title: Рекомендации по настройке. Политики дозаказа | Документация Майкрософт
...
---
# <a name="setup-best-practices-reordering-policies"></a>Рекомендации по настройке: политики дозаказа
...
Одной из ведущих основ при выборе политики повторного заказа является классификация товаров в алфавитном порядке. При использовании классификации ABC вы управляете товарами, разделенными на три класса. Используемый вами класс зависит от стоимости и объема товара по отношению к общему запасу. Распределение по стоимости по объему этих трех классов показано в следующей таблице.
