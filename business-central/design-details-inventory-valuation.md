...
ms.author: edupont
---
# <a name="design-details-inventory-valuation"></a><a name="design-details-inventory-valuation"></a><a name="design-details-inventory-valuation"></a>Сведения о проектировании: оценка стоимости запасов
...
## <a name="inventory-valuation-report"></a><a name="inventory-valuation-report"></a><a name="inventory-valuation-report"></a>Отчет "Оценка стоимости товаров"
...
## <a name="inventory-valuation---wip-report"></a><a name="inventory-valuation---wip-report"></a><a name="inventory-valuation---wip-report"></a>Отчет "Оценка стоимости запасов - НЗП"
