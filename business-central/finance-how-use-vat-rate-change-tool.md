...
# Управление изменениями ставки НДС
...
## Общее представление о процессе преобразования и ограничениях ставки НДС
...
## См. соответствующее [обучение Microsoft](/training/modules/rate-change-dynamics-365-business-central/)
