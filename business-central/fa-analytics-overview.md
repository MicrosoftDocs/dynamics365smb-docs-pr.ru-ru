...
> [!NOTE]
> Аналитика основных средств несколько отличается от других областей. Вам необходимо проанализировать уже существующие данные, такие как приобретение активов, амортизация и страхование, а также данные о будущих (прогнозируемых) данных, таких как амортизация и списание активов. Для последнего типа анализа [!INCLUDE[prod_short](includes/prod_short.md)] имеются встроенные отчеты, которые позволяют рассчитывать эти цифры.
