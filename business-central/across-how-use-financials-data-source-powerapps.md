...
> [!TIP]  
> Дополнительная документация по Power Apps и наши примеры приложений Power Apps, представленные на презентации [!INCLUDE[prod_short](includes/prod_short.md)], будут опубликованы здесь позже, одновременно с волной 1 выпуска за 2023 г. Подробнее читайте в статье [Начало работы с другими примерами шаблонов Power Automate и Power Apps](/dynamics365/release-plan/2023wave1/smb/dynamics365-business-central/get-started-more-sample-power-automate-templates-power-apps).
...
2. На домашней странице, в разделе **Начать с данных**, выберите плитка **Другие источники данных**.  
    ...
    Откроется Power Apps Studio. При первом входе в систему необходимо указать страну/регион.  
...
5. Далее вы увидите список таблиц, которые предоставляются как часть API для вашей среды. Выберите таблицу, к которой вы хотите подключиться, а затем выберите **Подключить**.
...
На данный момент вы успешно подключились с данным [!INCLUDE[prod_short](includes/prod_short.md)] и готовы приступать к созданию приложения Power Apps. Можно добавить дополнительные экраны и подключить дополнительные данные из [!INCLUDE[prod_short](includes/prod_short.md)]. Дополнительные сведения см. в разделе [Создание приложения на основе холста из примера в Power Apps](/powerapps/maker/canvas-apps/open-and-run-a-sample-app).  
