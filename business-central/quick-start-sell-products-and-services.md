...
# <a name="sales-quick-start" />Краткое руководство по продажам
...
## <a name="set-up-items-to-sell" />Настройка товаров для продажи
...
### <a name="set-up-a-new-item" />Настройте новый товар
...
## <a name="set-up-customers" />Настройка клиентов
...
### <a name="set-up-a-new-customer" />Настройка нового клиента
...
### <a name="to-create-a-sales-order" />Создание заказа на продажу
...
## <a name="create-a-sales-invoice" />Создать счет продажи
...
### <a name="to-create-and-post-a-sales-invoice" />Создание и учет счета продажи
