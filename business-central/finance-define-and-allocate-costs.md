...
ms.author: edupont
---
# <a name="defining-and-allocating-costs" />Определение и распределение затрат
...
## <a name="setting-up-allocation-source-and-targets" />Настройка источника и целей распределения
...
### <a name="to-set-up-cost-allocations" />Настройка распределения затрат
...
## <a name="setting-filters-for-dynamic-allocation-bases" />Настройка фильтров для базы динамического распределения
...
### <a name="setting-filters" />Установка фильтров
...
## <a name="scenario--defining-static-allocations-based-on-allocation-ratio" />Сценарий 1. Определение статических распределений на основе отношения распределений
...
### <a name="to-define-the-allocation-source-prod-cost-center-on-the-general-fasttab" />Определение места возникновения затрат ПРОД по источнику распределения на экспресс-вкладке "Общее"
...
### <a name="to-define-the-allocation-target-cost-objects-on-the-lines-fasttab" />Определение объектов затрат по целям распределения на экспресс-вкладке "Строки"
...
## <a name="scenario--defining-dynamic-allocations-based-on-items-sold" />Сценарий 2. Определение динамических распределений на основе проданных товаров
...
### <a name="to-define-dynamic-allocations-based-on-items-sold-in-the-previous-year" />Определение динамических распределений на основе количества проданных товаров в предыдущем году
...
## <a name="see-related-microsoft-trainingtrainingmodulesallocate-costs-dynamics--business-central" />См. соответствующее [обучение Microsoft](/training/modules/allocate-costs-dynamics-365-business-central/)
