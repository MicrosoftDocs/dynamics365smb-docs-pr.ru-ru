...
ms.author: edupont
---
# <a name="set-up-a-document-exchange-service" />Настройка службы обмена документами
...
## <a name="connecting-with-trading-partners" />Связь с торговыми партнерами
...
## <a name="to-connect-to-the-business-central-integration-app-on-tradeshift" />Чтобы подключиться к приложению интеграции Business Central в Tradeshift
...
## <a name="to-connect-to-a-document-exchange-service" />Подключение к службе обмена документами
...
## <a name="settings-for-business-central-on-premises" />Настройки электронной почты для локальной версии Business Central
