...
ms.author: edupont
---
# <a name="process-sales-return-orders" />Обработка заказов на возврат продажи
...
## <a name="create-a-sales-return-order-based-on-one-or-more-posted-sales-documents" />Создание заказа на возврат продажи на основе одного или нескольких учтенных документов продажи
...
## <a name="to-create-a-replacement-sales-order-from-a-sales-return-order" />Создание заказа на замену продажи на основе возврата продажи
...
## <a name="to-create-return-related-documents-from-a-sales-return-order" />Создание документов, связанных с возвратом, из заказа на возврат продажи
...
## <a name="to-create-a-restock-charge" />Создание платы за пополнение запасов
