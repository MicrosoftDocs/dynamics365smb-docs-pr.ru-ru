...
## <a name="to-add-prepayment-accounts-to-the-general-posting-setup" />Добавление счетов с предоплатой в общую настройку учета
...
## <a name="to-set-up-number-series-for-prepayment-documents" />Настройка серии номеров для документов предоплаты
...
## <a name="to-set-up-prepayment-percentages-for-items-customers-and-vendors" />Настройка процентных значений предоплаты для товаров, клиентов и поставщиков
...
### <a name="to-determine-which-prepayment-percentage-has-first-priority" />Определение процента предоплаты с наивысшим приоритетом
...
## <a name="to-automatically-release-sales-orders-when-prepayments-are-applied" />Для автоматического выпуска заказов на продажу при применении предоплаты
...
## <a name="see-related-microsoft-training" />См. соответствующее [обучение Microsoft](/training/modules/prepayment-invoices-dynamics-365-business-central/)
