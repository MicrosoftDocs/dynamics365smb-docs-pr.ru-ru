...
# <a name="set-up-prepayments"></a>Настройка предоплат
...
## <a name="to-automatically-release-sales-orders-when-prepayments-are-applied"></a>Для автоматического выпуска заказов на продажу при применении предоплаты
