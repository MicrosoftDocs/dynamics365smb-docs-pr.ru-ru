...
## <a name="what-operational-factors-and-settings-allow-for-effective-and-responsible-use-of-the-feature"></a>Какие рабочие факторы и параметры позволяют эффективно и ответственно использовать функцию?
...
### <a name="what-is-expected-of-users-while-using-e-documents-matching-assistance"></a>Что ожидается от пользователей при использовании функции «Помощь в сопоставлении электронных документов»?
...
### <a name="what-is-expected-of-administrators-and-users-when-operating-e-documents-matching-assistance"></a>Что ожидается от администраторов и пользователей при использовании функции «Помощь в сопоставлении электронных документов»?
