...
---
# <a name="analyze-list-data-using-data-analysis-mode" />Анализ данных списка с использованием режима анализа данных
...
## <a name="prerequisite" />Предварительные требования
...
## <a name="work-with-data-analysis-mode" />Работа в режиме анализа данных
...
### <a name="data-area-1" />Область данных (1)
...
### <a name="summary-bar-2" />Строка сводки (2)
...
### <a name="analysis-filters-4" />Фильтры анализа (4)
...
## <a name="pivot-mode" />Сводный режим
...
## <a name="limitations" />Ограничения
