...
---
# <a name="analyze-list-data-using-data-analysis-mode"></a><a name="analyze-list-data-using-data-analysis-mode"></a>Анализ данных списка с использованием режима анализа данных
...
## <a name="work-with-data-analysis-mode"></a><a name="work-with-data-analysis-mode"></a>Работа в режиме анализа данных
...
### <a name="data-area-1"></a><a name="data-area-1"></a>Область данных (1)
...
### <a name="summary-bar-2"></a><a name="summary-bar-2"></a>Строка сводки (2)
...
### <a name="columns-3"></a><a name="columns-3"></a>Столбцы (3)
...
### <a name="analysis-filters-4"></a><a name="analysis-filters-4"></a>Фильтры анализа (4)
...
### <a name="tabs-5"></a><a name="tabs-5"></a>Вкладки (5)
...
## <a name="pivot-mode"></a><a name="pivot-mode"></a>Сводный режим
