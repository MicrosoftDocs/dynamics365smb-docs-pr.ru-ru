...
Можно использовать функцию "Что вы хотите сделать" в веб-клиенте локальной версии для поиска действий, страниц и отчетов, но не документации, или приложения и консультативные услуги в AppSource. Пользователи, подключающиеся к [!INCLUDE[d365fin](includes/d365fin_md.md)] из клиента Dynamics NAV, продолжат использовать поиск страниц.
