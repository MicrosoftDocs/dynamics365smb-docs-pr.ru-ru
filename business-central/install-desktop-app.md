---
title: Работа с Business Central на компьютере
...
- Если у вас несколько сред [!INCLUDE [prod_short](includes/prod_short.md)] (только Online), вы можете установить приложение отдельно для каждой среды.
...
3. Когда приложение будет установлено, выберите **Открыть** и войдите в [!INCLUDE [prod_short](includes/prod_short.md)].
