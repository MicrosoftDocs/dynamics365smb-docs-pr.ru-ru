...
---
# <a name="get-the-business-central-desktop-app"></a>Получение приложения Business Central на настольном компьютере
...
## <a name="install-the-app-for--online"></a>Установка приложения Business Central Online
...
## <a name="install-the-app-for--on-premises"></a>Установка приложения Business Central локально
