...
Создайте рабочий процесс утверждения, указав в строках связанные с ним шаги. Каждый шаг включает в себя:
...
Определение шагов рабочего процесса осуществляется посредством заполнения полей в строках рабочего процесса с использованием фиксированных списков значений событий и ответов, представляющих сценарии, которые поддерживаются кодом приложения.<!--What are the "values"? Can we give an example?-->
