...
ms.author: edupont
---
# <a name="export-and-import-approval-workflows" />Экспорт и импорт рабочих процессов утвердения
...
## <a name="export-a-workflow" />Экспорт рабочего процесса
...
## <a name="import-a-workflow" />Импорт рабочего процесса
