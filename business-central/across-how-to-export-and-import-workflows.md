...
ms.locfileid: "9585422"
---
# <a name="export-and-import-approval-workflows"></a>Экспорт и импорт рабочих процессов утвердения
...
## <a name="export-a-workflow"></a>Экспорт рабочего процесса
...
## <a name="import-a-workflow"></a>Импорт рабочего процесса
