...
Новая группа пользователей добавляется на странице **Группы пользователей**. Переходите к добавлению пользователей. Дополнительные сведения см. в разделе [Группирование пользователей в группы пользователей](ui-how-users-permissions.md#to-group-users-in-a-user-group).  
