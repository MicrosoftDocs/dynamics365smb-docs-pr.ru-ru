...
## <a name="users-in-on-premises-deployments"></a>Пользователи в локальных развертываниях
...
После добавления пользователей вы можете указать, что они будут видеть в пользовательском интерфейсе и как они будут взаимодействовать с разрешенной им функциональностью через страницы. Это делается через профили, отражающие роли или отделы, которые вы назначаете различным типам пользователей. Дополнительные сведения см. в разделе [Управление профилями](admin-users-profiles-roles.md) и [Настройка [!INCLUDE[d365fin](includes/d365fin_md.md)]](ui-customizing-overview.md).

## <a name="to-add-a-user-in-business-central"></a>Добавление пользователя в Business Central
1. Выберите значок ![Лампочка, которая открывает функцию Что вы хотите сделать](media/ui-search/search_small.png "Что вы хотите сделать"), введите **Пользователи**, а затем выберите соответствующую ссылку.
...
## <a name="to-edit-or-delete-a-user"></a>Редактирование или удаление пользователя
1. Выберите значок ![Лампочка, которая открывает функцию Что вы хотите сделать](media/ui-search/search_small.png "Что вы хотите сделать"), введите **Пользователи**, а затем выберите соответствующую ссылку.
...
1. Выберите значок ![Лампочка, которая открывает функцию Что вы хотите сделать](media/ui-search/search_small.png "Что вы хотите сделать"), введите **Группы пользователей**, а затем выберите соответствующую ссылку.
...
1. Выберите значок ![Лампочка, которая открывает функцию Что вы хотите сделать](media/ui-search/search_small.png "Что вы хотите сделать"), введите **Настройки пользователей**, а затем выберите соответствующую ссылку.
...
1. Выберите значок ![Лампочка, которая открывает функцию Что вы хотите сделать](media/ui-search/search_small.png "Что вы хотите сделать"), введите **Наборы разрешений**, а затем выберите соответствующую ссылку.
...
Администратор может закрыть пользователю доступ к системе, изменив значение поля **Статус** на **Отключено**. Все ссылки на пользователя будут сохранены, однако пользователь больше не сможет войти в систему, и активные сеансы для пользователя будут прекращены. Чтобы снова предоставить пользователю доступ, измените значение поля **Статус** на **Включено**.
