...
# <a name="the-c5-data-migration-extension"></a>Расширение "Миграция данных C5"
...
## <a name="what-data-is-migrated"></a>Какие данные переносятся?
...
Если что-то пошло не так и возникла ошибка, в поле **Статус** отображается **Завершено с ошибками**, а в поле **Число ошибок** отображается количество ошибок. Для просмотра списка ошибок можно открыть страницу **Ошибки миграции данных**, выбрав:  

* Номер в поле **Число ошибок** для объекта.  
* Объект, затем действие **Показать ошибки**.  

На странице **Ошибки миграции данных** чтобы исправить ошибку, можно выбрать сообщение об ошибке, затем выбрать **Изменить запись** для просмотра перенесенных данных для объекта. Если имеется несколько ошибок, которые необходимо исправить, можно выбрать **Пакетное устранение ошибок** для редактирования объектов в списке. Однако все равно необходимо открывать индивидуальные записи, если причиной ошибки является связанная запись. Например, поставщик не будет перенесен, если адрес электронной почты одного из его контактов имеет неправильный формат.
