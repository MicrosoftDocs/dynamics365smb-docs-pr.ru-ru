...
# <a name="the-c5-data-migration-extension"></a><a name="the-c5-data-migration-extension"></a><a name="the-c5-data-migration-extension"></a>Расширение миграции данных C5
...
## <a name="what-data-is-migrated"></a><a name="what-data-is-migrated"></a><a name="what-data-is-migrated"></a>Какие данные переносятся?

Следующие данные можно перенести для каждого объекта:

### <a name="customers"></a><a name="customers"></a><a name="customers"></a>Клиенты
...
### <a name="vendors"></a><a name="vendors"></a><a name="vendors"></a>Поставщики
...
### <a name="items"></a><a name="items"></a><a name="items"></a>Товаров
...
### <a name="chart-of-accounts"></a><a name="chart-of-accounts"></a><a name="chart-of-accounts"></a>План счетов
...
## <a name="file-size-requirements"></a><a name="file-size-requirements"></a><a name="file-size-requirements"></a>Требования к размеру файла
...
## <a name="to-migrate-data"></a><a name="to-migrate-data"></a><a name="to-migrate-data"></a>Для миграции данных
...
## <a name="viewing-the-status-of-the-migration"></a><a name="viewing-the-status-of-the-migration"></a><a name="viewing-the-status-of-the-migration"></a>Просмотр состояния миграции
...
## <a name="how-to-avoid-double-posting"></a><a name="how-to-avoid-double-posting"></a><a name="how-to-avoid-double-posting"></a>Как избежать двойного учета
...
## <a name="correcting-errors"></a><a name="correcting-errors"></a><a name="correcting-errors"></a>Исправление ошибок
...
## <a name="verifying-data-after-migrating"></a><a name="verifying-data-after-migrating"></a><a name="verifying-data-after-migrating"></a>Проверка данных после миграции
...
## <a name="stopping-data-migration"></a><a name="stopping-data-migration"></a><a name="stopping-data-migration"></a>Остановка миграции данных
