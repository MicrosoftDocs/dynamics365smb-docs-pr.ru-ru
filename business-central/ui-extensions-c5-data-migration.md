...
## <a name="what-data-is-migrated" />Какие данные переносятся?
...
### <a name="chart-of-accounts" />План счетов
...
## <a name="file-size-requirements" />Требования к размеру файла
...
## <a name="to-migrate-data" />Для миграции данных
...
## <a name="viewing-the-status-of-the-migration" />Просмотр состояния миграции
...
## <a name="how-to-avoid-double-posting" />Как избежать двойного учета
...
## <a name="correcting-errors" />Исправление ошибок
...
## <a name="verifying-data-after-migrating" />Проверка данных после миграции
...
## <a name="stopping-data-migration" />Остановка миграции данных
