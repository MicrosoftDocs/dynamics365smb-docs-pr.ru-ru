...
## <a name="setting-up-sepa-credit-transfer" />Настройка кредитового перевода SEPA
...
### <a name="to-set-up-a-bank-account-for-sepa-credit-transfer" />Настройка банковского счета для кредитового перевода SEPA
...
### <a name="to-set-up-a-vendor-card-for-sepa-credit-transfer" />Настройка карточки поставщика для кредитового перевода SEPA
...
### <a name="to-set-the-payment-journal-up-to-export-payment-files" />Настройка журнала платежей для экспорта платежных файлов
...
### <a name="to-connect-the-data-exchange-definition-for-one-or-more-payment-types-with-the-relevant-payment-method-or-methods" />Подключение определения обмена данными для одного или нескольких типов платежей к соответствующему методу или методам оплаты
...
## <a name="preparing-the-payment-journal" />Подготовка журнала платежей
...
## <a name="exporting-payments-to-a-bank-file" />Экспорт платежей в файл банка
...
### <a name="to-export-payments-to-a-bank-file" />Экспорт платежей в файл банка
...
### <a name="to-plan-when-to-post-exported-payments" />Планирование учета экспортированных платежей
...
### <a name="to-re-export-payments-to-a-bank-file" />Повторный экспорт платежей в банковский файл
...
## <a name="posting-the-payments" />Учет платежей
