...
ms.author: edupont
---
# <a name="create-a-demand-forecast" />Создание прогноза спроса
...
## <a name="sales-forecasts-and-production-forecasts" />Прогнозы продаж и производства
...
## <a name="component-forecast" />Прогноз для компонента
...
## <a name="forecasting-periods" />Периоды прогнозирования
...
## <a name="forecast-by-locations" />Прогноз по складам
...
### <a name="use-forecast-by-locations" />Использовать прогноз по складам
...
### <a name="do-not-use-forecast-by-locations" />Не использовать прогноз по складам
...
## <a name="to-create-a-demand-forecast" />Создание прогноза спроса
