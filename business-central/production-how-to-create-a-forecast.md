...
На странице **Настройка производства** можно указать, как вы хотите работать с местоположениями, которые определены в прогнозах при расчете плана. 

### <a name="use-forecast-by-locations"></a>Использовать прогноз по складам

Если вы выберете поле **Использовать прогноз по складам**, тогда [!INCLUDE[prod_short](includes/prod_short.md)] будет учитывать любые коды местоположений, указанные для каждой записи прогноза спроса, и вычислять оставшийся прогноз для каждого местоположения.  
...
Если отключить параметр **Использовать прогноз по складам**, тогда [!INCLUDE[prod_short](includes/prod_short.md)] будет игнорировать коды местоположений, указанные для каждой записи прогноза спроса, и суммировать прогнозы в прогноз для пустых местоположений.  
