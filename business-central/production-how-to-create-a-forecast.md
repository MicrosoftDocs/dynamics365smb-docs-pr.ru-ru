...
description: "Прогнозы продаж и производственные прогнозы можно составить в окне **Прогноз спроса**."
...
Прогнозы продаж и производственные прогнозы можно составить в окне **Прогноз спроса**.  
...
Прогнозы создаются вручную в окне **Прогноз спроса**. В системе может существовать одновременно несколько прогнозов, которые различаются по имени и типу. Прогнозы можно копировать и изменять (по необходимости). Обратите внимание, что для планирования единовременно можно применять только один прогноз.  
...
> [!NOTE]  
>  Также можно откорректировать существующий прогноз. В окне **Матрица прогноза спроса** выберите действие **Копировать прогноз спроса** и заполните окно **Прогноз спроса** данными существующего прогноза. Затем можно внести нужные изменения в значения количества.  
