...
---
# <a name="create-workflows-to-connect-tasks-in-business-processes" />Создание рабочих процессов для соединения задач в бизнес-процессах
...
## <a name="to-create-a-workflow" />Создание потока операций
...
## <a name="example-of-creating-a-new-workflow-using-existing-events" />Пример создания нового рабочего процесса с использованием существующих событий
