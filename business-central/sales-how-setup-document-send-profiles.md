...
## <a name="to-set-up-a-document-sending-profile" />Настройка профиля отправки документов
...
## <a name="to-specify-a-sending-profile-on-a-customer-card" />Определение профиля отправки в карточке клиента
