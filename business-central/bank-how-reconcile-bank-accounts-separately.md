...
## <a name="about-bank-reconciliation"></a>О банковской выверке

Выверка транзакций в выписках из банка с банковскими операциями в [!INCLUDE[prod_short](includes/prod_short.md)] называется *определением соответствия или сопоставлением*. Существует три способа сопоставления транзакций с банковскими проводками:
...
* Автоматически, с помощью действия **Выверить с помощью Copilot**.
  ...
  Это действие доступно как часть функции помощи в выверке банковских счетов (предварительная версия), которая реализована на базе искусственного интеллекта. [Подробнее о помощи в выверке банковского счета](bank-reconciliation-with-copilot.md).
...
В строках с сопоставленными операциями установлен флажок **Применено**. Дополнительные сведения см. в разделе [Настройка правил для автоматического применения платежей](receivables-how-set-up-payment-application-rules.md). Если вы введете конечную дату выписки в банковской выверке после того, как сопоставите ее строки с операциями, [!INCLUDE [prod_short](includes/prod_short.md)] отменит сопоставления для строк и операций после этой даты.
...
Любые строки, которые не удалось сопоставить, обозначенные значением в поле **Разница**, останутся на странице **Сверка банковских счетов**  после публикации. Они представляют собой несоответствие, которое вы должны устранить, прежде чем сможете завершить выверку банковского счета. В следующей таблице описаны несколько типичных бизнес-ситуаций, которые могут привести к различиям.
...
## <a name="add-bank-statement-lines-by-importing-a-bank-statement"></a>Добавление строк банковской выписки путем импорта банковской выписки
...
## <a name="match-bank-statement-lines-with-bank-account-ledger-entries-manually"></a>Сопоставление строк банковских выписок с операциями книги банковских счетов вручную
...
## <a name="validate-your-bank-reconciliation"></a>Проверка банковской выверки
...
* При сверке платежей на странице **Журнала сверки платежей** .
...
|Сальдо счета ГК № <*номер*> на <*дата*> | Сальдо по счету ГК на конечную дату выписки. Это неотфильтрованное сальдо на эту дату. Если ваш банк использует вашу местную валюту, после сопоставления всех строк выписки это сальдо должно совпасть с сальдо вашего банковского счета (показанным в правой части заголовка отчета). Пустое значение **()** в названии этого поля означает, что ваш банк использует местную валюту.<br><br>Расхождение между этим и предыдущим полем может указывать на то, что вы учли операцию непосредственно на счете ГК или что вы используете один и тот же счет ГК для нескольких банков, что не рекомендуется. Банки связаны с главной книгой через учетную группу банковских счетов, указанную для счета.<br><br>При наличии напрямую учтенных операций в тестовом отчете появляется предупреждение, даже если сальдо учтенной операции равно нулю. Несбалансированные прямые проводки часто приводят к накоплению разниц для будущих банковских сверок. Вы должны проверить сальдо главной книги и операции книги учета, прежде чем учитывать банковскую выверку. Чтобы узнать больше о прямом учете, прочитайте статью [Недопущение прямого учета](#avoid-direct-posting).|
...
2. На странице **Перемещ. банк. выверки в фин. журнал** укажите, какую главную книгу требуется использовать, затем нажмите кнопку **ОК**.
    ...
    Страница **Главные журналы** открывается с новыми строками журнала для всех строк выписок банка, в которых отсутствуют записи в бухгалтерской книге.
...
При запуске отчета по банковским выпискам со страницы **Список выписок по банковским счетам**  вы можете включить переключатель **Неоплаченные записи**, и отчет будет включать раздел со списком неоплаченных записей.
...
Если вы обнаружите ошибку в разнесенной банковской выверке, вы можете использовать действие **Отменить** на странице **Список выписок по банковскому счету**, чтобы исправить ее. При отмене опубликованной банковской сверки записи перемещаются на страницу **Сверки банковских счетов**  и помечаются как **Открытые**, что означает, что они не сверены. Затем вы можете исправить банковскую выверку и снова разнести ее.
...
Вы выполнили выверку банковских счетов за январь, февраль и март. Номер банковской выписки за март был 100. Позже вы обнаружили, что март включал только записи до 30-го числа, что означает, что записи за 31-е число отсутствуют. Итак, вам нужно переделать банковскую выверку за март. В этом случае мы откроем страницу **Список выписок по банковским счетам**, выберем выписку за март, а затем выберем **Отменить**. 
...
[Сверка банковских счетов](bank-manage-bank-accounts.md)    
...
[Автоматическое применение платежей и сверка банковских счетов](receivables-apply-payments-auto-reconcile-bank-accounts.md)    
[Создание банковского дела](bank-setup-banking.md)    
[Настройте правила для автоматического применения платежей](receivables-how-set-up-payment-application-rules.md)    
