...
1. Выберите значок ![Поиск страницы или отчета](media/ui-search/search_small.png "Значок поиска страницы или отчета"), введите **Выверка банковских счетов**, а затем выберите соответствующую ссылку.
