...
description: Здесь описывается, как выполнить банковскую выверку на странице **Выверка банковского счета**; как стоимость ваших запасов выверяется с главной книгой.
author: SorenGP
