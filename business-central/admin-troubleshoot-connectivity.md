...
ROBOTS: NOINDEX
---
# Устранение неполадок подключения для Business Central
...
## Подключение к службе приложений
...
|-------|-------------|
|Отсутствует прошедший проверку подлинности пользователь для выполнения проверки|Перейдите к проверке **Аутентификация пользователя**.|
|Система Business Central временно недоступна. Попробуйте еще раз позднее.|Повторите попытку позже.|
