...
# Устранение неполадок с подключениями в Business Central
...
## Загрузка ресурсов CDN (сети доставки контента)
...
## Обнаружение сред Business Central
...
## Подключение к службе приложения
...
## Состояние работоспособности службы
