...
---
# <a name="design-details-central-concepts-of-the-planning-system"></a><a name="design-details-central-concepts-of-the-planning-system"></a><a name="design-details-central-concepts-of-the-planning-system"></a>Сведения о проектировании: основные понятия системы планирования
...
## <a name="planning-parameters"></a><a name="planning-parameters"></a><a name="planning-parameters"></a>Параметры планирования
...
## <a name="planning-starting-date"></a><a name="planning-starting-date"></a><a name="planning-starting-date"></a>Дата начала планирования
...
## <a name="dynamic-order-tracking-pegging"></a><a name="dynamic-order-tracking-pegging"></a><a name="dynamic-order-tracking-pegging"></a>Динамическая трассировка заказов (фиксация)
...
### <a name="dynamic-order-tracking-versus-the-planning-system"></a><a name="dynamic-order-tracking-versus-the-planning-system"></a><a name="dynamic-order-tracking-versus-the-planning-system"></a>Динамическая трассировка заказов и система планирования
...
## <a name="sequence-and-priority-in-planning"></a><a name="sequence-and-priority-in-planning"></a><a name="sequence-and-priority-in-planning"></a>Порядок и приоритет в планировании
...
### <a name="item-priority--low-level-code"></a><a name="item-priority--low-level-code"></a><a name="item-priority--low-level-code"></a>Приоритет/код нижнего уровня товара
...
#### <a name="optimizing-performance-for-low-level-calculations"></a><a name="optimizing-performance-for-low-level-calculations"></a><a name="optimizing-performance-for-low-level-calculations"></a>Оптимизация производительности для низкоуровневых вычислений
...
### <a name="locations--transfer-level-priority"></a><a name="locations--transfer-level-priority"></a><a name="locations--transfer-level-priority"></a>Приоритет на уровне склада/перемещения
...
### <a name="order-priority"></a><a name="order-priority"></a><a name="order-priority"></a>Приоритет заказа
...
## <a name="demand-forecasts-and-blanket-orders"></a><a name="demand-forecasts-and-blanket-orders"></a><a name="demand-forecasts-and-blanket-orders"></a>Прогнозы спроса и общие заказы
...
## <a name="planning-assignment"></a><a name="planning-assignment"></a><a name="planning-assignment"></a>Назначение произодственного плана
...
## <a name="item-dimensions"></a><a name="item-dimensions"></a><a name="item-dimensions"></a>Измерения товара
...
## <a name="item-attributes"></a><a name="item-attributes"></a><a name="item-attributes"></a>Атрибуты товара
...
### <a name="specific-attributes"></a><a name="specific-attributes"></a><a name="specific-attributes"></a>Специфические атрибуты
...
### <a name="non-specific-attributes"></a><a name="non-specific-attributes"></a><a name="non-specific-attributes"></a>Общие атрибуты
...
## <a name="order-to-order-links"></a><a name="order-to-order-links"></a><a name="order-to-order-links"></a>Связи "заказ-в-заказ"
...
## <a name="reservations"></a><a name="reservations"></a><a name="reservations"></a>Резервирования
...
## <a name="warnings"></a><a name="warnings"></a><a name="warnings"></a>Предупреждения
...
### <a name="emergency"></a><a name="emergency"></a><a name="emergency"></a>Экстренный,
...
### <a name="exception"></a><a name="exception"></a><a name="exception"></a>Исключение
...
### <a name="attention"></a><a name="attention"></a><a name="attention"></a>Внимание!
...
## <a name="error-logs"></a><a name="error-logs"></a><a name="error-logs"></a>Журналы ошибок
...
## <a name="planning-flexibility"></a><a name="planning-flexibility"></a><a name="planning-flexibility"></a>Гибкость планирования
...
## <a name="order-planning"></a><a name="order-planning"></a><a name="order-planning"></a>Планирование заказов
...
## <a name="finite-loading"></a><a name="finite-loading"></a><a name="finite-loading"></a>Ограниченная нагрузка
