...
---
# <a name="design-details-central-concepts-of-the-planning-system" />Сведения о проектировании: основные понятия системы планирования
...
## <a name="planning-parameters" />Параметры планирования
...
## <a name="planning-starting-date" />Дата начала планирования
...
## <a name="dynamic-order-tracking-pegging" />Динамическая трассировка заказов (фиксация)
...
### <a name="dynamic-order-tracking-versus-the-planning-system" />Динамическая трассировка заказов и система планирования
...
## <a name="sequence-and-priority-in-planning" />Порядок и приоритет в планировании
...
### <a name="item-priority--low-level-code" />Приоритет/код нижнего уровня товара
...
#### <a name="optimizing-performance-for-low-level-calculations" />Оптимизация производительности для низкоуровневых вычислений
...
### <a name="locations--transfer-level-priority" />Приоритет на уровне склада/перемещения
...
### <a name="order-priority" />Приоритет заказа
...
## <a name="demand-forecasts-and-blanket-orders" />Прогнозы спроса и общие заказы
...
## <a name="planning-assignment" />Назначение произодственного плана
...
## <a name="item-dimensions" />Измерения товара
...
## <a name="item-attributes" />Атрибуты товара
...
### <a name="specific-attributes" />Специфические атрибуты
...
### <a name="non-specific-attributes" />Общие атрибуты
...
## <a name="order-to-order-links" />Связи "заказ-в-заказ"
...
## <a name="reservations" />Резервирования
...
## <a name="warnings" />Предупреждения
...
## <a name="error-logs" />Журналы ошибок
...
## <a name="planning-flexibility" />Гибкость планирования
...
## <a name="order-planning" />Планирование заказов
...
## <a name="finite-loading" />Ограниченная нагрузка
