...
## <a name="planning-assignment"></a>Назначение произодственного плана
...
## <a name="item-attributes"></a>Атрибуты товара
...
### <a name="specific-attributes"></a>Специфические атрибуты
...
## <a name="finite-loading"></a>Ограниченная нагрузка
