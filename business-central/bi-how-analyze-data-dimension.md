...
## Настройка аналитического представления
...
## Обновление аналитического представления
...
## См. соответствующее обучение на странице [Microsoft Learn](/learn/modules/dimensions-financial-reports-dynamics-365-business-central/index).
