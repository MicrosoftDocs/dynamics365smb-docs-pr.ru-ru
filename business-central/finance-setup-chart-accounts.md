...
ms.author: bholtorf
---
# Настройка или изменение плана счетов
...
## Блокировать удаление счетов ГК
...
## См. соответствующее [обучение Microsoft](/training/modules/chart-accounts-dynamics-365-business-central/index)
