...
ms.author: edupont
---
# <a name="set-up-or-change-the-chart-of-accounts"></a><a name="set-up-or-change-the-chart-of-accounts"></a>Настройка или изменение плана счетов
...
## <a name="add-or-change-accounts"></a><a name="add-or-change-accounts"></a>Добавить или изменить счета
...
## <a name="delete-accounts"></a><a name="delete-accounts"></a>Удаление счетов
...
## <a name="block-deletion-of-gl-accounts"></a><a name="block-deletion-of-gl-accounts"></a>Блокировать удаление счетов ГК
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>См. соответствующее [обучение Microsoft](/training/modules/chart-accounts-dynamics-365-business-central/index)
