...
ms.author: edupont
---
# <a name="use-business-central-without-outlook"></a><a name="use-business-central-without-outlook"></a>Использование Business Central без Outlook
...
## <a name="sending-email"></a><a name="sending-email"></a>Отправка электронной почты
