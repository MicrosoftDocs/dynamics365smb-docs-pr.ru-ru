...
---
# <a name="walkthrough-set-up-and-invoicing-sales-prepayments"></a>Пошаговое руководство: настройка и выставление счетов на предоплату по продажам
...
## <a name="apply-the-prepayments"></a>Применение предоплат
...
## <a name="invoice-the-remaining-amount"></a>Выставление счета на сумму остатка
