...
ms.author: edupont
---
# Пошаговое руководство. Настройка и выставление счетов на продажу
...
### Процедура настройки серии номеров для предоплаты
...
### Блокировка отгрузок при отсутствии предоплаты
...
### Процедура назначения процента предоплаты по умолчанию клиентам и товарам
...
### Определение счета для авансов при общей настройке учета
...
### Процедура создания заказа на продажу с предоплатой
...
## Создание дополнительного счета на предоплату
...
### Процедура создания дополнительного счета на предоплату
...
### Процедура применения платежа к счетам на предоплату
...
## Выставления счета на сумму остатка
...
### Процедура выставления счета на сумму остатка
