...
Предоплата — это платежи, для которых выставление счетов и учет в заказах на предоплату при продажах или покупках осуществляется до окончательного выставления счетов. Например, можно потребовать задаток перед производством товара по заказу или платеж перед отгрузкой товаров клиенту. Благодаря функции предоплаты можно выставлять счета в [!INCLUDE[prod_short](includes/prod_short.md)] и собирать необходимые авансы от клиентов либо переводить авансы поставщикам. Таким образом, можно гарантировать учет всех платежей по счету.  
...
4.  Выберите **Связанный**, затем выберите **Продажи**, затем **Проценты предоплаты**
5.  Заполните две строки на странице **Проценты предоплаты при продаже**, как указано ниже.  
    ...
    |**Все клиенты**| |**1896-S**|**20**|  

    > [!IMPORTANT]  
    >  В зависимости от страны/региона, необходимо также указать код налоговой группы на экспресс-вкладке **Счет** для товара 1896-S.  
...
3.  Для **Номер клиента** выберите **20000**.  
...
9.  Измените сумму в поле **Сумма в строке предоплаты без налога** на **800** и закройте страницу.  
...
2.  В строке для товара **1896-S** введите в поле **Кол-во** значение **2**.  
    ...
    В действии **Заказ**, выберите **Статистика**. Теперь поле **Сумма в строке предоплаты без НДС** содержит **768.04**, а поле **Сумм. предопл. для выст. счета без НДС** содержит **417.76**. Это показывает, что есть дополнительная сумма предоплаты, которая еще не была включена в счет.  
...
4.  На странице **Применение операций клиента** выберите первый счет на предоплату, после чего выберите действие **Обработать**, затем **Установить код применения**.  
