...
---
# <a name="the-service-declaration-extension" />Расширение декларации услуг
...
## <a name="enable-the-service-declaration-extension" />Включение расширения декларации услуг
...
## <a name="set-up-the-service-declaration-extension" />Настройка расширения декларации услуг

Вы можете настроить расширение вручную или с помощью файла отчетности в определениях обмена данными.

### <a name="to-set-up-service-declaration-manually" />Ручная настройка деклараций услуг
...
### <a name="item-charges" />Товарные издержки
...
## <a name="create-new-service-declaration" />Создание новой декларации услуг
...
## <a name="modify-a-service-declaration" />Изменение декларации услуг
...
## <a name="overview-the-service-declaration-lines" />Обзор строк декларации услуг
...
## <a name="report-service-declaration-in-a-file" />Передача декларации услуг в файле
...
## <a name="other-considerations" />Прочие рекомендации
...
### <a name="using-services-in-document-lines" />Использование услуг в строках документа
