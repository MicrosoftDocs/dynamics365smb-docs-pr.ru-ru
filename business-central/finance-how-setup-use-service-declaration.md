...
---
# <a name="the-service-declaration-extension"></a><a name="the-service-declaration-extension"></a>Расширение декларации услуг
...
## <a name="enable-the-service-declaration-extension"></a><a name="enable-the-service-declaration-extension"></a>Включение расширения декларации услуг
...
## <a name="set-up-the-service-declaration-extension"></a><a name="set-up-the-service-declaration-extension"></a>Настройка расширения декларации услуг

Вы можете настроить расширение вручную или с помощью файла отчетности в определениях обмена данными.

### <a name="to-set-up-service-declaration-manually"></a><a name="to-set-up-service-declaration-manually"></a>Ручная настройка деклараций услуг
...
### <a name="resources"></a><a name="resources"></a>Ресурсы
...
### <a name="item-charges"></a><a name="item-charges"></a>Товарные издержки
...
## <a name="create-new-service-declaration"></a><a name="create-new-service-declaration"></a>Создание новой декларации услуг
...
## <a name="modify-a-service-declaration"></a><a name="modify-a-service-declaration"></a>Изменение декларации услуг
...
## <a name="overview-the-service-declaration-lines"></a><a name="overview-the-service-declaration-lines"></a>Обзор строк декларации услуг
...
## <a name="report-service-declaration-in-a-file"></a><a name="report-service-declaration-in-a-file"></a>Передача декларации услуг в файле
...
## <a name="other-considerations"></a><a name="other-considerations"></a>Прочие рекомендации
...
### <a name="using-services-in-document-lines"></a><a name="using-services-in-document-lines"></a>Использование услуг в строках документа
