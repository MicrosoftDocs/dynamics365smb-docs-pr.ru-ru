...
| Действие | Ссылка |
| --- | --- |
| Создайте предложение по продаже, в котором будут предлагаться продукты на согласуемых условиях, прежде чем преобразовать предложение в счет продажи. |[Создание предложений](sales-how-make-offers.md) |
