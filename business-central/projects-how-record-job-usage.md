...
---
# <a name="record-consumption-or-usage-for-projects"></a>Учет потребления или использования для работ
...
## <a name="to-record-usage-for-a-project-planning-line-of-type-budget"></a>Запись потребления для строки планирования работ типа "Бюджет"
...
## <a name="to-create-project-journal-lines-manually"></a>Создание вручную строк журнала работ
...
## <a name="to-view-project-usage-estimates-and-post-updates"></a>Просмотра оценок потребления работы и учет обновлений
...
## <a name="create-inventory-and-warehouse-pick-documents-for-a-project"></a>Создание документов инвентаризации и складского подбора для задания
...
## <a name="to-review-planning-lines-for-a-project-ledger-entry"></a>Проверка строк планирования для операции книги работ
