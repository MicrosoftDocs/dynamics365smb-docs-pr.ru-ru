...
ms.author: edupont
---
# <a name="block-customers"></a><a name="block-customers"></a><a name="block-customers"></a>Блокировка клиентов
...
## <a name="to-block-a-customer"></a><a name="to-block-a-customer"></a><a name="to-block-a-customer"></a>Для блокировки клиента
