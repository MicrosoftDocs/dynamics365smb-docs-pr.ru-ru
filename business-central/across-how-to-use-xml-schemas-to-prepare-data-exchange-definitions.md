...
ms.author: edupont
---
# <a name="use-xml-schemas-to-prepare-data-exchange-definitions" />Использование XML-схем для определения обмена данными
...
## <a name="to-load-an-xml-schema-file" />загрузка файла XML-схемы
...
### <a name="to-select-or-clear-nodes-in-an-xml-schema" />Выбор или удаление узлов в XML-схеме
...
### <a name="to-generate-a-data-exchange-definition-that-is-based-on-an-xml-schema" />Создание определения обмена данными на базе XML-схемы
