...
# <a name="sharing-business-central-records-and-page-links-in-microsoft-teams" />Совместное использование записей Business Central и ссылок на страницы в Microsoft Teams
...
## <a name="include-and-view-a-business-central-card-in-a-teams-conversation" />Включите и просмотрите карточку Business Central в беседу в Teams
...
### <a name="include-a-business-central-card-in-a-teams-conversation" />Включите карточку Business Central в беседу в Teams
...
### <a name="view-card-details" />Просмотр сведений карточки
...
### <a name="share-a-link" />Поделитесь ссылкой
