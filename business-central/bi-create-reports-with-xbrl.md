...
ms.locfileid: "8511757"
---
# <a name="create-reports-with-xbrl"></a>Создать отчеты с XBRL

> [!NOTE]
> Мы находимся в процессе удаления функций отчетности XBRL из [!INCLUDE[prod_short](includes/prod_short.md)]. Для получения дополнительной информации см. [Изменения в выпуске 2022, волна 1](/dynamics365/business-central/dev-itpro/upgrade/deprecated-features-w1).
...
1.  Выберите ![Лампочка, которая открывает функцию Что вы хотите сделать.](media/ui-search/search_small.png "Что вы хотите сделать") значок, введите **Таксономии XBRL**, а затем выберите связанную ссылку.  
...
4.  Чтобы импортировать схему, на странице **XBRL Схемы** выберите действие **Импорт**, затем выберите папку и файл XSD. Нажмите кнопку **Открыть**.  
5.  Чтобы импортировать базу ссылок, на странице **XBRL Схемы** выберите действие **Базы ссылок**, затем выберите папку и файл XML. Нажмите кнопку **Открыть**.  
