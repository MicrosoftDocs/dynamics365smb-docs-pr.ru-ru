...
ms.author: bholtorf
---
# <a name="the-quickbooks-payroll-file-import-extension" />Расширение импорта файла зарплаты QuickBooks
...
## <a name="steps-to-import-payroll-data" />Действия для импорта данных по зарплате
