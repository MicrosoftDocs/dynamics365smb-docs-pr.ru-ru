...
ms.author: edupont
---
# <a name="export-a-positive-pay-file" />Экспорт файла Positive Pay
...
## <a name="to-set-up-a-bank-account-for-positive-pay" />Настройка банковского счета для Positive Pay
...
## <a name="to-export-a-positive-pay-file" />Экспорт файла Positive Pay
1. Выберите ![Лампочка, которая открывает функцию Что вы хотите сделать.](media/ui-search/search_small.png "Что вы хотите сделать") значок, введите **Банковские счета**, а затем выберите связанную ссылку.
