...
description: Узнайте, как использовать шаблоны конфигурации для структурирования существующих данных о клиентах, прежде чем переносить основные данные в новую компанию в Business Central.
author: SorenGP
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
