...
ms.author: edupont
---
# <a name="suggest-vendor-payments" />Предлож. оплаты поставщикам
...
## <a name="to-use-the-suggest-vendor-payments-function" />Использование функции предложения оплаты поставщикам
...
## <a name="to-insert-the-due-date-as-posting-date-on-payment-journal-lines" />Вставка срока оплаты в качестве даты учета в строках журнала платежей
...
## <a name="see-related-microsoft-training" />См. соответствующее [обучение Microsoft](/training/modules/suggest-vendor-payments-dynamics-365-business-central/)
