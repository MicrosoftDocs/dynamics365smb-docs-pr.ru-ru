...
ms.author: jswymer
---
# <a name="manage-interactions-for-segments"></a><a name="manage-interactions-for-segments"></a>Управление взаимодействиями для сегментов
...
## <a name="segmenting"></a><a name="segmenting"></a>Сегментация
...
## <a name="interactions"></a><a name="interactions"></a>Взаимодействия
...
## <a name="logging"></a><a name="logging"></a>Регистрация
