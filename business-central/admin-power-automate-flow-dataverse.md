...
ms.author: bholtorf
---
# Использование потока Power Automate для своевременной синхронизации изменений сущностей Dataverse
...
## Уведомление Business Central об изменении
