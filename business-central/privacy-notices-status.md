...
## <a name="privacy-notices-status-page" />Страниц статуса уведомлений о конфиденциальности
...
## <a name="privacy-notice-approvals" />Утверждения уведомлений о конфиденциальности
