...
ms.author: edupont
---
# <a name="enter-external-document-numbers" />Ввод номеров внешних документов
...
## <a name="to-enter-external-document-numbers-in-a-sales-order" />Ввод номеров внешних документов в заказ на продажу
