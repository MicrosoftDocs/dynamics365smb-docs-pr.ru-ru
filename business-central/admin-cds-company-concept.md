---
title: Модели владения данными для синхронизации
...
# Модели владения данными для синхронизации
...
## Модель ответственности "Рабочая группа"
...
## Выбор другого бизнес-подразделения
...
## Модели ответственность "Физ. лицо"
