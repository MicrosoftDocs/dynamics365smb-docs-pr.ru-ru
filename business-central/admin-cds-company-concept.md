...
# <a name="data-ownership-models" />Модели владения данными
...
## <a name="team-ownership" />Модель ответственности "Рабочая группа"
...
## <a name="choosing-a-different-business-unit" />Выбор другого бизнес-подразделения
...
## <a name="person-ownership" />Модели ответственность "Физ. лицо"
