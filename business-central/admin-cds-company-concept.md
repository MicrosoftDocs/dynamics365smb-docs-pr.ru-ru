...
# <a name="data-ownership-models"></a><a name="data-ownership-models"></a>Модели владения данными
...
## <a name="team-ownership"></a><a name="team-ownership"></a>Модель ответственности "Рабочая группа"
...
## <a name="choosing-a-different-business-unit"></a><a name="choosing-a-different-business-unit"></a>Выбор другого бизнес-подразделения
...
## <a name="person-ownership"></a><a name="person-ownership"></a>Модели ответственность "Физ. лицо"
