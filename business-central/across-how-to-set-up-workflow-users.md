...
ms.author: bholtorf
---
# <a name="set-up-a-sequence-of-workflow-users"></a>Настройка последовательности пользователей рабочего процесса
...
## <a name="to-set-up-a-workflow-user-group"></a>Настройка группы пользователей рабочего процесса
