...
ms.author: bholtorf
---
# <a name="set-up-a-sequence-of-workflow-users" />Настройка последовательности пользователей рабочего процесса
...
## <a name="to-set-up-a-workflow-user-group" />Настройка группы пользователей рабочего процесса
