...
ms.author: edupont
---
# <a name="export-your-business-data-to-excel" />Экспорт бизнес-данных в Excel
...
## <a name="opening-lists-in-excel" />Открытие списков в Excel
...
### <a name="edit-data-in-excel" />Изменить данные в Excel
...
## <a name="exporting-data-to-other-finance-systems" />Экспорт данных в другие финансовые системы
