...
2. На странице **Настройка пользователя для утверждений** создайте новую строку и заполните поля, как описано в следующей таблице.  
    ...
    |**Администратор утверждения**|Укажите пользователя, у которого есть права на разблокировку рабочего процесса утверждения. Например, посредством делегирования запросов утверждения новым заместителям утверждающих лиц и удаления просроченных запросов утверждения.|
