...
Отчеты можно найти на вкладке **Отчеты** на выбранных страницах, или можно использовать поиск ![Поиск страницы или отчета](media/ui-search/search_small.png "Значок \"Поиск страницы или отчета\"") для поиска отчетов по имени.
