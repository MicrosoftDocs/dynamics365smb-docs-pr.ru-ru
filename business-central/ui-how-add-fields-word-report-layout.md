...
# <a name="work-with-word-layouts" />Работа с макетами Word
...
## <a name="embedding-fonts-in-word-layouts-for-consistency" />Внедрение шрифтов в макеты Word для единообразия
...
## <a name="adding-data-fields" />Добавление полей данных
...
### <a name="to-add-a-label-or-data-field" />Добавление поля метки или данных
...
### <a name="to-add-repeating-rows-of-data-fields-to-create-a-list" />Добавление повторяющихся строк полей данных для создания списка
...
## <a name="adding-image-fields" />Добавление полей изображений
...
### <a name="to-add-an-image" />Добавление изображения
...
### <a name="to-remove-a-label-or-data-field" />Удаление метки или поля данных
...
## <a name="custom-xml-part-overview" />Обзор пользовательской XML-части
...
### <a name="xml-structure-of-custom-xml-part" />Структура XML пользовательской части XML
...
### <a name="custom-xml-part-in-word" />Пользовательская часть XML в Word
