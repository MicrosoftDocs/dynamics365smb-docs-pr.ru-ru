...
# <a name="couple-and-synchronize-records-between-dataverse-and-business-central" />Связывание и синхронизация записей между Dataverse и Business Central
...
## <a name="video-example" />Видео с примером
...
## <a name="to-couple-a-record" />Связывание записи
...
## <a name="to-synchronize-a-single-record" />Синхронизация одной записи
...
## <a name="to-couple-multiple-records-using-match-based-coupling" />Чтобы связать несколько записей с помощью связывания на основе совпадений
...
## <a name="to-synchronize-multiple-records" />Синхронизация нескольких записей
...
## <a name="bulk-insert-and-couple-records" />Массовая вставка и связывание записей
...
## <a name="uncoupling-records" />Отмена связывания записей
