...
ms.author: jswymer
---
# <a name="managing-onedrive-integration-with-business-central" />Управление интеграцией OneDrive с Business Central
...
## <a name="configure-onedrive-for-integration-with-business-central" />Настройка OneDrive для интеграции с Business Central
...
### <a name="managing-privacy" />Управление конфиденциальностью
...
## <a name="configure-business-central" />Настройка Business Central
...
### <a name="about-multiple-environments" />О нескольких средах
...
### <a name="configure-onedrive-using-onedrive-setup" />Настройка OneDrive с использованием мастера "Настройка OneDrive"
...
### <a name="switching-to-new-onedrive-integration-after-upgrade" />Переход на новую интеграцию с OneDrive после обновления
...
## <a name="restoring-onedrive-and-includeprodshortincludesprodshortmd" />Восстановление OneDrive и [!INCLUDE[prod_short](includes/prod_short.md)]
