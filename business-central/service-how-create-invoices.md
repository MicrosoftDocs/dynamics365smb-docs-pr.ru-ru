...
1. Выберите значок ![Лампочка, которая открывает функцию Что вы хотите сделать](media/ui-search/search_small.png "Что вы хотите сделать"), введите **Сервисные счета**, затем выберите связанную ссылку.  
2. Заполните поля в строке по мере необходимости. [!INCLUDE[tooltip-inline-tip](includes/tooltip-inline-tip_md.md)]  
3. Выберите действие **Получить строки расх. накладной**. В окне **Получение строк сервисной расх. накладной** отображаются все строки, которые были отгружены, но не были включены в счет для клиента.  
