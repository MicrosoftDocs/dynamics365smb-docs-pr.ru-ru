...
ms.author: edupont
---
# <a name="work-with-production-families" />Работа с производственными семействами
...
## <a name="to-set-up-a-production-family" />Настройка производственного семейства
...
## <a name="to-produce-based-on-a-production-family" />Для производства на основе производственного семейства
