...
ms.author: edupont
---
# <a name="set-up-general-inventory-information" />Настройка общей информации по запасам

Можно указать общую информацию по запасам на странице **Настройка запасов**.

## <a name="to-set-up-general-inventory-information" />Настройка общей информации по запасам
