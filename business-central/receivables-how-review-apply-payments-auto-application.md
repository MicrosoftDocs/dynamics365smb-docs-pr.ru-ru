---
title: Просмотрите и примените платежи вручную после автоматического применения
...
---
# <a name="review-and-apply-payments-manually-after-automatic-application"></a>Просмотрите и примените платежи вручную после автоматического применения
...
Любая корректировка прибылей и убытков, необходимая в связи с конвертацией валют, не обрабатывается автоматически [!INCLUDE[prod_short](includes/prod_short.md)].
...
7. Чтобы применить часть платежа к одной или нескольким открытым записям, которых нет в базе данных, создайте новую строку под строкой для того же счета. В поле **Примененная сумма** введите сумму для применения к новой строке, а затем скорректируйте поле **Примененная сумма** в существующей строке.
