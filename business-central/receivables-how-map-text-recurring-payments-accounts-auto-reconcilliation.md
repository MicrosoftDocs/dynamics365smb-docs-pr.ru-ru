...
---
# Текст карты повторяющихся платежей по счетам для автоматической сверки
...
## Сопоставление текста на типовых платежах со счетами для автоматической выверки
...
## Пример: Текстовое сообщение на счет сопоставление для оплаты банковских сборов
