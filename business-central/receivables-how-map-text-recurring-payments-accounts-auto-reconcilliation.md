...
ms.author: edupont
---
# <a name="map-text-on-recurring-payments-to-accounts-for-automatic-reconciliation" />Сопоставление текста на типовых платежах со счетами для автоматической выверки
...
## <a name="to-map-text-on-recurring-payments-to-accounts-for-automatic-reconciliation" />Сопоставление текста на типовых платежах со счетами для автоматической выверки
...
## <a name="example-text-to-account-mapping-for-bank-fees" />Пример: сопоставление текст-счет для банковских сборов
