...
Чтобы всегда учитывать расходы на топливо, понесенные на заправках Shell, на счету ГК за бензин (счет 8510), заполните строку на странице **Сопоставление текста со счетами** следующим образом.
