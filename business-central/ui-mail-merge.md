...
# <a name="use-word-templates-for-bulk-communication"></a><a name="use-word-templates-for-bulk-communication"></a>Использование шаблонов Word для массовых сообщений
...
## <a name="set-up-the-source-of-data"></a><a name="set-up-the-source-of-data"></a>Настройка источника данных
...
## <a name="add-entries-that-are-related-or-unrelated-to-the-source-entity"></a><a name="add-entries-that-are-related-or-unrelated-to-the-source-entity"></a>Добавление записей, связанных или несвязанных с объектом-источником
...
### <a name="select-the-fields-to-include"></a><a name="select-the-fields-to-include"></a>Выбор полей для включения
...
## <a name="to-create-a-word-template-in-business-central"></a><a name="to-create-a-word-template-in-business-central"></a>Чтобы создать шаблон Word в Business Central
...
## <a name="set-up-the-template-in-word"></a><a name="set-up-the-template-in-word"></a>Настройка шаблона в Word
...
## <a name="apply-a-template"></a><a name="apply-a-template"></a>Применение шаблона
...
## <a name="use-word-templates-with-email"></a><a name="use-word-templates-with-email"></a>Использование шаблонов Word с электронной почтой
...
## <a name="edit-a-word-template"></a><a name="edit-a-word-template"></a>Редактирование шаблона Word
