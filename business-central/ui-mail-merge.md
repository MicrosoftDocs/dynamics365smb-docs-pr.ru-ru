...
# <a name="use-word-templates-for-bulk-communication" />Использование шаблонов Word для массовых сообщений
...
## <a name="set-up-the-source-of-data" />Настройка источника данных
...
## <a name="add-entries-that-are-related-or-unrelated-to-the-source-entity" />Добавление записей, связанных или несвязанных с объектом-источником
...
### <a name="select-the-fields-to-include" />Выбор полей для включения
...
## <a name="to-create-a-word-template-in-business-central" />Чтобы создать шаблон Word в Business Central
...
## <a name="set-up-the-template-in-word" />Настройка шаблона в Word
...
## <a name="apply-a-template" />Применение шаблона
...
## <a name="use-word-templates-with-email" />Использование шаблонов Word с электронной почтой
...
## <a name="edit-a-word-template" />Редактирование шаблона Word
