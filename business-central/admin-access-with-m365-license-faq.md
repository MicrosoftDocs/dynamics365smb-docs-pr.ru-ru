...
---
# <a name="access-with-microsoft--licenses-faq" />Доступ с лицензиями на Microsoft 365 — вопросы и ответы
...
### <a name="can-i-access-business-central-on-premises-with-microsoft--licenses" />Можно ли получить доступ к локальной версии Business Central с помощью лицензий Microsoft 365?
...
### <a name="do-users-that-only-have-a-microsoft--license-show-up-in-the-users-list-in-business-central" />Отображаются ли пользователи, имеющие только лицензию Microsoft 365, в списке пользователей в Business Central?
...
### <a name="is-this--free-of-charge" />Это полностью бесплатно?
...
### <a name="does-this-work-with-microsoft--trials-and-business-central-trials" />Работает ли это с пробными версиями Microsoft 365 и пробными версиями Business Central?
...
### <a name="the-list-of-licenses-in-business-central-shows-a-microsoft--license-whats-that" />Список лицензий в Business Central показывает лицензию Microsoft 365. Что это?
...
### <a name="do-i-need-to-acquire-a-new-type-of-microsoft--license-for-this-feature-to-work" />Нужно ли приобретать новый тип лицензии Microsoft 365, чтобы эта функция работала?
...
### <a name="how-do-i-find-out-which-users-have-only-a-microsoft--license" />Как узнать, у каких пользователей есть только лицензия Microsoft 365?
...
### <a name="how-do-i-filter-the-users-list-in-business-central-to-see-users-that-only-have-a-microsoft--license" />Как отфильтровать список «Пользователи» в Business Central, чтобы просмотреть пользователей, имеющих только лицензию Microsoft 365?
...
### <a name="what-about-users-that-have-both-a-microsoft--license-and-a-business-central-license" />Что насчет пользователей, у которых есть лицензия Microsoft 365 и лицензия Business Central?
...
### <a name="can-microsoft--users-remove-tabs" />Могут ли пользователи Microsoft 365 удалять вкладки?
