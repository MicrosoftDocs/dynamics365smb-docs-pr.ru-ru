...
---
# <a name="access-with-microsoft-365-licenses-faq" />Доступ с лицензиями на Microsoft 365 — вопросы и ответы
...
### <a name="can-i-proactively-configure-different-starting-permissions-for-different-groups-of-users" />Можно ли заблаговременно настроить разные разрешения на запуск для разных групп пользователей?
...
### <a name="can-i-proactively-configure-permissions-profiles-and-settings-for-individual-users-before-they-sign-in" />Можно ли заблаговременно настроить разрешения, профили и параметры для отдельных пользователей, прежде чем они войдут в систему?
...
### <a name="after-a-user-signs-in-can-i-change-which-objects-they-have-access-to" />Можно ли после входа пользователя изменить объекты, к которым у него будет доступ?
...
### <a name="how-do-i-prevent-access-to-sensitive-tables" />Как запретить доступ к конфиденциальным таблицам?
...
### <a name="instead-of-customizing-the-license-configuration-can-i-customize-a-user-group" />Можно ли настроить группу пользователей вместо настройки конфигурации лицензии?
...
### <a name="when-a-business-central-user-shares-a-record-in-teams-do-they-grant-new-permissions" />Когда пользователь Business Central делится записью в Teams, предоставляет ли он новые разрешения?
...
### <a name="does-this-feature-support-row-level-security" />Поддерживает ли эта функция безопасность на уровне строк?
...
### <a name="if-i-configure-permissions-that-include-write-access-will-users-be-able-to-write-in-teams" />Если настроить разрешения, включающие в себя доступ на запись, смогут ли пользователи выполнять запись в Teams?
...
### <a name="why-is-the-setting-to-enable-access-not-available-for-my-environment" />Почему параметр включения доступа недоступен для моей среды?
...
### <a name="can-i-access-business-central-on-premises-with-microsoft-365-licenses" />Можно ли получить доступ к локальной версии Business Central с помощью лицензий Microsoft 365?
...
### <a name="what-is-the-employee-profile" />Что такое профиль «Сотрудник»?
...
### <a name="what-is-the-teams-users-user-group" />Что такое группа «Пользователи Teams»?
...
### <a name="do-users-that-only-have-a-microsoft-365-license-show-up-in-the-users-list-in-business-central" />Отображаются ли пользователи, имеющие только лицензию Microsoft 365, в списке пользователей в Business Central?
...
### <a name="does-this-feature-work-for-embed-isv-solutions" />Работает ли эта функция для встроенных решений независимых поставщиков программного обеспечения?
...
### <a name="can-a-customer-use-this-feature-if-they-dont-have-business-central" />Может ли клиент использовать эту функцию, если у него нет Business Central?
...
### <a name="how-does-this-help-me-manage-subscription-costs-in-my-organization" />Как это помогает управлять стоимостью подписки в организации?
...
### <a name="is-this-100-free-of-charge" />Это полностью бесплатно?
...
### <a name="does-this-work-with-microsoft-365-trials-and-business-central-trials" />Работает ли это с пробными версиями Microsoft 365 и пробными версиями Business Central?
...
### <a name="the-list-of-licenses-in-business-central-shows-a-microsoft-365-license-whats-that" />Список лицензий в Business Central показывает лицензию Microsoft 365. Что это?
...
### <a name="do-i-need-to-acquire-a-new-type-of-microsoft-365-license-for-this-feature-to-work" />Нужно ли приобретать новый тип лицензии Microsoft 365, чтобы эта функция работала?
...
### <a name="how-do-i-find-out-which-users-have-only-a-microsoft-365-license" />Как узнать, у каких пользователей есть только лицензия Microsoft 365?
...
### <a name="how-do-i-filter-the-users-list-in-business-central-to-see-users-that-only-have-a-microsoft-365-license" />Как отфильтровать список «Пользователи» в Business Central, чтобы просмотреть пользователей, имеющих только лицензию Microsoft 365?
...
### <a name="what-about-users-that-have-both-a-microsoft-365-license-and-a-business-central-license" />Что насчет пользователей, у которых есть лицензия Microsoft 365 и лицензия Business Central?
...
### <a name="is-this-licensing-related-to-the-business-central-team-member-license" />Связано ли это лицензирование с лицензией Business Central Team Member?
...
### <a name="does-business-central-enforce-any-of-the-constraints" />Применяются ли в рамках платформы Business Central какие-либо ограничения?
...
### <a name="can-i-access-records-on-teams-for-ios-and-teams-for-android" />Можно ли получить доступ к записям в Teams для iOS и Teams для Android?
...
### <a name="how-do-users-change-their-personal-settings-in-my-settings" />Как пользователи могут изменить свои личные настройки в разделе «Мои настройки»?
...
### <a name="what-determines-the-choice-of-language-when-you-sign-in-for-the-first-time" />От чего зависит выбор языка при первом входе в систему?
...
### <a name="why-cant-i-activate-some-of-the-colored-links-in-tabs-and-card-details" />Почему не получается активировать некоторые цветные ссылки на вкладках и в сведениях карточки?
...
### <a name="why-cant-i-activate-page-notification-actions" />Почему не получается активировать действия уведомления страницы?
...
### <a name="can-microsoft-365-users-remove-tabs" />Могут ли пользователи Microsoft 365 удалять вкладки?
...
### <a name="if-i-cant-filter-will-i-still-see-a-filtered-list-that-was-created-by-others" />Если невозможно выполнять фильтрацию, будет ли отображаться отфильтрованный список, созданный другими?
