---
title: Доступ с лицензиями на Microsoft 365 — вопросы и ответы
...
## <a name="permissions"></a>[Разрешения](#tab/permissions) 
...
### <a name="after-a-user-signs-in-can-i-change-which-objects-they-have-access-to"></a>Можно ли после входа пользователя изменить объекты, к которым у него будет доступ?
...
## <a name="setup-and-configuration"></a>[Настройка и конфигурация](#tab/setup)
...
## <a name="licensing"></a>[Лицензирование](#tab/license)
...
## <a name="usage"></a>[Использование](#tab/usage)
