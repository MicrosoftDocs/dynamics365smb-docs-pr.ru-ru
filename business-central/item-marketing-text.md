...
# <a name="add-marketing-text-to-items" />Добавление маркетингового текста для товаров
...
### <a name="create-first-draft-with-copilot" />Создание первого черновика с Copilot
...
### <a name="review-edit-and-save-text" />Просмотр, редактирование и сохранение текста
...
### <a name="improve-and-tailor-text-suggestions" />Улучшение адаптация предложений текста
...
## <a name="create-marketing-text-from-scratch" />Создание маркетингового текста с нуля
