...
description: Чтобы понять, как работает система планирования, нужно понять приоритетные цели системы планирования, достигаемые путем балансировки предложения и спроса.
author: SorenGP
