...
---
# Сведения о проектировании: балансировка поставки и спроса
...
## Краткие сведения о балансировке
...
## Обработка заказов до даты начала планирования
...
### Серийные номера или номера партий и связи "заказ-в-заказ" исключены из предыдущего периода  
...
### Серийные номера и номера партий загружаются по уровням спецификации  
...
### Связи "заказ-в-заказ" никогда не нарушаются
...
### Требуемый компонент отправляется в соответствии с изменениями в производственном заказе
...
### Прогнозируемый спрос снижается заказами на продажу
...
### Спрос общего заказа снижается заказами на продажу
...
## Определение приоритета заказов
...
### Приоритеты на стороне поставки  
...
### Приоритет, связанный с состоянием поставки и спроса  
...
## Балансировка поставки и спроса
...
### Правила для действий для событий поставки
...
### Определить количество поставки  
...
### Связи трассировки заказов во время планирования  
...
## Закрыть сбалансированные поставки и спрос
...
### Создать строку планирования (предлагаемое действие)  
