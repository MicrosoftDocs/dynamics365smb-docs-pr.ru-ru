...
---
# <a name="design-details-balancing-supply-and-demand"></a>Сведения о проектировании: балансировка поставки и спроса
...
## <a name="process-orders-before-the-planning-start-date"></a>Обработка заказов до даты начала планирования
...
### <a name="serial-and-lot-numbers-and-order-to-order-links-are-exempt-from-the-previous-period"></a>Серийные номера или номера партий и связи "заказ-в-заказ" исключены из предыдущего периода
...
## <a name="load-inventory-profiles"></a>Загрузка профилей запасов
...
### <a name="serial-and-lot-numbers-are-loaded-by-specification-level"></a>Серийные номера и номера партий загружаются по уровням спецификации
...
### <a name="consume-safety-stock"></a>Потребление страхового запаса
...
## <a name="prioritize-orders"></a>Определение приоритета заказов
...
### <a name="priority-related-to-the-state-of-supply-and-demand"></a>Приоритет, связанный с состоянием поставки и спроса
...
### <a name="rules-for-actions-for-supply-events"></a>Правила для действий для событий поставки
...
### <a name="determine-the-supply-quantity"></a>Определить количество поставки
...
## <a name="close-balanced-supply-and-demand"></a>Закрыть сбалансированные поставки и спрос
...
### <a name="create-the-planning-line-suggested-action"></a>Создать строку планирования (предлагаемое действие)
