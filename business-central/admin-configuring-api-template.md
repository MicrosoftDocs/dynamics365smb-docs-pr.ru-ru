...
# <a name="configure-api-templates" />Настройка шаблонов API
...
## <a name="setting-up-the-entity-template" />Создание шаблона объекта
...
## <a name="assign-the-template-to-an-api" />Назначение шаблона API-интерфейсу
