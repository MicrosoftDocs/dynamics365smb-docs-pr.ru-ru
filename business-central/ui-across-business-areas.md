...
---
# <a name="general-business-functionality"></a><a name="general-business-functionality"></a><a name="general-business-functionality"></a>Общие бизнес-функции
...
Для поддержки этих задач, специфичных для вашей области бизнеса, можно воспользоваться различными общими бизнес-функциональностями, такими как определение расширенного текста для строк документов и организация задач связывания бизнеса в рабочих процессах.
...
В следующей таблице перечислены эти общие деловые области и приведены ссылки на статьи, в которых они описываются.
