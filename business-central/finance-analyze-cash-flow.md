...
# <a name="analyze-cash-flow-in-your-company"></a>Анализируйте денежный поток в вашей компании
...
| Когда может возникнуть избыток или дефицит денежных средств?</br> Следует ли выплатить долг или занять для удовлетворения предстоящих расходов? |Прогнозы движения денежных средств |
...
[Работать с [!INCLUDE[prod_short](includes/prod_short.md)]](ui-work-product.md)   
[Настройка анализа денежных потоков](finance-setup-cash-flow-analyses.md)    
[Прогнозируйте свой денежный поток в Dynamics 365 Business Central](/training/modules/forecast-cash-flow-dynamics-365-business-central/index)    
