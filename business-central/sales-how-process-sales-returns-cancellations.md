...
|Функция **Копировать из документа** на страницах **Кредит-нота продажи** и **Возврат продажи**|Копирует как заголовок, так и строки одного учтенного документа, который необходимо сторнировать.<br /><br /> Требуется установить флажок **Точный возврат себест. обязат.** на странице **Продажи и дебитор. задолж. - настройка**.|
