...
ms.author: edupont
---
# <a name="process-sales-returns-or-cancellations"></a><a name="process-sales-returns-or-cancellations"></a>Обработка возвратов продажи или отмен
...
## <a name="to-create-a-sales-credit-memo-from-a-posted-sales-invoice"></a><a name="to-create-a-sales-credit-memo-from-a-posted-sales-invoice"></a>Создание кредит-ноты продажи из учтенного счета продажи
...
## <a name="to-create-a-sales-credit-memo-by-copying-a-posted-sales-invoice"></a><a name="to-create-a-sales-credit-memo-by-copying-a-posted-sales-invoice"></a>Создание кредит-ноты продажи путем копирования учтенного счета продажи
...
## <a name="to-create-a-sales-allowance"></a><a name="to-create-a-sales-allowance"></a>Создание поправки продажи
...
## <a name="to-combine-return-receipts"></a><a name="to-combine-return-receipts"></a>Объединение возвратных приходных накладных
...
### <a name="to-manually-combine-return-receipts"></a><a name="to-manually-combine-return-receipts"></a>Объединение приходных накладных возврата вручную
...
### <a name="to-automatically-combine-return-receipts"></a><a name="to-automatically-combine-return-receipts"></a>Чтобы автоматически объединить возвратные накладные
...
### <a name="to-remove-a-received-and-invoiced-return-order"></a><a name="to-remove-a-received-and-invoiced-return-order"></a>Удаление полученных и включенных в счета возвратов
