...
| Выставляйте счет клиенту либо по завершении проекта, либо в соответствии с графиком выставления счетов. |[Выставление счетов по проекту](projects-how-invoice-jobs.md) |
