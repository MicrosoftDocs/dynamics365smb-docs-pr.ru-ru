...
---
# <a name="manage-project-budgets"></a>Управление бюджетами работ
...
## <a name="to-estimate-the-budgeted-costs-for-a-project"></a><a name="JobBudgetCosts"></a>Оценка бюджетных затрат для работы
