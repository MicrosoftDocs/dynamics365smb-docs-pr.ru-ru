...
В [!INCLUDE[d365fin](includes/d365fin_md.md)] одним из самых быстрых способов зарегистрировать платежи на странице **Журнал выверки платежей** — импорт файла банковской выписки. Платежи применяются к открытым операциям книги поставщиков или клиентов на основании совпадающих данных текста платежа и информации операции. Можно просмотреть и изменить совпадения перед выполнением учета журнала и закрыть операции книги банковских счетов для операций книги при учете журнала. Банковский счет выверяется после применения всех платежей.

Существуют и другие страницы, где можно либо применить платежи, либо провести выверку банковских счетов:

* На странице **Выверки банковского счета**, где выверка банковских счетов проводится путем сопоставления строк импортированной банковской выписки с операциями книги банковских счетов в вашей системе. Здесь также можно провести выверку платежей, совершенных с помощью платежных документов. Дополнительные сведения см. в разделе [Выверка банковских счетов по-отдельности](bank-how-reconcile-bank-accounts-separately.md). Применять платежи здесь нельзя.
...
|На странице **Применение платежа** можно просмотреть все открытые операции кандидатов для платежа и подробные сведения о сопоставлении данных, на котором основано применение платежа, для каждой операции.|[Проверка или применение платежей вручную после автоматического применения](receivables-how-review-apply-payments-auto-application.md)|
