...
ms.author: jswymer
---
# <a name="report-and-document-layouts-overview" />Обзор макетов отчетов и документов
...
## <a name="layout-types" />Типы макета
...
## <a name="layout-sources" />Источники макета
