...
ms.author: bholtorf
---
# Работа с сервисными контрактами и предложениями по сервисным контрактам
...
## Создание сервисного контракта или предложения по сервисному контракту  
...
## Преобразование предложения по сервисным контрактам в сервисный контракт  
...
## Чтобы создать кредит-ноты сервисных контрактов
...
## Обновление и оценка контрактов
...
## Добавление строки контракта в сервисный контракт или предложение по контракту  
...
## Затраты и значение строки сервиса
...
## Добавление скидки по контракту для предложений по сервисным контрактам  
...
## Изменение владельца сервисного контракта  
...
## Обновление цены по сервисному контракту  
...
## Учет операций предоплаты по контракту  
...
## Изменение статуса сервисного контракта
...
## Заполнение сервисного контракта или предложения по контракту  
