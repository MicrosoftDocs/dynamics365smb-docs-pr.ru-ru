...
ms.author: edupont
---
# <a name="register-new-customers"></a><a name="register-new-customers"></a>Регистрация новых клиентов
...
## <a name="adding-new-customers"></a><a name="adding-new-customers"></a>Добавление новых клиентов
...
### <a name="to-create-a-new-customer-card"></a><a name="to-create-a-new-customer-card"></a>Создание новой карточки клиента
...
### <a name="to-save-the-customer-card-as-a-template"></a><a name="to-save-the-customer-card-as-a-template"></a>Сохранение карточки клиента в качестве шаблона
...
## <a name="deleting-customer-cards"></a><a name="deleting-customer-cards"></a>Удаление карточек клиентов
...
## <a name="managing-credit-limits"></a><a name="managing-credit-limits"></a>Управление кредитными лимитами
...
### <a name="to-specify-credit-limit-warnings"></a><a name="to-specify-credit-limit-warnings"></a>Указание предупреждений о кредитном лимите
