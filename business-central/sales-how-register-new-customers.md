...
ms.author: edupont
---
# <a name="register-new-customers" />Регистрация новых клиентов
...
## <a name="adding-new-customers" />Добавление новых клиентов
...
### <a name="to-create-a-new-customer-card" />Создание новой карточки клиента
...
### <a name="to-save-the-customer-card-as-a-template" />Сохранение карточки клиента в качестве шаблона
...
## <a name="deleting-customer-cards" />Удаление карточек клиентов
...
## <a name="managing-credit-limits" />Управление кредитными лимитами
...
### <a name="to-specify-credit-limit-warnings" />Указание предупреждений о кредитном лимите
