...
В обоих случаях НДС рассчитывается на основании настройки учета НДС и учетных групп НДС, настроенных ранее. [!INCLUDE[prod_short](includes/prod_short.md)] показывает операции НДС на основе их **даты НДС**.
...
## <a name="to-set-up-vat-reports-in-prod_short"></a>Настройка отчетов по НДС в [!INCLUDE[prod_short](includes/prod_short.md)]
