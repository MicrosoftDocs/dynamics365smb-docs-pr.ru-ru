...
---
# <a name="design-details-planning-parameters" />Технические подробности: параметры планирования
...
## <a name="define-whether-the-item-is-planned" />Определяет, планируется ли товар
...
## <a name="define-when-to-reorder" />Определение времени дозаказа
...
## <a name="define-how-much-to-reorder" />Определение количества для дозаказа
...
## <a name="optimize-when-and-how-much-to-reorder" />Оптимизация времени и количества дозаказа
...
## <a name="modify-the-supply-orders" />Изменение заказов на поставку
...
## <a name="delimit-the-item" />Разделение товаров
...
## <a name="use-low-level-codes-to-manage-derived-demand" />Использование кодов нижнего уровня для управления производным спросом
