...
---
# <a name="design-details-planning-parameters"></a>Технические подробности: параметры планирования
...
## <a name="define-whether-the-item-is-planned"></a>Определяет, планируется ли товар
...
## <a name="delimit-the-item"></a>Разделение товаров
...
## <a name="use-low-level-codes-to-manage-derived-demand"></a>Использование кодов нижнего уровня для управления производным спросом
