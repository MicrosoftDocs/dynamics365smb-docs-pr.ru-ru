...
---
# <a name="design-details-planning-parameters"></a><a name="design-details-planning-parameters"></a><a name="design-details-planning-parameters"></a>Технические подробности: параметры планирования
...
## <a name="define-whether-the-item-is-planned"></a><a name="define-whether-the-item-is-planned"></a><a name="define-whether-the-item-is-planned"></a>Определяет, планируется ли товар
...
## <a name="define-when-to-reorder"></a><a name="define-when-to-reorder"></a><a name="define-when-to-reorder"></a>Определение времени дозаказа
...
## <a name="define-how-much-to-reorder"></a><a name="define-how-much-to-reorder"></a><a name="define-how-much-to-reorder"></a>Определение количества для дозаказа
...
## <a name="optimize-when-and-how-much-to-reorder"></a><a name="optimize-when-and-how-much-to-reorder"></a><a name="optimize-when-and-how-much-to-reorder"></a>Оптимизация времени и количества дозаказа
...
## <a name="modify-the-supply-orders"></a><a name="modify-the-supply-orders"></a><a name="modify-the-supply-orders"></a>Изменение заказов на поставку
...
## <a name="delimit-the-item"></a><a name="delimit-the-item"></a><a name="delimit-the-item"></a>Разделение товаров
...
## <a name="use-low-level-codes-to-manage-derived-demand"></a><a name="use-low-level-codes-to-manage-derived-demand"></a><a name="use-low-level-codes-to-manage-derived-demand"></a>Использование кодов нижнего уровня для управления производным спросом
