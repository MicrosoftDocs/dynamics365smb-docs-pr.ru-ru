...
ms.author: bholtorf
---
# <a name="lend-and-receive-loaners" />Предоставление и прием товаров для временного пользования
Можно предоставлять клиентам аренду, чтобы временно заменить сервисные товары, полученные вами для обслуживания.  
  
## <a name="to-lend-a-loaner-item" />Предоставление товара во временное пользование
...
## <a name="to-receive-a-loaner" />Получение товара для временного пользования
...
## <a name="to-register-loaner-comments" />Регистрация комментариев к аренде
