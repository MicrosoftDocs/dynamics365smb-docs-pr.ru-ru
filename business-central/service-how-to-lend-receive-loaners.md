...
ms.author: bholtorf
---
# <a name="lend-and-receive-loaners"></a><a name="lend-and-receive-loaners"></a>Предоставление и прием товаров для временного пользования
Можно предоставлять клиентам аренду, чтобы временно заменить сервисные товары, полученные вами для обслуживания.  
  
## <a name="to-lend-a-loaner-item"></a><a name="to-lend-a-loaner-item"></a>Предоставление товара во временное пользование
...
## <a name="to-receive-a-loaner"></a><a name="to-receive-a-loaner"></a>Получение товара для временного пользования
...
## <a name="to-register-loaner-comments"></a><a name="to-register-loaner-comments"></a>Регистрация комментариев к аренде
