...
ms.author: edupont
---
# <a name="about-item-types" />О типах товаров
...
## <a name="costing-methods-for-types-of-items" />Методы расчета себестоимости для типов товара
...
## <a name="catalog-and-service-items" />Товары из каталога и сервисные товары
