...
ms.author: bholtorf
---
# <a name="reverse-journal-postings-and-undo-receiptsshipments" />Сторнирование учета в журнале и отмена приходных/расходных накладных
...
## <a name="to-reverse-the-journal-posting-of-a-general-ledger-entry" />Сторнирование учета в журнале для операции главной книги
...
## <a name="to-post-a-negative-entry" />Учет расхода
...
## <a name="to-undo-a-quantity-on-a-posted-purchase-receipt" />Отмена количества в учтенной приходной накладной покупки
...
## <a name="to-undo-and-then-redo-a-quantity-posting-on-a-posted-return-shipment" />Отмена учета и последующий повторный учет количества в учтенной расходной накладной по возврату
