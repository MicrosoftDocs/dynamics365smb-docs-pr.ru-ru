...
---
# Сторнирование учета в журнале и отмена приходных/расходных накладных
...
>
> Кроме того, невозможно сторнировать операции, которые были учтены с информацией из проекта, или по которым есть реализованные прибыль и убытки в рамках одной транзакции.
