...
ms.author: edupont
---
# <a name="transfer-split-or-combine-fixed-assets" />Перемещение, разделение или объединение основных средств
...
## <a name="to-transfer-a-fixed-asset-to-a-different-department" />Перемещение основного средства в другое подразделение
...
## <a name="to-split-a-fixed-asset-into-three-fixed-assets" />Разделение основного средства на три основные средства
...
## <a name="to-combine-two-fixed-assets-into-one" />Объединение двух основных средств в одно
...
## <a name="to-view-changed-depreciation-book-values-due-to-fixed-asset-reclassification" />Просмотр балансовых значений амортизации, измененных из-за реклассификации основных средств
