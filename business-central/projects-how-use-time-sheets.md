...
description: 'Узнайте, как создавать, отправлять, утверждать и учитывать табели учета рабочего времени для ресурсов, работ и услуг.'
author: brentholtorf
ms.author: bholtorf
...
После утверждения операций табеля для задания их можно учесть в соответствующем журнале работ или журнале ресурсов. Подробнее см. в разделах [Учет строк табеля в журнале работ](#post-time-sheet-lines-in-a-job-journal) и [Учет строк табеля в журнале ресурсов](#post-time-sheet-lines-in-a-resource-journal).
...
Вы можете использовать страницу **Создание табелей учета рабочего времени**, чтобы настроить табели для определенных временных периодов или недель. Затем владелец табеля может открыть его и записать время, которое было затрачено на задачу. Вы также можете [запланировать автоматический запуск пакетного задания](ui-work-report.md#ScheduleReport).  
...
> [!NOTE]
> Чтобы утверждать табели учета времени на странице **Табели учета рабочего времени для менеджера по работам**, необходимо сначала установить флажок **Табель учета рабочего времени по утверждению работы** на странице **Настройка модуля «Ресурсы»**. О том, как настраивать утверждения для ресурсов, см. в статье [Настройка ресурсов](projects-how-setup-resources.md).

### Утверждение или отклонение табеля по работе

1. В поле **Поиск** введите **Управление табелями учета рабочего времени по заданию**, а затем выберите связанную ссылку. [!INCLUDE[prod_short](includes/prod_short.md)] отображает список строк табелей учета рабочего времени, связанных с работами, за которые вы отвечаете.
...
## Архивация табелей учета рабочего времени
