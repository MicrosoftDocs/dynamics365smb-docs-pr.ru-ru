...
ms.author: edupont
---
# <a name="use-time-sheets" />Использование табелей учета рабочего времени
...
## <a name="to-create-time-sheets" />Создание табелей учета рабочего времени
...
## <a name="to-reuse-time-sheet-lines-in-other-time-sheets" />Повторное использование строк табелей в других табелях
...
## <a name="to-copy-job-planning-lines-to-a-time-sheet" />Копирование строк планирования работ в табель учета времени
...
## <a name="to-define-work-types-and-add-one-to-a-time-sheet" />Определение видов работ и добавление вида работ в табель
...
## <a name="to-fill-in-time-sheet-lines-and-submit-for-approval" />Заполнение строк табелей и отправка на утверждение
...
## <a name="to-approve-or-reject-a-time-sheet" />Утверждение или отклонение табеля
...
## <a name="to-reopen-a-time-sheet" />Повторное открытие табеля
...
## <a name="to-view-and-approve-time-sheets-by-job" />Просмотр и утверждение табелей учета рабочего времени по работе
...
### <a name="to-approve-or-reject-a-time-sheet-by-job" />Утверждение или отклонение табеля учета рабочего времени по заданию
...
## <a name="to-post-time-sheet-lines-in-a-resource-journal" />Учет строк табеля в журнале ресурсов
...
## <a name="to-post-time-sheet-lines-in-a-job-journal" />Учет строк табеля в журнале работ
...
## <a name="to-archive-time-sheets" />Архивирование табелей
