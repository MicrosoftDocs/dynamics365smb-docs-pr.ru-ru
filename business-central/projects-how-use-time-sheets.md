...
## <a name="copy-project-planning-lines-to-a-time-sheet"></a>Копирование строк планирования работ в табель
...
## <a name="view-and-approve-time-sheets-by-project"></a>Просмотр и утверждение табелей по работе
...
### <a name="approve-or-reject-a-time-sheet-by-project"></a>Утверждение или отклонение табеля по работе
...
## <a name="post-time-sheet-lines-in-a-project-journal"></a>Учет строк табеля в журнале работ
