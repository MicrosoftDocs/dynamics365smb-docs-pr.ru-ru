...
ms.author: edupont
---
# Использование табелей учета рабочего времени
...
## Создание табелей учета рабочего времени
...
## Повторное использование строк табелей в других табелях
...
## Копирование строк планирования работ в табель учета времени
...
## Определение видов работ и добавление вида работ в табель
...
## Заполнение строк табелей и отправка на утверждение
...
## Утверждение или отклонение табеля
...
## Просмотр и утверждение табелей учета рабочего времени по работе
...
### Утверждение или отклонение табеля учета рабочего времени по заданию
...
## Учет строк табеля в журнале ресурсов
...
## Учет строк табеля в журнале работ
