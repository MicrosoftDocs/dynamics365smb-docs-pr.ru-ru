...
description: 'Business Central содержит ряд функций, которые помогут вам собирать, анализировать и передавать коллегам ценные о продажах для бизнес-анализа и принятия решений в сфере продаж.'
author: kennienp
ms.author: bholtorf
...
## <a name="analytics-needs-in-sales"></a>Потребности в аналитике в сфере продаж
...
|Менеджер по продажам      | Тенденции, сводки | Встроенные управленческие отчеты <br> Специальный анализ      | 
...
## <a name="use-financial-reporting-to-produce-financial-statements-and-kpis-related-to-sales"></a>Использование финансовой отчетности для создания финансовых отчетов и КПЭ, связанных с продажами
...
## <a name="finance-reporting-across-business-units-or-legal-entities-related-to-sales"></a>Финансовая отчетность по филиалам или юридическим лицам, связанная с продажами
...
## <a name="built-in-reports-for-sales"></a>Встроенные отчеты по продажам
...
Чтобы получить представление о доступных отчетах, выберите **Все отчеты** в верхней панели вашей домашней страницы. Откроется обозреватель ролей, в котором показаны только функции группы **Отчет и анализ**. Чтобы узнать больше, перейдите в раздел [Поиск отчетов с помощью обозревателя ролей](ui-role-explorer.md). 
...
## <a name="on-screen-sales-analytics"></a>Экранная аналитика по продажам
...
### <a name="show-sales-related-general-ledger-entries-and-balances-from-the-chart-of-accounts-page"></a>Отображение связанных с продажами операций и сальдо главной книги со страницы «План счетов»
...
### <a name="analyze-data-by-dimensions-related-to-sales"></a>Анализ данных по измерениям (связанным с продажами)
