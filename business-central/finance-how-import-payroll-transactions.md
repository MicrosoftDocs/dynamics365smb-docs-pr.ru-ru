...
ms.author: edupont
---
# <a name="importing-payroll-transactions"></a><a name="importing-payroll-transactions"></a>Импорт проводок по зарплате
...
## <a name="to-import-a-payroll-file"></a><a name="to-import-a-payroll-file"></a>Импорт файла зарплаты
