...
ms.author: edupont
---
# <a name="manage-employee-absence" />Управление простоем сотрудника
...
## <a name="to-register-employee-absence" />Регистрация простоя сотрудника
...
## <a name="to-view-an-individual-employees-absence" />Обзор фактов простоя отдельного сотрудника
...
## <a name="to-view-an-employees-absence-by-categories" />Просмотр фактов простоя отдельного сотрудника по категориям
1. В правом верхнем углу выберите значок **Поиск страницы или отчета**, введите **Сотрудники**, а затем выберите соответствующую ссылку.
...
## <a name="to-view-all-employee-absences-by-category" />Просмотр всех простоев сотрудников по категории
1. В правом верхнем углу выберите значок **Поиск страницы или отчета**, введите **Регистрация простоя**, а затем выберите соответствующую ссылку.
...
## <a name="to-view-all-employee-absences-by-period" />Просмотр всех простоев сотрудников по периоду
1. В правом верхнем углу выберите значок **Поиск страницы или отчета**, введите **Регистрация простоя**, а затем выберите соответствующую ссылку.
