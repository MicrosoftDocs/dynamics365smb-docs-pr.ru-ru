...
ms.author: bholtorf
---
# <a name="archive-documents"></a><a name="archive-documents"></a>Архивирование документов
...
## <a name="to-set-up-automatic-document-archiving"></a><a name="to-set-up-automatic-document-archiving"></a>Настройка автоматического архивирования документов
...
## <a name="to-manually-archive-a-sales-order"></a><a name="to-manually-archive-a-sales-order"></a>Архивирование заказа на продажу
...
## <a name="to-restore-a-non-posted-sales-order-from-the-archive"></a><a name="to-restore-a-non-posted-sales-order-from-the-archive"></a>Восстановление неучтенного заказа на продажу из архива
...
## <a name="to-delete-archived-sales-orders"></a><a name="to-delete-archived-sales-orders"></a>Удаление архивных заказов продажу
