...
## <a name="to-restore-a-non-posted-sales-document-or-a-project-from-the-archive"></a>Восстановление неучтенного заказа на продажу из архива
...
## <a name="to-delete-archived-versions"></a>Удаление архивных заказов продажу
