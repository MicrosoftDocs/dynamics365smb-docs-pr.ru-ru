...
ms.author: bholtorf
---
# <a name="archive-documents" />Архивирование документов
...
## <a name="to-set-up-automatic-document-archiving" />Настройка автоматического архивирования документов
...
## <a name="to-manually-archive-a-sales-order" />Архивирование заказа на продажу
...
## <a name="to-restore-a-non-posted-sales-order-from-the-archive" />Восстановление неучтенного заказа на продажу из архива
...
## <a name="to-delete-archived-sales-orders" />Удаление архивных заказов продажу
