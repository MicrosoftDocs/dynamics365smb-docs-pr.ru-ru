...
---
# <a name="selling-inventory-items-in-assemble-to-order-flows" />Продажа складских товаров в потоках сборки на заказ
...
## <a name="to-sell-inventory-items-in-assemble-to-order-flows" />Продажа складских товаров в потоках сборки на заказ
