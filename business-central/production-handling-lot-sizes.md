...
# <a name="handling-lot-sizes-in-production" />Обработка размеров партий в производстве
...
## <a name="units-of-measure-in-production-bill-of-materials" />Единицы измерения в производственной спецификации
...
## <a name="lot-size-on-routing-lines" />Размер партии в строках маршрутов
...
## <a name="lot-sizes-for-items-and-stockkeeping-units" />Размеры партий для номенклатур и единиц складского учета
...
## <a name="lot-size-on-item-and-stockkeeping-units" />Размер партии для номенклатур и единиц складского учета
