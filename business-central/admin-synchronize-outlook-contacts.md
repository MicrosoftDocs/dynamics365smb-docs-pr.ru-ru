...
ms.author: bholtorf
---
# <a name="synchronize-contacts-in-business-central-with-contacts-in-microsoft-outlook" />Синхронизация контактов в Business Central с контактами в Microsoft Outlook
...
## <a name="set-up-synchronization" />Настройка синхронизации
...
### <a name="automate-synchronization" />Автоматизация синхронизации
...
## <a name="synchronize-contacts" />Синхронизация контактов
