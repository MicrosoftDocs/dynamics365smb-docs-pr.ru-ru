...
description: В этом разделе рассказывается, как комплектовать и размещать без исходного документа, как создать внутренний подбор, и как создать внутреннее размещение.
author: SorenGP
...
1.  Выберите ![Лампочка, которая открывает функцию Что вы хотите сделать.](media/ui-search/search_small.png "Что вы хотите сделать") значок, введите **Внутренний подбор склада**, а затем выберите связанную ссылку.  
...
1.  Выберите ![Лампочка, которая открывает функцию Что вы хотите сделать.](media/ui-search/search_small.png "Что вы хотите сделать") значок, введите **Внутреннее складское размещение**, а затем выберите связанную ссылку.  
2. Выберите действие **Создать**.
