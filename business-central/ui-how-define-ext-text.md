...
ms.author: edupont
---
# <a name="add-extended-text" />Добавить расширенный текст
...
## <a name="to-define-extended-text-for-an-description" />Определение расширенного текста для описания
...
## <a name="to-add-an-extended-item-text-on-a-sales-order-line" />Добавление расширенного текста товара в строку заказа на продажу
