...
## <a name="set-up-vat-using-the-assisted-vat-setup-guide-recommended"></a>Настройка НДС с использованием руководства по сопровождаемой настройке "Настройка НДС" (рекомендуется) 
