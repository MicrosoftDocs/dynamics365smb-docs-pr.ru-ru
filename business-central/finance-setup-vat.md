...
Если вы хотите настроить расчеты НДС самостоятельно или желаете лишь ознакомиться с каждым шагом, в этой статье приводится описание каждого шага.  
...
Чтобы помочь вам быстро начать работу, [!INCLUDE [prod_short](includes/prod_short.md)] покажет вам уведомления, если отсутствуют счета главной книги (ГК) в учетных группах или настройках учета, таких как страница **Настройка учета НДС**. Вы можете включить или выключить этот тип уведомлений с помощью уведомления *Счета ГК отсутствуют в учетной группе или в настройке* на странице **Мои уведомления**. Перейдите на страницу **Мои настройки** и выберите *Изменение времени получения уведомлений.* .  
...
На этом этапе вы можете просто заполнить недостающие счета ГК. Затем, позже, при дальнейшем уточнении настройки, вы можете понять, что она была неправильной. [!INCLUDE [prod_short](includes/prod_short.md)] не позволяет удалить настройку учета НДС и общую настройку учета при наличии операций, созданных на основе таких конфигураций. Начиная с волны 1 выпуска 2022 года, вы можете использовать поле **Заблокировано** поле на странице **Настройка учета НДС**, чтобы пользователи не могли по ошибке использовать настройку, которая больше не актуальна для нового учета.
...
4. При необходимости выберите поле **Все коды языков** или укажите подходящий язык в поле **Код языка**, если вы используете коды языков.  
5. Заполните поля **Дата начала** и **Дата окончания** для ограничения времени использования расширенного текста.  
6. В строках **Текст** напишите расширенный текст для ваших статей НДС.  
7. Выберите подходящие поля для тех типов документов, в которых необходимо печатать расширенный текст.  
8. Закрытие страницы.  
