...
> [!NOTE]
> После проводки документа или журнала **Дата НДС** появится в разделах **Записи по НДС** и **Записи ГК**, а также на проведенном документе, если таковой имеется.
