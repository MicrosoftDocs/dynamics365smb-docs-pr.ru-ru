...
3. После завершения мастера настройки откройте страницу **Настройка учета НДС** и проверьте, нужно ли заполнять дополнительные поля в соответствии с версией вашей страны. Дополнительную информацию см. в разделе [Локальная функциональность в Business Central](about-localization.md).  
