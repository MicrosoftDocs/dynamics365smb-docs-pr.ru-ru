...
ms.author: bholtorf
---
# <a name="integrating-with-dynamics-365-sales" />Интеграция с Dynamics 365 Sales
...
## <a name="integrating-through-dataverse" />Интеграция через Dataverse
...
### <a name="connection-settings-in-the-setup-guide" />Настройки подключения в руководстве по установке
...
### <a name="connection-settings-on-the-microsoft-dynamics-365-connection-setup-page" />Параметры подключения на странице настройки подключения Microsoft Dynamics 365
...
<!--
### <a name="user-account-settings" />User Account Settings
...
### <a name="standard-sales-entity-mapping-for-synchronization" />Сопоставление стандартных объектов Sales для синхронизации
...
## <a name="synchronizing-items-and-resources-with-products-with-different-units-of-measure" />Синхронизация номенклатур и ресурсов с товарами с разными единицами измерения
...
### <a name="mapping-items-and-resources-to-products" />Сопоставление товаров и ресурсов с продуктами
...
### <a name="synchronization-rules" />Правила синхронизации
...
### <a name="synchronization-jobs-for-a-sales-integration" />Задания синхронизации для интеграции Sales
...
### <a name="default-synchronization-job-queue-entries" />Операции очереди заданий синхронизации по умолчанию
...
## <a name="connecting-to-on-premises-versions-of-business-central-2019-release-wave-1-and-microsoft-dynamics-nav-2018" />Подключение к локальным версиям выпуска Business Central 2019, волны 1 и Microsoft Dynamics NAV 2018
...
### <a name="to-connect-business-central-2019-release-wave-1-and-dynamics-nav-2018" />Для подключения выпуска Business Central 2019 волны 1 и Dynamics NAV 2018
