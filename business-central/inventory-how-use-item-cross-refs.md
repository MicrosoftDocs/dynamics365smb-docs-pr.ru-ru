...
description: Установите перекрестные ссылки между описаниями, которые вы и ваш поставщик используете для товара, чтобы вставить описание товара поставщика в документы покупки.
author: bholtorf
