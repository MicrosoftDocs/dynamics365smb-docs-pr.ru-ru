...
ms.author: edupont
---
# <a name="legacy-import-and-export-custom-report-layouts" />(Устарело) Импорт и экспорт пользовательских макетов отчетов
...
### <a name="to-export-a-report-layout-to-a-file" />Экспорт макета отчета в файл
...
### <a name="to-import-a-report-layout-file" />Импорт файла макета отчета
