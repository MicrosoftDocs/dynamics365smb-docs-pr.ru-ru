...
# <a name="assign-permissions-to-users-and-groups"></a><a name="assign-permissions-to-users-and-groups"></a>Назначение разрешений пользователям и группам
...
## <a name="to-create-a-permission-set"></a><a name="to-create-a-permission-set"></a>Создание набора разрешений
...
### <a name="example---indirect-permission"></a><a name="example---indirect-permission"></a>Пример — косвенное разрешение
...
### <a name="to-add-other-permission-sets"></a><a name="to-add-other-permission-sets"></a>Чтобы добавить другие наборы разрешений
...
## <a name="to-copy-a-permission-set"></a><a name="to-copy-a-permission-set"></a>Копирование набора разрешений
...
## <a name="to-create-or-modify-permissions-by-recording-your-actions"></a><a name="to-create-or-modify-permissions-by-recording-your-actions"></a>Создание или изменение разрешений путем записи действий
...
### <a name="to-export-and-import-a-permission-set"></a><a name="to-export-and-import-a-permission-set"></a>Экспорт и импорт набора разрешений
...
## <a name="to-remove-obsolete-permissions-from-all-permission-sets"></a><a name="to-remove-obsolete-permissions-from-all-permission-sets"></a>Удаление устаревших разрешений из всех наборов разрешений

На странице **Наборы разрешений** выберите действие **Удалить устаревшие разрешения**.

## <a name="to-set-up-time-constraints-for-users"></a><a name="to-set-up-time-constraints-for-users"></a>Настройка ограничений по времени для пользователей
...
## <a name="to-manage-permissions-through-user-groups"></a><a name="to-manage-permissions-through-user-groups"></a>Для управления разрешениями через группы пользователей
...
### <a name="to-add-users-to-a-user-group"></a><a name="to-add-users-to-a-user-group"></a>Процедура добавления пользователей в группу пользователей
...
### <a name="to-copy-a-user-group-and-all-its-permission-sets"></a><a name="to-copy-a-user-group-and-all-its-permission-sets"></a>Копирование группы пользователей и всех ее наборов разрешений
...
### <a name="to-assign-permission-sets-to-user-groups"></a><a name="to-assign-permission-sets-to-user-groups"></a>Назначение наборов разрешений группам пользователей
...
### <a name="to-assign-a-permission-set-on-the-permission-set-by-user-group-page"></a><a name="to-assign-a-permission-set-on-the-permission-set-by-user-group-page"></a>Назначение набора разрешений на странице **Набор разрешений по группе пользователей**
...
## <a name="to-assign-permission-sets-to-users"></a><a name="to-assign-permission-sets-to-users"></a>Назначение наборов разрешений пользователям
...
### <a name="to-assign-a-permission-set-on-a-user-card"></a><a name="to-assign-a-permission-set-on-a-user-card"></a>Назначение набора разрешений карте пользователя
...
### <a name="to-assign-a-permission-set-on-the-permission-set-by-user-page"></a><a name="to-assign-a-permission-set-on-the-permission-set-by-user-page"></a>Назначение набора разрешений на странице Набор разрешений по пользователю
...
## <a name="to-get-an-overview-of-a-users-permissions"></a><a name="to-get-an-overview-of-a-users-permissions"></a>Получение просмотра разрешений пользователя
...
### <a name="security-filters-limit-a-users-access-to-specific-records-in-a-table"></a><a name="security-filters-limit-a-users-access-to-specific-records-in-a-table"></a>Фильтры безопасности ограничивают доступ пользователя к определенным записям в таблице
...
## <a name="viewing-permission-changes-telemetry"></a><a name="viewing-permission-changes-telemetry"></a>Просмотр телеметрии изменений разрешений
...
## <a name="delegated-admin-users"></a><a name="delegated-admin-users"></a>Пользователи в качестве делегированного администратора
