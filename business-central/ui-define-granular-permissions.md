...
description: В этом разделе описывается, как определить гранулированные разрешения, предоставив определенным пользователям доступ к объектам и назначив им наборы разрешений.
author: SorenGP
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
...
|Задача  |Ссылка  |
|---------|---------|
|Чтобы упростить управление разрешениями для нескольких пользователей, вы можете организовать их в группы пользователей и тем самым назначить или изменить один набор разрешений для многих пользователей за одно действие.| [Для управления разрешениями через группы пользователей](#to-manage-permissions-through-user-groups) |
