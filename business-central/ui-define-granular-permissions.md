...
# <a name="assign-permissions-to-users-and-groups" />Назначение разрешений пользователям и группам
...
## <a name="to-create-a-permission-set" />Создание набора разрешений
...
### <a name="example---indirect-permission" />Пример — косвенное разрешение
...
### <a name="to-add-other-permission-sets" />Чтобы добавить другие наборы разрешений
...
## <a name="to-copy-a-permission-set" />Копирование набора разрешений
...
## <a name="to-create-or-modify-permissions-by-recording-your-actions" />Создание или изменение разрешений путем записи действий
...
### <a name="to-export-and-import-a-permission-set" />Экспорт и импорт набора разрешений
...
## <a name="to-remove-obsolete-permissions-from-all-permission-sets" />Удаление устаревших разрешений из всех наборов разрешений

На странице **Наборы разрешений** выберите действие **Удалить устаревшие разрешения**.

## <a name="to-set-up-time-constraints-for-users" />Настройка ограничений по времени для пользователей
...
## <a name="to-manage-permissions-through-user-groups" />Для управления разрешениями через группы пользователей
...
### <a name="to-add-users-to-a-user-group" />Процедура добавления пользователей в группу пользователей
...
### <a name="to-copy-a-user-group-and-all-its-permission-sets" />Копирование группы пользователей и всех ее наборов разрешений
...
### <a name="to-assign-permission-sets-to-user-groups" />Назначение наборов разрешений группам пользователей
...
### <a name="to-assign-a-permission-set-on-the-permission-set-by-user-group-page" />Назначение набора разрешений на странице **Набор разрешений по группе пользователей**
...
## <a name="to-assign-permission-sets-to-users" />Назначение наборов разрешений пользователям
...
### <a name="to-assign-a-permission-set-on-a-user-card" />Назначение набора разрешений карте пользователя
...
### <a name="to-assign-a-permission-set-on-the-permission-set-by-user-page" />Назначение набора разрешений на странице Набор разрешений по пользователю
...
## <a name="to-get-an-overview-of-a-users-permissions" />Получение просмотра разрешений пользователя
...
### <a name="security-filters-limit-a-users-access-to-specific-records-in-a-table" />Фильтры безопасности ограничивают доступ пользователя к определенным записям в таблице
...
## <a name="viewing-permission-changes-telemetry" />Просмотр телеметрии изменений разрешений
...
## <a name="delegated-admin-users" />Пользователи в качестве делегированного администратора
