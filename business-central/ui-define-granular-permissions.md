---
title: Определение детализированных разрешений
...
ms.search.form: '1, 119, 8930, 9800, 9807, 9808, 9830, 9831, 9802, 9855_Primary, 9862_Primary, 9878_Primary, 9865_Primary'
ms.date: 05/07/2024
...
|Задача  |Ссылка  |
|---------|---------|
|Чтобы упростить управление разрешениями для нескольких пользователей, вы можете объединить их в группы безопасности, а затем назначить или изменить один набор разрешений для множества пользователей в одно действие.| [Управление разрешениями через группы пользователей](#manage-permissions-through-user-groups) |
|Управление наборами разрешений для определенных пользователей | [Назначение наборов разрешений пользователям](#assign-permission-sets-to-users) |
|Чтобы узнать, как определить набор разрешений|[Создание набора разрешений](#create-a-permission-set)|
|Просмотр или устранение проблем с разрешениями пользователя|[Получение обзора разрешений пользователя](#get-an-overview-of-a-users-permissions)|
...
### <a name="to-add-other-permission-sets"></a>Чтобы добавить другие наборы разрешений
...
## <a name="copy-a-permission-set"></a>Копирование набора разрешений
...
## <a name="create-or-modify-permissions-by-recording-your-actions"></a>Создание или изменение разрешений путем записи действий
...
## <a name="remove-obsolete-permissions-from-all-permission-sets"></a>Удаление устаревших разрешений из всех наборов разрешений

На странице **Наборы разрешений** выберите действие **Удалить устаревшие разрешения**.

## <a name="set-up-time-constraints-for-users"></a>Настройка ограничений по времени для пользователей
...
## <a name="control-access-to-specific-companies"></a>Управление доступом к конкретным организациям
...
Подробнее см. в разделах [Назначение наборов разрешений пользователям](#assign-permission-sets-to-users) и [Назначение разрешений группе безопасности](ui-security-groups.md#assign-permissions-to-a-security-group).

## <a name="manage-permissions-through-user-groups"></a>Управление разрешениями через группы пользователей
...
## <a name="assign-permission-sets-to-users"></a>Назначение наборов разрешений пользователям
...
1. Выберите пользователя, которому нужно назначить разрешение.

   Любые наборы разрешений, которые уже назначены пользователю, отображаются на информационной панели **Наборы разрешений**.
1. Выберите действие **Правка**, чтобы открыть страницу **Карточка пользователя**.
1. На экспресс-вкладке **Наборы разрешений пользователя** в новой строке заполните требуемые поля. Дополнительные сведения см. в разделе [Создание и изменение набора разрешений](ui-define-granular-permissions.md#create-a-permission-set).

   Если вы хотите, чтобы набор разрешений применялся к конкретной организации, укажите эту организацию в поле **Организация**. Если вы хотите, чтобы набор разрешений распространялся на все организации, оставьте поле **Организация** пустым. [Узнать больше](#control-access-to-specific-companies).
...
1. Выберите ![Лампочка, которая открывает функцию Что вы хотите сделать.](media/ui-search/search_small.png "Что вы хотите сделать") значок, введите **Пользователи**, а затем выберите связанную ссылку.
1. На странице **Пользователи** выберите действие **Набор разрешений по пользователю**.
1. Если вы хотите, чтобы наборы разрешений применялись только к конкретной организации, укажите эту организацию в поле **Организация**. Если вы хотите, чтобы набор разрешений распространялся на все организации, оставьте поле **Название организации** пустым. [Узнать больше](#control-access-to-specific-companies).
1. На странице **Набор разрешений по пользователю** установите флажок **[имя пользователя]** в строке для соответствующего набора разрешений для назначения набора пользователю.

    Установите флажок **Все пользователи**, чтобы назначить набор разрешений для всех пользователей.

## <a name="get-an-overview-of-a-users-permissions"></a>Получение обзора разрешений пользователя
...
3. Выберите действие **Действующие разрешения**.
    ...
    >
    > Подробнее о ранжировании см. в разделе [Создание набора разрешений](ui-define-granular-permissions.md#create-a-permission-set).  
...
## <a name="view-permission-changes-telemetry"></a>Просмотр телеметрии изменений разрешений
