...
## <a name="to-set-up-time-constraints-for-users"></a>Настройка ограничений по времени для пользователей
...
4. На экспресс-вкладке **Наборы разрешений пользователя** в новой строке заполните требуемые поля. Дополнительные сведения см. в разделе [Создание и изменение набора разрешений](ui-define-granular-permissions.md#to-create-a-permission-set).
   ...
   Используйте поле **Организация**, чтобы применить набор разрешений к конкретной организации. Если оставить это поле пустым, он будет применяться ко всем организациям.
