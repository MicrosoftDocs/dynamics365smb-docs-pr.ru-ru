...
> [!NOTE]
> Если вы не хотите ограничивать доступ пользователя более, чем это уже определено лицензией, вы можете назначить пользователю специальный набор разрешений, называемый SUPER. Этот набор разрешений гарантирует, что пользователь может получить доступ ко всем объектам, указанным в лицензии.<br /><br />
