...
ms.author: jswymer
---
# <a name="add-contacts-to-segments"></a><a name="add-contacts-to-segments"></a><a name="add-contacts-to-segments"></a>Добавление контактов к сегментам
...
## <a name="to-add-a-contact-to-a-segment"></a><a name="to-add-a-contact-to-a-segment"></a><a name="to-add-a-contact-to-a-segment"></a>Добавление контакта к сегменту
...
## <a name="to-refine-the-number-of-contacts"></a><a name="to-refine-the-number-of-contacts"></a><a name="to-refine-the-number-of-contacts"></a>Обновление числа контактов
...
## <a name="to-reduce-the-number-of-contacts"></a><a name="to-reduce-the-number-of-contacts"></a><a name="to-reduce-the-number-of-contacts"></a>Уменьшение числа контактов
