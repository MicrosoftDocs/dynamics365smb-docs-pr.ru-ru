...
ms.author: jswymer
---
# <a name="sharing-business-data-from-business-central"></a><a name="sharing-business-data-from-business-central"></a>Совместное использование бизнес-данных из Business Central
...
## <a name="copying-a-link"></a><a name="copying-a-link"></a>Копирование ссылки
...
### <a name="modify-the-page-link"></a><a name="modify-the-page-link"></a>Изменить ссылку на страницу
...
### <a name="about-filtered-lists"></a><a name="about-filtered-lists"></a>О отфильтрованных списках
...
## <a name="sharing-to-teams"></a><a name="sharing-to-teams"></a>Отправка данных в Teams
...
## <a name="sharing-through-onedrive"></a><a name="sharing-through-onedrive"></a>Обмен через OneDrive
...
## <a name="opening-in-excel"></a><a name="opening-in-excel"></a>Открытие в Excel
...
## <a name="sharing-rows-or-tables"></a><a name="sharing-rows-or-tables"></a>Совместное использование строк или таблиц
