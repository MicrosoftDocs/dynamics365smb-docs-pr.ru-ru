...
# <a name="set-up-company-consolidation" />Настройка консолидации компании
...
## <a name="simple-consolidation-setup" />Простая настройка консолидации
...
## <a name="advanced-consolidation-setup" />Расширенная настройка консолидации
...
### <a name="set-up-the-consolidated-company" />Настройте консолидированную организацию
...
### <a name="a-namebusunitaadd-business-units" /><a name="busunit"></a>Добавление бизнес-подразделений
...
### <a name="a-nameglaccaprepare-general-ledger-accounts-for-consolidation" /><a name="glacc"></a>Подготовка счетов главной книги для консолидации
...
### <a name="a-nameexchratesaspecify-exchange-rates-for-consolidations" /><a name="exchrates"></a>Задание обменных курсов для консолидации
...
### <a name="a-namedimainclude-or-exclude-dimensions" /><a name="dim"></a>Включить или исключить измерения
...
### <a name="a-nameexcludeaexclude-a-company-from-consolidation" /><a name="exclude"></a>Исключение организации из консолидации
...
### <a name="a-nameincludeainclude-a-partially-owned-company-in-consolidation" /><a name="include"></a>Включение в консолидацию организации с частичной собственностью
