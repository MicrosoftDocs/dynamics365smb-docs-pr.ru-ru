...
### <a name="add-business-units" /><a name="busunit"></a>Добавление бизнес-подразделений
...
### <a name="prepare-general-ledger-accounts-for-consolidation" /><a name="glacc"></a>Подготовка счетов главной книги для консолидации
...
### <a name="specify-exchange-rates-for-consolidations" /><a name="exchrates"></a>Задание обменных курсов для консолидации
...
### <a name="include-or-exclude-dimensions" /><a name="dim"></a>Включить или исключить измерения
...
### <a name="exclude-a-company-from-consolidation" /><a name="exclude"></a>Исключение организации из консолидации
...
### <a name="include-a-partially-owned-company-in-consolidation" /><a name="include"></a>Включение в консолидацию организации с частичной собственностью
