...
# Настройка консолидации компании
...
### <a name="busunit"></a>Добавление бизнес-подразделений
...
### <a name="glacc"></a>Подготовка счетов главной книги для консолидации
...
### <a name="exchrates"></a>Задание обменных курсов для консолидации
...
### <a name="dim"></a>Включить или исключить измерения
...
### <a name="exclude"></a>Исключение организации из консолидации
...
### <a name="include"></a>Включение в консолидацию организации с частичной собственностью
