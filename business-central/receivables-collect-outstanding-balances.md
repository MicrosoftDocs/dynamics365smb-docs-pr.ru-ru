...
ms.author: edupont
---
# <a name="collect-outstanding-balances" />Сбор непогашенных остатков задолженности
...
### <a name="to-send-the-customer-statement-report" />Отправка отчета по клиенту.
...
## <a name="reminders" />Напоминания

[!INCLUDE [receivables-reminders](includes/receivables-reminders.md)]

## <a name="finance-charges" />Финансовые расходы
...
### <a name="to-create-a-finance-charge-memo-manually" />Создание процент-ноты вручную
...
### <a name="to-update-finance-charge-memo-texts" />Обновление текстов процент-нот
...
### <a name="to-issue-finance-charge-memos" />Выдача процент-нот
...
### <a name="to-cancel-an-issued-finance-charge-memo" />Отмена выпущенной процент-ноты
...
### <a name="to-view-reminder-and-finance-charge-entries" />Просмотр операций напоминаний и процент-нот
...
## <a name="multiple-interest-rates" />Сложные процентные ставки
...
## <a name="see-related-microsoft-trainingtrainingpathsprocess-financial-periodic-activities-dynamics--business-central" />См. соответствующее [обучение Microsoft](/training/paths/process-financial-periodic-activities-dynamics-365-business-central/)
