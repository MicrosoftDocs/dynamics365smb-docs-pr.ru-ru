...
ms.author: bholtorf
---
# <a name="the-troubleshooting-fa-ledger-entries-extension" />Расширение "Поиск и устранение неисправностей для операций книги ОС"
...
## <a name="troubleshooting-fixed-asset-ledger-entries" />Поиск и устранение неисправностей для операций книги ОС
