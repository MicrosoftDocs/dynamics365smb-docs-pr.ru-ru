...
description: 'Business Central содержит ряд функций, которые помогут вам собирать, анализировать и передавать коллегам ценные о продажах для бизнес-анализа и принятия решений в сфере закупок.'
author: kennienp
ms.author: kepontop
...
# <a name="analytics-in-purchasing"></a>Аналитика закупок
...
## <a name="analytics-needs-in-purchasing"></a>Потребности в аналитике в сфере закупок
...
Люди на разных ролях имеют разные потребности в данных и используют их по-разному. Например, специалисты по управлению активами и финансам взаимодействуют с данными иначе, чем сотрудники отдела продаж.
...
|начальник отдела снабжения.      | Тенденции, сводки | Встроенные управленческие отчеты <br> Специальный анализ      | 
...
## <a name="use-financial-reporting-to-produce-financial-statements-and-kpis-related-to-purchasing"></a>Использование финансовой отчетности для создания финансовых отчетов и КПЭ (связанных с закупками)
...
## <a name="finance-reporting-across-business-units-or-legal-entities-related-to-purchasing"></a>Финансовая отчетность по филиалам или юридическим лицам (связанная с закупками)
...
## <a name="ad-hoc-analysis-of-purchasing-data"></a>Ad-hoc-анализ данных по закупкам
...
## <a name="built-in-reports-for-purchasing"></a>Встроенные отчеты по закупкам
...
## <a name="on-screen-purchasing-analytics"></a>Экранная аналитика по закупкам
...
### <a name="show-purchasing-related-general-ledger-entries-and-balances-from-the-chart-of-accounts-page"></a>Отображение связанных с закупками операций и сальдо главной книги со страницы «План счетов»
...
### <a name="analyze-data-by-dimensions-related-to-purchasing"></a>Анализ данных по измерениям (связанным с закупками)
