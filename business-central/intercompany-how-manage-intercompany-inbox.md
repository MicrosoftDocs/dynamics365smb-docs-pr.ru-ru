...
Однако, в зависимости от того, как межфирменные отношения настроены для вашей компании, некоторые транзакции автоматически реплицируются для соответствующих межфирменных партнеров. С волны 1 выпуска 2022 года вы можете настроить компанию для автоматического создания полученных межфирменных транзакций от межфирменных партнеров, учитываемых через межфирменный общий журнал. Для получения дополнительной информации см. [Заполнение и учет межфирменного журнала](intercompany-how-work-documents-journals.md#to-fill-in-and-post-an-intercompany-journal).  
...
#### Создана межфирменным партнером  
...
## Восстановление операций во входном ящике  
...
## Просмотр межфирменных транзакций за некоторый период  
...
В этом случае можно задать в системе обход входящего и исходящего ящиков, установив флажок **Авто. Принять транзакции** на странице **Межфирменный партнер** и флажок **Авто. Отправить транзакции** на странице **Настройка МФ**, соответственно. Входящие внутрихолдинговые транзакции могут быть автоматически приняты, только если включен планировщик задач. Дополнительные сведения см. в разделе [Настройка Business Central Server — параметры планировщика задач](/dynamics365/business-central/dev-itpro/administration/configure-server-instance#Task).
...
1. Выберите ![Лампочка, которая открывает функцию Что вы хотите сделать.](media/ui-search/search_small.png "Что вы хотите сделать") значок введите **Входящие межфирменные транзакции**, а затем выберите связанную ссылку.  
...
1.  Выберите ![Лампочка, которая открывает функцию Что вы хотите сделать.](media/ui-search/search_small.png "Что вы хотите сделать") значок введите **Исходящие межфирменные транзакции**, а затем выберите связанную ссылку.  
...
## Восстановление межфирменных транзакций во входном ящике  
