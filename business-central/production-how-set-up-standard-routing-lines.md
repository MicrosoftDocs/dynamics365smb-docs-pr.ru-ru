...
ms.author: edupont
---
# <a name="set-up-standard-routing-lines"></a><a name="set-up-standard-routing-lines"></a><a name="set-up-standard-routing-lines"></a>Настройка стандартных строк маршрута
...
## <a name="to-set-up-a-standard-task"></a><a name="to-set-up-a-standard-task"></a><a name="to-set-up-a-standard-task"></a>Чтобы настроить стандартную задачу
...
## <a name="to-add-a-standard-task-to-an-operation"></a><a name="to-add-a-standard-task-to-an-operation"></a><a name="to-add-a-standard-task-to-an-operation"></a>Добавление стандартной задачи к операции
