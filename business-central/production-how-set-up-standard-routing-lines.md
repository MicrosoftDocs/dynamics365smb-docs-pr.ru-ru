...
ms.author: edupont
---
# <a name="set-up-standard-routing-lines" />Настройка стандартных строк маршрута
...
## <a name="to-set-up-a-standard-task" />Чтобы настроить стандартную задачу
...
## <a name="to-add-a-standard-task-to-an-operation" />Добавление стандартной задачи к операции
