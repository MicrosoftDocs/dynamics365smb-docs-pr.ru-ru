...
ms.author: bholtorf
---
# <a name="set-up-invoice-rounding" />Настройка округления счета
...
## <a name="set-up-general-ledger-accounts-for-invoice-rounding-differences" />Настройка счетов главной книги для разницы округления счета
...
### <a name="to-set-up-general-ledger-accounts-for-invoice-rounding-differences" />Настройка счетов главной книги для разницы округления счета
...
## <a name="set-up-rounding-for-foreign-and-local-currencies" />Настройка округления для иностранной и местной валюты
...
### <a name="to-set-up-rounding-for-foreign-currencies" />Для настройки правил округления для иностранных валют
...
### <a name="to-set-up-rounding-for-your-local-currency" />Для настройки округления для локальной валюты
...
## <a name="activate-the-invoice-rounding-function" />Активизация функции округления счета
