...
![Порядок операций, связанных со сборкой, во время корректировки себестоимости](media/design_details_assembly_posting_3.png "Порядок операций, связанных со сборкой, во время корректировки себестоимости")  
