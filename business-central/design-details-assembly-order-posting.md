...
ms.author: edupont
---
# <a name="design-details-assembly-order-posting"></a><a name="design-details-assembly-order-posting"></a>Сведения о проектировании: учет заказа на сборку
...
## <a name="posting-sequence"></a><a name="posting-sequence"></a>Порядок учета
...
## <a name="cost-adjustment"></a><a name="cost-adjustment"></a>Коррекция себестоимости
...
### <a name="performing-the-adjustment"></a><a name="performing-the-adjustment"></a>Выполнение коррекции
...
## <a name="assembly-costs-are-always-actual"></a><a name="assembly-costs-are-always-actual"></a>Затраты на сборку всегда фактические
...
### <a name="posting-dates"></a><a name="posting-dates"></a>Даты учета
