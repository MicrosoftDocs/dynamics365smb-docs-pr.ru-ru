...
## Экспорт и импорт бюджетов ГК с помощью Excel
...
## См. соответствующее [обучение Microsoft](/training/modules/budgets-exchange-rates-dynamics-365-business-central/index)
