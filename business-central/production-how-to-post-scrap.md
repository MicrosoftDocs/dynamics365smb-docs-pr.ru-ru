---
title: Учет брака/отходов вручную
...
ms.author: edupont
---
# <a name="post-scrap-manually"></a><a name="post-scrap-manually"></a><a name="post-scrap-manually"></a>Учет брака/отходов вручную
...
## <a name="to-post-scrap-manually"></a><a name="to-post-scrap-manually"></a><a name="to-post-scrap-manually"></a>Учет брака вручную
