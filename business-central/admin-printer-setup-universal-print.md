...
# <a name="set-up-universal-print-printers" />Настройка принтеров универсальной печати
...
## <a name="set-up-universal-print-and-printers-in-microsoft-azure" />Настройка универсальной печати и принтеров в Microsoft Azure
...
## <a name="add-printers-in-business-central-online" />Добавление принтеров в Business Central Online
...
## <a name="add-printers-in-business-central-on-premises" />Добавление принтеров в Business Central локальная версия
...
<!-- To Do Adding printers individually lets you duplicate printers with custom , like different paper trays and paper size and orientation.  To add printers individually, you'll need to know printer's share name in Universal Print. -->
### <a name="connect-to-universal-print-for-the-first-time" />Подключитесь к универсальной печати в первый раз
...
## <a name="common-problems-and-resolutions" />Распространенные проблемы и способы их решения
...
### <a name="you-dont-have-access-to-the-printer-your-printer" />У вас нет доступа к принтеру \<your-printer\>.
...
## <a name="there-was-an-error-fetching-printers-shared-to-you" />Произошла ошибка при извлечении принтеров, к которым вам предоставлен доступ.
