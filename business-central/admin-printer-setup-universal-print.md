...
4. Изменение свойств принтера (необязательно)
    ...
    Подробнее см. в разделе [Управление настройками принтера с помощью Universal Print Portal](/universal-print/reference/portal/printer-settings).

5. Поделитесь принтерами с пользователями.

    Любой принтер, который вы хотите использовать в [!INCLUDE[prod_short](includes/prod_short.md)], необходимо открыть для *общего доступа* в службе универсальной печати. Любой пользователь, которому требуется доступ к принтеру, должен быть добавлен в качестве участника общего доступа к принтеру. Узнайте больше на странице [Общий доступ к принтеру](/universal-print/reference/portal/share-printers).

    > [!TIP]
    > Вы всегда можете добавить или удалить пользователей позже. Подробнее см. в разделе [Настройка прав пользователя для общего доступа к принтеру](/universal-print/reference/portal/share-printers#configure-user-permissions-for-a-printer-share).
...
6. Включите преобразование документов.
    ...
    Узнайте больше на странице [Преобразование документов](/universal-print/reference/portal/settings#2-document-conversion).
