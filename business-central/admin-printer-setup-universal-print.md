...
# <a name="set-up-universal-print-printers"></a><a name="set-up-universal-print-printers"></a><a name="set-up-universal-print-printers"></a>Настройка принтеров универсальной печати
...
## <a name="set-up-universal-print-and-printers-in-microsoft-azure"></a><a name="set-up-universal-print-and-printers-in-microsoft-azure"></a><a name="set-up-universal-print-and-printers-in-microsoft-azure"></a>Настройка универсальной печати и принтеров в Microsoft Azure
...
## <a name="add-printers-in-business-central-online"></a><a name="add-printers-in-business-central-online"></a><a name="add-printers-in-business-central-online"></a>Добавление принтеров в Business Central Online
...
## <a name="add-printers-in-business-central-on-premises"></a><a name="add-printers-in-business-central-on-premises"></a><a name="add-printers-in-business-central-on-premises"></a>Добавление принтеров в Business Central локальная версия
...
<!-- To Do Adding printers individually lets you duplicate printers with custom , like different paper trays and paper size and orientation.  To add printers individually, you'll need to know printer's share name in Universal Print. -->
### <a name="connect-to-universal-print-for-the-first-time"></a><a name="connect-to-universal-print-for-the-first-time"></a><a name="connect-to-universal-print-for-the-first-time"></a>Подключитесь к универсальной печати в первый раз
...
## <a name="common-problems-and-resolutions"></a><a name="common-problems-and-resolutions"></a><a name="common-problems-and-resolutions"></a>Распространенные проблемы и способы их решения
...
### <a name="you-dont-have-access-to-the-printer-your-printer"></a><a name="you-dont-have-access-to-the-printer-your-printer"></a><a name="you-dont-have-access-to-the-printer-your-printer"></a>У вас нет доступа к принтеру \<your-printer\>.
...
## <a name="there-was-an-error-fetching-printers-shared-to-you"></a><a name="there-was-an-error-fetching-printers-shared-to-you"></a><a name="there-was-an-error-fetching-printers-shared-to-you"></a>Произошла ошибка при извлечении принтеров, к которым вам предоставлен доступ.
...
#### <a name="you-dont-see-the-a-printer-in-the"></a><a name="you-dont-see-the-a-printer-in-the"></a><a name="you-dont-see-the-a-printer-in-the"></a>You don't see the a printer in the

The printer is not shared in Universal Print.

### <a name="you-get-an-error-when-tryong-to-add-all-or-a-single-printer"></a><a name="you-get-an-error-when-tryong-to-add-all-or-a-single-printer"></a><a name="you-get-an-error-when-tryong-to-add-all-or-a-single-printer"></a>You get an error when tryong to add all or a single printer
...
## <a name="could-not-upload-the-document-to-print-job-50"></a><a name="could-not-upload-the-document-to-print-job-50"></a><a name="could-not-upload-the-document-to-print-job-50"></a>Could not upload the document to print job 50.
