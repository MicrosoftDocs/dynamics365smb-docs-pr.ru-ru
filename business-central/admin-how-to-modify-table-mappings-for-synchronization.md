---
title: Изменение сопоставления таблиц для синхронизации | Документация Майкрософт
description: Узнайте, как изменить сопоставления таблиц, которые используются при синхронизации данных между Business Central и Dynamics 365 Sales.
author: bholtorf
