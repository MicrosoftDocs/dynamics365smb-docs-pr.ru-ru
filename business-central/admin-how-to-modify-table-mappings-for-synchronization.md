...
---
# <a name="mapping-the-tables-and-fields-to-synchronize" />Сопоставление таблиц и полей для синхронизации
...
## <a name="mapping-integration-tables" />Сопоставление таблиц интеграции
...
### <a name="additional-mappings" />Дополнительные сопоставления
...
### <a name="strategies-for-auto-resolving-conflicts" />Стратегии автоматического разрешения конфликтов
...
## <a name="mapping-integration-fields" />Сопоставление полей интеграции
...
### <a name="handle-differences-in-field-values" />Обработка различий в значениях полей
...
### <a name="handle-missing-option-values" />Обработка отсутствия значений параметров
...
## <a name="couple-records" />Связывание записей
...
## <a name="filter-records-and-rows" />Фильтрация записей и строк
...
## <a name="create-new-records" />Создание новых записей
...
### <a name="to-create-new-records-during-synchronization" />Создание записей во время синхронизации
...
## <a name="use-configuration-templates-on-table-mappings" />Использование шаблонов конфигурации для сопоставлений таблицы
...
### <a name="to-specify-configuration-templates-on-a-table-mapping" />Указание шаблонов конфигурации для сопоставления таблицы
