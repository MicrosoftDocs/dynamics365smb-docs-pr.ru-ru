...
ms.author: edupont
---
# <a name="work-with-item-attributes" />Работа с атрибутами товаров
...
## <a name="create-item-attributes" />Создание атрибутов товара
...
## <a name="create-values-for-item-attributes-of-type-option" />Создание значений для атрибутов товаров типа "Параметр"
...
## <a name="assign-item-attributes-to-items" />Назначение товарам атрибутов товара
...
## <a name="assign-item-attributes-to-item-categories" />Назначение атрибутов товара категориям товаров
...
## <a name="filter-by-item-attributes" />Фильтрация по атрибутам товаров
