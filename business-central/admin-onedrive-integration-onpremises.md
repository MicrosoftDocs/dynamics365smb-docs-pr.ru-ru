...
ms.author: jswymer
---
# <a name="configuring-onedrive-integration-with-business-central-on-premises" />Настройка интеграции OneDrive с локальной версией Business Central
...
## <a name="set-up-the-onedrive-connection-in-version--and-later" />Настройка подключения к OneDrive в версии 21 и выше
...
### <a name="run-onedrive-setup" />Запуск настройки OneDrive
...
## <a name="set-up-the-connection-in-includeprodshortincludesprodshortmd-version--and-" />Настройка подключения в [!INCLUDE[prod_short](includes/prod_short.md)] версий 19 и 20
...
## <a name="after-upgrade-to-version-" />После обновления до версии 21
...
## <a name="switching-from-legacy-sharepoint-to-new-onedrive-integration" />Переход со старой интеграции с SharePoint на новую интеграцию с OneDrive
...
#### <a name="how-the-changes-affect-the-integration" />Как изменения влияют на интеграцию
...
### <a name="run-onedrive-setup-to-switch-to-the-new-onedrive-integration" />Запуск настройки OneDrive для перехода на новую интеграцию с OneDrive
