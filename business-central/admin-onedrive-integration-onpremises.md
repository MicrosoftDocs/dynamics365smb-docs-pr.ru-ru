...
## <a name="register-an-app-in-azure-ad-for-onedrive-integration"></a><a name="registerapp"></a>Регистрация приложения в Azure AD для интеграции с OneDrive
...
## <a name="set-up-the-connection-in-prod_short-version-19-and-20"></a>Настройка подключения в [!INCLUDE[prod_short](includes/prod_short.md)] версий 19 и 20
...
## <a name="switching-from-legacy-sharepoint-to-new-onedrive-integration"></a>Переход со старой интеграции с SharePoint на новую интеграцию с OneDrive 
