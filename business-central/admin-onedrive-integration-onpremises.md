...
- Если в мастере **Настройка учетных записей Microsoft Entra** не указано приложение, интеграция с OneDrive будет использовать то же приложение, что и раньше.
   ...
   Мастер настройки **Настройка OneDrive** скопирует конфигурацию приложения в мастере настройки **Настройка учетных записей Microsoft Entra**, чтобы она могла использоваться для других интеграций, которые будут настроены в дальнейшем.
