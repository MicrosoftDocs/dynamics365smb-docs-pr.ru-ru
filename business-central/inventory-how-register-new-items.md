...
ms.author: edupont
---
# <a name="register-new-items" />Регистрация новых товаров
...
## <a name="to-create-a-new-item-card" />Создание новой карточки товара
...
### <a name="to-save-the-item-card-as-a-template" />Сохранение карточки товара в качестве шаблона
...
### <a name="items-used-in-production-orders" />Товары, используемые в производственных заказах
...
## <a name="to-set-up-multiple-vendors-for-an-item" />Настройка нескольких поставщиков для товара
...
## <a name="set-up-item-substitutions" />Настройка замен товаров
...
### <a name="to-make-an-item-substitution" />Создание замены товара
...
## <a name="deleting-item-cards" />Удаление карточек товаров
...
## <a name="manage-inventory-in-warehouses" />Управление запасами на складе
