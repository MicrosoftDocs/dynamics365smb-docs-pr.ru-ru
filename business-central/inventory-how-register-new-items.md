...
1. Выберите ![Лампочка, которая открывает функцию Что вы хотите сделать.](media/ui-search/search_small.png "Что вы хотите сделать") значок введите **Товары**, а затем выберите связанную ссылку.  
2. Найдите соответствующий товар, а затем нажмите **Номер товара**, чтобы открыть карточку товара.  
3. Выберите действие **Связанный**, затем выберите **Товар**, а потом **Замены**, чтобы открыть страницу ввода замены товара.  
...
Если запрошенное количество, такое как в строке продаж, превышает количество товара в наличии, появляется сообщение с информацией о наличии товаров для замены.
