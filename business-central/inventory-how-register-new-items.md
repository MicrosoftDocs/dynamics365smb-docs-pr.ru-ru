...
ms.author: edupont
---
# <a name="register-new-items"></a><a name="register-new-items"></a><a name="register-new-items"></a>Регистрация новых товаров
...
Товар может быть структурирован как родительский товар с основными дочерними товарами в спецификации. Подробнее о сборочных и производственных спецификациях см. в разделе [Работа со спецификациями](inventory-how-work-BOMs.md).
...
*Товары из каталога* — это товары, которые вы предлагаете клиентам, но не хотите обрабатывать их в своей системе до начала торговли ими. Товары из каталога не являются обычными товарами типа **Нескладируемые**. Подробнее в разделе [Работа с товарами из каталога](inventory-how-work-nonstock-items.md).  
...
## <a name="to-create-a-new-item-card"></a><a name="to-create-a-new-item-card"></a><a name="to-create-a-new-item-card"></a>Создание новой карточки товара
...
### <a name="to-save-the-item-card-as-a-template"></a><a name="to-save-the-item-card-as-a-template"></a><a name="to-save-the-item-card-as-a-template"></a>Сохранение карточки товара в качестве шаблона
...
### <a name="items-used-in-production-orders"></a><a name="items-used-in-production-orders"></a><a name="items-used-in-production-orders"></a>Товары, используемые в производственных заказах
...
## <a name="to-set-up-multiple-vendors-for-an-item"></a><a name="to-set-up-multiple-vendors-for-an-item"></a><a name="to-set-up-multiple-vendors-for-an-item"></a>Настройка нескольких поставщиков для товара
...
## <a name="set-up-item-substitutions"></a><a name="set-up-item-substitutions"></a><a name="set-up-item-substitutions"></a>Настройка замен товаров
...
### <a name="to-make-an-item-substitution"></a><a name="to-make-an-item-substitution"></a><a name="to-make-an-item-substitution"></a>Создание замены товара
...
## <a name="deleting-item-cards"></a><a name="deleting-item-cards"></a><a name="deleting-item-cards"></a>Удаление карточек товаров
...
## <a name="manage-inventory-in-warehouses"></a><a name="manage-inventory-in-warehouses"></a><a name="manage-inventory-in-warehouses"></a>Управление запасами на складе
...
## <a name="planning"></a><a name="planning"></a><a name="planning"></a>Планир.
