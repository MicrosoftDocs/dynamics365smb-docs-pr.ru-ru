...
ms.locfileid: "8525228"
---
# <a name="create-bank-deposits"></a>Создание внесения на банковский счет
> [!NOTE]
...
### <a name="number-series-and-lump-sum-deposits"></a>Серии номеров и единовременные внесения на счет
...
### <a name="general-journal-templates-for-bank-deposits"></a>Шаблоны общих журналов для внесений на счет
...
## <a name="dimensions-on-bank-deposit-lines"></a>Размеры строк внесений на счет
...
## <a name="create-a-bank-deposit"></a>Создание внесения на банковский счет
...
## <a name="finding-posted-bank-deposits"></a>Поиск внесений на счет
...
## <a name="reversing-a-posted-bank-deposit"></a>Сторнирование учтенного внесения на банковский счет
