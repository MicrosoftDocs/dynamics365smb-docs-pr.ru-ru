...
# <a name="create-bank-deposits"></a>Создавайте банковские депозиты
...
6. Заполните соответствующим образом остальные поля. [!INCLUDE [tooltip-inline-tip_md](../archive/SetupAndAdministration/includes/tooltip-inline-tip_md.md)]
    ...
    Дата в поле **Дата отправки**  и измерения в полях **Код отдела** и **Код группы клиентов** будут назначены строкам, которые вы создаете для банковского депозита. Если требуется, их можно изменить.
