...
ms.author: bholtorf
---
# <a name="create-bank-deposits" />Создание внесения на банковский счет
> [!NOTE]
...
### <a name="number-series-and-lump-sum-deposits" />Серии номеров и единовременные внесения на счет
...
### <a name="general-journal-templates-for-bank-deposits" />Шаблоны общих журналов для внесений на счет
...
## <a name="dimensions-on-bank-deposit-lines" />Размеры строк внесений на счет
...
## <a name="create-a-bank-deposit" />Создание внесения на банковский счет
...
## <a name="finding-posted-bank-deposits" />Поиск внесений на счет
...
## <a name="reversing-a-posted-bank-deposit" />Сторнирование учтенного внесения на банковский счет
