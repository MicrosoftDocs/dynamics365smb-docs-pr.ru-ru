...
ms.author: edupont
---
# <a name="service-posting" />Учет сервиса
...
## <a name="to-view-information-about-a-posted-service-document" />Просмотр информации об учтенном сервисном документе
