...
ms.author: edupont
---
# <a name="create-service-items" />Создание сервисных товаров
...
## <a name="to-create-a-service-item" />Создание сервисного товара
...
## <a name="to-create-service-items-within-a-service-order" />Создание сервисных товаров в сервисном заказе
...
## <a name="to-create-a-service-item-when-shipping-items" />Создание сервисного товара при отгрузке товаров
...
## <a name="to-insert-a-starting-fee-for-a-service-item" />Вставка начального тарифа для сервисного товара
