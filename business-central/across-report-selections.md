...
ms.author: bholtorf
---
# <a name="report-selection-for-documents-in-business-central" />Выбор отчетов для документов в Business Central
...
## <a name="available-report-selections" />Доступный выбор отчетов
...
## <a name="example-report-selection-for-sales-documents" />Пример. Выбор отчета для документов на продажу
