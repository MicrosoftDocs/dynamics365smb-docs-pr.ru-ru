...
# Определения столбцов в бухгалтерской отчетности
...
## Создание или изменение определения столбцов
...
## Встроенные определения столбцов
...
## Пример: создание определения столбцов для вычисления процентов
...
## Импорт и экспорт определений столбцов для бухгалтерской отчетности
