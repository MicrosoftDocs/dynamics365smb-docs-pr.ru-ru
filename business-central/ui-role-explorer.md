...
Чтобы получить обзор бизнес-функций, доступных для всех других ролей, в дополнение к вашей собственной, выберите действие **Смотреть все** на странице, которая представляет обозреватель ролей.
