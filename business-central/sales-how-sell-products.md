...
---
# <a name="sell-products-with-a-customer-sales-order"></a>Продажа продукции с помощью клиентского заказа на продажу
...
11. При желании в поле **Сумма скидки по счету** введите сумму, которую нужно вычесть из значения, отображаемого в поле **Всего с учетом налога**.
...
## <a name="working-with-amount-fields"></a>Работа с полями сумм
