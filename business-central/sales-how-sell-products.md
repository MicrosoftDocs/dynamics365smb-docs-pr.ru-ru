...
Товары могут быть и товарами в запасах, и услугами; это обозначается типами **Товар** и **Услуга** в карточке товара. Процедура обработки заказа на продажу такая же для обоих типов товаров. Дополнительные сведения см. в разделе [Регистрация новых товаров](inventory-how-register-new-items.md).
