...
9. Чтобы добавить комментарий о строке предложения, которую клиент может просмотреть в напечатанном предложении по продаже, напишите комментарий в поле **Описание** нужно записать в пустой строке.  
10. Повторите шаги с 4 по 8 для каждого товара, который требуется продать клиенту.
