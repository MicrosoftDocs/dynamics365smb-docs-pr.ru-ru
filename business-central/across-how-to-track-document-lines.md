...
ms.author: edupont
---
# <a name="track-document-lines" />Отслеживание строк документа
...
## <a name="to-track-documents-related-to-a-sales-order-line" />Отслеживание документов, связанных со строкой заказа на продажу
