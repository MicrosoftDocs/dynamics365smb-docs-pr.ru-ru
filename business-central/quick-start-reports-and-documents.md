---
title: Быстрый старт базовых отчетов и документов
...
# <a name="basic-reports-and-documents-output-quick-start"></a>Быстрый старт базовых отчетов и документов
...
После того как изображение отобразится в поле  **Изображение**, вы можете закрыть страницу  **Информация о компании** .
