...
ms.author: edupont
---
# <a name="set-up-resources-for-projects" />Настройка ресурсов для проектов
...
## <a name="to-set-up-a-resource" />Настройка ресурса
...
## <a name="to-set-up-a-resource-group" />Настройка группы ресурсов
...
## <a name="to-set-capacity-for-a-resource" />Настройка производственной мощности ресурса
...
## <a name="to-set-up-alternate-resource-costs" />Настройка альтернативных затрат на ресурсы
...
## <a name="to-set-up-alternate-resource-prices" />Настройка альтернативных цен ресурсов
