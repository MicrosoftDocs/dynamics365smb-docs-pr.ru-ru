...
ms.author: jswymer
---
# <a name="add-and-view-notes-on-records"></a><a name="add-and-view-notes-on-records"></a>Добавление и просмотр заметок в записях
 ...
 > [!NOTE]  
 >  В настоящий момент эта функция недоступна.  
...
<!--OnPrem
## <a name="to-work-with-notes-on-a-record"></a><a name="to-work-with-notes-on-a-record"></a>To work with notes on a record
