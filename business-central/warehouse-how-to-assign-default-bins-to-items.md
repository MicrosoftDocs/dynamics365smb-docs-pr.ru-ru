...
ms.author: edupont
---
# <a name="assign-default-bins-to-items" />Присвоение товарам стандартных ячеек
...
## <a name="to-assign-a-default-bin-to-an-item" />Присвоение товару ячейки по умолчанию
...
## <a name="to-change-the-default-bin-for-an-item" />Изменение стандартной ячейки для товара
