...
ms.author: edupont
---
# <a name="reserve-items" />Резервирование товаров
...
## <a name="reserve-items-for-sales" />Резервирование товаров с целью продажи
...
## <a name="reserve-an-item-for-a-production-order-line" />Резервирование товара для строки производственного заказа
...
## <a name="reserve-items-for-production-order-components" />Резервирование товаров для компонентов производственного заказа
...
## <a name="change-a-reservation" />Изменение резервирования
...
## <a name="cancel-a-reservation" />Отмена резервирования
...
## <a name="reserve-a-specific-serial-or-lot-number" />Резервирование определенного серийного номера или номера партии
...
## <a name="see-related-microsoft-trainingtrainingmodulesmanage-outbound-serial-lot-numbers" />См. соответствующее [обучение Microsoft](/training/modules/manage-outbound-serial-lot-numbers/)
