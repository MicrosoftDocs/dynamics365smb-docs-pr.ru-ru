...
1. Выберите значок ![Поиск страницы или отчета](media/ui-search/search_small.png "Значок поиска страницы или отчета"), введите **Заказы на продажу**, затем выберите связанную ссылку.  
...
7. Нажмите кнопку **ОК**, чтобы открыть окно **Резервирование**, содержащее только предложения с указанным номером трассировки товара. Если имеются какие-либо неспецифические резервирования в любом из номеров трассировки товара, который указан для этой строки, появляется уведомления о количестве уже зарезервированного товара.  
