...
description: Узнайте различные способы размещения товаров в Business Central с помощью следующих задач складского размещения.
author: SorenGP
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
...
1.  Выберите ![Лампочка, которая открывает функцию Что вы хотите сделать.](media/ui-search/search_small.png "Что вы хотите сделать") значок, введите **Учтенные складские приемки**, а затем выберите связанную ссылку.  
