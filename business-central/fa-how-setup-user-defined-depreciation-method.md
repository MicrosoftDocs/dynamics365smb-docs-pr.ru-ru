...
# <a name="set-up-fixed-assets-with-user-defined-depreciation-methods" />Настройка основных средств с использованием методов амортизации, определяемых пользователем
...
## <a name="to-assign-a-depreciation-book-to-a-fixed-asset-with-a-user-defined-depreciation-method" />Назначение книги амортизации для основных средств с помощью определяемого пользователем метода амортизации
...
## <a name="to-set-up-user-defined-depreciation-methods" />Настройка пользовательских методов амортизации
...
### <a name="depreciation-based-on-number-of-units" />Амортизация на основании числа единиц
...
### <a name="example---user-defined-depreciation" />Пример. Определенная пользователем амортизация
