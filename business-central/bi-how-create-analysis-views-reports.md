...
ms.author: edupont
---
# <a name="create-analysis-reports" />Создание аналитических отчетов
...
## <a name="setting-up-line-and-column-layouts" />Настройка раскладок строк и столбцов
...
## <a name="set-up-analysis-column-templates" />Настройка шаблонов столбцов анализа
...
## <a name="set-up-analysis-line-templates" />Настройка шаблонов строк анализа
...
## <a name="create-a-new-sales-analysis-report" />Создание нового аналитического отчета по продажам
