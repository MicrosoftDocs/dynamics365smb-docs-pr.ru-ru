...
На основе настроенных строк и столбцов [!INCLUDE[d365fin](includes/d365fin_md.md)] будет выполнять агрегирование результатов отчета на странице  **Аналитический отчет**, как показано в следующей таблице.  
