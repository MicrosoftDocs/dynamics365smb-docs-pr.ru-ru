...
ms.author: edupont
---
# <a name="create-analysis-reports"></a><a name="create-analysis-reports"></a>Создание аналитических отчетов
...
## <a name="setting-up-line-and-column-layouts"></a><a name="setting-up-line-and-column-layouts"></a>Настройка раскладок строк и столбцов
...
## <a name="set-up-analysis-column-templates"></a><a name="set-up-analysis-column-templates"></a>Настройка шаблонов столбцов анализа
...
## <a name="set-up-analysis-line-templates"></a><a name="set-up-analysis-line-templates"></a>Настройка шаблонов строк анализа
...
## <a name="create-a-new-sales-analysis-report"></a><a name="create-a-new-sales-analysis-report"></a>Создание нового аналитического отчета по продажам
