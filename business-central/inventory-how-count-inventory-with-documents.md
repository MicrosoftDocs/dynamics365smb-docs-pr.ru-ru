...
1. Выберите значок ![Лампочка, которая открывает функцию Что вы хотите сделать](media/ui-search/search_small.png "Что вы хотите сделать"), введите **Заказы инвентаризации**, затем выберите связанную ссылку.
...
Можно также выбрать действие **Разница заказов инвентаризации** для просмотра любых различий между ожидаемым количеством и сосчитанным количеством.
...
1. Выберите значок ![Лампочка, которая открывает функцию Что вы хотите сделать](media/ui-search/search_small.png "Что вы хотите сделать"), введите **Учтенные заказы инвентаризации**, затем выберите связанную ссылку.
