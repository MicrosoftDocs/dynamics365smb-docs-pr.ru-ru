...
### <a name="to-set-up-numbering-for-inventory-documents"></a>Чтобы настроить нумерацию инвентарных документов
...
1. Выберите значок ![Лампочка, которая открывает функцию "Что вы хотите сделать"](media/ui-search/search_small.png "Что вы хотите сделать"), введите **Приходные накладные**, затем выберите соответствующую ссылку.  
...
## <a name="printing-inventory-documents"></a>Печать инвентарных документов
