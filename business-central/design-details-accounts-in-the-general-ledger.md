...
---
# Технические подробности: счета в главной книге
...
|**Тип операции книги товаров**|**Тип операции стоимости**|**Тип отклонения**|**Ожидаемая себестоимость**|**Учетная запись**|**Балансирующий счет**|  
|--------------------------------|--------------------------|-----------------------|-----------------------|-----------------|---------------------------|  
...
|Производственный|Машинный центр/производственный центр|Косв. затраты|Счет НЗП|Примененные накл. расх.|  
