...
ms.author: edupont
---
# <a name="design-details-accounts-in-the-general-ledger" />Сведения о проектировании: счета в главной книге
...
## <a name="from-the-inventory-ledger" />Из книги запасов
...
## <a name="from-the-capacity-ledger" />Из книги производственных мощностей
...
## <a name="calculating-the-amount-to-post-to-the-general-ledger" />Расчет суммы для учета в главной книге
