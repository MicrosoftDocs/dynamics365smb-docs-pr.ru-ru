...
ms.locfileid: "8525171"
---
# <a name="setting-the-layout-used-by-a-report"></a>Установите макет, используемый отчетом
...
Существует два способа задать макет, который будет использоваться в отчете. Один способ — на странице **Выбор макета отчета**. Другой способ — на странице **Макеты отчетов**. У каждой страницы есть преимущества, например: 

- Страница **Выбор макета отчета** отображает список всех отчетов.

  На этой странице показано, для какого отчета используется макет. Кроме того, вы можете устанавливать макеты в разных компаниях без необходимости менять компанию, с которой вы работаете.

- Страница **Макеты отчетов** отображает все доступные макеты для каждого отчета в текущей компании.

  Конкретный макет легко найти, отсортировав или отфильтровав список. Как только вы найдете макет, вы можете установить его для отчета с помощью одного выбора.
