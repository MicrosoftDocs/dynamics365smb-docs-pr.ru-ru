...
1. Откройте [страницу **Список товаров**](https://businesscentral.dynamics.com/?page=31), а затем откройте соответствующий товар.  
2. На странице **Карточка товара** выберите действие **Варианты**.  
