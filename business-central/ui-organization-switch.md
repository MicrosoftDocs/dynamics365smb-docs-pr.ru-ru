...
# <a name="switching-to-another-company-or-environment" />Переключение на другую компанию или среду
...
## <a name="about-companies-and-environments" />О компаниях и средах
...
## <a name="features-for-switching-company-or-environment" />Функции для переключения компаний или сред
...
## <a name="use-the-company-switcher" />Использование средства переключения компаний
...
## <a name="use-the-app-launcher" />Использование средства запуска приложений
...
-->
## <a name="use-my-settings" />Использование пункта "Мои настройки"
...
## <a name="use-company-hub" />Использование "Центра компаний"
