...
# <a name="switching-to-another-company-or-environment"></a><a name="switching-to-another-company-or-environment"></a>Переключение на другую компанию или среду
...
## <a name="about-companies-and-environments"></a><a name="about-companies-and-environments"></a>О компаниях и средах
...
## <a name="features-for-switching-company-or-environment"></a><a name="features-for-switching-company-or-environment"></a>Функции для переключения компаний или сред
...
## <a name="use-the-company-switcher"></a><a name="use-the-company-switcher"></a>Использование средства переключения компаний
...
## <a name="use-the-app-launcher"></a><a name="use-the-app-launcher"></a>Использование средства запуска приложений
...
-->
## <a name="use-my-settings"></a><a name="use-my-settings"></a>Использование пункта "Мои настройки"
...
## <a name="use-company-hub"></a><a name="use-company-hub"></a>Использование "Центра компаний"
