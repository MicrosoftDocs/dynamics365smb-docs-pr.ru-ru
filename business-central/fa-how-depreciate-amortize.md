...
> [!NOTE]
> Если вы выберете поле **Число дней обязательно** и в поле **Число дней обязательно** установлено значение, которое приводит к дате разноски за вычетом значения полей **Количество дней** — это дата в предыдущем календарном году, вы не можете разнести амортизацию. Обходной путь — уменьшить значение **Число дней обязательно** до не более чем рассчитанных дней до даты разноски с использованием 30 дней в месяц ИЛИ выберите поле **Финансовый год из 365 дней** в книге амортизации. Мы рекомендуем первый вариант, поскольку вы можете не захотеть менять использование 30 дней/месяц для амортизации. Для получения дополнительной информации прочитайте [Амортизация поля финансового года за 365 дней](fa-how-setup-depreciation.md#fiscal-year-365-days-field-depreciation).
