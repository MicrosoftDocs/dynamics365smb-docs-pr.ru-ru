...
ms.author: edupont
---
# <a name="depreciate-or-amortize-fixed-assets" />Амортизация основных средств
...
## <a name="to-calculate-depreciation-automatically" />Расчет амортизации автоматически
...
## <a name="to-post-depreciation-manually-from-the-fixed-asset-gl-journal" />Учет амортизации вручную с использованием журнала ГК основных средств
...
## <a name="to-manage-the-ending-book-value" />Управление конечной балансовой стоимостью
...
## <a name="to-calculate-allocations-in-the-fixed-asset-gl-journal" />Расчет распределения в журнале ГК учета основных средств
...
## <a name="use-duplication-lists-to-prepare-to-post-to-multiple-depreciation-books" />Использование списков дублирования для подготовки учета в нескольких книгах амортизации
...
## <a name="to-post-entries-to-different-depreciation-books" />Учет операций для различных книг амортизации
...
## <a name="to-copy-fixed-asset-ledger-entries-between-depreciation-books" />Копирование операций из книги основных средств между книгами амортизации
