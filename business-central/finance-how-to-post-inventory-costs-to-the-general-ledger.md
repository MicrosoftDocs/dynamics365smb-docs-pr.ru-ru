...
ms.author: edupont
---
# <a name="reconcile-inventory-costs-with-the-general-ledger" />Выверка себестоимости товаров с главной книгой
...
## <a name="to-post-inventory-costs-manually" />Учет себестоимости товаров на складе вручную
...
## <a name="to-audit-the-reconciliation-between-the-inventory-ledger-and-the-general-ledger" />Аудит выверки книги инвентаризации и главной книги
...
## <a name="reporting-costs-and-reconciling-with-the-general-ledger" />Отчет о затратах и выверка с главной книгой
