...
description: В этом разделе описывается, как управлять физическими продуктами, которыми вы торгуете, путем создания карточки товара в запасах.
author: SorenGP
...
|Настройте отслеживание товаров, чтобы вы могли отслеживать серийные номера товаров, например, для отслеживания товаров в случае отзыва.|[Настройка отслеживания товаров по серийному номеру, номеру партии и номеру упаковки](inventory-how-setup-item-tracking.md)|
...
|Используйте ресурсы с особыми навыками для различных услуг и пунктов обслуживания.|[Настройка распределения ресурсов](service-how-setup-resource-allocation.md)|
