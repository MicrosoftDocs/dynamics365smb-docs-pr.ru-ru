...
1. В правом верхнем углу выберите значок **Поиск страницы или отчета**, введите **Счета продажи**, а затем выберите соответствующую ссылку.
...
**Примечание**. Функция раскрытия спецификации также доступна на странице **Сборочная спецификация**.
