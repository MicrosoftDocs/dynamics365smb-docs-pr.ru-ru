...
# <a name="install-the-include-prodshortincludesprodshortmd-app-for-microsoft-teams" />Установите приложение [!INCLUDE [prod_short](includes/prod_short.md)] для Microsoft Teams
...
## <a name="add-the-business-central-app-to-teams" />Добавление приложения Business Central в Teams
...
## <a name="next-step" />Следующий шаг
