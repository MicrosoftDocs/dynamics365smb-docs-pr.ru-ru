...
ms.author: bholtorf
---
# <a name="set-up-locations"></a><a name="set-up-locations"></a><a name="set-up-locations"></a>Настройка складов
...
## <a name="location-cards"></a><a name="location-cards"></a><a name="location-cards"></a>Карточки склада
...
### <a name="to-set-up-a-location"></a><a name="to-set-up-a-location"></a><a name="to-set-up-a-location"></a>Настройка склада
...
### <a name="to-create-a-transfer-route"></a><a name="to-create-a-transfer-route"></a><a name="to-create-a-transfer-route"></a>Создание маршрута перемещения
...
## <a name="bins"></a><a name="bins"></a><a name="bins"></a>Ячейки
...
## <a name="zones"></a><a name="zones"></a><a name="zones"></a>Зоны
...
## <a name="default-dimensions-for-locations"></a><a name="default-dimensions-for-locations"></a><a name="default-dimensions-for-locations"></a>Размеры по умолчанию для складов
...
### <a name="example-of-default-dimensions-on-locations"></a><a name="example-of-default-dimensions-on-locations"></a><a name="example-of-default-dimensions-on-locations"></a>Примеры измерений по умолчанию для складов
...
## <a name="see-related-training-at-microsoft-learn"></a><a name="see-related-training-at-microsoft-learn"></a><a name="see-related-training-at-microsoft-learn"></a>См. соответствующее обучение на странице [Microsoft Learn](/learn/modules/trade-set-up-dynamics-365-business-central/)
