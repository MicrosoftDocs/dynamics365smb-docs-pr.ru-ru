...
Вы устанавливаете размеры по умолчанию для склада на странице **Карточка склада**, выбрав **Склад**, а потом **Измерения**. Размеры склада по умолчанию копируются в журналы и документы, когда вы указываете склад в строке, но при необходимости вы можете удалить или изменить измерение в строке. Вы можете потребовать, чтобы люди указали измерения для определенных складов, прежде чем они смогут опубликовать запись. Вы также можете включить значения измерения склада в **Приоритеты измерения по умолчанию** и **Комбинации измерений** для комбинаций правил приоритета и измерений.
