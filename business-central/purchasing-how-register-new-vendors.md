...
ms.author: bholtorf
---
# <a name="register-new-vendors" />Регистрация новых поставщиков
...
## <a name="adding-new-vendors" />Добавление новых поставщиков
...
### <a name="to-create-a-new-vendor" />Создание нового поставщика
...
### <a name="deleting-and-editing-vendor-information" />Удаление и редактирование информации о поставщике
...
## <a name="to-save-the-vendor-card-as-a-template" />Сохранение карточки поставщика в качестве шаблона
