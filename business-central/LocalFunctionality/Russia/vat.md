...
# <a name="vat-overview-in-the-russian-version"></a><a name="vat-overview-in-the-russian-version"></a>Обзор НДС в русской версии

НДС применяется к транзакциям по товарами и услугам, продаваемым в России или импортируемым в Россию.

## <a name="vat-calculation"></a><a name="vat-calculation"></a>Расчёт НДС
...
## <a name="vat-payments"></a><a name="vat-payments"></a>Уплата НДС
