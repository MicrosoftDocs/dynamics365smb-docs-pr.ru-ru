...
# <a name="custom-declaration" />Таможенная декларация
...
### <a name="to-check-the-format-of-customs-declarations" />Чтобы проверить формат таможенных деклараций
...
### <a name="to-create-a-customs-declaration" />Чтобы создать таможенную декларацию
...
### <a name="purchase-and-sales" />Покупки и продажи
...
### <a name="to-change-a-customs-declaration-number" />Чтобы изменить номер таможенной декларации
...
## <a name="printing-the-factura-invoice" />Печать счета-фактуры
Номер таможенной декларации необходимо печатать на документах счета-фактуры.

### <a name="to-print-the-posted-factura-invoice" />Печать учтенного счета-фактуры
...
### <a name="to-print-the-factura-invoice-before-posting" />Печать учтенного счета-фактуры до учета
