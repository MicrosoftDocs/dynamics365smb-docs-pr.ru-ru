...
# <a name="depreciation-bonus"></a><a name="depreciation-bonus"></a>Амортизационная премия
...
## <a name="depreciation-bonus-calculation"></a><a name="depreciation-bonus-calculation"></a>Расчет амортизационной премии
...
## <a name="depreciation-bonus-settings"></a><a name="depreciation-bonus-settings"></a>Параметры амортизационной премии
...
## <a name="selecting-and-canceling-depreciation-bonus-transactions"></a><a name="selecting-and-canceling-depreciation-bonus-transactions"></a>Выбор и отмена транзакций амортизационной премии
