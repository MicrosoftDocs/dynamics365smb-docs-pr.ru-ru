...
# <a name="inventory-setup" />Настройка запасов
...
## <a name="item-charge-assignment-in-purchase-documents" />Назначение товарных издержек в документах покупки
...
## <a name="item-corrections" />Корректировки товара
...
### <a name="adjusting-item-cost" />Корректировка себестоимости товаров
