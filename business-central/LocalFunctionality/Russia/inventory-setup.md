...
# <a name="inventory-setup"></a><a name="inventory-setup"></a>Настройка запасов
...
## <a name="item-charge-assignment-in-purchase-documents"></a><a name="item-charge-assignment-in-purchase-documents"></a>Назначение товарных издержек в документах покупки
...
## <a name="item-corrections"></a><a name="item-corrections"></a>Корректировки товара
...
### <a name="adjusting-item-cost"></a><a name="adjusting-item-cost"></a>Корректировка себестоимости товаров
