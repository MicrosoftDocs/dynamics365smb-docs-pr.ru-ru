...
# <a name="tax-differences"></a><a name="tax-differences"></a>Налоговые разницы
...
## <a name="preparing-the-chart-of-accounts"></a><a name="preparing-the-chart-of-accounts"></a>Подготовка плана счетов
...
## <a name="getting-started-with-tax-differences"></a><a name="getting-started-with-tax-differences"></a>Начало работы с налоговыми разницами
