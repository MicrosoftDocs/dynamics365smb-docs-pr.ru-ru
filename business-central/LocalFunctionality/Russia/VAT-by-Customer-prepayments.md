...
# <a name="vat-by-customer-prepayment"></a><a name="vat-by-customer-prepayment"></a>НДС по предоплатам клиентов
...
## <a name="receiving-prepayment"></a><a name="receiving-prepayment"></a>Получение предоплаты
...
## <a name="return-prepayment"></a><a name="return-prepayment"></a>Возврат предоплаты
