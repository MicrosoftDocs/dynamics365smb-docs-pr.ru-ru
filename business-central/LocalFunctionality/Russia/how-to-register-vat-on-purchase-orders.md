...
# <a name="register-vat-on-purchase-orders" />Регистрация НДС по заказам на покупку
...
## <a name="to-register-vat-on-a-purchase-order" />Регистрация НДС по заказам на покупку
