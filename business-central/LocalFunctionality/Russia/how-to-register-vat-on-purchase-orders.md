...
# <a name="register-vat-on-purchase-orders"></a><a name="register-vat-on-purchase-orders"></a>Регистрация НДС по заказам на покупку
...
## <a name="to-register-vat-on-a-purchase-order"></a><a name="to-register-vat-on-a-purchase-order"></a>Регистрация НДС по заказам на покупку
