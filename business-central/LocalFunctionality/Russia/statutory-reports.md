...
# <a name="statutory-reports"></a><a name="statutory-reports"></a>Регламентные отчеты
...
## <a name="getting-started-with-statutory-reports"></a><a name="getting-started-with-statutory-reports"></a>Начало работы с регламентными отчетами
...
## <a name="data-for-statutory-reports"></a><a name="data-for-statutory-reports"></a>Данные для регламентных отчетов
