...
# <a name="post-tax-differences"></a><a name="post-tax-differences"></a>Учет налоговых разниц
...
## <a name="to-post-tax-differences"></a><a name="to-post-tax-differences"></a>Учет налоговых разниц
