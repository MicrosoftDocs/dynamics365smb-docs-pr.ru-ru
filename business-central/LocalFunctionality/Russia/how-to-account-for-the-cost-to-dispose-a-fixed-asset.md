...
# <a name="account-for-the-cost-to-dispose-a-fixed-asset"></a><a name="account-for-the-cost-to-dispose-a-fixed-asset"></a><a name="account-for-the-cost-to-dispose-a-fixed-asset"></a>Учет себестоимости реализации основного средства
...
## <a name="to-set-up-a-maintenance-code"></a><a name="to-set-up-a-maintenance-code"></a><a name="to-set-up-a-maintenance-code"></a>Настройки кодов обслуживания
...
## <a name="to-post-expenses-on-a-fixed-asset-disposal"></a><a name="to-post-expenses-on-a-fixed-asset-disposal"></a><a name="to-post-expenses-on-a-fixed-asset-disposal"></a>Учет расходов на реализацию основного средства
...
## <a name="to-print-a-report-with-expenses-on-a-fixed-asset-disposal"></a><a name="to-print-a-report-with-expenses-on-a-fixed-asset-disposal"></a><a name="to-print-a-report-with-expenses-on-a-fixed-asset-disposal"></a>Печать отчета с расходами на реализацию основного средства
