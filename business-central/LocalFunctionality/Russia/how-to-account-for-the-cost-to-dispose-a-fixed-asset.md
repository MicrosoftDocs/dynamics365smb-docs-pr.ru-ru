...
# <a name="account-for-the-cost-to-dispose-a-fixed-asset" />Учет себестоимости реализации основного средства
...
## <a name="to-set-up-a-maintenance-code" />Настройки кодов обслуживания
...
## <a name="to-post-expenses-on-a-fixed-asset-disposal" />Учет расходов на реализацию основного средства
...
## <a name="to-print-a-report-with-expenses-on-a-fixed-asset-disposal" />Печать отчета с расходами на реализацию основного средства
