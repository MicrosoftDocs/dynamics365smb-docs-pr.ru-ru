...
# <a name="work-with-financial-reports" />Работа с финансовыми отчетами
...
## <a name="account-categories-and-financial-reports" />Категории счетов и финансовые отчеты
...
## <a name="to-create-new-financial-reports" />Создание новых финансовых отчетов
...
### <a name="to-create-a-column-that-calculates-percentages" />Создание столбца для вычисления процентов
...
## <a name="to-set-up-financial-reports-with-overviews" />Настройка финансовых отчетов с обзорами
