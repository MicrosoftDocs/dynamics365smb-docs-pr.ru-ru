...
# <a name="vat-reinstatement"></a><a name="vat-reinstatement"></a>Восстановление НДС
...
## <a name="vat-accounting-group-settings"></a><a name="vat-accounting-group-settings"></a>Параметры группы учета НДС
...
## <a name="vat-reinstatement-1"></a><a name="vat-reinstatement-1"></a>Восстановление НДС
