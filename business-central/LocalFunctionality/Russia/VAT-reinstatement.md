...
# <a name="vat-reinstatement" />Восстановление НДС
...
## <a name="vat-accounting-group-settings" />Параметры группы учета НДС
...
## <a name="vat-reinstatement-1" />Восстановление НДС
