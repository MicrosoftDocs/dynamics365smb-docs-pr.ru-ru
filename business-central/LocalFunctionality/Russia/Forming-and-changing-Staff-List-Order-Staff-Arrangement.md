...
---
# <a name="forming-and-changing-the-staff-list-order"></a><a name="forming-and-changing-the-staff-list-order"></a><a name="forming-and-changing-the-staff-list-order"></a><a name="forming-and-changing-the-staff-list-order"></a>Формирование и изменение порядка составления штатного расписания

Вы можете формировать и изменять штатное расписание.

## <a name="changing-of-staff-list"></a><a name="changing-of-staff-list"></a><a name="changing-of-staff-list"></a><a name="changing-of-staff-list"></a>Изменение штатного расписания
...
## <a name="forming-of-staff-list"></a><a name="forming-of-staff-list"></a><a name="forming-of-staff-list"></a><a name="forming-of-staff-list"></a>Формирование штатного расписания
...
## <a name="staff-arrangement"></a><a name="staff-arrangement"></a><a name="staff-arrangement"></a><a name="staff-arrangement"></a>Штатная расстановка
