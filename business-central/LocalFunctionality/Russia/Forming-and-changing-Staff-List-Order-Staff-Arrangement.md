...
---
# <a name="forming-and-changing-the-staff-list-order" /><a name="forming-and-changing-the-staff-list-order"></a>Формирование и изменение порядка составления штатного расписания

Вы можете формировать и изменять штатное расписание.

## <a name="changing-of-staff-list" /><a name="changing-of-staff-list"></a>Изменение штатного расписания
...
## <a name="forming-of-staff-list" /><a name="forming-of-staff-list"></a>Формирование штатного расписания
...
## <a name="staff-arrangement" /><a name="staff-arrangement"></a>Штатная расстановка
