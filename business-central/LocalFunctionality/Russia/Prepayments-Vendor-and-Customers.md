...
# <a name="posting-vendor-and-customer-prepayments" />Учет предоплаты поставщиков и клиентов
...
## <a name="to-post-a-prepayment" />Для учета предоплаты
...
## <a name="to-apply-prepayments" />Чтобы применить предоплаты
