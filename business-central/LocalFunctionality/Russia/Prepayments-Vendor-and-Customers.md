...
# <a name="posting-vendor-and-customer-prepayments"></a><a name="posting-vendor-and-customer-prepayments"></a>Учет предоплаты поставщиков и клиентов
...
## <a name="to-post-a-prepayment"></a><a name="to-post-a-prepayment"></a>Для учета предоплаты
...
## <a name="to-apply-prepayments"></a><a name="to-apply-prepayments"></a>Чтобы применить предоплаты
