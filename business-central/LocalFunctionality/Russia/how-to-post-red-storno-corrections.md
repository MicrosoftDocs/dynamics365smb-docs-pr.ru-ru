...
# <a name="post-red-storno-corrections" />Учет коррекций "красный сторно"
...
## <a name="to-post-corrective-entries-in-the-item-journal" />Учет корректирующих операций в журнале товаров
...
## <a name="to-reverse-item-documents" />Сторнирование товарных документов
...
## <a name="to-post-item-revaluation-or-item-reclassification-journals" />Учет журналов переоценки или реклассификации товаров
