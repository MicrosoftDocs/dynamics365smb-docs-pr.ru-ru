...
# <a name="vendor-tax-agent-scheme" />Схема налогового агента поставщика

## <a name="vat-from-internal-funds" />НДС из внутренних фондов
...
## <a name="prepayment-and-payment-vat" />Предоплата и оплата НДС
...
## <a name="vat-from-vendor-funds" />НДС из фондов поставщика
...
## <a name="post-prepayment-and-payment-vat" />Учет предоплаты и оплаты НДС
