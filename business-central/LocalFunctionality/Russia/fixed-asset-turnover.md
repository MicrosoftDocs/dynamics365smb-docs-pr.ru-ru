...
# <a name="fixed-asset-turnover"></a><a name="fixed-asset-turnover"></a><a name="fixed-asset-turnover"></a>Оборот основных средств
...
## <a name="fixed-asset-turnover-report"></a><a name="fixed-asset-turnover-report"></a><a name="fixed-asset-turnover-report"></a>Отчет по обороту основных средств
...
## <a name="comparing-depreciation-book-entries-report"></a><a name="comparing-depreciation-book-entries-report"></a><a name="comparing-depreciation-book-entries-report"></a>Отчет по сравнению записей книг амортизации
...
## <a name="fixed-asset-sheet-window"></a><a name="fixed-asset-sheet-window"></a><a name="fixed-asset-sheet-window"></a>Окно ведомости основных средств
...
## <a name="fixed-asset-general-ledger-turnover-window"></a><a name="fixed-asset-general-ledger-turnover-window"></a><a name="fixed-asset-general-ledger-turnover-window"></a>Окно "Оборотная ведомость ОС"
...
## <a name="fixed-asset-general-ledger-turnover-report"></a><a name="fixed-asset-general-ledger-turnover-report"></a><a name="fixed-asset-general-ledger-turnover-report"></a>Отчет "ОС - оборотная ведомость"
