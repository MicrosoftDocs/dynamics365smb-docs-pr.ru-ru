...
# <a name="fixed-asset-turnover" />Оборот основных средств
...
## <a name="fixed-asset-turnover-report" />Отчет по обороту основных средств
...
## <a name="comparing-depreciation-book-entries-report" />Отчет по сравнению записей книг амортизации
...
## <a name="fixed-asset-sheet-window" />Окно ведомости основных средств
...
## <a name="fixed-asset-general-ledger-turnover-window" />Окно "Оборотная ведомость ОС"
...
## <a name="fixed-asset-general-ledger-turnover-report" />Отчет "ОС - оборотная ведомость"
