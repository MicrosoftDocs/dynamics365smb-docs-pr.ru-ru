...
# <a name="set-up-responsible-employees-and-advance-statements" />Настройка материально-ответственных сотрудников и авансовых отчетов
...
## <a name="creating-the-responsible-employee-card" />Создание карточки подотчетного лица
...
### <a name="to-create-a-responsible-employee-card" />Создание карточки подотчетного лица
...
### <a name="to-create-a-responsible-employee-card-from-an-employee-card" />Создание карточки подотчетного лица из карточки сотрудника
...
## <a name="creating-the-advance-statement" />Создание авансового отчета
...
### <a name="to-access-the-advance-statement" />Чтобы открыть авансовый отчет, необходимо выполнить следующие действия.
...
## <a name="printing-an-unposted-advance-statement" />Печать неучтенного авансового отчета

Ниже показано, как напечатать неучтенный авансовый отчет.

### <a name="to-print-an-unposted-advance-statement" />Печать неучтенного авансового отчета
...
## <a name="viewing-the-posted-advance-statement" />Просмотр учтенного авансового отчета

В следующей процедуре показано, как открыть учтенный **Авансовый отчет**.

### <a name="to-view-the-posted-advance-statement" />Просмотр учтенного авансового отчета
...
## <a name="printing-the-posted-advance-statement" />Печать учтенного авансового отчета

Ниже показано, как напечатать учтенный **Авансовый отчет**.

### <a name="to-print-a-posted-advance-statement" />Печать учтенного авансового отчета
