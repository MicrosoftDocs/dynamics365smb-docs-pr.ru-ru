...
# <a name="set-up-a-bank-payment-order"></a><a name="set-up-a-bank-payment-order"></a>Настройка платежного поручения
...
## <a name="to-set-up-a-bank-payment-order"></a><a name="to-set-up-a-bank-payment-order"></a>Настройка платежного поручения
