...
## <a name="report-item-write-off-act-torg-16-based-on-an-unposted-inventory-shipment"></a><a name="report-item-write-off-act-torg-16-based-on-an-unposted-inventory-shipment"></a><a name="report-item-write-off-act-torg-16-based-on-an-unposted-inventory-shipment"></a>Отчет об акте списания товаров ТОРГ-16 на основании неучтенной расходной накладной
...
## <a name="report-item-write-off-act-torg-16-based-on-an-posted-inventory-shipment"></a><a name="report-item-write-off-act-torg-16-based-on-an-posted-inventory-shipment"></a><a name="report-item-write-off-act-torg-16-based-on-an-posted-inventory-shipment"></a>Отчет об акте списания товаров ТОРГ-16 на основании учтенной расходной накладной
...
## <a name="report-transfer-order-torg-13-based-on-an-unposted-transfer-document"></a><a name="report-transfer-order-torg-13-based-on-an-unposted-transfer-document"></a><a name="report-transfer-order-torg-13-based-on-an-unposted-transfer-document"></a>Накладная на перемещение ТОРГ-13 на основании неучтенного документа перемещения
...
## <a name="report-transfer-order-torg-13-based-on-a-posted-transfer-document---transfer-receipt"></a><a name="report-transfer-order-torg-13-based-on-a-posted-transfer-document---transfer-receipt"></a><a name="report-transfer-order-torg-13-based-on-a-posted-transfer-document---transfer-receipt"></a>Накладная на перемещение ТОРГ-13 на основании учтенного документа перемещения - "Приходная накладная на перемещение"
...
## <a name="report-transfer-order-torg-13-based-on-a-posted-transfer-document---transfer-shipment"></a><a name="report-transfer-order-torg-13-based-on-a-posted-transfer-document---transfer-shipment"></a><a name="report-transfer-order-torg-13-based-on-a-posted-transfer-document---transfer-shipment"></a>Накладная на перемещение ТОРГ-13 на основании учтенного документа перемещения - "Расходная накладная на перемещение"
