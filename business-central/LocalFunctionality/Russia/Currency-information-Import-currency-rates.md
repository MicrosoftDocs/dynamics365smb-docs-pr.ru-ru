...
# <a name="currency-information-import-currency-rates" />Информация о валюте, импорт курсов валют
...
### <a name="import-currencies" />Импорт валют
...
##### <a name="import-currency-rates" />Импорт курсов валют:
