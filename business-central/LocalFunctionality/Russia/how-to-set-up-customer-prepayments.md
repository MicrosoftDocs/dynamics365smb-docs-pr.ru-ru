...
# <a name="set-up-customer-prepayments"></a><a name="set-up-customer-prepayments"></a>Настройка предоплат клиентов
...
## <a name="to-set-up-customer-prepayments"></a><a name="to-set-up-customer-prepayments"></a>Настройка предоплат клиентов
