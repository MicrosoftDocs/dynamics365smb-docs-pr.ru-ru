...
# <a name="posting-vat-on-sales"></a><a name="posting-vat-on-sales"></a>Учет НДС в продажах
...
## <a name="trans-vat-account-field"></a><a name="trans-vat-account-field"></a>Поле "НДС транз. счет ГК"
