...
# <a name="payroll"></a><a name="payroll"></a>Зарплата
...
## <a name="payroll-accounting-groups"></a><a name="payroll-accounting-groups"></a>Учетные группы заработной платы
...
## <a name="payroll-1"></a><a name="payroll-1"></a>Зарплата
