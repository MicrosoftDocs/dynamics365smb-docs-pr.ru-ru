...
ms.reviewer: edupont
ms.author: soalex
ms.openlocfilehash: 4aab704e0508491e6495cc5409e764e9b3248389
ms.sourcegitcommit: 02e704bc3e01d62072144919774f1244c42827e4
ms.translationtype: HT
ms.contentlocale: ru-RU
ms.lasthandoff: 10/01/2019
ms.locfileid: "2301135"
---
...
1. Выберите значок ![Лампочка, которая открывает функцию Что вы хотите сделать](../../media/ui-search/search_small.png "Что вы хотите сделать"), введите **Товары - оборотная ведомость по ГК**, а затем выберите соответствующую ссылку.
