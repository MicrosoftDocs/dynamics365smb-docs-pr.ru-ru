...
# <a name="item-general-ledger-turnover"></a><a name="item-general-ledger-turnover"></a>Оборотная ведомость для товаров по ГК
...
## <a name="item-general-ledger-turnover-page-12449"></a><a name="item-general-ledger-turnover-page-12449"></a>Товары - оборотная ведомость по ГК - страница (12449)
...
## <a name="item-turnover-qty-report-12469"></a><a name="item-turnover-qty-report-12469"></a>Отчет "Оборотная ведомость товаров (кол-во)" (12469)
