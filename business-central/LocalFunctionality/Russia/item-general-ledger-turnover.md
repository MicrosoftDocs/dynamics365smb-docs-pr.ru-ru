...
# <a name="item-general-ledger-turnover" />Оборотная ведомость для товаров по ГК
...
## <a name="item-general-ledger-turnover-page-12449" />Товары - оборотная ведомость по ГК - страница (12449)
...
## <a name="item-turnover-qty-report-12469" />Отчет "Оборотная ведомость товаров (кол-во)" (12469)
