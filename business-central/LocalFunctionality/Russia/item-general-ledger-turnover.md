...
## <a name="item-general-ledger-turnover-page-" />Товары - оборотная ведомость по ГК - страница (12449)
...
## <a name="item-turnover-qty-report-" />Отчет "Оборотная ведомость товаров (кол-во)" (12469)
