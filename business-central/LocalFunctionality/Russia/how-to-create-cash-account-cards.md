...
# <a name="create-cash-account-cards"></a><a name="create-cash-account-cards"></a><a name="create-cash-account-cards"></a>Создание карточек счетов кассы
...
## <a name="to-create-a-cash-account-card"></a><a name="to-create-a-cash-account-card"></a><a name="to-create-a-cash-account-card"></a>Создание карточек счетов кассы
