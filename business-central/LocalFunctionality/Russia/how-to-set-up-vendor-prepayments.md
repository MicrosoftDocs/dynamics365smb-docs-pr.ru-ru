...
# <a name="set-up-vendor-prepayments"></a><a name="set-up-vendor-prepayments"></a>Настройка предоплат поставщикам
...
## <a name="to-set-up-vendor-prepayments"></a><a name="to-set-up-vendor-prepayments"></a>Настройка предоплат поставщикам
