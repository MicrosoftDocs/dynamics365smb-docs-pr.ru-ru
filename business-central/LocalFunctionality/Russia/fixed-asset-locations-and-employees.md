...
# <a name="fixed-asset-locations-and-employees"></a><a name="fixed-asset-locations-and-employees"></a>ОС: местоположения и ответственные сотрудники
...
## <a name="added-fields"></a><a name="added-fields"></a>Добавленные поля
