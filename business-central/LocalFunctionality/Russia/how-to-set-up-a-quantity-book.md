...
# <a name="set-up-a-quantity-book"></a><a name="set-up-a-quantity-book"></a><a name="set-up-a-quantity-book"></a>Настройка книги количественного учета
...
## <a name="to-set-up-a-quantity-book"></a><a name="to-set-up-a-quantity-book"></a><a name="to-set-up-a-quantity-book"></a>Настройка книги количественного учета
