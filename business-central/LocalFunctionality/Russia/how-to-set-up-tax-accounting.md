...
# <a name="set-up-tax-accounting"></a><a name="set-up-tax-accounting"></a><a name="set-up-tax-accounting"></a>Настройка налогового учета
...
## <a name="to-activate-tax-accounting"></a><a name="to-activate-tax-accounting"></a><a name="to-activate-tax-accounting"></a>Активация налогового учета
