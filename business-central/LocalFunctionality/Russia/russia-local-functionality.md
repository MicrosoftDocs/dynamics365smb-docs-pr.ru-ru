...
ms.author: soalex
---
# <a name="russia-local-functionality" />Функциональность локальной версии для России
...
## <a name="feature-availability" />Доступность функций
...
## <a name="future-legislation-requirements-being-investigated" />Изучение будущих законодательных требований
