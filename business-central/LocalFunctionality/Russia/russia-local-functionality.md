...
ms.author: soalex
---
# <a name="russia-local-functionality"></a><a name="russia-local-functionality"></a>Функциональность локальной версии для России
...
## <a name="feature-availability"></a><a name="feature-availability"></a>Доступность функций
...
## <a name="future-legislation-requirements-being-investigated"></a><a name="future-legislation-requirements-being-investigated"></a>Изучение будущих законодательных требований
