...
# <a name="upload-books-of-purchases-and-sales-and-the-vat-declaration-in-xml-format" />Загрузка книг покупок и продаж и декларации НДС в формате XML
...
## <a name="vat-declaration" />Декларация по НДС
...
## <a name="upload-purchase-and-sales-books-and-additional-sheets-to-xml-files" />Загрузка книг покупок и продаж, а также дополнительных листов в файлы XML
...
## <a name="uploading-vat-declaration-to-xml" />Загрузка декларации по НДС в XML
