...
# <a name="upload-books-of-purchases-and-sales-and-the-vat-declaration-in-xml-format"></a><a name="upload-books-of-purchases-and-sales-and-the-vat-declaration-in-xml-format"></a><a name="upload-books-of-purchases-and-sales-and-the-vat-declaration-in-xml-format"></a>Загрузка книг покупок и продаж и декларации НДС в формате XML
...
## <a name="vat-declaration"></a><a name="vat-declaration"></a><a name="vat-declaration"></a>Декларация по НДС
...
## <a name="upload-purchase-and-sales-books-and-additional-sheets-to-xml-files"></a><a name="upload-purchase-and-sales-books-and-additional-sheets-to-xml-files"></a><a name="upload-purchase-and-sales-books-and-additional-sheets-to-xml-files"></a>Загрузка книг покупок и продаж, а также дополнительных листов в файлы XML
...
## <a name="uploading-vat-declaration-to-xml"></a><a name="uploading-vat-declaration-to-xml"></a><a name="uploading-vat-declaration-to-xml"></a>Загрузка декларации по НДС в XML
