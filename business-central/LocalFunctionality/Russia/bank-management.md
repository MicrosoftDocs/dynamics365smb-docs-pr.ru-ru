...
# <a name="bank-management"></a><a name="bank-management"></a>Управление банками
...
## <a name="creating-bank-directory-structures"></a><a name="creating-bank-directory-structures"></a>Создание структур справочника ЦБ РФ
...
## <a name="creating-budget-classification-codes"></a><a name="creating-budget-classification-codes"></a>Создание кодов бюджетной классификации
...
## <a name="creating-bank-account-details-records"></a><a name="creating-bank-account-details-records"></a>Создание записей сведений о банковском счете
...
## <a name="printing-and-posting-required-documents"></a><a name="printing-and-posting-required-documents"></a>Печать и учет необходимых документов
