...
# <a name="bank-management" />Управление банками
...
## <a name="creating-bank-directory-structures" />Создание структур справочника ЦБ РФ
...
## <a name="creating-budget-classification-codes" />Создание кодов бюджетной классификации
...
## <a name="creating-bank-account-details-records" />Создание записей сведений о банковском счете
...
## <a name="printing-and-posting-required-documents" />Печать и учет необходимых документов
