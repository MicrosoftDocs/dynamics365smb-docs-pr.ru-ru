...
# <a name="inventory-act-of-receivables-and-payables-inv-17" />Акт инвентаризации расчетов с клиентами и поставщиками ИНВ-17
...
## <a name="setting-up-a-number-series-for-inventory-acts" />Настройка серии номеров для актов инвентаризации
...
## <a name="inventory-act-processing" />Обработка актов инвентаризации

Вы можете создавать и обрабатывать акты инвентаризации с контрагентами. Также эти акты можно напечатать.

### <a name="creating-an-inventory-act-card" />Создание карточки акта инвентаризации
...
### <a name="changing-separate-lines-in-an-inventory-act" />Изменение отдельных строк акта инвентаризации
...
## <a name="printing-the-inv-17-form-and-the-supplement-to-inv-17-form" />Печать формы ИНВ-17 и формы Приложение к ИНВ-17
