...
# <a name="inventory-act-of-receivables-and-payables-inv-" />Акт инвентаризации расчетов с клиентами и поставщиками ИНВ-17
...
## <a name="printing-the-inv--form-and-the-supplement-to-inv--form" />Печать формы ИНВ-17 и формы Приложение к ИНВ-17
