...
# <a name="setting-up-tax-difference-calculation"></a><a name="setting-up-tax-difference-calculation"></a><a name="setting-up-tax-difference-calculation"></a>Настройка расчета налоговых разниц
...
## <a name="setting-up-posting-groups"></a><a name="setting-up-posting-groups"></a><a name="setting-up-posting-groups"></a>Настройка учетных групп
