...
# <a name="set-up-an-intangible-assets-account" />Настройка счета нематериальных активов
...
## <a name="to-set-up-an-intangible-asset-account" />Настройка счета нематериальных активов
