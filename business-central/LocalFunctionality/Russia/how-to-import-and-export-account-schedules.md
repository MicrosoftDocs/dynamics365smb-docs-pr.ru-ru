...
# <a name="import-and-export-financial-reports"></a><a name="import-and-export-financial-reports"></a><a name="import-and-export-financial-reports"></a>Импорт и экспорт бухгалтерских отчетов

Вы можете импортировать и экспортировать финансовые отчеты в другие организации в базы данных.

## <a name="to-import-and-export-financial-reports"></a><a name="to-import-and-export-financial-reports"></a><a name="to-import-and-export-financial-reports"></a>Импорт и экспорт бухгалтерских отчетов
