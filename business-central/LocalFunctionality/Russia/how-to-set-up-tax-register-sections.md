...
# <a name="set-up-tax-register-sections"></a><a name="set-up-tax-register-sections"></a><a name="set-up-tax-register-sections"></a>Настройка секций налогового регистра
...
## <a name="to-set-up-a-tax-register"></a><a name="to-set-up-a-tax-register"></a><a name="to-set-up-a-tax-register"></a>Настройка налогового регистра
...
## <a name="to-remove-a-tax-register-from-the-register-list"></a><a name="to-remove-a-tax-register-from-the-register-list"></a><a name="to-remove-a-tax-register-from-the-register-list"></a>Удаление налогового регистра из списка регистров
