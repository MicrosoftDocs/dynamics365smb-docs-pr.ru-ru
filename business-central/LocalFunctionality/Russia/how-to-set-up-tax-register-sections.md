...
# <a name="set-up-tax-register-sections" />Настройка секций налогового регистра
...
## <a name="to-set-up-a-tax-register" />Настройка налогового регистра
...
## <a name="to-remove-a-tax-register-from-the-register-list" />Удаление налогового регистра из списка регистров
