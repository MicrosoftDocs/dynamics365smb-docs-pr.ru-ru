...
1. В окне **Книга покупок** или **Книга продаж** на вкладке **Действия** выберите вкладку **Параметры**.

2. Выберите **Дополнительный лист**.
...
3. Выберите поле **Дата скорректированного документа**.
