...
ms.author: soalex
---
# <a name="create-additional-sheets" />Создание дополнительных листов
...
## <a name="to-create-entries-for-an-additional-sheet-for-a-vat-purchase-or-sales-ledger" />Создание операций для дополнительного листа книги НДС покупок или продаж
...
## <a name="to-print-additional-sheets-on-a-vat-ledger" />Печать дополнительных листов книги НДС
...
## <a name="creating-corrective-documents-to-include-in-additional-sheets" />Создание корректирующих документов для включения в дополнительные листы
...
### <a name="to-create-a-correction-entry-for-posted-purchase-credit-memos" />Создание корректирующей операции для учтенных кредит-нот покупки
...
### <a name="to-create-a-correction-entry-for-a-posted-purchase-invoice" />Создание корректирующей операции для учтенного счета покупки
...
### <a name="to-post-additional-vat" />Учет дополнительного НДС
