...
# <a name="set-up-customer-and-vendor-agreements"></a><a name="set-up-customer-and-vendor-agreements"></a>Настройка договоров с клиентами и поставщиками
...
## <a name="to-set-up-an-agreement"></a><a name="to-set-up-an-agreement"></a>Настройка договора
...
## <a name="to-create-a-customer-or-vendor-agreement"></a><a name="to-create-a-customer-or-vendor-agreement"></a>Создание договора с клиентом или поставщиком
