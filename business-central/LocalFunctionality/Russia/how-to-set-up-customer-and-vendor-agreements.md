...
# <a name="set-up-customer-and-vendor-agreements" />Настройка договоров с клиентами и поставщиками
...
## <a name="to-set-up-an-agreement" />Настройка договора
...
## <a name="to-create-a-customer-or-vendor-agreement" />Создание договора с клиентом или поставщиком
