...
### <a name="to-put-away-output-with-an-inventory-put-away"></a>Размещение продукции выхода с помощью складского размещения
...
## <a name="to-put-away-assembly-and-production-output-in-advanced-warehouse-configurations"></a>Размещение сборки или выходной продукции в расширенных конфигурациях склада
