...
---
# <a name="put-away-production-or-assembly-output" />Размещение выпуска производства или сборки
...
## <a name="to-put-away-production-output-with-an-inventory-put-away" />Размещение выходной продукции с помощью размещения запасов
...
### <a name="to-create-the-inbound-warehouse-request" />Создание входящего запроса склада
...
### <a name="to-put-output-away-with-an-inventory-put-away" />Размещение продукции выхода с помощью складского размещения
...
## <a name="to-put-assembly-and-production-output-away-in-advanced-warehouse-configurations" />Размещение сборки или выходной продукции в расширенных конфигурациях склада
