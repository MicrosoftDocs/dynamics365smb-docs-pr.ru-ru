...
ms.author: edupont
---
# <a name="set-up-the-amc-banking-365-fundamentals-extension"></a><a name="set-up-the-amc-banking-365-fundamentals-extension"></a>Настройка расширения AMC Banking 365 Fundamentals
...
## <a name="to-sign-your-company-up-for-the-amc-banking-365-fundamentals-extension"></a><a name="to-sign-your-company-up-for-the-amc-banking-365-fundamentals-extension"></a>Как зарегистрировать компанию в расширении AMC Banking 365 Fundamentals
...
## <a name="to-view-or-update-the-list-of-currently-supported-bank-data-formats"></a><a name="to-view-or-update-the-list-of-currently-supported-bank-data-formats"></a>Просмотр или обновление списка поддерживаемых в настоящее время форматов банковских данных
1. Выберите ![Лампочка, которая открывает функцию Что вы хотите сделать.](media/ui-search/search_small.png "Что вы хотите сделать") значок, введите **Настройка службы преобр. банковских данных**, а затем выберите связанную ссылку.
