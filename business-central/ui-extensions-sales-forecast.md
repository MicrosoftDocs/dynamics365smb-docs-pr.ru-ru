...
# <a name="the-sales-and-inventory-forecast-extension"></a><a name="the-sales-and-inventory-forecast-extension"></a>Расширения "Прогноз продаж и запасов"
...
## <a name="setting-up-forecasting"></a><a name="setting-up-forecasting"></a>Настройка прогнозирования
...
## <a name="use-the-forecasts"></a><a name="use-the-forecasts"></a>Использование прогнозов
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>См. соответствующее [обучение Microsoft](/training/modules/use-sales-inventory-forecast-extension/)
