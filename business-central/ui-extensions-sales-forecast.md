...
# <a name="the-sales-and-inventory-forecast-extension" />Расширения "Прогноз продаж и запасов"
...
## <a name="setting-up-forecasting" />Настройка прогнозирования
...
## <a name="use-the-forecasts" />Использование прогнозов
...
## <a name="a-nameanchortext-acreate-and-use-your-own-predictive-web-service-for-sales-and-inventory-forecasts" /><a name="AnchorText"> </a>Создание собственной веб-службы прогнозирования для прогнозов продаж и запасов
