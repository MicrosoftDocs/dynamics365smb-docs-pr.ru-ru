...
ms.author: edupont
---
# <a name="design-details-item-tracking-availability"></a><a name="design-details-item-tracking-availability"></a>Сведения о проектировании: доступность трассировки товара
...
## <a name="calculation-formula"></a><a name="calculation-formula"></a>Формула расчета
