...
ms.author: edupont
---
# <a name="depreciation-methods-for-fixed-assets" />Методы амортизации для основных средств
...
## <a name="straight-line-depreciation" />Линейная амортизация
...
### <a name="depreciation-period" />Период амортизации
...
### <a name="fixed-yearly-percentage" />Фиксированный годовой процент
...
### <a name="fixed-yearly-amount" />Фиксированная ежегодная сумма
...
### <a name="example---straight-line-depreciation" />Пример - линейная амортизация
...
## <a name="declining-balance-1-depreciation" />Амортизация с уменьшаемым остатком DB 1
...
### <a name="example---declining-balance-1-depreciation" />Пример - амортизация DB 1
...
## <a name="declining-balance-2-depreciation" />Амортизация с уменьшаемым остатком DB 2
...
### <a name="example---declining-balance-2-depreciation" />Пример. Амортизация методом уменьшаемого остатка 2
...
## <a name="db1sl-depreciation" />Амортизация DB1/SL
...
### <a name="example---db1-sl-depreciation" />Пример. Амортизация DB1-SL
...
## <a name="half-year-convention-depreciation" />Амортизация с полугодовой нормой износа
...
### <a name="example---half-year-convention-depreciation" />Пример. Амортизация с полугодовой нормой износа
...
## <a name="example---db1sl-depreciation-using-half-year-convention" />Пример. Амортизация DB1/SL с использованием полугодовой нормы износа
...
## <a name="duplicating-entries-to-more-depreciation-books" />Дублирование операций в дополнительные книги амортизации
