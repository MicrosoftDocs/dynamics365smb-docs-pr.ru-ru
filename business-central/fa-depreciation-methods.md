...
# Методы амортизации для основных средств
...
## Амортизация амортизация методом уменьшаемого остатка 1
...
### Пример 1: амортизация методом уменьшаемого остатка 1
...
### Пример 2: амортизация методом уменьшаемого остатка 1
...
### Пример 3: амортизация методом уменьшаемого остатка 1
...
### Пример 4: амортизация методом уменьшаемого остатка 1
...
## Амортизация методом уменьшаемого остатка 2
...
## Дублирование операций в другие книги амортизации
