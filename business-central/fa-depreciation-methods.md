...
## <a name="declining-balance--depreciation" />Амортизация с уменьшаемым остатком DB 1
...
### <a name="example---declining-balance--depreciation" />Пример - амортизация DB 1
...
## <a name="declining-balance--depreciation" />Амортизация с уменьшаемым остатком DB 2
...
### <a name="example---declining-balance--depreciation" />Пример. Амортизация методом уменьшаемого остатка 2
...
## <a name="dbsl-depreciation" />Амортизация DB1/SL
...
### <a name="example---db-sl-depreciation" />Пример. Амортизация DB1-SL
...
## <a name="example---dbsl-depreciation-using-half-year-convention" />Пример. Амортизация DB1/SL с использованием полугодовой нормы износа
