...
ms.author: edupont
---
# <a name="depreciation-methods-for-fixed-assets"></a><a name="depreciation-methods-for-fixed-assets"></a>Методы амортизации для основных средств
...
## <a name="straight-line-depreciation"></a><a name="straight-line-depreciation"></a>Линейная амортизация
...
### <a name="depreciation-period"></a><a name="depreciation-period"></a>Период амортизации
...
### <a name="fixed-yearly-percentage"></a><a name="fixed-yearly-percentage"></a>Фиксированный годовой процент
...
### <a name="fixed-yearly-amount"></a><a name="fixed-yearly-amount"></a>Фиксированная ежегодная сумма
...
### <a name="example---straight-line-depreciation"></a><a name="example---straight-line-depreciation"></a>Пример - линейная амортизация
...
## <a name="declining-balance-1-depreciation"></a><a name="declining-balance-1-depreciation"></a>Амортизация с уменьшаемым остатком DB 1
...
### <a name="example---declining-balance-1-depreciation"></a><a name="example---declining-balance-1-depreciation"></a>Пример - амортизация DB 1
...
## <a name="declining-balance-2-depreciation"></a><a name="declining-balance-2-depreciation"></a>Амортизация с уменьшаемым остатком DB 2
...
### <a name="example---declining-balance-2-depreciation"></a><a name="example---declining-balance-2-depreciation"></a>Пример. Амортизация методом уменьшаемого остатка 2
...
## <a name="db1sl-depreciation"></a><a name="db1sl-depreciation"></a>Амортизация DB1/SL
...
### <a name="example---db1-sl-depreciation"></a><a name="example---db1-sl-depreciation"></a>Пример. Амортизация DB1-SL
...
## <a name="half-year-convention-depreciation"></a><a name="half-year-convention-depreciation"></a>Амортизация с полугодовой нормой износа
...
### <a name="example---half-year-convention-depreciation"></a><a name="example---half-year-convention-depreciation"></a>Пример. Амортизация с полугодовой нормой износа
...
## <a name="example---db1sl-depreciation-using-half-year-convention"></a><a name="example---db1sl-depreciation-using-half-year-convention"></a>Пример. Амортизация DB1/SL с использованием полугодовой нормы износа
...
## <a name="duplicating-entries-to-more-depreciation-books"></a><a name="duplicating-entries-to-more-depreciation-books"></a>Дублирование операций в дополнительные книги амортизации
