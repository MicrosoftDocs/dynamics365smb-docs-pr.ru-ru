...
* Пользовательский  
  ...
  > [!NOTE]  
  > Укажите собственный метод амортизации, задав таблицы амортизации. Подробнее о применении определенного пользователем метода амортизации см. в статье [Настройка пользовательского метода амортизации](fa-how-setup-user-defined-depreciation-method.md).
* Вручную  
