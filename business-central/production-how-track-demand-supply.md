...
ms.author: edupont
---
# <a name="track-relations-between-demand-and-supply" />Отслеживание связей между спросом и предложением
...
## <a name="to-track-linked-items" />Трассировка связанных товаров
...
## <a name="untracked-planning-elements" />Нетрассируемые элементы планирования
