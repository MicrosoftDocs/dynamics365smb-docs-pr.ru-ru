...
Прежде чем начать, вы должны убедиться, что у вас есть разрешение на запуск объектов RapidStart Services. Например, вы можете иметь набор разрешений SUPER или быть внутренним или делегированным администратором. Мы также рекомендуем вам открыть ролевой центр со ссылками на RapidStart Services, например ролевый центр администрирования. Дополнительные сведения см. в разделе [Изменение роли](ui-change-basic-settings.md#to-change-the-role).  
