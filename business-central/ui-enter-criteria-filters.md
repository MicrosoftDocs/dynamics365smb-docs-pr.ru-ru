...
В отчетах и XMLport можно устанавливать фильтры, как в списках, чтобы определить, какие данные включить в отчет или XMLport, однако выполнять сортировку и поиск в них нельзя.
