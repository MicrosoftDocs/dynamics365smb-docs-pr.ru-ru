...
ms.author: jswymer
---
# <a name="sorting-searching-and-filtering" />Сортировка, поиск и фильтрация
...
### <a name="fine-tuning-the-search-with-filter-criteria" />Точная настройка поиска с помощью критериев фильтра
...
### <a name="filtering-with-option-fields" />Фильтрация с помощью полей параметров
...
### <a name="setting-filters-on-lists" />Установка фильтров в списках
...
### <a name="setting-filters-in-reports-batch-jobs-and-xmlports" />Установка фильтров в отчетах, пакетных заданиях и XMLport
...
## <a name="entering-filter-criteria" />Ввод критериев фильтрации
...
### <a name="a-namefiltercriteria-afilter-criteria-and-operators" /><a name="FilterCriteria"> </a>Критерии фильтра и операторы
...
#### <a name="-greater-than" />(>) Больше чем

|Образец выражения|Отображаемые записи|  
|-----------------------|-----------------------|  
|`>1200`|Числа больше, чем 1 200|  

#### <a name="-greater-than-or-equal-to" />(>=) Больше чем или равно

|Образец выражения|Отображаемые записи|  
|-----------------------|-----------------------|  
|`>=1200`|Номера больше или равны 1 200|  

#### <a name="-less-than" />(<) Меньше чем

|Образец выражения|Отображаемые записи|  
|-----------------------|-----------------------|  
|`<1200`|Номера меньше, чем 1 200|  

#### <a name="-less-than-or-equal-to" />(<=) Меньше или равно
...
#### <a name="-an-exact-character-match" />('') Точное совпадение символа
...
#### <a name="-case-insensitive" />(@) Без учета регистра

|Образец выражения|Отображаемые записи|  
|-----------------------|-----------------------|  
|`@man*`|Текст, начинающийся с **man** без учета регистра.|  

#### <a name="-an-indefinite-number-of-unknown-characters" />(*) Неопределенное количество неизвестных символов
...
#### <a name="-one-unknown-character" />(?) Один неизвестный символ

|Образец выражения|Отображаемые записи|  
|-----------------------|-----------------------|  
|`Hans?n`|Такой текст, как **Hansen** или **Hanson**|  

#### <a name="combined-format-expressions" />Объединенные выражения форматов
...
### <a name="a-namefiltertokens-afilter-tokens" /><a name="FilterTokens"> </a>Токены фильтра
...
#### <a name="me-or-userid-records-assigned-to-you" />(%me или %userid) Записи, назначенные вам
...
#### <a name="mycustomers-customers-in-my-customers" />(%mycustomers) Клиенты в "Мои клиенты"
...
#### <a name="myitems-items-in-my-items" />(%myitems) Товары в списке "Мои товары"
...
#### <a name="myvendors-vendors-in-my-vendors" />(%myvendors) Поставщики в списке "Мои поставщики"
