...
### <a name="a-namefiltercriteria-afilter-criteria-and-operators"></a><a name="FilterCriteria"> </a>Критерии фильтра и операторы
...
### <a name="a-namefiltertokens-afilter-tokens"></a><a name="FilterTokens"> </a>Токены фильтра
...
## <a name="see-related-microsoft-training"></a>См. соответствующее [обучение Microsoft](/training/modules/search-filter-sort-data-dynamics-365-business-central/)
