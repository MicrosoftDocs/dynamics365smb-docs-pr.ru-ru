...
#### <a name="me-or-user-records-assigned-to-you"></a>(%me или %user) Записи, назначенные вам
...
|Образец выражения|Отображаемые записи|  
|-----------------------|-----------------------|  
|`%me`<br />или<br />`%user`|Записи, которые назначены вашей учетной записи пользователя. |  
