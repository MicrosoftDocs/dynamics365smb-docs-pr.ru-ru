...
### <a name="FilterCriteria"> </a>Критерии фильтра и операторы
...
### <a name="symbols"></a>Фильтрация значений, содержащих символы
...
#### (%me или %userid) Записи, назначенные вам
...
## См. соответствующее [обучение Microsoft](/training/modules/search-filter-sort-data-dynamics-365-business-central/)
