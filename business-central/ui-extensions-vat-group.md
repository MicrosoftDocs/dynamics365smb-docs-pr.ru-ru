...
4. В поле **Счет зачета по группе** укажите расчетный счет, используемый для сумм налога НДС участника группы.
5. В поле **Счет зачета НДС** укажите счет, который вы используете для зачета НДС.
