...
ms.author: bholtorf
---
# <a name="fulfilling-service-contracts"></a><a name="fulfilling-service-contracts"></a><a name="fulfilling-service-contracts"></a>Выполнение контрактов на обслуживание
