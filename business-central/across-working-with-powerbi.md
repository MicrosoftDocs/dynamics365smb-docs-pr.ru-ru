...
ms.author: jswymer
---
# <a name="work-with-power-bi-reports-in-"></a><a name="work-with-power-bi-reports-in-"></a>Работа с отчетами Power BI в [!INCLUDE [prod_short](includes/prod_short.md)]
...
## <a name="get-started"></a><a name="get-started"></a>Начало работы
...
### <a name="sign-up-power-bi"></a><a name="sign-up-power-bi"></a>Регистрация на Power BI
...
## <a name="connect-to-power-bi---one-time-only"></a><a name="connect-to-power-bi---one-time-only"></a><a name="connect"></a>Подключение к Power BI — только один раз
...
#### <a name="from--on-premises"></a><a name="from--on-premises"></a>Из [!INCLUDE [prod_short](includes/prod_short.md)] On-premises
...
## <a name="work-with-power-bi-reports"></a><a name="work-with-power-bi-reports"></a>Работа с отчетами Power BI

### <a name="show-reports-on-list-pages"></a><a name="show-reports-on-list-pages"></a>Отображение отчетов на страницах списков
...
### <a name="switch-reports"></a><a name="switch-reports"></a>Переключение отчетов
...
### <a name="get-more-reports"></a><a name="get-more-reports"></a>Получить больше отчетов
...
### <a name="manage-and-modify-reports"></a><a name="manage-and-modify-reports"></a>Управление отчетами и их изменение
...
### <a name="upload-reports"></a><a name="upload-reports"></a><a name="upload"></a>Отправка отчетов
...
#### <a name="you-cant-see-a-report-on-the-select-report-page-on-a-list-page"></a><a name="you-cant-see-a-report-on-the-select-report-page-on-a-list-page"></a>Вы не можете увидеть отчет на странице "Выбор отчета" на странице списка
