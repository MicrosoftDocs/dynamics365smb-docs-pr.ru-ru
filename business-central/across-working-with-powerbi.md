...
ms.author: jswymer
---
# Работа с отчетами Power BI в [!INCLUDE [prod_short](includes/prod_short.md)]

В этой статье вы узнаете некоторые основные сведения о просмотре отчетов Power BI, включая системы показателей, в [!INCLUDE [prod_short](includes/prod_short.md)].
...
## <a name="connect"></a>Подключение к Power BI — только один раз
...
#### Из [!INCLUDE [prod_short](includes/prod_short.md)] On-premises

Присоединение к Power BI из [!INCLUDE [prod_short](includes/prod_short.md)] похоже на случай Online. Однако на странице **РАЗРЕШЕНИЯ СЛУЖБЫ MICROSOFT ENTRA** вам может быть предложено предоставить доступ к службам Power BI. Чтобы предоставить доступ, выберите **Авторизовать службы Azure**, затем **Принять**.

После подключения вы можете выбрать отчет из части Power BI на страницах.

## Работа с отчетами Power BI

### Отображение отчетов на страницах списков
...
### <a name="upload"></a>Отправка отчетов
...
### Сообщение: "Включенные отчеты отсутствуют. Нажмите кнопку "Выбрать отчет", чтобы увидеть список отчетов, которые можно открыть.
...
#### Вы не можете увидеть отчет на странице "Выбор отчета" на странице списка
