...
### <a name="sign-up-power-bi" />Регистрация на Power BI
...
## <a name="work-with-power-bi-reports" />Работа с отчетами Power BI

### <a name="show-reports-on-list-pages" />Отображение отчетов на страницах списков
...
### <a name="switch-reports" />Переключение отчетов
...
### <a name="get-more-reports" />Получить больше отчетов
...
### <a name="manage-and-modify-reports" />Управление отчетами и их изменение
...
#### <a name="you-cant-see-a-report-on-the-select-report-page-on-a-list-page" />Вы не можете увидеть отчет на странице "Выбор отчета" на странице списка
