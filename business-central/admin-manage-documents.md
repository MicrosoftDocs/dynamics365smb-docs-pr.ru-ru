...
2. Выполните одно из следующих действий:
    1. Чтобы использовать руководство по мастеру настройки для настройки сжатия данных одного или нескольких типов данных, выберите **Мастер администрирования данных**.
    1. Чтобы настроить сжатие для отдельного типа данных, выберите **Сжатие данных**, **Сжать операции**, а затем выберите данные для сжатия.
