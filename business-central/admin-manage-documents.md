...
ms.author: edupont
---
# <a name="manage-storage-by-deleting-documents-or-compressing-data"></a><a name="manage-storage-by-deleting-documents-or-compressing-data"></a>Управление хранилищем путем удаления документов или сжатия данных
...
## <a name="delete-documents"></a><a name="delete-documents"></a>Удаление документов
...
## <a name="compress-data-with-date-compression"></a><a name="compress-data-with-date-compression"></a>Сжатие данных с помощью сжатия по дате
...
## <a name="posting-compressed-entries"></a><a name="posting-compressed-entries"></a>Учет сжатых операций
...
### <a name="to-run-a-date-compression"></a><a name="to-run-a-date-compression"></a>Запуск сжатия данных
