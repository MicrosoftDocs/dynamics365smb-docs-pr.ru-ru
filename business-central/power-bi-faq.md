...
## [Общие](#tab/general)
<!-- 26 -->
### Я выбрал отчет для своего ролевого центра в Business Central. Если позже я внесу изменения в визуальные элементы отчета в Интернете, будет ли центр ролей автоматически обновлен в соответствии с моими изменениями?
...
<!-- 7 -->
### Соединитель работает со страницами API?
...
<!-- 13 --> 
### Есть ли способ для конечного пользователя создать веб-службу со столбцом в таблице Business Central, но не на странице? Или разработчику придется создавать собственный запрос? 
...
-->
### <a name="perms"></a>Как изменить или удалить учетную запись пользователя, которую я сейчас использую для подключения к Business Central из Power BI Desktop?
...
<!-- 21 -->
### Если я использую фабрику данных Azure для получения данных из Business Central и использования их в Power BI, это поможет повысить производительность? 
...
### Когда я получаю данные из Business Central для использования в моих отчетах Power BI, я вижу некоторые значения, такие как "_х0020_". Что это за значения?
