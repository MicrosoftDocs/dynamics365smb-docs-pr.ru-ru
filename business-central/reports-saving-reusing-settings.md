...
ms.author: edupont
---
# <a name="manage-saved-settings-for-reports-and-batch-jobs" />Управление сохраненными настройками отчетов и пакетных заданий
...
## <a name="manage-saved-settings" />Управление сохраненными настройками
...
## <a name="create-or-modify-saved-settings-for-all-users" />Создайте или измените сохраненные настройки для всех пользователей
