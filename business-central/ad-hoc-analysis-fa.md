...
## <a name="fixed-assets-ad-hoc-analysis-scenarios"></a>Сценарии ad-hoc-анализа данных по основным средствам
...
### <a name="example-fixed-assets-current-value"></a>Пример: текущая стоимость основных средств
...
### <a name="example-asset-value-changes-over-time"></a>Изменение стоимости активов в динамике
...
### <a name="example-fixed-asset-depreciations-over-time"></a>Пример: амортизация основных средств в динамике
...
## <a name="data-foundation-for-ad-hoc-analysis-on-fixed-assets"></a>Данные, используемые для ad-hoc-анализа основных средств
