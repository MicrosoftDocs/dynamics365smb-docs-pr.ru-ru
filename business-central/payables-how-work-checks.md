...
ms.author: bholtorf
---
# Совершение платежей с помощью платежных документов
...
## Отмена напечатанных платежных документов. которые не учтены
...
## См. соответствующее [обучение Microsoft](/training/modules/use-checks-dynamics-365-business-central/)
