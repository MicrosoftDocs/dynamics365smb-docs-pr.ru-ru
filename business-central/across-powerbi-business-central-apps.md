...
ms.author: jswymer
---
# <a name="use-the--apps-in-power-bi"></a>Использование приложений [!INCLUDE [prod_short](includes/prod_short.md)] в Power BI
...
Приложениям Power BI требуются разрешения в отношении таблиц, из которых извлекаются данные, и веб-служб, используемых для извлечения данных. В следующей таблице перечислены веб-службы, необходимые для каждого приложения Power BI:
...
## <a name="install-a--app-in-power-bi"></a>Установка приложения [!INCLUDE[prod_short](includes/prod_short.md)] в Power BI
...
2. На панели навигации выберите **Приложения**.
    
    Откроется страница **Приложения**.

3. На странице **Приложения** выберите **Получить приложения** в правом верхнем углу страницы.
    
    Откроется страница **Приложения Power BI**, на которой вы сможете найти приложения, доступные для [!INCLUDE[prod_short](includes/prod_short.md)].

    ![Переход на страницу для получения приложений.](./media/across-how-to-connect-powerbi-d365-content-packs/powerbi-get-data.png)

> [!TIP] 
> Вы также можете открыть **Отчет Power BI** из [!INCLUDE [prod_short](includes/prod_short.md)]. Выберите «Отчеты Power BI» и **Выбрать отчеты** на своей домашней странице. В разделе **Получить отчеты** выберите **Службы** или **Моя организация**. Откроется галерея организации в Power BI или Microsoft AppSource, в которой отображаются только приложения, связанные с [!INCLUDE[prod_short](includes/prod_short.md)].

5. В поле **Поиск** введите **Dynamics 365 Business Central**.
6. Выберите приложение, которое вы хотите использовать, выберите **Получить сейчас**, затем **Установить**.  

    По завершении приложение будет доступно в пункте **Приложения** в меню навигации в Power BI.

## <a name="connect-the--app-to-your-data"></a>Подключение приложения [!INCLUDE[prod_short](includes/prod_short.md)] к вашим данным
...
### <a name="message-there-are-no-enabled-reports-select-report-to-see-a-list-of-reports-that-you-can-display"></a>Сообщение: "Включенные отчеты отсутствуют. Выберите «Отчет», чтобы увидеть список отчетов, которые можно открыть.
...
### <a name="you-need-a-power-bi-pro-license-to-install-the--app-in-power-bi"></a>Вам необходима лицензия Power BI Pro для установки приложения [!INCLUDE[prod_short](includes/prod_short.md)] в Power BI
