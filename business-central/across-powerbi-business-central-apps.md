...
ms.author: jswymer
---
# Использование приложений [!INCLUDE [prod_short](includes/prod_short.md)] в Power BI
...
## Установка приложения [!INCLUDE[prod_short](includes/prod_short.md)] в Power BI
...
## Подключение приложения [!INCLUDE[prod_short](includes/prod_short.md)] к вашим данным
...
### У вас нет учетной записи Power BI
...
### Сообщение: "Включенные отчеты отсутствуют. Выберите «Отчет», чтобы увидеть список отчетов, которые можно открыть.
...
### Вам необходима лицензия Power BI Pro для установки приложения [!INCLUDE[prod_short](includes/prod_short.md)] в Power BI
...
### Сообщение: ваш источник данных не может быть обновлен, потому что учетные данные недействительны. Обновите свои учетные данные и попробуйте еще раз
...
### Ключ не соответствует ни одной из строк в таблице
...
### Я вижу данные только для одной организации
