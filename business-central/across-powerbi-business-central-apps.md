...
### <a name="you-dont-have-a-power-bi-account" />У вас нет учетной записи Power BI
...
### <a name="message-there-are-no-enabled-reports-choose-select-report-to-see-a-list-of-reports-that-you-can-display" />Сообщение: "Включенные отчеты отсутствуют. Нажмите кнопку "Выбрать отчет", чтобы увидеть список отчетов, которые можно открыть."
...
### <a name="parameter-validation-failed-please-make-sure-all-parameters-are-valid" />"Ошибка при проверке параметра. Убедитесь, что все параметры допустимы"
...
### <a name="cant-sign-in" />Не удается войти
...
### <a name="message-your-data-source-cant-be-refreshed-because-the-credentials-are-invalid-please-update-your-credentials-and-try-again" />Сообщение: ваш источник данных не может быть обновлен, потому что учетные данные недействительны. Обновите свои учетные данные и попробуйте еще раз
...
### <a name="incorrect-company-name" />Неверное название организации
...
### <a name="the-key-didnt-match-any-rows-in-the-table" />Ключ не соответствует ни одной из строк в таблице
...
### <a name="historical-data-appears-to-be-missing" />Исторические данные отсутствуют
...
### <a name="i-only-see-data-for-a-single-company" />Я вижу данные только для одной организации
