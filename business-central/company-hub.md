...
# <a name="manage-work-across-multiple-companies-in-the-company-hub" />Управление работой нескольких компаний в разделе организаций
...
## <a name="company-hub-home-page" />Домашняя страница раздела организации
...
## <a name="assigned-tasks" />Назначенные задачи
...
### <a name="my-user-tasks" />Мои задачи пользователя
...
## <a name="access-the-company-hub" />Доступ к разделу организации
...
## <a name="set-up-the-company-hub" />Настройка раздела организации
