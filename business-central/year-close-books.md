...
ms.author: jswymer
---
# <a name="closing-the-books"></a><a name="closing-the-books"></a>Закрытие книг
...
## <a name="closing-book-process"></a><a name="closing-book-process"></a>Процесс закрытия книги
...
## <a name="what-happens-when-you-close"></a><a name="what-happens-when-you-close"></a>Что произойдет после закрытия
