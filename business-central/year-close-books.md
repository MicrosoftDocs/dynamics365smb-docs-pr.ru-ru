...
ms.author: jswymer
---
# <a name="closing-the-books" />Закрытие книг
...
## <a name="closing-book-process" />Процесс закрытия книги
...
## <a name="what-happens-when-you-close" />Что произойдет после закрытия
